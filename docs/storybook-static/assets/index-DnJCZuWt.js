import"./index-DOWla3nt.js";import"./index-BGQl1LKU.js";import{T as g}from"./toggle.constants-C_vhhR1i.js";import{T as i}from"./index-riA1qVWu.js";import"./index-DFdAu0El.js";import{i as u,k as r,D as a}from"./lit-element-D5KKan5q.js";import{n as k}from"./provider.component-BaQC7CJH.js";import{R as b}from"./class-map-BcCVsMyu.js";import{R as f}from"./roles-DU0xbrD4.js";import{M as m}from"./menuitem.component-D3BPzg6E.js";import{D as E,I as o,T}from"./menuitemcheckbox.constants-CWk8F82j.js";const C=u`
...
`,L=[C];var v=Object.defineProperty,p=(l,e,n,x)=>{for(var t=void 0,c=l.length-1,h;c>=0;c--)(h=l[c])&&(t=h(e,n,t)||t);return t&&v(e,n,t),t};const d=class d extends m{constructor(){super(),this.checked=!1,this.indicator=E.INDICATOR,this.addEventListener("click",this.handleMouseClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=f.MENUITEMCHECKBOX}handleMouseClick(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}update(e){super.update(e),e.has("checked")&&(this.ariaChecked=`${this.checked}`)}staticCheckbox(){return this.indicator===o.CHECKBOX?r`
    ...
    `}};d.styles=[...m.styles,...L];let s=d;p([k({type:Boolean,reflect:!0})],s.prototype,"checked");p([k({type:String,reflect:!0})],s.prototype,"indicator");s.register(T);
