import{S as E,U as y,X as R,u as S,q as N,V as I,c as _,k as c,h as O,E as $,n as T}from"./iframe-1S-3kruQ.js";import{B as x}from"./buttonsimple.component-aqhU12I7.js";import"./index-DMCOyubd.js";import{c as w,s as L}from"./commonArgTypes-BluK8w5L.js";import{a as U}from"./utils-Dd_sfl9-.js";import"./preload-helper-C1FmrZbK.js";import"./TabIndexMixin-BzAaGOX6.js";import"./DisabledMixin-CoPZzXIJ.js";import"./index-B4c666dc.js";import"./index-DTrDRi1E.js";const C=E`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,V=[y,C,...R()],D=S.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:N.BODY_MIDSIZE_REGULAR,TAG_NAME:I.SPAN,SIZE:_[24],ROLE:"button"},G=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var M=Object.defineProperty,f=(r,i,h,j)=>{for(var a=void 0,d=r.length-1,p;d>=0;d--)(p=r[d])&&(a=p(i,h,a)||a);return a&&M(i,h,a),a};const m=class m extends x{constructor(){super(...arguments),this.variant=e.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return c`
      ...
      ${this.label?c`<mdc-text part="label" type="${e.TEXT_TYPE}" tagname="${e.TAG_NAME}"
            >${this.label}</mdc-text
          >`:O}
    `}};m.styles=[...$.styles,...V];let t=m;f([T({type:String})],t.prototype,"variant");f([T({type:String})],t.prototype,"label");t.register(D);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,P=r=>c` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
