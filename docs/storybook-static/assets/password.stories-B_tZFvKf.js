import"./index-DfWVvsBp.js";import"./index-BK86NvBQ.js";import{u as M,h as Y,k as w,B as j,a4 as U,n as g}from"./iframe-DtiRZQ2l.js";import"./index-DhTfUzOi.js";import{I as y}from"./input.component-CPjgxhDe.js";import{I as v}from"./input.constants-D6HOI2GJ.js";import{D as $,V as G}from"./formfieldwrapper.constants-B3uNFiAc.js";import{t as o}from"./if-defined-r97CdV4N.js";import{c as K,s as X}from"./commonArgTypes-BG7EqI50.js";import{h as Z}from"./utils-B5QUENNQ.js";import{P as J,S as Q}from"./popover.constants-BYzMFhXU.js";import"./button.component-CbP3poVC.js";import"./buttonsimple.component-Q3CPaVOs.js";import"./DisabledMixin-D_v0Rzs7.js";import"./KeyDownHandledMixin-DXj2iMY0.js";import"./index-DOdZz0Sq.js";import"./button.utils-rNW36Ji7.js";import"./preload-helper-C1FmrZbK.js";import"./index-DTrDRi1E.js";import"./popover.component-B7wDhef-.js";import"./BackdropMixin-DeyzsEP1.js";import"./index-CsiNuVo8.js";import"./v4-CmTdKEVZ.js";import"./directive-Ctav8iJK.js";import"./index-g6DkUIkb.js";import"./formfieldwrapper.component-CkDgddNq.js";import"./DataAriaLabelMixin-CLQqFjU0.js";import"./FormInternalsMixin-DvPMNih1.js";const S={HIDE_BOLD:"hide-bold",SHOW_BOLD:"show-bold"},ee=M.constructTagName("password");var te=Object.defineProperty,f=(e,r,s,d)=>{for(var t=void 0,a=e.length-1,l;a>=0;a--)(l=e[a])&&(t=l(r,s,t)||t);return t&&te(r,s,t),t};const x=class x extends y{constructor(){super(...arguments),this.showButtonAriaLabel="",this.hideButtonAriaLabel="",this.helpTextType=$.VALIDATION,this.showPassword=!1}connectedCallback(){super.connectedCallback(),this.trailingButton=!0}toggleShowPassword(){this.showPassword=!this.showPassword}renderTrailingButton(r=!1){const s=r||this.value;return s?w`
      <mdc-button
      ...
      ></mdc-button>
    `:Y}renderInputElement(r,s){const d=this.showPassword?v.TEXT:v.PASSWORD;return super.renderInputElement(d,s)}};x.styles=[...y.styles];let n=x;f([g({type:String,attribute:"show-button-aria-label",reflect:!0})],n.prototype,"showButtonAriaLabel");f([g({type:String,attribute:"hide-button-aria-label",reflect:!0})],n.prototype,"hideButtonAriaLabel");f([g({type:String,attribute:"help-text-type"})],n.prototype,"helpTextType");f([U()],n.prototype,"showPassword");n.register(ee);const{action:i}=__STORYBOOK_MODULE_ACTIONS__,C=e=>{const r=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return w` <mdc-password
    @input="${i("oninput")}"
    @change="${i("onchange")}"
    @focus="${i("onfocus")}"
    @blur="${i("onblur")}"
...
}`,...(N=(k=b.parameters)==null?void 0:k.docs)==null?void 0:N.source}}};const qe=["Example","FormFieldPassword","FormFieldPasswordWithHelpTextValidation","DefaultValidation","ErrorValidation","SuccessValidation"];export{c as DefaultValidation,h as ErrorValidation,p as Example,u as FormFieldPassword,m as FormFieldPasswordWithHelpTextValidation,b as SuccessValidation,qe as __namedExportsOrder,Oe as default};
