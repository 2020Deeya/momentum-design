import{k as i}from"./iframe-27lSNS5L.js";import{t as f}from"./if-defined-Cfu5CGM9.js";import"./index-Bc7wK8do.js";import"./index-DogmHr-7.js";import{c as D,s as v}from"./commonArgTypes-BG7EqI50.js";import{h as U,a as W}from"./utils-B5QUENNQ.js";import{V as L}from"./ControlTypeMixin-lI57aift.js";import{I as c}from"./menuitemcheckbox.constants-7fwRvnsk.js";import"./preload-helper-C1FmrZbK.js";import"./index-C_tIGTbA.js";import"./DisabledMixin-C8yRpiPh.js";import"./formfieldwrapper.constants-Dhs6NMSb.js";import"./popover.constants-0eGuKeFU.js";import"./toggle.constants-DeuioLeT.js";import"./index-BlOMbVH0.js";import"./popover.component-BsQBAUky.js";import"./BackdropMixin-tLZVBOEW.js";import"./KeyDownHandledMixin-C0pPiymU.js";import"./index-VdFiEtqE.js";import"./v4-CmTdKEVZ.js";import"./class-map-C0YyyVA7.js";import"./directive-Ctav8iJK.js";import"./menuitem.component-CU8ektZG.js";import"./listitem.component-Dq1fn1Qo.js";import"./query-assigned-elements-CnblnU_U.js";import"./LifeCycleMixin-CkFTW4AQ.js";import"./listitem.constants-X_X8IF7b.js";import"./index-DTrDRi1E.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,M=e=>i`<div role="menu" style="width: 25rem;">${e}</div>`,O=e=>M(i` <mdc-menuitemcheckbox
      @change="${l("onchange")}"
      @click="${l("onclick")}"
      @focus="${l("onfocus")}"
      ?disabled="${e.disabled}"
    ...
    >
      ${e.children}
    </mdc-menuitemcheckbox>`),de={title:"Components/menupopover/menuitemcheckbox",tags:["autodocs"],component:"mdc-menuitemcheckbox",render:O,argTypes:{checked:{control:"boolean"},indicator:{control:"select",options:Object.values(c)},disabled:{control:"boolean"},label:{control:"text"},"secondary-label":{control:"text"},"control-type":{control:"select",options:[void 0,...L]},"soft-disabled":{control:"boolean"},...U(["data-aria-label","variant","tertiary-label","side-header-text","subline-text","leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","arrow-position","arrow-direction"]),...D,...v}},o={args:{indicator:c.CHECKBOX,checked:!1,label:"Menu Item",disabled:!1,"secondary-label":"",children:i`<mdc-icon length-unit="rem" name="alert-muted-bold" slot="leading-controls"></mdc-icon>`}},t={args:{checked:!0,indicator:c.TOGGLE,label:"Menu Item With Toggle",disabled:!1,"secondary-label":""}},m={args:{checked:!0,indicator:c.CHECKBOX,label:"Menu Item With Checkbox",disabled:!1,"secondary-label":""}},n={args:{checked:!0,indicator:c.CHECKMARK,label:"Menu Item With Checkmark",disabled:!1,"secondary-label":""}},d={render:()=>M(i`
  ...
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};const ie=["Example","ToggleWithMenuItem","CheckboxWithMenuItem","CheckmarkWithMenuItem","AllVariants"];export{d as AllVariants,m as CheckboxWithMenuItem,n as CheckmarkWithMenuItem,o as Example,t as ToggleWithMenuItem,ie as __namedExportsOrder,de as default};
