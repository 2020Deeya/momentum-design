import{N as f,r as h,h as u,q as x,a2 as v,a4 as T,k as c,n as o}from"./iframe-DKOSXYge.js";import{t as p}from"./if-defined-9DVKm8cQ.js";import{e as E,i as $,t as d}from"./directive-Ctav8iJK.js";import"./index-SPGVoC_t.js";import{D as A}from"./formfieldwrapper.constants-DHCgIqCo.js";import{D as I}from"./DataAriaLabelMixin-_U9vqJnT.js";import{F as _}from"./FormInternalsMixin-F02z8FKV.js";import{A as k}from"./buttonsimple.component-m5qQMgZ_.js";import{a as C,A as O,N as w}from"./KeyDownHandledMixin-BZbD0Ghi.js";import{A as F,a as N,D as l,P as S}from"./input.constants-Ck9RyprQ.js";import{F as g}from"./formfieldwrapper.component-mnD_8GSS.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L=E(class extends ${constructor(i){if(super(i),i.type!==d.PROPERTY&&i.type!==d.ATTRIBUTE&&i.type!==d.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!f(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===h||t===u)return t;const e=i.element,a=i.name;if(i.type===d.PROPERTY){if(t===e[a])return h}else if(i.type===d.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(a))return h}else if(i.type===d.ATTRIBUTE&&e.getAttribute(a)===t+"")return h;return x(i),t}}),R=[v`
    :host {
  ...
  `,...T(!0)];var P=Object.defineProperty,n=(i,t,e,a)=>{for(var s=void 0,m=i.length-1,b;m>=0;m--)(b=i[m])&&(s=b(t,e,s)||s);return s&&P(t,e,s),s};const y=class y extends C(k(_(I(g)))){constructor(){super(...arguments),this.placeholder="",this.trailingButton=!1,this.autocapitalize=F.OFF,this.autocomplete=N.OFF,this.clearAriaLabel="",this.dataAriaDescribedby=null}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.setInputValidity(),this.internals.setFormValue(this.inputElement.value))}).catch(t=>{this.onerror&&this.onerror(t)})}firstUpdated(t){this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(t)}formResetCallback(){this.value="",this.inputElement.value="",this.setInputValidity(),this.requestUpdate()}formStateRestoreCallback(t){this.value=t}attributeChangedCallback(t,e,a){super.attributeChangedCallback(t,e,a),t==="validation-message"&&this.updateComplete.then(()=>{this.setInputValidity()}).catch(s=>{this.onerror&&this.onerror(s)})}setInputValidity(){this.inputElement.setCustomValidity(""),!this.inputElement.validity.valid&&this.validationMessage&&this.inputElement.setCustomValidity(this.validationMessage),this.setValidity()}updateValue(){this.value=this.inputElement.value,this.internals.setFormValue(this.inputElement.value)}onInput(){this.updateValue(),this.setInputValidity(),this.checkValidity()}onChange(t){this.updateValue(),this.setInputValidity();const e=t.constructor;this.dispatchEvent(new e(t.type,t))}handleKeyDown(t){var e;this.getActionForKeyEvent(t)===O.ENTER&&this.getKeyboardNavMode()===w.DEFAULT&&((e=this.form)==null||e.requestSubmit())}renderLeadingIcon(){return this.leadingIcon?c`
    ...
    `:u}renderInputElement(t,e=!1){const a=e?"":this.placeholder;return c`<input
      ...
      type="${t}"
      aria-describedby="${p(this.helpText?A.HELPER_TEXT_ID:this.dataAriaDescribedby??"")}"
    ...
    `}};y.styles=[...g.styles,...R];let r=y;n([o({type:String})],r.prototype,"placeholder");n([o({type:String,attribute:"prefix-text"})],r.prototype,"prefixText");n([o({type:String,attribute:"leading-icon"})],r.prototype,"leadingIcon");n([o({type:Boolean,attribute:"trailing-button"})],r.prototype,"trailingButton");n([o({type:Number})],r.prototype,"maxlength");n([o({type:Number})],r.prototype,"minlength");n([o({type:String})],r.prototype,"autocapitalize");n([o({type:String})],r.prototype,"autocomplete");n([o({type:String})],r.prototype,"dirname");n([o({type:String})],r.prototype,"pattern");n([o({type:String})],r.prototype,"list");n([o({type:Number})],r.prototype,"size");n([o({type:String,attribute:"clear-aria-label"})],r.prototype,"clearAriaLabel");n([o({type:String,reflect:!0,attribute:"data-aria-describedby"})],r.prototype,"dataAriaDescribedby");export{L as F,r as I};
