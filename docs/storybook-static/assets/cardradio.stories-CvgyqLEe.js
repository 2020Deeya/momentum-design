import{i as Z,D as P,k as l}from"./lit-element-D5KKan5q.js";import{n as j}from"./provider.component-BaQC7CJH.js";import{D as Q}from"./DisabledMixin-DcYwkKYf.js";import{T as K}from"./TabIndexMixin-TvgH_pmh.js";import{C as x}from"./card.component-CILrMeDi.js";import{R as X}from"./roles-DU0xbrD4.js";import{K as y}from"./keys-hFXe221I.js";import{a as Y}from"./index-B-GnYs90.js";import{T as J}from"./index-CWmbmZhr.js";import"./index-BmhPXs3q.js";import{V as E}from"./index-riA1qVWu.js";import"./index-CeWuhPGb.js";import{Q as ee}from"./repeat-CNQ7t7Vw.js";import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as te,s as ae}from"./commonArgTypes-BluK8w5L.js";import{a as re,t as oe,d as ie}from"./utils-CFOyPOhY.js";import{V as le,O as T,D as t}from"./FooterMixin-9o7JZZe3.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-BpS-4nLb.js";import"./buttonsimple.constants-CNAgWCp2.js";import"./index-DCVXJxdB.js";import"./index-CD8x53FU.js";import"./button.component-DvOKP7op.js";import"./state-C0WmBOuD.js";import"./buttonsimple.component-I-gcvU8_.js";import"./button.utils-rNW36Ji7.js";import"./index-fJma5t3H.js";import"./popover.component-LefqH8IC.js";import"./if-defined-D5BV9-c0.js";import"./index-Dm_kZN_u.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-Cpdy3gUS.js";import"./formfieldwrapper.component-C-SgLT80.js";import"./radio.constants-9sXjEnlE.js";import"./iframe-di5J3S6I.js";import"../sb-preview/runtime.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-ChWiF_5p.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-Df3Yk0mX.js";const de=Z`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,se=[de,...Y()];var ne=Object.defineProperty,q=(e,a,i,d)=>{for(var r=void 0,o=e.length-1,I;o>=0;o--)(I=e[o])&&(r=I(a,i,r)||r);return r&&ne(a,i,r),r};const f=class f extends Q(K(x)){constructor(){super(),this.checked=!1,this.name="",this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=X.RADIO}getAllCardsWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-cardradio[name="${this.name}"]`))}toggleChecked(){if(this.disabled)return;this.getAllCardsWithinSameGroup().forEach(i=>{i.checked=!1}),this.checked=!0}setDisabled(a){this.setAttribute("aria-disabled",`${a}`),this.tabIndex=a?-1:0}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&this.setDisabled(this.disabled)}updateCardRadio(a,i){a[i].focus(),a[i].toggleChecked()}toggleOnEnter(a){if(this.disabled)return;const d=this.getAllCardsWithinSameGroup().filter(o=>!o.disabled),r=d.indexOf(this);if(["ArrowDown","ArrowRight"].includes(a.key)){const o=(r+1)%d.length;this.updateCardRadio(d,o)}else if(["ArrowUp","ArrowLeft"].includes(a.key)){const o=(r-1+d.length)%d.length;this.updateCardRadio(d,o)}a.key===y.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===y.SPACE&&this.toggleChecked()}renderHeader(){return this.cardTitle?l`<div part="header">
    ...
    `}};f.styles=[...x.styles,...se];let c=f;q([j({type:Boolean,reflect:!0})],c.prototype,"checked");q([j({type:String})],c.prototype,"name");c.register(J);const ce=e=>l` <mdc-cardradio
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
  ...
  >`,tt={title:"Components/card/cardradio",tags:["autodocs"],component:"mdc-cardradio",render:ce,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(le)},orientation:{control:"select",options:Object.values(T)},name:{control:"text"},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"title-tag-name":{control:"select",options:Object.values(E)},"subtitle-tag-name":{control:"select",options:Object.values(E)},...re(["children"]),...oe(["--mdc-card-width"]),...te,...ae}},s=l`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
...
>`,m={args:{"card-title":"Title",name:"radio-card",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,variant:t.VARIANT,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,children:s}},p={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x280","image-alt":"Image Alt","icon-name":"placeholder-bold","aria-label":"Aria Label","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:T.HORIZONTAL,children:s}},h={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"aria-label":"Aria Label",checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION,children:s}},b={args:{"image-src":"https://placehold.co/320x200","image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION}},u={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,children:l` <mdc-text slot="before-body" type="body-midsize-medium" tagname="span"
  ...
  `,argTypes:{...ie(["aria-label","name","variant","orientation","card-title","subtitle","image-src","image-alt","icon-name","checked","disabled","tabIndex"])}};var k,v,N;m.parameters={...m.parameters,docs:{...(k=m.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    name: 'radio-card',
    subtitle: 'Subtitle',
...
}`,...(W=(z=A.parameters)==null?void 0:z.docs)==null?void 0:W.source}}};const at=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInRadioGroup"];export{b as CardWithoutBody,h as CardWithoutImage,A as CardsInRadioGroup,g as ContentAfterBody,u as ContentBeforeBody,m as Example,p as HorizontalCard,at as __namedExportsOrder,tt as default};
