import{S as p,u as g,k as c,h,V as v,q as b,n as m}from"./iframe-BiyimdiQ.js";import{t as f}from"./if-defined-CMi5315P.js";import{d,b as y}from"./dialog.component-umuTYKHX.js";import"./index-Bo-BlVMu.js";const x=p`
  :host {
...
`,E=[x],S=g.constructTagName("announcementdialog"),z=["medium","large","xlarge","fullscreen"],_={SIZE:"medium"};var D=Object.defineProperty,T=Object.getOwnPropertyDescriptor,u=(l,t,r,i)=>{for(var e=i>1?void 0:i?T(t,r):t,a=l.length-1,o;a>=0;a--)(o=l[a])&&(e=(i?o(t,r,e):o(e))||e);return i&&e&&D(t,r,e),e};const s=class s extends d{get size(){var t,r;return(r=(t=this.responsiveSettingsContext)==null?void 0:t.value)!=null&&r.forceFullscreenDialog?"fullscreen":this.internalSize}set size(t){this.internalSize=t}constructor(){super(),this.internalSize=_.SIZE}connectedCallback(){super.connectedCallback(),this.variant=y.DEFAULT}renderHeader(){return c`${h}`}renderBody(){return c`
      <div part="body">
    ...
    `}};s.styles=[...d.styles,...E];let n=s;u([m({type:String,reflect:!0})],n.prototype,"illustration",2);u([m({type:String,reflect:!0})],n.prototype,"size",1);n.register(S);export{z as A,_ as D};
