import"./index-DfmSPb8h.js";import{i as h,k as v}from"./lit-element-D5KKan5q.js";import{u as m,C as s,n}from"./provider.component-BaQC7CJH.js";import{D as p}from"./DisabledMixin-DcYwkKYf.js";const b=m.constructTagName("statictoggle"),u={DEFAULT:"default",COMPACT:"compact"},l={CHECKED:"check-bold",UNCHECKED:"cancel-bold"},E={compact:.75,default:1.25},f={SIZE:u.DEFAULT},k=[h`
    :host {
  ...
  `];var C=Object.defineProperty,g=(r,a,i,y)=>{for(var t=void 0,c=r.length-1,d;c>=0;c--)(d=r[c])&&(t=d(a,i,t)||t);return t&&C(a,i,t),t};const e=class e extends p(s){constructor(){super(...arguments),this.checked=!1,this.size=f.SIZE}render(){return v`
    ...
    `}};e.styles=[...s.styles,...k];let o=e;g([n({type:Boolean,reflect:!0})],o.prototype,"checked");g([n({type:String,reflect:!0})],o.prototype,"size");o.register(b);const I=m.constructTagName("toggle"),A={DEFAULT:"default",COMPACT:"compact"},N={SIZE:A.DEFAULT,VALIDATION_MESSAGE:"Please toggle this switch if you want to proceed."};export{N as D,A as T,I as a};
