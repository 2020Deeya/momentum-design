import{i as g,k as m}from"./lit-element-D5KKan5q.js";import{n as i}from"./index-C9z9WAEj.js";import{r as b}from"./state-CSSggq2n.js";import{a as v}from"./buttonsimple.component-9hW3yvQZ.js";import{D as a,B as l,b as d,I as y,P as k,a as x,T as I}from"./button.constants-Bfip8hYE.js";import{g as f}from"./button.utils-rNW36Ji7.js";import"./index-D9plsxGQ.js";const z=g`
  :host {
...
`,N=[z];var T=Object.defineProperty,e=(h,o,n,s)=>{for(var r=void 0,c=h.length-1,p;c>=0;c--)(p=h[c])&&(r=p(o,n,r)||r);return r&&T(o,n,r),r};const u=class u extends v{constructor(){super(...arguments),this.variant=a.VARIANT,this.size=a.SIZE,this.color=a.COLOR,this.role="button",this.typeInternal=a.TYPE_INTERNAL}update(o){super.update(o),o.has("active")&&this.inferFilledIconName(this.active),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(o){o?(this.prefixIcon&&(this.prefixFilledIconName=`${f(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${f(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}setVariant(o){this.setAttribute("variant",Object.values(l).includes(o)?o:a.VARIANT)}setSize(o){const s=this.typeInternal===d.ICON?Object.values(y).includes(o)&&!(o===y[20]&&this.variant!==l.TERTIARY):Object.values(k).includes(o);this.setAttribute("size",s?`${o}`:`${a.SIZE}`)}setColor(o){!Object.values(x).includes(o)||this.variant===l.TERTIARY?this.setAttribute("color",`${a.COLOR}`):this.setAttribute("color",o)}inferButtonType(){var n,s;const o=(s=(n=this.shadowRoot)==null?void 0:n.querySelector("slot"))==null?void 0:s.assignedNodes().filter(r=>{var c;return r.nodeType!==Node.TEXT_NODE||((c=r.textContent)==null?void 0:c.trim())}).length;o&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=d.PILL_WITH_ICON,this.setAttribute("data-btn-type","pill-with-icon")):!o&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=d.ICON,this.setAttribute("data-btn-type","icon")):(this.typeInternal=d.PILL,this.setAttribute("data-btn-type","pill"))}render(){return m`
    ...
    `}};u.styles=[...v.styles,...N];let t=u;e([i({type:String,attribute:"prefix-icon",reflect:!0})],t.prototype,"prefixIcon");e([i({type:String,attribute:"postfix-icon",reflect:!0})],t.prototype,"postfixIcon");e([i({type:String})],t.prototype,"variant");e([i({type:Number})],t.prototype,"size");e([i({type:String})],t.prototype,"color");e([i({type:String,reflect:!0})],t.prototype,"role");e([b()],t.prototype,"typeInternal");e([b()],t.prototype,"prefixFilledIconName");e([b()],t.prototype,"postfixFilledIconName");t.register(I);export{t as B};
