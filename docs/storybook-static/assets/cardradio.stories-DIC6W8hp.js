import{i as q,D as Z,k as l}from"./lit-element-D5KKan5q.js";import{n as W}from"./index-C9z9WAEj.js";import{h as Q}from"./index-MA1r3zrt.js";import{D as P}from"./DisabledMixin-BZruwOeC.js";import{T as X}from"./TabIndexMixin-CsrHswKP.js";import{C as x}from"./card.component-DpGb14jq.js";import{R as J}from"./roles-Ch6n0tol.js";import{T as K}from"./index-CkhtyItZ.js";import"./index-EdEUAxWC.js";import{V as y}from"./index-D1yLszQ-.js";import"./index-BQHpR8ua.js";import{Q as Y}from"./repeat-CNQ7t7Vw.js";import{a as s}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as ee,s as te}from"./commonArgTypes-BluK8w5L.js";import{h as ae,d as re}from"./utils-CO8B6ZcN.js";import{V as oe,O as T,D as t}from"./CardAndDialogFooterMixin-DHafZQ0X.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-D0QAbDxL.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./index-BPCHG_9R.js";import"./index-B-wQI-3B.js";import"./button.component-CETyLHgp.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-UuTVCePh.js";import"./button.utils-rNW36Ji7.js";import"./index-CPByYJJW.js";import"./popover.component-B9J0JIz9.js";import"./if-defined-D5BV9-c0.js";import"./FocusTrapMixin-CjzCjsSm.js";import"./index-CWUJHaLg.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-D53Z5CZ7.js";import"./formfieldwrapper.component-B1RGcmSz.js";import"./radio.constants-DXoIHWZL.js";import"./iframe-BWoec5za.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-CqyNsepP.js";const ie=q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,le=[ie,...Q()];var de=Object.defineProperty,j=(e,a,i,d)=>{for(var r=void 0,o=e.length-1,I;o>=0;o--)(I=e[o])&&(r=I(a,i,r)||r);return r&&de(a,i,r),r};const f=class f extends P(X(x)){constructor(){super(),this.checked=!1,this.name="",this.addEventListener("click",this.toggleChecked),this.addEventListener("keydown",this.toggleOnEnter),this.addEventListener("keyup",this.toggleOnSpace)}connectedCallback(){super.connectedCallback(),this.role=J.RADIO}getAllCardsWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-cardradio[name="${this.name}"]`))}toggleChecked(){if(this.disabled)return;this.getAllCardsWithinSameGroup().forEach(i=>{i.checked=!1}),this.checked=!0}setDisabled(a){this.setAttribute("aria-disabled",`${a}`),this.tabIndex=a?-1:0}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&this.setDisabled(this.disabled)}updateCardRadio(a,i){a[i].focus(),a[i].toggleChecked()}toggleOnEnter(a){if(this.disabled)return;const d=this.getAllCardsWithinSameGroup().filter(o=>!o.disabled),r=d.indexOf(this);if(["ArrowDown","ArrowRight"].includes(a.key)){const o=(r+1)%d.length;this.updateCardRadio(d,o)}else if(["ArrowUp","ArrowLeft"].includes(a.key)){const o=(r-1+d.length)%d.length;this.updateCardRadio(d,o)}a.key==="Enter"&&this.toggleChecked()}toggleOnSpace(a){a.key===" "&&this.toggleChecked()}renderHeader(){return this.cardTitle?l`<div part="header">
  ...
  `}};f.styles=[...x.styles,...le];let c=f;j([W({type:Boolean,reflect:!0})],c.prototype,"checked");j([W({type:String})],c.prototype,"name");c.register(K);const ne=e=>l`
  <mdc-cardradio
    @click="${s("onclick")}"
    @keydown="${s("onkeydown")}"
    @keyup="${s("onkeyup")}"
...
Ut in massa luctus lacus sodales accumsan. Praesent at aliquam leo. Ut a scelerisque turpis.</mdc-text>`,m={args:{"card-title":"Title",name:"radio-card",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,variant:t.VARIANT,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,children:n}},p={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x280","image-alt":"Image Alt","icon-name":"placeholder-bold","aria-label":"Aria Label","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:T.HORIZONTAL,children:n}},h={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"aria-label":"Aria Label",checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION,children:n}},b={args:{"image-src":"https://placehold.co/320x200","image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION}},u={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,children:l`
    ...
    ${n}`}},g={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x540","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:T.HORIZONTAL,checked:!1,disabled:!1,tabIndex:0,children:l`
...
}`,...(z=(_=A.parameters)==null?void 0:_.docs)==null?void 0:z.source}}};const et=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInRadioGroup"];export{b as CardWithoutBody,h as CardWithoutImage,A as CardsInRadioGroup,g as ContentAfterBody,u as ContentBeforeBody,m as Example,p as HorizontalCard,et as __namedExportsOrder,Ye as default};
