import{u as P,i as k,D as f,k as e,C as S,n as l,z as A}from"./iframe-Cg5TAAQy.js";import{t as V}from"./if-defined-Op7ekpVq.js";import{o as Y}from"./query-assigned-elements-uEuc3rg8.js";import{F as z}from"./FooterMixin-c1s763po.js";import{T as W,V as G}from"./index-lZ1m-Bbe.js";import{I as j,T as Z,B as y}from"./button.constants-HgvmXQcx.js";import"./index-Bu_SSHse.js";import"./index-BEaL0hYd.js";import"./index-C8qqicjX.js";import"./index-DTZKhFtw.js";import{c as H,s as J}from"./commonArgTypes-BluK8w5L.js";import{d as X,a as K,t as q,h as v}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./link.constants-BchvI1Rx.js";import"./buttonsimple.constants-D0Md3OfM.js";import"./roles-CJI3JVG-.js";import"./index-BFrJzZic.js";import"./index-hvNnVypU.js";import"./index-DTrDRi1E.js";import"./button.component-Dpkpepks.js";import"./buttonsimple.component-dowWq62Q.js";import"./keys-hFXe221I.js";import"./DisabledMixin-BKNV4Fwu.js";import"./TabIndexMixin-0hHS2f4l.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-D3QzhMf-.js";import"./index-vuJ3tNmV.js";const Q=P.constructTagName("toast"),m={CUSTOM:"custom",SUCCESS:"success",WARNING:"warning",ERROR:"error"},T={SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},a={HEADER_TAG_NAME:"h2",CANCEL_ICON:"cancel-bold",ARROW_UP_BOLD:"arrow-up-bold",ARROW_DOWN_BOLD:"arrow-down-bold",PREFIX_ICON_SIZE:1.5,CLOSE_ICON_SIZE:j[20],BUTTON:Z,PRIMARY_BUTTON:y.PRIMARY,SECONDARY_BUTTON:y.SECONDARY,TERTIARY_BUTTON:y.TERTIARY,VARIANT:m.CUSTOM},tt=t=>{switch(t){case m.SUCCESS:return T.SUCCESS_ICON_NAME;case m.WARNING:return T.WARNING_ICON_NAME;case m.ERROR:return T.ERROR_ICON_NAME;default:return null}},et=k`
  :host {
...
`,ot=[et];var rt=Object.defineProperty,s=(t,o,n,g)=>{for(var d=void 0,b=t.length-1,_;b>=0;b--)(_=t[b])&&(d=_(o,n,d)||d);return d&&rt(o,n,d),d};const N=class N extends z(S){constructor(){super(...arguments),this.variant=a.VARIANT,this.headerTagName=a.HEADER_TAG_NAME,this.ariaLabel=null,this.isDetailVisible=!1,this.hasDetailedSlot=!1,this.hasFooterButtons=""}closeToast(){const o=new CustomEvent("close",{bubbles:!0,composed:!0,detail:{id:this.id}});this.dispatchEvent(o)}toggleDetailVisibility(){this.isDetailVisible=!this.isDetailVisible}updateDetailedSlotPresence(){var o;this.hasDetailedSlot=((o=this.detailedElements)==null?void 0:o.some(n=>{var g;return(g=n.textContent)==null?void 0:g.trim()}))??!1}updateFooterButtonsPresence(){var o,n;this.hasFooterButtons=(((o=this.footerButtonPrimary)==null?void 0:o.length)??0)>0||(((n=this.footerButtonSecondary)==null?void 0:n.length)??0)>0||this.shouldRenderToggleButton()?"has-footer-buttons":""}firstUpdated(o){super.firstUpdated(o),this.updateDetailedSlotPresence()}renderIcon(o){return o?e`
    ...
    `:f}renderHeader(){return this.headerText?e`
          <mdc-text part="toast-header" tagname="${this.headerTagName}" type="${W.BODY_LARGE_BOLD}">
            ${this.headerText}
          </mdc-text>
      ...
      <div part="content-container">
        ${this.variant===a.VARIANT?e`<slot name="content-prefix"></slot>`:e`${this.renderIcon(tt(this.variant)??"")}`}
      ...
      ${this.renderFooter()}
    `}};N.styles=[...S.styles,...ot];let r=N;s([l({type:String,reflect:!0})],r.prototype,"variant");s([l({type:String,attribute:"close-button-aria-label"})],r.prototype,"closeButtonAriaLabel");s([l({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText");s([l({type:String,reflect:!0,attribute:"header-tag-name"})],r.prototype,"headerTagName");s([l({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel");s([l({type:String,reflect:!0,attribute:"show-more-text"})],r.prototype,"showMoreText");s([l({type:String,reflect:!0,attribute:"show-less-text"})],r.prototype,"showLessText");s([A()],r.prototype,"isDetailVisible");s([A()],r.prototype,"hasDetailedSlot");s([Y({slot:"toast-body-detailed",flatten:!0})],r.prototype,"detailedElements");s([A()],r.prototype,"hasFooterButtons");r.register(Q);const{action:at}=__STORYBOOK_MODULE_ACTIONS__,L=t=>e`
  <mdc-toast
    variant="${V(t.variant)}"
...
`,h={args:{...i,"header-text":"Toast Title","show-more-text":"Show more","show-less-text":"Show less","prefix-icon":"placeholder-bold","normal-body":"This is a toast message.","detailed-body":"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",children:e`${c}`}},p={name:"All Variants",render:()=>e`
  ...
  `,...v()},u={name:"User Joined",args:{...i,"header-text":"",children:e`
    ...
    `},...v()},x={name:"Connecting",args:{...i,"header-text":"Connecting",children:e` <mdc-spinner slot="content-prefix" size="small"></mdc-spinner> `},...v()};var O,C,E;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    ...DefaultArgs,
...
}`,...(E=(C=h.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var w,R,$;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'All Variants',
  render: () => html\`
    <div style="display: grid; grid-template-columns: repeat(2, 0fr); gap: 2rem;">
      \${[{
  ...
  \`,
  ...hideAllControls()
}`,...($=(R=p.parameters)==null?void 0:R.docs)==null?void 0:$.source}}};var D,I,B;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'User Joined',
  args: {
    ...DefaultArgs,
    'header-text': '',
  ...
  ...hideAllControls()
}`,...(M=(F=x.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};const Bt=["Example","AllVariants","UserJoined","Connecting"];export{p as AllVariants,x as Connecting,h as Example,u as UserJoined,Bt as __namedExportsOrder,It as default};
