import{i as g,k as d,D as m}from"./lit-element-D5KKan5q.js";import{n as e}from"./property-Bj3TGwkg.js";import{g as p}from"./button.utils-rNW36Ji7.js";import{B as v}from"./buttonsimple.component-1GEifFmP.js";import{T as h,V as k}from"./index-D2VIkDCb.js";import{I as y}from"./IconNameMixin-Bk-Z_FTS.js";import{R as f}from"./roles-CJI3JVG-.js";import{u as x}from"./provider.component-DrWB4byV.js";import{h as I,a as A}from"./index-CqVtAZCJ.js";import"./index-g4PC2eax.js";const N=x.constructTagName("tab"),u={GLASS:"glass",LINE:"line",PILL:"pill"},l={VARIANT:u.PILL,ACTIVE:!1},T=[I,g`
    :host {
  ...
  `,...A()];var S=Object.defineProperty,i=(s,a,t,E)=>{for(var r=void 0,c=s.length-1,b;c>=0;c--)(b=s[c])&&(r=b(a,t,r)||r);return r&&S(a,t,r),r};const n=class n extends y(v){constructor(){super(...arguments),this.active=l.ACTIVE,this.variant=l.VARIANT,this.handleTabActiveChange=a=>{const t=new CustomEvent("activechange",{detail:{tabId:this.tabId,active:a},bubbles:!0});this.dispatchEvent(t)}}connectedCallback(){super.connectedCallback(),this.role=f.TAB,this.softDisabled=void 0,this.size=void 0,this.type=void 0,this.ariaStateKey="aria-selected",!this.tabId&&this.onerror&&this.onerror("tab id is required")}modifyIconName(a){this.iconName&&(a?(this.prevIconName=this.iconName,this.iconName=`${p(this.iconName)}-filled`):this.prevIconName&&(this.iconName=this.prevIconName))}setVariant(a){this.setAttribute("variant",Object.values(u).includes(a)?a:l.VARIANT)}setActive(a,t){super.setActive(a,t),this.modifyIconName(t)}executeAction(){this.handleTabActiveChange(this.active)}update(a){super.update(a),a.has("variant")&&this.setVariant(this.variant)}render(){return d`
      <div part="container">
