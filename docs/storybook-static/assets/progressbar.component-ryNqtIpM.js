import{i as b,k as a}from"./lit-element-D5KKan5q.js";import{u as v,n}from"./index-C9z9WAEj.js";import{a as u}from"./index-MA1r3zrt.js";import"./index-CeyAPSga.js";import{V as o,F as g}from"./formfieldwrapper.component-B1RGcmSz.js";import{D as f}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{R as x}from"./roles-BH_hBfTz.js";import{v as y}from"./v4-CmTdKEVZ.js";const T=[u,b`
:host {
...
`],R=v.constructTagName("progressbar"),l={DEFAULT:"default",INLINE:"inline"},A={VARIANT:l.DEFAULT,VALIDATION:o.DEFAULT};var V=Object.defineProperty,c=(p,r,t,h)=>{for(var e=void 0,i=p.length-1,m;i>=0;i--)(m=p[i])&&(e=m(r,t,e)||e);return e&&V(r,t,e),e};const d=class d extends f(g){constructor(){super(...arguments),this.variant=A.VARIANT,this.value="0",this.error=!1,this.renderProgressbar=()=>{const r=this.getValidationVariant(),t=this.clampedValue>0&&this.clampedValue<100,h=this.error?"100":`${this.clampedValue}`;return a`
      <div
    ...
    `}}connectedCallback(){super.connectedCallback(),this.id=`mdc-progressbar-${y()}`,this.disabled=void 0,this.toggletipText=void 0,this.toggletipPlacement=void 0}get clampedValue(){const r=Number(this.value);return Number.isNaN(r)?0:Math.max(0,Math.min(100,r))}getValidationVariant(){return this.error?this.helpTextType=o.ERROR:this.clampedValue===100?this.helpTextType=o.SUCCESS:this.helpTextType=o.DEFAULT,this.helpTextType}render(){const r=this.variant===l.INLINE;return a`
      ${r?a`<div part="inline-label-container">${this.renderLabelElement()} ${this.renderProgressbar()}</div>`:a`
          ...
          `}
    `}};d.styles=[...g.styles,...T];let s=d;c([n({type:String,reflect:!0})],s.prototype,"variant");c([n({type:String,reflect:!0})],s.prototype,"value");c([n({type:Boolean,attribute:"error"})],s.prototype,"error");export{A as D,s as P,R as T,l as V};
