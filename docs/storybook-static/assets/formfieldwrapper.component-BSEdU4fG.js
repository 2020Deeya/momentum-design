import{u,V as x,q as b,U as y,S as I,h as l,k as a,B as E,E as T,n as e}from"./iframe-RauP6Djh.js";import{t as A}from"./if-defined-CvYHhL43.js";import{D}from"./DisabledMixin-Dnl3OyzP.js";import{v as f}from"./v4-CmTdKEVZ.js";const P=u.constructTagName("formfieldwrapper"),n={DEFAULT:"default",ERROR:"error",PRIORITY:"priority",SUCCESS:"success",WARNING:"warning"},o={VALIDATION:n.DEFAULT,HELPER_TEXT_ID:"helper-text-id",HEADING_ID:"heading-id",ICON_SIZE:20,INFO_ICON:"info-badge-filled",TOGGLETIP_PLACEMENT:"top",TOGGLETIP_STRATEGY:"absolute"},h={TAGNAME:x.SPAN,TYPE:b.BODY_MIDSIZE_REGULAR,HEADER_TYPE:b.BODY_MIDSIZE_BOLD},S=[y,I`
    :host {
  ...
  `],_=p=>({[n.ERROR]:"error-legacy-badge-filled",[n.WARNING]:"warning-badge-filled",[n.SUCCESS]:"check-circle-badge-filled",[n.PRIORITY]:"priority-badge-filled",[n.DEFAULT]:""})[p]||"";var $=Object.defineProperty,r=(p,i,d,v)=>{for(var s=void 0,c=p.length-1,m;c>=0;c--)(m=p[c])&&(s=m(i,d,s)||s);return s&&$(i,d,s),s};const g=class g extends D(T){constructor(){super(...arguments),this.inputId=`mdc-el-${f()}`,this.required=!1,this.helpTextType=o.VALIDATION,this.toggletipPlacement=o.TOGGLETIP_PLACEMENT,this.toggletipStrategy=o.TOGGLETIP_STRATEGY,this.readonly=!1,this.softDisabled=!1,this.shouldRenderLabel=!0}renderLabelElement(){return this.label?this.shouldRenderLabel?a`<label for="${this.inputId}" id="${o.HEADING_ID}" part="label">${this.label}</label>`:a` <mdc-text
    ...
    </div>`:l}};g.styles=[...T.styles,...S];let t=g;r([e({reflect:!0,type:String})],t.prototype,"label");r([e({type:Boolean,reflect:!0,attribute:"required"})],t.prototype,"required");r([e({reflect:!0,attribute:"help-text-type"})],t.prototype,"helpTextType");r([e({type:String,reflect:!0,attribute:"help-text"})],t.prototype,"helpText");r([e({type:String,reflect:!0,attribute:"toggletip-text"})],t.prototype,"toggletipText");r([e({type:String,reflect:!0,attribute:"toggletip-placement"})],t.prototype,"toggletipPlacement");r([e({type:String,reflect:!0,attribute:"toggletip-strategy"})],t.prototype,"toggletipStrategy");r([e({type:String,reflect:!0,attribute:"info-icon-aria-label"})],t.prototype,"infoIconAriaLabel");r([e({type:Boolean,reflect:!0})],t.prototype,"readonly");r([e({type:Boolean,reflect:!0,attribute:"soft-disabled"})],t.prototype,"softDisabled");export{o as D,t as F,P as T,n as V};
