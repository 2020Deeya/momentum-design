import"./index-Cwg5uQUX.js";import{T as p}from"./index-BrLJ_9IK.js";import"./index-DtB-8-Xs.js";import{i as f,k as a,D as h}from"./lit-element-D5KKan5q.js";import{u,n as o}from"./index-C9z9WAEj.js";import{t as g}from"./if-defined-D5BV9-c0.js";import{F as x}from"./FormInternalsMixin-CqDKsEWP.js";import{L as b,a as m}from"./listitem.component-B4xe0EG5.js";const v="check-bold",y=u.constructTagName("option"),T=f`
  :host {
...
`,I=[T];var E=Object.defineProperty,n=(c,t,s,A)=>{for(var e=void 0,r=c.length-1,d;r>=0;r--)(d=c[r])&&(e=d(t,s,e)||e);return e&&E(t,s,e),e};const l=class l extends x(m){constructor(){super(...arguments),this.selected=!1,this.ariaLabel=null}connectedCallback(){super.connectedCallback(),this.role="option",this.variant=b.INSET_RECTANGLE,this.setAttribute("aria-selected",`${this.selected}`),this.setAttribute("aria-disabled",`${!!this.disabled}`),this.name=void 0,this.sideHeaderText=void 0,this.sublineText=void 0}update(t){super.update(t),t.has("selected")&&this.setAttribute("aria-selected",`${this.selected}`)}render(){const t=this.prefixIcon?a`
