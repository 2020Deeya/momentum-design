import{i as Z,D as f,k as o}from"./lit-element-D5KKan5q.js";import{u as q,n as z}from"./index-C9z9WAEj.js";import{D as W}from"./DisabledMixin-BZruwOeC.js";import{T as Q}from"./TabIndexMixin-CsrHswKP.js";import{C as x}from"./card.component-SIS7N_u7.js";import{R as J}from"./roles-BH_hBfTz.js";import{a as ee}from"./index-B-GnYs90.js";import"./index-BbyJKVAH.js";import{V as y}from"./index-BrLJ_9IK.js";import"./index-CMSqfM1H.js";import{Q as te}from"./repeat-CNQ7t7Vw.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as ae,s as oe}from"./commonArgTypes-BluK8w5L.js";import{h as re,d as ie}from"./utils-CF1irry3.js";import{V as le,O as T,D as t}from"./CardAndDialogFooterMixin-Bxo6tU4P.js";import"./index-BtHJxrcg.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-D0QAbDxL.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./iframe-BYQQzRbp.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-CqyNsepP.js";import"./index-CnIrUYOi.js";import"./button.component-DLvLGT3A.js";import"./buttonsimple.component-q2YakOka.js";import"./button.utils-rNW36Ji7.js";import"./index-C3-LVExe.js";import"./popover.component-DRVNZbmp.js";import"./if-defined-D5BV9-c0.js";import"./index-96ToHBu8.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-D53Z5CZ7.js";import"./formfieldwrapper.component-D6q8AeiS.js";const ce=q.constructTagName("cardcheckbox"),k={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},A={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},se=Z`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,ne=[se,...ee()];var de=Object.defineProperty,j=(e,a,C,pe)=>{for(var i=void 0,g=e.length-1,I;g>=0;g--)(I=e[g])&&(i=I(a,C,i)||i);return i&&de(a,C,i),i};const E=class E extends W(Q(x)){constructor(){super(),this.checked=!1,this.selectionType=A.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked),this.addEventListener("keydown",this.toggleOnEnter),this.addEventListener("keyup",this.toggleOnSpace)}connectedCallback(){super.connectedCallback(),this.role=J.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked)}toggleOnEnter(a){a.key==="Enter"&&this.toggleChecked()}toggleOnSpace(a){a.key===" "&&this.toggleChecked()}renderSelection(){const a=this.checked?k.CHECKED:k.DEFAULT;switch(this.selectionType){case r.CHECK:return o`<mdc-icon
    ...
    `}};E.styles=[...x.styles,...ne];let s=E;j([z({type:Boolean,reflect:!0})],s.prototype,"checked");j([z({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(ce);const me=e=>o` <mdc-cardcheckbox
    @click="${c("onclick")}"
    @keydown="${c("onkeydown")}"
    @keyup="${c("onkeyup")}"
    @focus="${c("onfocus")}"
...
}`,...(Y=(w=u.parameters)==null?void 0:w.docs)==null?void 0:Y.source}}};const tt=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInCheckboxGroup"];export{p as CardWithoutBody,m as CardWithoutImage,u as CardsInCheckboxGroup,b as ContentAfterBody,h as ContentBeforeBody,n as Example,d as HorizontalCard,tt as __namedExportsOrder,et as default};
