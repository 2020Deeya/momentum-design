import{k as o}from"./iframe-xJvWfTzZ.js";import{a as be,h as he}from"./utils-Dd_sfl9-.js";import"./index-Bk5fWp_B.js";import"./index-BECTlSZy.js";import"./index-D56ck7oO.js";import"./index-5glYnjhF.js";import"./index-BtiDvopj.js";import"./index-CoB2COmj.js";import"./index-DuZrBrln.js";import"./index-6GR0aNdN.js";import"./index-C_XKKTaE.js";import"./index-DK8-LS-B.js";import{P as d,C as xe,D as t}from"./popover.component-JAlOViKa.js";import"./preload-helper-C1FmrZbK.js";import"./button.component-DS_uJzH5.js";import"./buttonsimple.component-BiDxEwPG.js";import"./keys-hFXe221I.js";import"./DisabledMixin-Dw5Pn0Dw.js";import"./TabIndexMixin-CiYdC3A9.js";import"./button.utils-rNW36Ji7.js";import"./index-BbYB32IG.js";import"./index-DzxFCTYp.js";import"./index-DTrDRi1E.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./if-defined-GCyvQTHu.js";import"./FormInternalsMixin-DS4X73T0.js";import"./query-DXShiZ7f.js";import"./listitem.component-CO55L9vN.js";import"./index-DYfAieGV.js";import"./index-VJPGxuE5.js";import"./index-LkDpviH3.js";import"./v4-CmTdKEVZ.js";import"./CaptureDestroyEventForChildElement-l_YyFmyz.js";import"./DataAriaLabelMixin-BOwflVwV.js";import"./ListNavigationMixin-DuNaxkxz.js";import"./formfieldwrapper.component-BIugPeVU.js";import"./menuitemradio.constants-39f2d65J.js";import"./menupopover.constants-B6hCYF3J.js";import"./badge.constants-O5IPE0LW.js";import"./menuitem.component-DqEnxf5Y.js";import"./menuitemcheckbox.constants-D_Mlez5o.js";import"./dialog.component-CREtFEzo.js";import"./BackdropMixin-DWE1QluE.js";import"./FooterMixin-CM4AcpIw.js";import"./link.constants-CV5K_A85.js";const{action:s}=__STORYBOOK_MODULE_ACTIONS__,m=(e,n)=>o`
  <mdc-popover
    id="${e.id}"
...
`,xt={title:"Components/popover",tags:["autodocs"],component:"mdc-popover",render:fe,argTypes:{id:{control:"text"},triggerID:{control:"text"},trigger:{control:"text"},placement:{control:"select",options:Object.values(d)},offset:{if:{arg:"offset"},control:"number"},visible:{control:"boolean"},delay:{control:"text"},color:{control:"select",options:Object.values(xe)},flip:{control:"boolean"},size:{control:"boolean"},backdrop:{control:"boolean"},"z-index":{if:{arg:"z-index"},control:"number"},"show-arrow":{control:"boolean"},"close-button":{control:"boolean"},interactive:{control:"boolean"},"focus-trap":{control:"boolean"},"should-focus-trap-wrap":{control:"boolean"},"prevent-scroll":{control:"boolean"},"hide-on-blur":{control:"boolean"},"hide-on-escape":{control:"boolean"},"hide-on-outside-click":{control:"boolean"},"focus-back-to-trigger":{control:"boolean"},"append-to":{control:"text"},"close-button-aria-label":{control:"text"},"aria-label":{control:"text"},"aria-labelledby":{control:"text"},"aria-describedby":{control:"text"},role:{control:"text"},"disable-aria-expanded":{control:"boolean"},...be(["arrowElement","onOutsidePopoverClick","onEscapeKeydown","onPopoverFocusOut","startCloseDelay","cancelCloseDelay","enabledPreventScroll","enabledFocusTrap","shouldWrapFocus","utils"])}},l={args:{id:"popover",triggerID:"popover-trigger",trigger:"click",placement:d.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,flip:t.FLIP,"show-arrow":!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!0,interactive:t.INTERACTIVE}},u={render:Ee,args:{id:"popover-interactive",triggerID:"popover-trigger-interactive",trigger:"click",placement:d.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,"focus-trap":!0,interactive:!0,"show-arrow":!0,flip:t.FLIP,size:!0,role:t.ROLE,color:t.COLOR,"disable-aria-expanded":!1}},g={render:ke,args:{id:"popover-interactive-hover",triggerID:"popover-trigger-interactive-hover",trigger:"mouseenter",placement:d.BOTTOM,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,flip:t.FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,"focus-back-to-trigger":!0,role:t.ROLE,color:t.COLOR}},v={render:De,args:{id:"popover-multiple",triggerID:"popover-trigger-multiple",trigger:"click",placement:d.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,flip:t.FLIP,"focus-trap":!0,interactive:!0,"focus-back-to-trigger":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"show-arrow":!0,"close-button":!0,role:t.ROLE,color:t.COLOR}},b={render:Oe,args:{id:"popover-nested",triggerID:"popover-trigger-nested",trigger:"click",placement:d.TOP,offset:t.OFFSET,"z-index":10,delay:t.DELAY,flip:t.FLIP,"focus-trap":!0,interactive:!0,"show-arrow":!0,"hide-on-escape":!0,role:t.ROLE,color:t.COLOR,"focus-back-to-trigger":!0,"hide-on-outside-click":!0}},h={render:Ie,args:{id:"popover-hide-on-blur",triggerID:"popover-trigger-hide-on-blur",trigger:"click",placement:d.RIGHT,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,flip:t.FLIP,interactive:!0,"show-arrow":!0,"hide-on-blur":!0,role:t.ROLE,color:t.COLOR}},x={render:Te,args:{id:"popover-backdrop",triggerID:"popover-trigger-backdrop",trigger:"click",placement:d.TOP,offset:t.OFFSET,"z-index":t.Z_INDEX,delay:t.DELAY,flip:t.FLIP,interactive:!0,"show-arrow":!0,backdrop:!0,"hide-on-outside-click":!0,"focus-trap":!0,role:t.ROLE,color:t.COLOR}},f={render:()=>o`
  ...
  `},k={render:()=>{const e=i=>{var c;const a=i.target;(c=a.querySelector(".hover-menu"))==null||c.appendChild(document.getElementById(a.dataset.tpl).content.cloneNode(!0))},n=i=>{const a=i.target.querySelector(".hover-menu");a.innerHTML=""};return o`
      <style>
        .container {
          width: 25rem;
          height: 10rem;
  ...
  `},D={args:{...l.args,id:"popover",placement:d.RIGHT_START,triggerID:"trigger-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,"keep-connected-tooltip-closed":!0},render:e=>o`
    ...
    ${m(e,o`
        <mdc-button
          @click=${()=>{document.getElementById("popover").hide();const i=document.getElementById("popover-dialog");i.visible=!0}}
        >
          Open dialog
        </mdc-button>
      `)}
  ...
  `},T={args:{...l.args,id:"popover-scroll-overflow",triggerID:"trigger-scroll-btn",interactive:!0,"focus-trap":!0,"focus-back-to-trigger":!0,"show-arrow":!0,"hide-on-escape":!0,"hide-on-outside-click":!0,size:!0},render:()=>{let e=1;const n=()=>{e+=1;const c=document.querySelector("#item-2"),w=c.parentElement;c.remove(),w.append(c);let r=document.querySelector("#item-3");const L=r.parentElement;r.remove(),r=document.createElement("mdc-button"),r.setAttribute("id","item-3"),r.setAttribute("prefix-icon","placeholder-bold"),r.innerHTML=`Open v${e}`,L.append(r)};let i=1;return o`
      <div>
        ...
        <mdc-buttongroup>
          ...
          <mdc-button @click="${()=>{i+=1;const c=document.querySelector('[triggerID="item-2"]'),w=c.parentElement;c.remove(),w.append(c);let r=document.querySelector('[triggerID="item-3"]');const L=r.parentElement;r.remove(),r=document.getElementById("popover-tpl").content.cloneNode(!0),r.querySelector("div").innerHTML=`Item 3 v${i}`,L.append(r)}}">Update Popovers</mdc-button>
        </mdc-buttongroup>
...
}`,...(re=(oe=k.parameters)==null?void 0:oe.docs)==null?void 0:re.source}}};var ne,ie,ce;I.parameters={...I.parameters,docs:{...(ne=I.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  args: {
    ...Example.args,
  ...
  \`
}`,...(ce=(ie=I.parameters)==null?void 0:ie.docs)==null?void 0:ce.source}}};var de,me,pe;D.parameters={...D.parameters,docs:{...(de=D.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    id: 'popover',
    placement: POPOVER_PLACEMENT.RIGHT_START,
  ...
  \`
}`,...(se=(ae=O.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};var ue,ge,ve;T.parameters={...T.parameters,docs:{...(ue=T.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  args: {
    ...Example.args,
    id: 'popover-scroll-overflow',
    triggerID: 'trigger-scroll-btn',
...
}`,...(ve=(ge=T.parameters)==null?void 0:ge.docs)==null?void 0:ve.source}}};const ft=["Example","interactiveContent","interactiveHover","interactiveMultiple","nestedPopover","hideOnBlur","popoverWithBackdrop","popoverWithSelect","MultipleSingleLevelPopovers","AppendTo","NestedMenu","PopoverWithTooltipAndDialog","PopoverScrollOverflow","PopoverInChangingList"];export{k as AppendTo,l as Example,E as MultipleSingleLevelPopovers,I as NestedMenu,T as PopoverInChangingList,O as PopoverScrollOverflow,D as PopoverWithTooltipAndDialog,ft as __namedExportsOrder,xt as default,h as hideOnBlur,u as interactiveContent,g as interactiveHover,v as interactiveMultiple,b as nestedPopover,x as popoverWithBackdrop,f as popoverWithSelect};
