...
`,N=[b,$];var I=Object.defineProperty,S=(n,t,r,u)=>{for(var e=void 0,s=n.length-1,d;s>=0;s--)(d=n[s])&&(e=d(t,r,e)||e);return e&&I(t,r,e),e};const c=class c extends x(v(h)){constructor(){super(...arguments),this.handleIconButtons=()=>{var t;(t=this.iconButtons)==null||t.forEach(r=>{r.matches(a.BUTTON)&&(r.setAttribute("variant",f.TERTIARY),r.setAttribute("size","32"))})}}update(t){super.update(t),t.has("variant")&&this.updateFooterButtonColors(this.variant)}renderHeader(){return l`<div part="header">
    ...
    `}};c.styles=[...h.styles,...N];let p=c;S([y({slot:"icon-button"})],p.prototype,"iconButtons");export{p as C,x as a};
