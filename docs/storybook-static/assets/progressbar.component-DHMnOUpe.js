import{i as b,k as a}from"./lit-element-D5KKan5q.js";import{u as v,n}from"./index-C9z9WAEj.js";import{a as u}from"./index-MA1r3zrt.js";import"./index-BVEL-TUz.js";import{V as o,F as g}from"./formfieldwrapper.component-B1RGcmSz.js";import{D as f}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{v as x}from"./v4-CmTdKEVZ.js";const y=[u,b`
:host {
...
`],I=v.constructTagName("progressbar"),l={DEFAULT:"default",INLINE:"inline"},T={VARIANT:l.DEFAULT,VALIDATION:o.DEFAULT};var A=Object.defineProperty,c=(p,r,t,h)=>{for(var e=void 0,i=p.length-1,m;i>=0;i--)(m=p[i])&&(e=m(r,t,e)||e);return e&&A(r,t,e),e};const d=class d extends f(g){constructor(){super(...arguments),this.variant=T.VARIANT,this.value="0",this.error=!1,this.renderProgressbar=()=>{const r=this.getValidationVariant(),t=this.clampedValue>0&&this.clampedValue<100,h=this.error?"100":`${this.clampedValue}`;return a`
      <div
    ...
    `}}connectedCallback(){super.connectedCallback(),this.id=`mdc-progressbar-${x()}`,this.disabled=void 0,this.toggletipText=void 0,this.toggletipPlacement=void 0}get clampedValue(){const r=Number(this.value);return Number.isNaN(r)?0:Math.max(0,Math.min(100,r))}getValidationVariant(){return this.error?this.helpTextType=o.ERROR:this.clampedValue===100?this.helpTextType=o.SUCCESS:this.helpTextType=o.DEFAULT,this.helpTextType}render(){const r=this.variant===l.INLINE;return a`
      ${r?a`<div part="inline-label-container">${this.renderLabelElement()} ${this.renderProgressbar()}</div>`:a`
          ...
          `}
    `}};d.styles=[...g.styles,...y];let s=d;c([n({type:String,reflect:!0})],s.prototype,"variant");c([n({type:String,reflect:!0})],s.prototype,"value");c([n({type:Boolean,attribute:"error"})],s.prototype,"error");export{T as D,s as P,I as T,l as V};
