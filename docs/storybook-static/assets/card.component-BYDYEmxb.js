...
`,$=[f,N];var S=Object.defineProperty,I=(n,t,r,u)=>{for(var e=void 0,s=n.length-1,d;s>=0;s--)(d=n[s])&&(e=d(t,r,e)||e);return e&&S(t,r,e),e};const c=class c extends x(v(h)){constructor(){super(...arguments),this.handleIconButtons=()=>{var t;(t=this.iconButtons)==null||t.forEach(r=>{r.matches(a.BUTTON)&&(r.setAttribute("variant",b.TERTIARY),r.setAttribute("size","32"))})}}update(t){super.update(t),t.has("variant")&&this.updateFooterButtonColors(this.variant)}renderHeader(){return this.cardTitle?l`<div part="header">
    ...
    `}};c.styles=[...h.styles,...$];let p=c;I([y({slot:"icon-button"})],p.prototype,"iconButtons");export{p as C,x as a};
