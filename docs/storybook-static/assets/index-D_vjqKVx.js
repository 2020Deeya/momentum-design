import"./index-Dngq1J7R.js";import"./index-D3DhXfcW.js";import{L as u,a as h}from"./listitem.component-C6iupxrL.js";import{i as f,k as r,D as m}from"./lit-element-D5KKan5q.js";import{u as b,n as l}from"./index-C9z9WAEj.js";import{t as g}from"./if-defined-D5BV9-c0.js";import{F as x}from"./FormInternalsMixin-CSixOKbK.js";import{T as v}from"./text.constants-ZF0jM5wn.js";const y="check-bold",I=b.constructTagName("option"),T=f`
  :host {
...
`,A=[T];var E=Object.defineProperty,n=(c,t,e,o)=>{for(var i=void 0,a=c.length-1,p;a>=0;a--)(p=c[a])&&(i=p(t,e,i)||i);return i&&E(t,e,i),i};const d=class d extends x(h){constructor(){super(...arguments),this.selected=!1,this.ariaLabel=null}connectedCallback(){super.connectedCallback(),this.role="option",this.variant=u.INSET_RECTANGLE,this.updateAttribute("aria-selected",`${this.selected}`),this.updateAttribute("aria-disabled",`${!!this.disabled}`),this.name=void 0,this.secondaryLabel=void 0,this.sideHeaderText=void 0,this.sublineText=void 0}handleDefaultSlotChange(){var e,o,i;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("slot");t&&!this.label&&(this.label=(i=(o=t.assignedNodes()[0])==null?void 0:o.textContent)==null?void 0:i.trim())}updateAttribute(t,e){this.setAttribute(t,e)}update(t){super.update(t),t.has("selected")&&this.updateAttribute("aria-selected",`${this.selected}`)}render(){const t=this.prefixIcon?r`
    ...
    `}};d.styles=[...h.styles,...A];let s=d;n([l({type:Boolean,reflect:!0})],s.prototype,"selected");n([l({type:String,reflect:!0,attribute:"prefix-icon"})],s.prototype,"prefixIcon");n([l({type:String,reflect:!0,attribute:"aria-label"})],s.prototype,"ariaLabel");s.register(I);export{I as T};
