import{i as u,k as i,D as n}from"./lit-element-CHllvULs.js";import{u as p,n as v}from"./index-HW6KrQZO.js";import{h as k,a as y}from"./index-BGjwsboe.js";import{g as f}from"./button.utils-CM5PFBkb.js";import{a as s}from"./buttonsimple.component-BPMM56DO.js";import{T as b,V as x}from"./text.constants-DJu2q-6E.js";import{I as N}from"./IconNameMixin-DXlfdGtk.js";import"./index-CUxX-hvH.js";import"./index-BGkqZMsC.js";const I=[k,u`
...
`,...y()],A=p.constructTagName("tab"),h={GLASS:"glass",LINE:"line",PILL:"pill"},m={VARIANT:h.PILL};var S=Object.defineProperty,g=(d,a,t,T)=>{for(var o=void 0,e=d.length-1,l;e>=0;e--)(l=d[e])&&(o=l(a,t,o)||o);return o&&S(a,t,o),o};const c=class c extends N(s){constructor(){super(),this.variant=m.VARIANT,this.role="tab",this.softDisabled=void 0,this.size=void 0,this.type=void 0}modifyIconName(a){this.iconName&&(a?(this.prevIconName=this.iconName,this.iconName=`${f(this.iconName)}-filled`):this.prevIconName&&(this.iconName=this.prevIconName))}setVariant(a){this.setAttribute("variant",Object.values(h).includes(a)?a:m.VARIANT)}setActive(a,t){a.setAttribute("aria-selected",t?"true":"false"),this.modifyIconName(t)}executeAction(){this.active=!this.active}update(a){super.update(a),a.has("variant")&&this.setVariant(this.variant)}render(){return i`
      <div part="container">
    ...
    `}};c.styles=[...s.styles,...I];let r=c;g([v({type:String,reflect:!0})],r.prototype,"text");g([v({type:String,reflect:!0})],r.prototype,"variant");r.register(A);export{h as T};
