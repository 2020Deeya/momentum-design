import{u as y,n as d,i as I,D as p,k as h,C as v,z}from"./iframe-BZIqfezz.js";import{t as f}from"./if-defined-CZ3GbhfA.js";import{I as O}from"./IconNameMixin-COUfbKOL.js";import{h as M}from"./index-B-4qjIUw.js";import{a as n}from"./index-DOu19QRD.js";import{T as s}from"./index-CeMd0DMi.js";import"./index-DXkeu3PJ.js";const C=y.constructTagName("avatar"),r={COUNTER:"counter",ICON:"icon",PHOTO:"photo",TEXT:"text"},T=99,_="user-regular",e={24:24,32:32,48:48,64:64,72:72,88:88,124:124},b={TYPE:r.PHOTO,SIZE:e[32],ICON_NAME:_};var P=Object.defineProperty,l=(o,t,i,E)=>{for(var a=void 0,c=o.length-1,m;c>=0;c--)(m=o[c])&&(a=m(t,i,a)||a);return a&&P(t,i,a),a};const x=o=>{class t extends o{constructor(){super(...arguments),this.size=b.SIZE,this.isTyping=!1}}return l([d({type:String})],t.prototype,"src"),l([d({type:String})],t.prototype,"initials"),l([d({type:String})],t.prototype,"presence"),l([d({type:Number,reflect:!0,attribute:"size"})],t.prototype,"size"),l([d({type:Number})],t.prototype,"counter"),l([d({type:Boolean,attribute:"is-typing"})],t.prototype,"isTyping"),t},N=[M,I`
    :host {
  ...
  `],S=o=>({[e[124]]:n[124],[e[88]]:n[88],[e[72]]:n[72],[e[64]]:n[64],[e[48]]:n[48],[e[32]]:n[32],[e[24]]:n[24]})[o]||n[32],A=o=>({[e[124]]:4.75,[e[88]]:3,[e[72]]:2.5,[e[64]]:2.25,[e[48]]:1.75,[e[32]]:1.25,[e[24]]:1})[o]||1.25,k=o=>({[e[124]]:s.HEADING_XLARGE_MEDIUM,[e[88]]:s.HEADING_LARGE_MEDIUM,[e[72]]:s.HEADING_MIDSIZE_MEDIUM,[e[64]]:s.HEADING_SMALL_MEDIUM,[e[48]]:s.HEADING_SMALL_MEDIUM,[e[32]]:s.BODY_MIDSIZE_MEDIUM,[e[24]]:s.BODY_SMALL_MEDIUM})[o]||s.BODY_MIDSIZE_MEDIUM;var D=Object.defineProperty,w=(o,t,i,E)=>{for(var a=void 0,c=o.length-1,m;c>=0;c--)(m=o[c])&&(a=m(t,i,a)||a);return a&&D(t,i,a),a};const g=class g extends x(O(v)){constructor(){super(...arguments),this.isPhotoLoaded=!1}getPresenceTemplateBasedOnType(t){return t===r.COUNTER&&(this.counter||this.counter===0)||this.isTyping?p:this.presence?h`
    ...
    `}};g.styles=[...v.styles,...N];let u=g;w([z()],u.prototype,"isPhotoLoaded");u.register(C);export{e as A,b as D,x as a};
