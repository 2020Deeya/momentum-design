import{i as E,k as i}from"./lit-element-D5KKan5q.js";import{u as y,C as R,n as f}from"./index-C9z9WAEj.js";import{h as N,a as S}from"./index-BX3Tn-Br.js";import{b as I,a as x}from"./buttonsimple.component-CNln8tgM.js";import{T as $,V as O}from"./text.constants-ZF0jM5wn.js";import"./index-D3DhXfcW.js";import"./index-CebKo0V0.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as _,s as w}from"./commonArgTypes-BluK8w5L.js";import{h as L}from"./utils-D1SE5bce.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./iframe-DSarDEbX.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";const C=E`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,U=[N,C,...S()],V=y.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:$.BODY_MIDSIZE_REGULAR,TAG_NAME:O.SPAN,SIZE:I[24],ROLE:"button"},G=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var M=Object.defineProperty,T=(r,s,h,j)=>{for(var a=void 0,m=r.length-1,p;m>=0;m--)(p=r[m])&&(a=p(s,h,a)||a);return a&&M(s,h,a),a};const d=class d extends x{constructor(){super(...arguments),this.variant=e.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return i`
  ...
  @focus="${c("onfocus")}"
    variant="${r.variant}"
    label="${r.label}"
  ></mdc-alertchip>`,nr={title:"Components/chip/alert",tags:["autodocs"],component:"mdc-alertchip",render:P,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(o)},label:{control:"text"},..._,...w,...L(["soft-disabled","size","role","type","active","disabled"])}},n={args:{variant:o.NEUTRAL,label:"Alert"}},l={render:()=>i`
