...
`,pe=t=>a(l`
  ...
  `),Ke={title:"Components/listbox",tags:["autodocs"],component:"mdc-listbox",render:pe,parameters:{badges:["stable"]},argTypes:{name:{control:"text"},value:{control:"text"},...ie(["--mdc-listbox-max-height"]),...S(["default"]),...ne,...ae}},p={args:{value:"london"}},m={render:()=>a(l`
  ...
  ...hideAllControls()
}`,...(H=(j=v.parameters)==null?void 0:j.docs)==null?void 0:H.source}}};const Ue=["Example","ListboxWithSecondaryLabel","ListboxWithGroups","ListboxWithLongOptionText","ListboxWithIconOptions","ListboxWithFixedHeight","ListboxWithDynamicOptions","ListboxWithChangingSelectedAfterMount"];export{p as Example,v as ListboxWithChangingSelectedAfterMount,g as ListboxWithDynamicOptions,x as ListboxWithFixedHeight,b as ListboxWithGroups,u as ListboxWithIconOptions,h as ListboxWithLongOptionText,m as ListboxWithSecondaryLabel,Ue as __namedExportsOrder,Ke as default};
