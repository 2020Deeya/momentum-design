import{i as V,D as k,k as a}from"./lit-element-D5KKan5q.js";import{B}from"./buttonsimple.component-jROCF6tv.js";import{a as H,C as z}from"./card.component-CuN9bBbP.js";import{a as j}from"./index-B-GnYs90.js";import{u as W}from"./provider.component-DrWB4byV.js";import"./index-BEvv3dN7.js";import{V as T}from"./index-D2VIkDCb.js";import{a as i}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as _,s as q}from"./commonArgTypes-BluK8w5L.js";import{a as Z,t as w}from"./utils-CFOyPOhY.js";import{V as P,O as p,D as t}from"./FooterMixin-oJpTePmN.js";import{B as Q}from"./button.constants-BBlkZKjZ.js";import"./property-Bj3TGwkg.js";import"./keys-hFXe221I.js";import"./DisabledMixin-B-Cnza7-.js";import"./TabIndexMixin-DEwGeIeI.js";import"./buttonsimple.constants-CVV9o_W6.js";import"./roles-CJI3JVG-.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./iframe-BcvPl-hx.js";import"../sb-preview/runtime.js";import"./state-CmYk530Z.js";import"./index-CwZu4Wnd.js";import"./iconprovider.component-BtAZSWEH.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";import"./link.constants-DNTydABS.js";const X=V`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,J=[X,...j()],A=class A extends H(B){connectedCallback(){super.connectedCallback(),this.active=void 0,this.size=void 0}renderHeader(){return this.cardTitle?a`<div part="header">${this.renderIcon()} ${this.renderTitle()}</div>`:k}render(){return a`
    ...
    `}};A.styles=[...z.styles,...J];let u=A;const K=W.constructTagName("cardbutton");u.register(K);const Y=e=>a` <mdc-cardbutton
    @click="${i("onclick")}"
    @keydown="${i("onkeydown")}"
    @keyup="${i("onkeyup")}"
    @focus="${i("onfocus")}"
  ...
  >`,Rt={title:"Components/card/cardbutton",tags:["autodocs"],component:"mdc-cardbutton",render:Y,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(P)},orientation:{control:"select",options:Object.values(p)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},"title-tag-name":{control:"select",options:Object.values(T)},"subtitle-tag-name":{control:"select",options:Object.values(T)},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},tabIndex:{control:"number"},type:{control:"select",options:Object.values(Q)},"auto-focus-on-mount":{control:"boolean"},...Z(["children","active","size"]),...w(["--mdc-card-width"]),..._,...q}},o=a`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
...
>`,r={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/100x100","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,children:o,disabled:!1,"soft-disabled":!1}},l={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/100x100","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:p.HORIZONTAL,children:o}},n={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,children:o}},s={args:{"image-src":"https://placehold.co/100x100","image-alt":"Image Alt",variant:t.VARIANT,orientation:t.ORIENTATION,children:o}},c={args:{"image-src":"https://placehold.co/100x100","image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"icon-name":"placeholder-bold",variant:t.VARIANT,orientation:t.ORIENTATION}},d={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/100x100","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,children:a`<div slot="before-body">
      ...
      ${o}`}},m={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/100x100","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:p.HORIZONTAL,children:a`<div slot="after-body">
