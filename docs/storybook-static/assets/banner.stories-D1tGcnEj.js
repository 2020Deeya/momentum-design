import{u as W,i as Y,C as N,D as s,k as a,n as h}from"./iframe-Bj0osOL6.js";import{t as v}from"./if-defined-CbM6SSoV.js";import"./index-CMrnPay3.js";import{T as S,V as I}from"./index-BjY5WNcT.js";import"./index-DUmiLLSY.js";import"./index-BtqqqYhC.js";import{i as _}from"./imageFixtures-CD4avj2q.js";import{c as j,s as X}from"./commonArgTypes-BluK8w5L.js";import{d as Z,t as K,h as G}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./index-vCr8mJ6x.js";import"./index-Dlj8Qg7i.js";import"./index-DTrDRi1E.js";import"./button.component-CijhK_wp.js";import"./button.constants-CTne--Mk.js";import"./buttonsimple.constants-ElE0wGVf.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-BmcHpvsb.js";import"./keys-hFXe221I.js";import"./DisabledMixin-BTbPzOYb.js";import"./TabIndexMixin-CrwsWmHR.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-DCn8z7t-.js";import"./linksimple.component-BMicW1xG.js";import"./DataAriaLabelMixin-CIL0eAON.js";import"./link.constants-_bJ-_aV0.js";const q=W.constructTagName("banner"),n={CUSTOM:"custom",INFORMATIONAL:"informational",WARNING:"warning",ERROR:"error",SUCCESS:"success"},c={INFORMATIONAL_ICON_NAME:"info-circle-bold",SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},y={VARIANT:n.CUSTOM,PREFIX_ICON_SIZE:1.5},H=Y`
  :host {
...
`,J=[H],Q=e=>{switch(e){case n.INFORMATIONAL:return c.INFORMATIONAL_ICON_NAME;case n.SUCCESS:return c.SUCCESS_ICON_NAME;case n.WARNING:return c.WARNING_ICON_NAME;case n.ERROR:return c.ERROR_ICON_NAME;default:return null}};var ee=Object.defineProperty,f=(e,l,x,te)=>{for(var r=void 0,g=e.length-1,C;g>=0;g--)(C=e[g])&&(r=C(l,x,r)||r);return r&&ee(l,x,r),r};const A=class A extends N{constructor(){super(...arguments),this.variant=y.VARIANT,this.label=""}renderIcon(l){return l?a`
    ...
    `:s}getTextLabel(){return this.label?a`
      <mdc-text part="leading-label" type="${S.BODY_LARGE_REGULAR}" tagname="${I.SPAN}"
        >${this.label}</mdc-text
      >
      ${this.secondaryLabel?a`<mdc-text part="leading-secondary-label" type="${S.BODY_MIDSIZE_REGULAR}" tagname="${I.SPAN}"
    ...
    `}};A.styles=[...N.styles,...J];let o=A;f([h({type:String,reflect:!0})],o.prototype,"variant");f([h({type:String,reflect:!0})],o.prototype,"label");f([h({type:String,reflect:!0,attribute:"secondary-label"})],o.prototype,"secondaryLabel");o.register(q);const{action:i}=__STORYBOOK_MODULE_ACTIONS__,z=e=>a`
  <mdc-banner
    variant="${v(e.variant)}"
    label="${v(e.label)}"
...
`,$e={title:"Components/banner",tags:["autodocs"],component:"mdc-banner",render:z,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(n)},label:{control:"text"},"secondary-label":{control:"text"},...j,...X,...Z(["children","content","leading-icon","leading-text","trailing-actions"]),...K(["--mdc-banner-background-color","--mdc-banner-border-color","--mdc-banner-icon-color","--mdc-banner-elevation","--mdc-banner-padding","--mdc-banner-gap"])}},ae={variant:"custom",label:"Banner Label","secondary-label":"This is the secondary label of the banner."},t=a`
...
`,d={args:{...ae,variant:"informational",label:"System Update Available","secondary-label":"A new version is ready to install. Please save your work before proceeding.",children:t}},m={name:"All Variants",render:()=>a`
...
}`,...($=(R=d.parameters)==null?void 0:R.docs)==null?void 0:$.source}}};var w,E,L;m.parameters={...m.parameters,docs:{...(w=m.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'All Variants',
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      \${[{
  ...
  \`,
  ...hideAllControls()
}`,...(L=(E=m.parameters)==null?void 0:E.docs)==null?void 0:L.source}}};var T,k,M;b.parameters={...b.parameters,docs:{...(T=b.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: 'Label Only',
  args: {
    variant: 'informational',
    label: 'System Update Available',
  ...
  \`,
  ...hideAllControls()
}`,...(V=(F=p.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};const we=["Example","AllVariants","LabelOnly","WithoutActions","PromotionalBanner"];export{m as AllVariants,d as Example,b as LabelOnly,p as PromotionalBanner,u as WithoutActions,we as __namedExportsOrder,$e as default};
