import{a3 as p,a2 as h,u as v,C as m,R as u,k as f,n as s}from"./iframe-DKOSXYge.js";const y=[p,h`
    :host {
  ...
  `],E=v.constructTagName("spinner"),N={LARGE:"large",MIDSIZE:"midsize",SMALL:"small"},A={STANDALONE:"standalone",BUTTON:"button"},i={VARIANT:A.STANDALONE,SIZE:N.MIDSIZE,INVERTED:!1};var I=Object.defineProperty,a=(l,t,c,S)=>{for(var r=void 0,n=l.length-1,d;n>=0;n--)(d=l[n])&&(r=d(t,c,r)||r);return r&&I(t,c,r),r};const o=class o extends m{constructor(){super(...arguments),this.inverted=i.INVERTED,this.size=i.SIZE,this.ariaLabel=null,this.variant=i.VARIANT}updated(t){super.updated(t),t.has("ariaLabel")&&(this.role=this.ariaLabel?u.IMG:null,this.ariaHidden=this.ariaLabel?"false":"true")}render(){return f`
