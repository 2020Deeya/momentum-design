...
`,he=e=>p(o`
  ...
  `,...d()},x={render:()=>o`
      <form @submit=${m=>{m.preventDefault();const t=new FormData(m.target),s=t.get("stone-count"),l=t.get("avengers-name");a("Form Submitted")({value:{selectedStones:s,selectedAvengers:l}})}}>
    ...
    `},args:{required:!0,"help-text":"","help-text-type":"default"},...d()},A={render:()=>{const e=Array.from({length:10},(t,s)=>o`<mdc-option label="Option ${s+1}"></mdc-option>`);let m=null;return setTimeout(()=>{m=o`<mdc-option label="Delayed Option"></mdc-option>`;const t=document.querySelector('mdc-select[label="Select option"] mdc-selectlistbox');if(t){const s=document.createElement("mdc-option");s.setAttribute("label","Delayed Option"),t.appendChild(s)}},2e3),p(o`
  ...
  ...hideAllControls()
}`,...(re=(ie=k.parameters)==null?void 0:ie.docs)==null?void 0:re.source}}};var me,se,de;w.parameters={...w.parameters,docs:{...(me=w.parameters)==null?void 0:me.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(de=(se=w.parameters)==null?void 0:se.docs)==null?void 0:de.source}}};var pe,ue,be;O.parameters={...O.parameters,docs:{...(pe=O.parameters)==null?void 0:pe.docs,source:{originalSource:`{
