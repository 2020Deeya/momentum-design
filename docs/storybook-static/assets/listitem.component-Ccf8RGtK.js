import{u as E,S as y,X as x,W as f,k as d,V as L,h as T,q as n,E as g,n as r}from"./iframe-1S-3kruQ.js";import{o as v}from"./query-assigned-elements-uEuc3rg8.js";import{T as k,K as c}from"./TabIndexMixin-BzAaGOX6.js";import{D}from"./DisabledMixin-CoPZzXIJ.js";const p={CREATED:"created",DESTROYED:"destroyed",MODIFIED:"modified"},I=o=>{class t extends o{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event(p.CREATED,{bubbles:!0,composed:!0}))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event(p.DESTROYED,{bubbles:!0,composed:!0}))}dispatchModifiedEvent(s){this.dispatchEvent(new CustomEvent(p.MODIFIED,{detail:{change:s},bubbles:!0,composed:!0}))}}return t},N=E.constructTagName("listitem"),C={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},S={VARIANT:C.FULL_WIDTH};class u{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const A=y`
  :host {
