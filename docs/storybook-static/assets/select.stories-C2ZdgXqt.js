import{k as o}from"./iframe-BZIqfezz.js";import"./index-DhEFhIGt.js";import{c as de,s as re}from"./commonArgTypes-BluK8w5L.js";import{a as se,t as me,h as s,d as pe}from"./utils-CFOyPOhY.js";import"./index-ZxuQL_RW.js";import{V as k}from"./formfieldwrapper.component-oW93GVYf.js";import"./index-j5sdvfY7.js";import"./index-_eMQ-HQ2.js";import"./index-CcLekXMS.js";import{P as ue,S as be}from"./popover.component-DuH_0Ism.js";import"./preload-helper-C1FmrZbK.js";import"./index-C18IF3Nt.js";import"./button.component-DnOt1KFN.js";import"./button.constants-BODbV2mJ.js";import"./buttonsimple.constants-Cujjikw1.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-CkAGc9fc.js";import"./keys-hFXe221I.js";import"./DisabledMixin-Cmda32_X.js";import"./TabIndexMixin-BPvoRxP_.js";import"./index-B-4qjIUw.js";import"./button.utils-rNW36Ji7.js";import"./index-DXkeu3PJ.js";import"./index-CQdIFnMT.js";import"./index-DTrDRi1E.js";import"./index-PjxgI6do.js";import"./index-CeMd0DMi.js";import"./index-CJCK-I0Z.js";import"./if-defined-CZ3GbhfA.js";import"./index-CAOGzmdW.js";import"./v4-CmTdKEVZ.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./CaptureDestroyEventForChildElement-XewiySbo.js";import"./listitem.component-BuBfQ0VF.js";import"./query-assigned-elements-uEuc3rg8.js";import"./DataAriaLabelMixin-CFQK4gtm.js";import"./FormInternalsMixin-CopWLCDr.js";import"./ListNavigationMixin-DgCStHq0.js";import"./divider.constants-BLqfhjr3.js";import"./BackdropMixin-CWGYOY4a.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,L=Object.values(k).filter(e=>e!=="priority"),$=e=>o`
...
`,w=e=>$(o`
  ...
  `),ot={title:"Components/select/select",tags:["autodocs"],component:"mdc-select",render:w,argTypes:{name:{control:"text"},label:{control:"text"},required:{control:"boolean"},placeholder:{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${L.map(e=>`'${e}'`).join(", ")}.`,options:L},"info-icon-aria-label":{control:"text"},"data-aria-label":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(ue)},"toggletip-strategy":{control:"select",options:Object.values(be)},"auto-focus-on-mount":{control:"boolean"},placement:{control:"select",options:["bottom-start","top-start"]},"soft-disabled":{control:"boolean"},...se(["id","value","validity","validation-message","willValidate","default","itemsStore"]),...me(["--mdc-select-background-color","--mdc-select-background-color-hover","--mdc-select-background-color-active","--mdc-select-background-color-disabled","--mdc-select-text-color","--mdc-select-text-color-selected","--mdc-select-text-color-disabled","--mdc-select-border-color","--mdc-select-border-color-disabled","--mdc-select-border-color-success","--mdc-select-border-color-warning","--mdc-select-border-color-error","--mdc-select-width","--mdc-select-listbox-height","--mdc-select-listbox-width"]),...de,...re}},p={args:{label:"Headquarters location",required:!0,placeholder:"Select your headquarters location",disabled:!1,readonly:!1,"help-text":"Select Help Text","help-text-type":"","data-aria-label":"Select label",placement:"bottom-start",children:o`<mdc-selectlistbox>
  ...
  `,...s()},g={render:()=>o`
      <form @submit=${d=>{d.preventDefault();const t=new FormData(d.target),r=t.get("stone-count"),c=t.get("avengers-name");l("Form Submitted")({value:{selectedStones:r,selectedAvengers:c}})}}>
    ...
    `,...s()},y={render:e=>{const d=(c,n)=>{const a=c.querySelector('mdc-select[name="avengers-name"]'),i=c.querySelector('mdc-select[name="stone-count"]'),m=a.value,q=i.value;let O=!0;return n.required&&(!m||m==="")?(a.setAttribute("help-text","Please select your favorite Avenger"),a.setAttribute("help-text-type","error"),O=!1):(a.setAttribute("help-text","Looks good!"),a.setAttribute("help-text-type","success")),n.required&&(!q||q==="")?(i.setAttribute("help-text","Please select the Infinity Stone count"),i.setAttribute("help-text-type","error"),O=!1):(i.setAttribute("help-text","Looks good!"),i.setAttribute("help-text-type","success")),O};return o`
    ...
    `},args:{required:!0,"help-text":"","help-text-type":"default"},...s()},S={render:()=>{const e=Array.from({length:10},(t,r)=>o`<mdc-option label="Option ${r+1}"></mdc-option>`);let d=null;return setTimeout(()=>{d=o`<mdc-option label="Delayed Option"></mdc-option>`;const t=document.querySelector('mdc-select[label="Select option"] mdc-selectlistbox');if(t){const r=document.createElement("mdc-option");r.setAttribute("label","Delayed Option"),t.appendChild(r)}},2e3),$(o`
      <mdc-select placeholder="Select an option" label="Select option">
        <mdc-selectlistbox> ${e} ${d} </mdc-selectlistbox>
      </mdc-select>
    `)},argTypes:{...pe(["readonly","name","data-aria-label","disabled","required","help-text-type","help-text"])},...s()},f={render:()=>$(o`
    ...
    `),...s()},A={render:()=>o` <mdc-button @click=${()=>{const t=document.querySelector('mdc-select[label="Select"]');t&&(t.value="option3")}}>Set value to Option 3</mdc-button>
      ...
      </mdc-select>`,...s()};var T,C,W;p.parameters={...p.parameters,docs:{...(T=p.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
  ...
  \`,
  ...hideAllControls()
}`,...(G=(P=x.parameters)==null?void 0:P.docs)==null?void 0:G.source}}};var j,U,K;g.parameters={...g.parameters,docs:{...(j=g.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(K=(U=g.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var Z,J,Q;y.parameters={...y.parameters,docs:{...(Z=y.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
  ...
  ...hideAllControls()
}`,...(Q=(J=y.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var X,ee,te;S.parameters={...S.parameters,docs:{...(X=S.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => {
  ...
  ...hideAllControls()
}`,...(te=(ee=S.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var oe,le,ce;f.parameters={...f.parameters,docs:{...(oe=f.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
    const handleClick = () => {
  ...
  ...hideAllControls()
}`,...(ie=(ae=A.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};const lt=["Example","SelectWithSecondaryLabel","SelectWithGroups","SelectWithLongOptionText","SelectWithIconOptions","SelectWithStates","SelectWithForm","SelectWithFormHelpTextValidation","SelectWithDynamicOptions","SelectWithChangingSelectedOption","SelectWithChangingValueAttribute"];export{p as Example,f as SelectWithChangingSelectedOption,A as SelectWithChangingValueAttribute,S as SelectWithDynamicOptions,g as SelectWithForm,y as SelectWithFormHelpTextValidation,b as SelectWithGroups,v as SelectWithIconOptions,h as SelectWithLongOptionText,u as SelectWithSecondaryLabel,x as SelectWithStates,lt as __namedExportsOrder,ot as default};
