import"./index-B-wQI-3B.js";import{V as B,T as N}from"./index-D1yLszQ-.js";import{i as ue,k as n,D as O}from"./lit-element-D5KKan5q.js";import{t as L}from"./if-defined-D5BV9-c0.js";import{u as be,C as P,n as a}from"./index-C9z9WAEj.js";import{F as ye}from"./FocusTrapMixin-CjzCjsSm.js";import{B as fe,I as ve}from"./button.constants-D0QAbDxL.js";import{C as Ee}from"./CardAndDialogFooterMixin-DHafZQ0X.js";import{a as $}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as xe,s as Ae}from"./commonArgTypes-BluK8w5L.js";import{d as Ie,h as De}from"./utils-CO8B6ZcN.js";import"./index-njiAX_XQ.js";import"./button.component-CETyLHgp.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-UuTVCePh.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./index-MA1r3zrt.js";import"./button.utils-rNW36Ji7.js";import"./index-EdEUAxWC.js";import"./iframe-BWoec5za.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./link.constants-CqyNsepP.js";import"./v4-CQkTLCs1.js";import"./IconNameMixin-CujGSn0t.js";import"./linksimple.component-CZN2acD1.js";const Te=ue`
  :host {
...
`,Se=[Te],$e=be.constructTagName("dialog"),ge={DEFAULT:"default",PROMOTIONAL:"promotional"},i={VISIBLE:!1,Z_INDEX:1e3,ROLE:"dialog",SIZE:"small",HEADER_TAG_NAME:"h2",DESCRIPTION_TAG_NAME:"p",CANCEL_ICON:"cancel-bold",VARIANT:ge.DEFAULT,DISABLE_ARIA_HAS_POPUP:!1},h=["small","medium","large"],Ce=["dialog","alertdialog"];class b{static dispatchDialogEvent(e,o){o.dispatchEvent(new CustomEvent(e,{detail:{show:o.visible},composed:!0,bubbles:!0}))}static onShowDialog(e){this.dispatchDialogEvent("shown",e)}static onHideDialog(e){this.dispatchDialogEvent("hidden",e)}static onCreatedDialog(e){this.dispatchDialogEvent("created",e)}static onDestroyedDialog(e){this.dispatchDialogEvent("destroyed",e)}}var Le=Object.defineProperty,s=(t,e,o,d)=>{for(var l=void 0,p=t.length-1,g;p>=0;p--)(g=t[p])&&(l=g(e,o,l)||l);return l&&Le(e,o,l),l};const _=class _ extends ye(Ee(P)){constructor(){super(...arguments),this.id="",this.visible=i.VISIBLE,this.zIndex=i.Z_INDEX,this.size=i.SIZE,this.variant=i.VARIANT,this.closeButtonAriaLabel=null,this.ariaLabel=null,this.ariaLabelledby=null,this.ariaDescribedBy=null,this.ariaDescription=null,this.headerTagName=i.HEADER_TAG_NAME,this.descriptionTagName=i.DESCRIPTION_TAG_NAME,this.role=i.ROLE,this.disableAriaHasPopup=i.DISABLE_ARIA_HAS_POPUP,this.focusTrap=!0,this.triggerElement=null,this.backdropElement=null,this.lastActiveElement=null,this.onEscapeKeydown=e=>{!this.visible||e.code!=="Escape"||(e.preventDefault(),this.hideDialog())},this.hideDialog=()=>{this.visible=!1},this.showDialog=()=>{this.visible=!0}}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.onEscapeKeydown.bind(this))}disconnectedCallback(){var e,o,d;super.disconnectedCallback(),document.removeEventListener("keydown",this.onEscapeKeydown),(e=this.backdropElement)==null||e.remove(),this.backdropElement=null,(o=this.deactivateFocusTrap)==null||o.call(this),(d=this.triggerElement)==null||d.setAttribute("aria-expanded","false"),this.focusBackToTrigger(),b.onDestroyedDialog(this)}async firstUpdated(e){super.firstUpdated(e),this.setAttribute("aria-modal","true"),this.setupAriaLabelledDescribedBy(),this.style.zIndex=`${this.zIndex}`,b.onCreatedDialog(this)}async updated(e){if(super.updated(e),e.has("triggerId")&&(this.triggerElement=this.getRootNode().querySelector(`[id="${this.triggerId}"]`),this.setupAriaHasPopup()),e.has("visible")){const o=e.get("visible");await this.isOpenUpdated(o,this.visible)}e.has("zIndex")&&this.setAttribute("z-index",`${this.zIndex}`),e.has("variant")&&this.updateFooterButtonColors(this.variant),(e.has("ariaLabel")||e.has("ariaLabelledBy")||e.has("ariaDescribedBy")||e.has("ariaDescription")||e.has("headerText")||e.has("descriptionText"))&&this.setupAriaLabelledDescribedBy()}setupAriaHasPopup(){var e,o;this.disableAriaHasPopup||(o=this.triggerElement)==null||o.setAttribute("aria-haspopup",((e=this.triggerElement)==null?void 0:e.getAttribute("aria-haspopup"))||"dialog")}setupAriaLabelledDescribedBy(){!this.ariaLabelledby&&!this.ariaLabel&&(this.headerText?this.setAttribute("aria-label",this.headerText):this.triggerId&&this.setAttribute("aria-labelledby",this.triggerId)),!this.ariaDescribedBy&&!this.ariaDescription&&(this.descriptionText?this.setAttribute("aria-description",this.descriptionText):this.triggerId&&this.setAttribute("aria-describedby",this.triggerId))}createBackdrop(){var d;const e=document.createElement("div");e.classList.add("dialog-backdrop");const o=document.createElement("style");o.textContent=`
    ...
    `,e.appendChild(o),(d=this.parentElement)==null||d.appendChild(e),this.backdropElement=e}async isOpenUpdated(e,o){var d,l,p,g,w,z;e!==o&&(o&&!e?(this.lastActiveElement=document.activeElement,this.enabledPreventScroll=!0,this.createBackdrop(),await this.updateComplete,(d=this.activateFocusTrap)==null||d.call(this),(l=this.setInitialFocus)==null||l.call(this),(p=this.triggerElement)==null||p.setAttribute("aria-expanded","true"),b.onShowDialog(this)):!o&&e&&((g=this.backdropElement)==null||g.remove(),this.backdropElement=null,(w=this.deactivateFocusTrap)==null||w.call(this),(z=this.triggerElement)==null||z.setAttribute("aria-expanded","false"),this.focusBackToTrigger(),b.onHideDialog(this)))}focusBackToTrigger(){this.triggerElement?this.triggerElement.focus():this.lastActiveElement&&this.lastActiveElement.focus&&this.lastActiveElement.focus()}render(){return n`
      ...
      ${this.renderFooter()}
    `}};_.styles=[...P.styles,...Se];let r=_;s([a({type:String,reflect:!0})],r.prototype,"id");s([a({type:String,reflect:!0})],r.prototype,"triggerId");s([a({type:Boolean,reflect:!0})],r.prototype,"visible");s([a({type:Number,reflect:!0,attribute:"z-index"})],r.prototype,"zIndex");s([a({type:String,reflect:!0})],r.prototype,"size");s([a({type:String,reflect:!0})],r.prototype,"variant");s([a({type:String,attribute:"close-button-aria-label"})],r.prototype,"closeButtonAriaLabel");s([a({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel");s([a({type:String,reflect:!0,attribute:"aria-labelledby"})],r.prototype,"ariaLabelledby");s([a({type:String,reflect:!0,attribute:"aria-describedby"})],r.prototype,"ariaDescribedBy");s([a({type:String,reflect:!0,attribute:"aria-description"})],r.prototype,"ariaDescription");s([a({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText");s([a({type:String,reflect:!0,attribute:"description-text"})],r.prototype,"descriptionText");s([a({type:String,reflect:!0,attribute:"header-tag-name"})],r.prototype,"headerTagName");s([a({type:String,reflect:!0,attribute:"description-tag-name"})],r.prototype,"descriptionTagName");s([a({type:String,reflect:!0})],r.prototype,"role");s([a({type:Boolean,reflect:!0,attribute:"disable-aria-haspopup"})],r.prototype,"disableAriaHasPopup");r.register($e);const u=(t,e)=>n`<mdc-dialog
  class="${t.class}"
  style="${t.style}"
  id="${t.id}"
  z-index="${t["z-index"]}"
...
`,ke=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")};return n`
    ...
    ${u(t,k(e))}
  `},_e=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")};return n`
    ${C(t.triggerId,"Click me!",e)}
    ${u(t,k(e,!0))}
  `},we=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{window.confirm("Are you sure you want to cancel?")&&e()};return n`
    ${C(t.triggerId,"Click me!",e)}
    ${u(t,n`
      <div slot="dialog-body">
        <p>This is the body content of the dialog.</p>
  ...
  `},pt={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:ke,parameters:{badges:["stable"]},argTypes:{...xe,...Ae,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(ge)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},role:{control:"select",options:Object.values(Ce)},size:{control:"select",options:Object.values(h)},visible:{control:"boolean"},...Ie(["--mdc-dialog-primary-background-color","--mdc-dialog-border-color","--mdc-dialog-header-text-color","--mdc-dialog-description-text-color","--mdc-dialog-elevation-3","--mdc-dialog-width"]),...De(["focusTrap"])}},c={id:"dialog","z-index":i.Z_INDEX,role:i.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:i.VARIANT},m={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":i.HEADER_TAG_NAME,"description-tag-name":i.DESCRIPTION_TAG_NAME},y={args:{size:i.SIZE,...c,...m}},f={args:{size:h[0],...c,...m}},v={args:{size:h[1],...c,...m}},E={args:{size:h[2],...c,...m}},x={args:{...c,size:h[0]}},A={render:ze,args:{...c,size:h[0]}},I={render:we,args:{...c,...m,size:i.SIZE}},D={render:_e,args:{...c,...m,size:i.SIZE}},T={render:t=>n`
  ...
  `},S={render:t=>n`
      ...
      ${t.mountDialog?u(t,k()):""}
    `,args:{...c,...m,size:i.SIZE,mountDialog:!0,visible:!0}};var R,H,Z;y.parameters={...y.parameters,docs:{...(R=y.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
...
}`,...(te=(ee=A.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var oe,re,ie;I.parameters={...I.parameters,docs:{...(oe=I.parameters)==null?void 0:oe.docs,source:{originalSource:`{
...
}`,...(ie=(re=I.parameters)==null?void 0:re.docs)==null?void 0:ie.source}}};var ae,se,ne;D.parameters={...D.parameters,docs:{...(ae=D.parameters)==null?void 0:ae.docs,source:{originalSource:`{
