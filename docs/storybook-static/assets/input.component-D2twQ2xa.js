import{R as h,D as u,i as f,k as d}from"./lit-element-D5KKan5q.js";import{n as o}from"./provider.component-BaQC7CJH.js";import{t as l}from"./if-defined-D5BV9-c0.js";import{e as v,i as x,t as p}from"./directive-Ctav8iJK.js";import{r as T,d as E}from"./directive-helpers-Bb6vhctq.js";import"./index-C9Ylha4w.js";import{D as $,F as g}from"./formfieldwrapper.component-C-SgLT80.js";import{D as I}from"./DataAriaLabelMixin-Cpdy3gUS.js";import{F as k}from"./FormInternalsMixin-BIoSiX4k.js";import{K as A}from"./keys-hFXe221I.js";import{A as _,a as w,D as c,P as C}from"./input.constants-Dk8u4o3a.js";import{a as R}from"./index-B-GnYs90.js";/**
 * @license
  ...
  `,...R(!0)];var P=Object.defineProperty,n=(r,t,e,a)=>{for(var s=void 0,m=r.length-1,y;m>=0;m--)(y=r[m])&&(s=y(t,e,s)||s);return s&&P(t,e,s),s};const b=class b extends k(I(g)){constructor(){super(...arguments),this.placeholder="",this.readonly=!1,this.trailingButton=!1,this.autocapitalize=_.OFF,this.autocomplete=w.OFF,this.autofocus=!1,this.clearAriaLabel=""}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.setInputValidity(),this.internals.setFormValue(this.inputElement.value))}).catch(t=>{this.onerror&&this.onerror(t)})}formResetCallback(){this.value="",this.inputElement.value="",this.setInputValidity(),this.requestUpdate()}formStateRestoreCallback(t){this.value=t}attributeChangedCallback(t,e,a){super.attributeChangedCallback(t,e,a),t==="validation-message"&&this.updateComplete.then(()=>{this.setInputValidity()}).catch(s=>{this.onerror&&this.onerror(s)})}setInputValidity(){this.inputElement.setCustomValidity(""),!this.inputElement.validity.valid&&this.validationMessage&&this.inputElement.setCustomValidity(this.validationMessage),this.setValidity()}updateValue(){this.value=this.inputElement.value,this.internals.setFormValue(this.inputElement.value)}onInput(){this.updateValue(),this.setInputValidity(),this.checkValidity()}onChange(t){this.updateValue(),this.setInputValidity();const e=t.constructor;this.dispatchEvent(new e(t.type,t))}handleKeyDown(t){var e;t.key===A.ENTER&&((e=this.form)==null||e.requestSubmit())}renderLeadingIcon(){return this.leadingIcon?d`
    ...
    `:u}renderPrefixText(){return this.prefixText?d`
      <mdc-text
        ...
        aria-hidden="true"
      >
        ${this.prefixText.slice(0,C.MAX_LENGTH)}
      </mdc-text>
