import{k as i}from"./iframe-DtiRZQ2l.js";import{t as f}from"./if-defined-r97CdV4N.js";import"./index-DLb2JQPc.js";import"./index-BK86NvBQ.js";import{c as D,s as v}from"./commonArgTypes-BG7EqI50.js";import{h as U,a as W}from"./utils-B5QUENNQ.js";import{V as L}from"./ControlTypeMixin-DqfXclDu.js";import{I as c}from"./menuitemcheckbox.constants-1Uy4iXPW.js";import"./preload-helper-C1FmrZbK.js";import"./index-DT8t-KQI.js";import"./DisabledMixin-D_v0Rzs7.js";import"./formfieldwrapper.constants-B3uNFiAc.js";import"./popover.constants-BYzMFhXU.js";import"./toggle.constants-Cgx5qi7I.js";import"./index-Ccx2WKW7.js";import"./popover.component-B7wDhef-.js";import"./BackdropMixin-DeyzsEP1.js";import"./KeyDownHandledMixin-DXj2iMY0.js";import"./index-DOdZz0Sq.js";import"./v4-CmTdKEVZ.js";import"./class-map-DrZ1WPHn.js";import"./directive-Ctav8iJK.js";import"./menuitem.component-D839K_sS.js";import"./listitem.component-Bfsg9ZUf.js";import"./query-assigned-elements-DwDnvVcz.js";import"./index-DTrDRi1E.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,M=e=>i`<div role="menu" style="width: 25rem;">${e}</div>`,O=e=>M(i` <mdc-menuitemcheckbox
      @change="${l("onchange")}"
      @click="${l("onclick")}"
      @focus="${l("onfocus")}"
      ?disabled="${e.disabled}"
    ...
    >
      ${e.children}
    </mdc-menuitemcheckbox>`),me={title:"Components/menupopover/menuitemcheckbox",tags:["autodocs"],component:"mdc-menuitemcheckbox",render:O,argTypes:{checked:{control:"boolean"},indicator:{control:"select",options:Object.values(c)},disabled:{control:"boolean"},label:{control:"text"},"secondary-label":{control:"text"},"control-type":{control:"select",options:[void 0,...L]},"soft-disabled":{control:"boolean"},...U(["data-aria-label","variant","tertiary-label","side-header-text","subline-text","leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","arrow-position","arrow-direction"]),...D,...v}},o={args:{indicator:c.CHECKBOX,checked:!1,label:"Menu Item",disabled:!1,"secondary-label":"",children:i`<mdc-icon length-unit="rem" name="alert-muted-bold" slot="leading-controls"></mdc-icon>`}},t={args:{checked:!0,indicator:c.TOGGLE,label:"Menu Item With Toggle",disabled:!1,"secondary-label":""}},m={args:{checked:!0,indicator:c.CHECKBOX,label:"Menu Item With Checkbox",disabled:!1,"secondary-label":""}},n={args:{checked:!0,indicator:c.CHECKMARK,label:"Menu Item With Checkmark",disabled:!1,"secondary-label":""}},d={render:()=>M(i`
  ...
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};const ne=["Example","ToggleWithMenuItem","CheckboxWithMenuItem","CheckmarkWithMenuItem","AllVariants"];export{d as AllVariants,m as CheckboxWithMenuItem,n as CheckmarkWithMenuItem,o as Example,t as ToggleWithMenuItem,ne as __namedExportsOrder,me as default};
