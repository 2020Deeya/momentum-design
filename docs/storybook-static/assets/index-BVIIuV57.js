import{i as y,D as p,k as c}from"./lit-element-D5KKan5q.js";import{r as M}from"./state-CmYk530Z.js";import{t as v}from"./if-defined-D5BV9-c0.js";import{u as b,C as f}from"./provider.component-DrWB4byV.js";import{n as h}from"./property-Bj3TGwkg.js";import{I as O}from"./IconNameMixin-Bk-Z_FTS.js";import{h as _}from"./index-B-GnYs90.js";import{S as n}from"./index-CMNZTGnd.js";import{T as s}from"./index-DeEenWCE.js";import"./index-BRXB0ni5.js";const z=b.constructTagName("avatar"),r={COUNTER:"counter",ICON:"icon",PHOTO:"photo",TEXT:"text"},T=99,A="user-regular",e={24:24,32:32,48:48,64:64,72:72,88:88,124:124},E={TYPE:r.PHOTO,SIZE:e[32],ICON_NAME:A};var L=Object.defineProperty,l=(o,t,i,I)=>{for(var a=void 0,d=o.length-1,m;d>=0;d--)(m=o[d])&&(a=m(t,i,a)||a);return a&&L(t,i,a),a};const S=o=>{class t extends o{constructor(){super(...arguments),this.size=E.SIZE,this.isTyping=!1}}return l([h({type:String})],t.prototype,"src"),l([h({type:String})],t.prototype,"initials"),l([h({type:String})],t.prototype,"presence"),l([h({type:Number,reflect:!0,attribute:"size"})],t.prototype,"size"),l([h({type:Number})],t.prototype,"counter"),l([h({type:Boolean,attribute:"is-typing"})],t.prototype,"isTyping"),t},C=[_,y`
    :host {
  ...
  `],x=o=>({[e[124]]:n.XX_LARGE,[e[88]]:n.X_LARGE,[e[72]]:n.LARGE,[e[64]]:n.MIDSIZE,[e[48]]:n.SMALL,[e[32]]:n.X_SMALL,[e[24]]:n.XX_SMALL})[o]||n.X_SMALL,P=o=>({[e[124]]:4.75,[e[88]]:3,[e[72]]:2.5,[e[64]]:2.25,[e[48]]:1.75,[e[32]]:1.25,[e[24]]:1})[o]||1.25,N=o=>({[e[124]]:s.HEADING_XLARGE_MEDIUM,[e[88]]:s.HEADING_LARGE_MEDIUM,[e[72]]:s.HEADING_MIDSIZE_MEDIUM,[e[64]]:s.HEADING_SMALL_MEDIUM,[e[48]]:s.HEADING_SMALL_MEDIUM,[e[32]]:s.BODY_MIDSIZE_MEDIUM,[e[24]]:s.BODY_SMALL_MEDIUM})[o]||s.BODY_MIDSIZE_MEDIUM;var k=Object.defineProperty,D=(o,t,i,I)=>{for(var a=void 0,d=o.length-1,m;d>=0;d--)(m=o[d])&&(a=m(t,i,a)||a);return a&&k(t,i,a),a};const g=class g extends S(O(f)){constructor(){super(...arguments),this.isPhotoLoaded=!1}getPresenceTemplateBasedOnType(t){return t===r.COUNTER&&(this.counter||this.counter===0)||this.isTyping?p:this.presence?c`
