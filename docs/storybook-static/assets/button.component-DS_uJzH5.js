...
`,B=[$];var L=Object.defineProperty,u=(c,o,l,r)=>{for(var t=void 0,e=c.length-1,a;e>=0;e--)(a=c[e])&&(t=a(o,l,t)||t);return t&&L(o,l,t),t};const f=class f extends F(O){constructor(){super(...arguments),this.size=s.SIZE,this.inverted=s.INVERTED,this.role=R.BUTTON}update(o){super.update(o),o.has("active")&&this.inferFilledIconName(this.active),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(o){o?(this.prefixIcon&&(this.prefixFilledIconName=`${w(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${w(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return v`
      <slot name="prefix" part="prefix">
        ${this.prefixFilledIconName?v` <mdc-icon
      ...
      <slot name="postfix" part="postfix">
        ${this.postfixFilledIconName?v` <mdc-icon
              name="${this.postfixFilledIconName}"
              part="postfix-icon"
              length-unit="rem"
            ></mdc-icon>`:""}
      </slot>
    `}};f.styles=[...O.styles,...B];let m=f;u([d({type:Number})],m.prototype,"size");u([d({type:Boolean,reflect:!0})],m.prototype,"inverted");u([d({type:String,reflect:!0})],m.prototype,"role");u([y()],m.prototype,"prefixFilledIconName");u([y()],m.prototype,"postfixFilledIconName");export{m as B,F as a};
