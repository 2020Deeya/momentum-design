...
`,B=[$];var L=Object.defineProperty,p=(c,t,l,r)=>{for(var o=void 0,e=c.length-1,a;e>=0;e--)(a=c[e])&&(o=a(t,l,o)||o);return o&&L(t,l,o),o};const f=class f extends F(S){constructor(){super(...arguments),this.size=s.SIZE,this.inverted=s.INVERTED,this.role=R.BUTTON}update(t){super.update(t),t.has("active")&&this.inferFilledIconName(this.active),t.has("size")&&this.setSize(this.size),t.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),t.has("color")&&this.setColor(this.color),t.has("typeInternal")&&this.setSize(this.size),(t.has("prefixIcon")||t.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(t){t?(this.prefixIcon&&(this.prefixFilledIconName=`${w(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${w(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return b`
    ...
    `}};f.styles=[...S.styles,...B];let m=f;p([d({type:Number})],m.prototype,"size");p([d({type:Boolean,reflect:!0})],m.prototype,"inverted");p([d({type:String,reflect:!0})],m.prototype,"role");p([y()],m.prototype,"prefixFilledIconName");p([y()],m.prototype,"postfixFilledIconName");export{m as B,F as a};
