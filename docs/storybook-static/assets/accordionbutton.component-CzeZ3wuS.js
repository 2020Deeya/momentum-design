import{u as E,a2 as x,a8 as f,k as s,h as n,T,V as g,R as h,C as v,n as d}from"./iframe-DtiRZQ2l.js";import{D as I}from"./DisabledMixin-D_v0Rzs7.js";import{K as R,a as S,A}from"./KeyDownHandledMixin-DXj2iMY0.js";import{v as m}from"./v4-CmTdKEVZ.js";const V=E.constructTagName("accordiongroup"),y={SMALL:"small",LARGE:"large"},D={BORDERLESS:"borderless",CONTAINED:"contained",STACKED:"stacked"},z={SIZE:y.SMALL,VARIANT:D.STACKED},M=E.constructTagName("accordionbutton"),c={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},L={DEFAULT:"default",BORDERLESS:"borderless"},r={EXPANDED:!1,SIZE:y.SMALL,DATA_ARIA_LEVEL:3,VARIANT:L.DEFAULT,ICON_NAME:c.ARROW_UP},N=x`
  :host {
...
`,$=[N,...f(!0)];var _=Object.defineProperty,o=(b,e,i,k)=>{for(var a=void 0,l=b.length-1,u;l>=0;l--)(u=b[l])&&(a=u(e,i,a)||a);return a&&_(e,i,a),a};const p=class p extends R(S(I(v))){constructor(){super(...arguments),this.size=r.SIZE,this.variant=r.VARIANT,this.dataAriaLevel=r.DATA_ARIA_LEVEL,this.expanded=r.EXPANDED,this.headSectionId=`head-section-${m()}`,this.bodySectionId=`body-section-${m()}`}handleHeaderClick(){this.disabled||(this.expanded=!this.expanded,this.dispatchHeaderClickEvent())}click(){this.disabled||(super.click(),this.handleHeaderClick())}dispatchHeaderClickEvent(){const e=new CustomEvent("shown",{bubbles:!0,cancelable:!0,detail:{expanded:this.expanded}});this.dispatchEvent(e)}handleKeyDown(e){const i=this.getActionForKeyEvent(e);(i===A.ENTER||i===A.SPACE)&&(this.handleHeaderClick(),this.keyDownEventHandled())}renderIcon(e){return e?s`<mdc-icon name="${e}" length-unit="rem" size="1"></mdc-icon>`:n}renderHeadingText(){return this.headerText?s`<mdc-text
    ...
    `}getArrowIconName(){return this.disabled?c.ARROW_DOWN:this.expanded?c.ARROW_UP:c.ARROW_DOWN}renderBody(){return this.disabled?n:this.expanded?s`<div
      ...
      >
        <slot></slot>
      </div>`:n}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",`${this.disabled}`),e.has("dataAriaLevel")&&!this.dataAriaLevel&&(this.dataAriaLevel=r.DATA_ARIA_LEVEL),e.has("size")&&!this.size&&(this.size=r.SIZE),e.has("variant")&&!this.variant&&(this.variant=r.VARIANT)}render(){return s` ${this.renderHeader()} ${this.renderBody()} `}};p.styles=[...v.styles,...$];let t=p;o([d({type:String,reflect:!0})],t.prototype,"size");o([d({type:String,reflect:!0})],t.prototype,"variant");o([d({type:Number,reflect:!0,attribute:"data-aria-level"})],t.prototype,"dataAriaLevel");o([d({type:Boolean,reflect:!0})],t.prototype,"expanded");o([d({type:String,reflect:!0,attribute:"header-text"})],t.prototype,"headerText");o([d({type:String,attribute:"prefix-icon"})],t.prototype,"prefixIcon");export{t as A,z as D,y as S,M as T,L as V,V as a,D as b};
