import{u as l,i as m,C as b,k as p,n as d}from"./iframe-Cg5TAAQy.js";import{o as h}from"./query-assigned-elements-uEuc3rg8.js";import{h as v}from"./index-hvNnVypU.js";const g=l.constructTagName("buttongroup"),y={40:40,32:32,28:28,24:24},f={HORIZONTAL:"horizontal",VERTICAL:"vertical"},z={PRIMARY:"primary",SECONDARY:"secondary"},a={SIZE:y[28],VARIANT:z.PRIMARY,ORIENTATION:f.HORIZONTAL},T=m`
  :host {
...
`,A=[v,T];var w=Object.defineProperty,e=(s,t,c,N)=>{for(var r=void 0,n=s.length-1,u;n>=0;n--)(u=s[n])&&(r=u(t,c,r)||r);return r&&w(t,c,r),r};const i=class i extends b{constructor(){super(...arguments),this.orientation=a.ORIENTATION,this.variant=a.VARIANT,this.size=a.SIZE,this.compact=!1}handleSlotChange(){this.buttons.forEach(t=>{t.setAttribute("size",this.size.toString()),t.setAttribute("variant",this.variant)})}updated(t){super.updated(t),(t.has("size")||t.has("variant"))&&this.handleSlotChange()}render(){return p`<div part="container"><slot @slotchange=${this.handleSlotChange}></slot></div>`}};i.styles=[...b.styles,...A];let o=i;e([d({type:String,reflect:!0})],o.prototype,"orientation");e([d({type:String,reflect:!0})],o.prototype,"variant");e([d({type:Number,reflect:!0})],o.prototype,"size");e([d({type:Boolean,reflect:!0})],o.prototype,"compact");e([h({selector:"mdc-button"})],o.prototype,"buttons");o.register(g);export{z as B,f as a,y as b};
