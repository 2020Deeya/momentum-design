import{R as h,D as u,i as f,k as d}from"./lit-element-D5KKan5q.js";import{n as o}from"./index-C9z9WAEj.js";import{t as l}from"./if-defined-D5BV9-c0.js";import{e as v,i as x,t as p}from"./directive-Ctav8iJK.js";import{r as T,d as E}from"./directive-helpers-Bb6vhctq.js";import"./index-DV1HLhBk.js";import{D as $,F as g}from"./formfieldwrapper.component-D6q8AeiS.js";import{D as I}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as k}from"./FormInternalsMixin-CqDKsEWP.js";import{A,a as _,D as c,P as w}from"./input.constants-CQyrWSWB.js";import{a as C}from"./index-B-GnYs90.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L=v(class extends x{constructor(r){if(super(r),r.type!==p.PROPERTY&&r.type!==p.ATTRIBUTE&&r.type!==p.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!T(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[t]){if(t===h||t===u)return t;const e=r.element,a=r.name;if(r.type===p.PROPERTY){if(t===e[a])return h}else if(r.type===p.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(a))return h}else if(r.type===p.ATTRIBUTE&&e.getAttribute(a)===t+"")return h;return E(r),t}}),O=[f`
    :host {
  ...
  `,...C(!0)];var R=Object.defineProperty,n=(r,t,e,a)=>{for(var s=void 0,m=r.length-1,y;m>=0;m--)(y=r[m])&&(s=y(t,e,s)||s);return s&&R(t,e,s),s};const b=class b extends k(I(g)){constructor(){super(...arguments),this.placeholder="",this.readonly=!1,this.trailingButton=!1,this.autocapitalize=A.OFF,this.autocomplete=_.OFF,this.autofocus=!1,this.clearAriaLabel=""}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.setInputValidity(),this.internals.setFormValue(this.inputElement.value))}).catch(t=>{this.onerror&&this.onerror(t)})}formResetCallback(){this.value="",this.inputElement.value="",this.setInputValidity(),this.requestUpdate()}formStateRestoreCallback(t){this.value=t}attributeChangedCallback(t,e,a){super.attributeChangedCallback(t,e,a),t==="validation-message"&&this.updateComplete.then(()=>{this.setInputValidity()}).catch(s=>{this.onerror&&this.onerror(s)})}setInputValidity(){this.inputElement.setCustomValidity(""),!this.inputElement.validity.valid&&this.validationMessage&&this.inputElement.setCustomValidity(this.validationMessage),this.setValidity()}updateValue(){this.value=this.inputElement.value,this.internals.setFormValue(this.inputElement.value)}onInput(){this.updateValue(),this.setInputValidity(),this.checkValidity()}onChange(t){this.updateValue(),this.setInputValidity();const e=t.constructor;this.dispatchEvent(new e(t.type,t))}handleKeyDown(t){var e;t.key==="Enter"&&((e=this.form)==null||e.requestSubmit())}renderLeadingIcon(){return this.leadingIcon?d`
      <mdc-icon
        class="leading-icon"
        part="leading-icon"
    ...
    `:u}renderPrefixText(){return this.prefixText?d`
      <mdc-text
        ...
        aria-hidden="true"
      >
        ${this.prefixText.slice(0,w.MAX_LENGTH)}
      </mdc-text>
    `:u}clearInputText(){var t;this.value="",(t=this.inputElement)==null||t.focus()}renderTrailingButton(t=!1){const e=t||this.value&&this.trailingButton;return e?d`
      <mdc-button
    ...
    `}};b.styles=[...g.styles,...O];let i=b;n([o({type:String})],i.prototype,"placeholder");n([o({type:Boolean})],i.prototype,"readonly");n([o({type:String,attribute:"prefix-text"})],i.prototype,"prefixText");n([o({type:String,attribute:"leading-icon"})],i.prototype,"leadingIcon");n([o({type:Boolean,attribute:"trailing-button"})],i.prototype,"trailingButton");n([o({type:Number})],i.prototype,"maxlength");n([o({type:Number})],i.prototype,"minlength");n([o({type:String})],i.prototype,"autocapitalize");n([o({type:String})],i.prototype,"autocomplete");n([o({type:Boolean})],i.prototype,"autofocus");n([o({type:String})],i.prototype,"dirname");n([o({type:String})],i.prototype,"pattern");n([o({type:String})],i.prototype,"list");n([o({type:Number})],i.prototype,"size");n([o({type:String,attribute:"clear-aria-label"})],i.prototype,"clearAriaLabel");export{i as I};
