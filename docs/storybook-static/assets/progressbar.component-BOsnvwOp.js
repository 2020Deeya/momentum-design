import{u as b,a3 as u,a2 as v,k as t,R as f,n as l}from"./iframe-DtiRZQ2l.js";import"./index-g6DkUIkb.js";import{D as T}from"./DataAriaLabelMixin-CLQqFjU0.js";import{V as o}from"./formfieldwrapper.constants-B3uNFiAc.js";import{v as y}from"./v4-CmTdKEVZ.js";import{F as m}from"./formfieldwrapper.component-CkDgddNq.js";const A=b.constructTagName("progressbar"),n={DEFAULT:"default",INLINE:"inline"},V={VARIANT:n.DEFAULT,VALIDATION:o.DEFAULT},$=[u,v`
    :host {
  ...
  `];var x=Object.defineProperty,d=(c,r,a,h)=>{for(var e=void 0,i=c.length-1,g;i>=0;i--)(g=c[i])&&(e=g(r,a,e)||e);return e&&x(r,a,e),e};const p=class p extends T(m){constructor(){super(...arguments),this.variant=V.VARIANT,this.value="0",this.error=!1,this.renderProgressbar=()=>{const r=this.getValidationVariant(),a=this.clampedValue>0&&this.clampedValue<100,h=this.error?"100":`${this.clampedValue}`;return t`
      <div
