import{R as h,D as u,i as v,k as d}from"./lit-element-D5KKan5q.js";import{n as o}from"./provider.component-BaQC7CJH.js";import{t as l}from"./if-defined-D5BV9-c0.js";import{e as f,i as x,t as p}from"./directive-Ctav8iJK.js";import{r as T,d as E}from"./directive-helpers-Bb6vhctq.js";import"./index-BuAqNQtd.js";import{D as $,F as g}from"./formfieldwrapper.component-Bh3Mxn5K.js";import{D as I}from"./DataAriaLabelMixin-Cpdy3gUS.js";import{F as k}from"./FormInternalsMixin-CvUI0OX_.js";import{K as A}from"./keys-hFXe221I.js";import{A as _}from"./buttonsimple.component-CKyEWPbX.js";import{A as w,a as C,D as c,P as O}from"./input.constants-z5HAYAGU.js";import{a as F}from"./index-CqVtAZCJ.js";/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const R=f(class extends x{constructor(r){if(super(r),r.type!==p.PROPERTY&&r.type!==p.ATTRIBUTE&&r.type!==p.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!T(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[t]){if(t===h||t===u)return t;const e=r.element,a=r.name;if(r.type===p.PROPERTY){if(t===e[a])return h}else if(r.type===p.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(a))return h}else if(r.type===p.ATTRIBUTE&&e.getAttribute(a)===t+"")return h;return E(r),t}}),L=[v`
    :host {
