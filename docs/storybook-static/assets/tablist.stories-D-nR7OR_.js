...
<!-- End of example markup for the tab panels -->`,Dt={title:"Components/tablist",tags:["autodocs"],component:"mdc-tablist",render:Z,parameters:{badges:["stable"]},argTypes:{"active-tab-id":{control:"text"},"data-aria-label":{control:"text"},tabvariant:{control:"select",description:"Set the variant of tab inside the tablist",options:Object.values(H)},...K(["tabvariant"]),...G(["--mdc-tablist-gap","--mdc-tablist-width","--mdc-tablist-arrow-button-margin","change","Default"])}},h={args:{tabvariant:"line"}},u={args:{tabvariant:"glass","active-tab-id":"documents-tab","data-aria-label":"Media types"}};var R,x,E;h.parameters={...h.parameters,docs:{...(R=h.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    tabvariant: 'line'
  }
...
}`,...(F=(I=u.parameters)==null?void 0:I.docs)==null?void 0:F.source}}};const St=["Example","ActiveTabAttributeSet"];export{u as ActiveTabAttributeSet,h as Example,St as __namedExportsOrder,Dt as default};
