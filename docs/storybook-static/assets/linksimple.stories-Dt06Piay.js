import{L as O,T as _}from"./linksimple.component-CgBqcslP.js";import{k as L}from"./iframe-bG46usBV.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-Di4ztU1F.js";import"./DataAriaLabelMixin-_5Vvd-29.js";import"./DisabledMixin-Bj73smRD.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
