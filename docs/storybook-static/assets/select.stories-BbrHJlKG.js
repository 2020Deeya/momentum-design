import{a as d}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{i as Z,k as i,D as X}from"./lit-element-D5KKan5q.js";import"./index-BBR7WaI6.js";import"./index-n8xuU4eM.js";import"./index-D3DhXfcW.js";import{u as J,n as O}from"./index-C9z9WAEj.js";import{r as p}from"./state-CSSggq2n.js";import{e as Q}from"./query-DXShiZ7f.js";import{o as ee}from"./query-assigned-elements-uEuc3rg8.js";import{K as r}from"./keys-CuA-OPmH.js";import{D as te}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as oe}from"./FormInternalsMixin-DWM52DiH.js";import{D as ae,F as w,V as f}from"./formfieldwrapper.component-DWkrE3Yi.js";import{T as le}from"./index-DPkVAo11.js";import{T as V}from"./index-DFvgevc3.js";import{P as re}from"./popover.component-MSr1o-8H.js";import{T as ie,V as se}from"./text.constants-ZF0jM5wn.js";import{h as ne}from"./index-MA1r3zrt.js";import{c as ce,s as de}from"./commonArgTypes-BluK8w5L.js";import{h as pe,a as m,d as me}from"./utils-CO8B6ZcN.js";import"./index-B_gr288Z.js";import"./v4-CQkTLCs1.js";import"./iframe-Cl9FYLKo.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./index-DHB6QJLv.js";import"./buttonsimple.component-Djhz-GfJ.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./button.constants--xhTiFYY.js";import"./button.utils-CP-c2W9c.js";import"./base-DIkkzJ-c.js";import"./v4-CmTdKEVZ.js";import"./index-DV4kDnGu.js";import"./if-defined-D5BV9-c0.js";import"./listitem.component-CAQJg3uX.js";const he=J.constructTagName("select"),S={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},ue=Z`
  :host {
...
`,be=[ue,...ne(!0)];var ve=Object.defineProperty,n=(o,e,t,a)=>{for(var l=void 0,c=o.length-1,T;c>=0;c--)(T=o[c])&&(l=T(e,t,l)||l);return l&&ve(e,t,l),l};const $=class $ extends oe(te(w)){constructor(){super(...arguments),this.readonly=!1,this.height="auto",this.baseIconName=S.ARROW_DOWN,this.selectedValue="",this.displayPopover=!1,this.activeDescendant=""}connectedCallback(){super.connectedCallback(),this.value=void 0,this.addEventListener("keydown",this.handleKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.handleKeydown)}getAllValidOptions(){var e;return((e=this.optionsList)==null?void 0:e.map(t=>t.tagName.toLowerCase()===V?t:t.tagName.toLowerCase()===le?Array.from(t.children).filter(a=>a.tagName.toLowerCase()===V):[]).flat())||[]}handlePopoverOpen(){this.baseIconName=S.ARROW_UP}handlePopoverClose(){this.baseIconName=S.ARROW_DOWN}updateTabIndexForAllOptions(e){var a;let t=!1;this.getAllValidOptions().forEach(l=>{l===e?(this.setSelectedValue(l),t=!0,l.setAttribute("selected",""),l.setAttribute("tabindex","0")):(l==null||l.setAttribute("tabindex","-1"),l==null||l.removeAttribute("selected"))}),!t&&((a=this.getAllValidOptions()[0])==null||a.setAttribute("tabindex","0"))}handleOptionsClick(e){this.updateTabIndexForAllOptions(e.target)}setSelectedValue(e){this.selectedValueText=(e==null?void 0:e.getAttribute("label"))??(e==null?void 0:e.textContent)??"",this.selectedValue=(e==null?void 0:e.getAttribute("value"))??(e==null?void 0:e.textContent)??"",this.internals.setFormValue(this.selectedValue),this.manageRequired(),this.dispatchChange(this.selectedValue)}manageRequired(){!this.selectedValue&&this.requiredLabel?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.selectedValue="",this.selectedValueText=void 0,this.internals.setFormValue(this.selectedValue),this.updateTabIndexForAllOptions()}formStateRestoreCallback(e){this.selectedValue=e,this.selectedValueText=e}dispatchChange(e){e&&this.dispatchEvent(new CustomEvent("change",{detail:{value:e},composed:!0,bubbles:!0}))}handleKeydown(e){this.displayPopover?this.handlePopoverOnOpen(e):this.handlePopoverOnClose(e)}handlePopoverOnOpen(e){var t;switch(e.key){case r.SPACE:this.updateTabIndexForAllOptions(e.target),this.closePopover();break;case r.ENTER:this.updateTabIndexForAllOptions(e.target),this.closePopover(),(t=this.form)==null||t.requestSubmit();break;case r.ESCAPE:this.closePopover();break;case r.HOME:this.setFocusAndTabIndex(0);break;case r.END:this.setFocusAndTabIndex(this.getAllValidOptions().length-1);break;case r.ARROW_DOWN:case r.ARROW_UP:case r.PAGE_DOWN:case r.PAGE_UP:this.handleOptionsNavigation(e),this.updateActivedescendant(e.target);break}}handlePopoverOnClose(e){switch(e.key){case r.ARROW_DOWN:case r.ARROW_UP:case r.ENTER:case r.SPACE:this.openPopover(),e.preventDefault();break;case r.HOME:this.openPopover(),this.setFocusAndTabIndex(0);break;case r.END:this.openPopover(),this.setFocusAndTabIndex(this.getAllValidOptions().length-1);break}}handleOptionsNavigation(e){const t=this.getAllValidOptions(),a=t.findIndex(c=>c===e.target),l=this.getNewIndexBasedOnKey(e.key,a,t.length);l!==-1&&(this.setFocusAndTabIndex(l),e.preventDefault())}getNewIndexBasedOnKey(e,t,a){return e===r.ARROW_DOWN&&t!==a-1?t+1:e===r.ARROW_UP&&t>0?t-1:e===r.PAGE_DOWN?t+10>a?a-1:t+10:e===r.PAGE_UP?t-10<0?0:t-10:-1}updateActivedescendant(e){var a;const t=this.getAllValidOptions().findIndex(l=>l===e);this.activeDescendant=((a=this.getAllValidOptions()[t])==null?void 0:a.id)??""}resetActivedescendant(){this.activeDescendant=""}setFocusAndTabIndex(e){var t;(t=this.getAllValidOptions()[e])==null||t.focus(),this.getAllValidOptions().forEach((a,l)=>{const c=e===l?"0":"-1";a==null||a.setAttribute("tabindex",c)})}openPopover(){this.displayPopover=!0,this.resetActivedescendant()}closePopover(){this.displayPopover=!1,this.resetActivedescendant()}firstUpdated(){const e=this.getAllValidOptions(),t=e.findIndex(a=>a==null?void 0:a.hasAttribute("selected"));t!==-1?(this.setSelectedValue(e[t]),this.updateTabIndexForAllOptions(e[t])):this.placeholder?this.placeholder&&this.manageRequired():(this.setSelectedValue(e[0]),this.updateTabIndexForAllOptions())}getNativeSelect(){return i`
    ...
    `}};$.styles=[...w.styles,...be];let s=$;n([O({type:String})],s.prototype,"placeholder");n([O({type:Boolean})],s.prototype,"readonly");n([O({type:String,attribute:"height"})],s.prototype,"height");n([ee()],s.prototype,"optionsList");n([p()],s.prototype,"baseIconName");n([p()],s.prototype,"selectedValueText");n([p()],s.prototype,"selectedValue");n([p()],s.prototype,"displayPopover");n([p()],s.prototype,"activeDescendant");n([Q("select")],s.prototype,"inputElement");s.register(he);const I=Object.values(f).filter(o=>o!=="priority"),A=o=>i`
...
`),ot={title:"Work In Progress/select",tags:["autodocs"],component:"mdc-select",render:ge,parameters:{badges:["wip"]},argTypes:{name:{control:"text"},label:{control:"text"},"required-label":{control:"text"},placeholder:{control:"text"},disabled:{control:"boolean"},readonly:{control:"boolean"},"help-text":{control:"text"},"help-text-type":{control:"select",description:`The type of help text. It can be ${I.map(o=>`'${o}'`).join(", ")}.`,options:I},"data-aria-label":{control:"text"},height:{control:"text"},...pe(["id","value","validity","validation-message","willValidate","default","label-info"]),...ce,...de}},h={args:{label:"Headquarters location","required-label":"required",placeholder:"Select your headquarters location",disabled:!1,readonly:!1,"help-text":"Select Help Text","help-text-type":"","data-aria-label":"Select label"}},u={render:()=>i`
  ...
  ...hideAllControls()
}`,...(j=(z=y.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};const at=["Example","SelectWithGroups","SelectWithLongOptionText","SelectWithIconOptions","SelectWithStates","SelectWithFixedHeight","SelectWithForm"];export{h as Example,x as SelectWithFixedHeight,y as SelectWithForm,u as SelectWithGroups,v as SelectWithIconOptions,b as SelectWithLongOptionText,g as SelectWithStates,at as __namedExportsOrder,ot as default};
