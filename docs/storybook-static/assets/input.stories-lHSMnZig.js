import"./index-CK6jBm3c.js";import{k as o}from"./lit-element-D5KKan5q.js";import{t}from"./if-defined-D5BV9-c0.js";import{a as r}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as D,s as q}from"./commonArgTypes-BluK8w5L.js";import{V as L}from"./formfieldwrapper.component-nmLPHhLb.js";import{t as A,d as H}from"./utils-CF1irry3.js";import{P as z}from"./popover.component-b3MZdLOz.js";import{A as V}from"./input.constants-BEj_o4-8.js";import"./index-By-ccbFQ.js";import"./button.component-CzH-VU4W.js";import"./index-C9z9WAEj.js";import"./state-CSSggq2n.js";import"./button.constants-ld6CW6g-.js";import"./buttonsimple.constants-wHSLNcjv.js";import"./buttonsimple.component-CHHctxKG.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./keys-Hz01Ianf.js";import"./index-B-GnYs90.js";import"./button.utils-rNW36Ji7.js";import"./index-CG5ZFYCw.js";import"./iframe-BwtIvwmR.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./index-BrLJ_9IK.js";import"./index-CjMuRb2X.js";import"./index-96ToHBu8.js";import"./v4-CmTdKEVZ.js";import"./input.component-etsDCV76.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./index-CgRYvEy7.js";import"./DataAriaLabelMixin-D53Z5CZ7.js";import"./FormInternalsMixin-CqDKsEWP.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./v4-CQkTLCs1.js";import"./roles-BH_hBfTz.js";const T=e=>{const c=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return o`<mdc-input
    @input="${r("oninput")}"
    @change="${r("onchange")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
  ...
  `},d={argTypes:{...H(["label","help-text","required","placeholder","value","help-text-type"])},render:()=>o` <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
      ...
      <form @submit=${l=>{l.preventDefault();const s=new FormData(l.target).get("user-name");r("Form Submitted")({value:s})}}>
        <fieldset>
      ...
      <form @submit=${l=>{l.preventDefault();const s=new FormData(l.target).get("user-name");r("Form Submitted")({value:s})}}>
        <fieldset>
          ...
          <mdc-input
            ...
            @input=${l=>{const a=l.target;a.validity.valueMissing&&a.setAttribute("validation-message","Please enter a name"),a.validity.tooShort&&a.setAttribute("validation-message","Please enter a name with at least 5 characters")}}
          ></mdc-input>
          <div style="display: flex; gap: 0.25rem;; margin-top: 0.25rem">
            <mdc-button type="submit" size="24">Submit</mdc-button>
            <mdc-button type="reset" size="24" variant="secondary">Reset</mdc-button>
...
}`,...(I=(E=m.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};const Pe=["Example","InputInSmallContainer","AllVariants","FormFieldInput","FormFieldInputWithCustomValidationMessage"];export{d as AllVariants,n as Example,p as FormFieldInput,m as FormFieldInputWithCustomValidationMessage,i as InputInSmallContainer,Pe as __namedExportsOrder,Fe as default};
