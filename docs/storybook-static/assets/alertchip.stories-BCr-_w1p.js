import{i as E,u as y,k as c,D as R,C as N,n as f}from"./iframe-Cg5TAAQy.js";import{B as S}from"./buttonsimple.component-dowWq62Q.js";import{h as I,a as _}from"./index-hvNnVypU.js";import{a as O}from"./buttonsimple.constants-D0Md3OfM.js";import{T as $,V as x}from"./index-lZ1m-Bbe.js";import"./index-Bu_SSHse.js";import{c as w,s as L}from"./commonArgTypes-BluK8w5L.js";import{a as C,t as U}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./keys-hFXe221I.js";import"./DisabledMixin-BKNV4Fwu.js";import"./TabIndexMixin-0hHS2f4l.js";import"./roles-CJI3JVG-.js";import"./index-BFrJzZic.js";import"./index-DTrDRi1E.js";const V=E`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,D=[I,V,..._()],G=y.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:$.BODY_MIDSIZE_REGULAR,TAG_NAME:x.SPAN,SIZE:O[24],ROLE:"button"},M=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var P=Object.defineProperty,T=(r,s,h,B)=>{for(var a=void 0,m=r.length-1,p;m>=0;m--)(p=r[m])&&(a=p(s,h,a)||a);return a&&P(s,h,a),a};const d=class d extends S{constructor(){super(...arguments),this.variant=e.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return c`
      ...
      ${this.label?c`<mdc-text part="label" type="${e.TEXT_TYPE}" tagname="${e.TAG_NAME}"
            >${this.label}</mdc-text
          >`:R}
    `}};d.styles=[...N.styles,...D];let t=d;T([f({type:String})],t.prototype,"variant");T([f({type:String})],t.prototype,"label");t.register(G);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,j=r=>c` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
