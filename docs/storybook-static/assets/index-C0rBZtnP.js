import{i as g,D as c,k as d}from"./lit-element-CHllvULs.js";import{u as x,n as r}from"./index-HW6KrQZO.js";import{t as n}from"./if-defined-C4tJgJ33.js";import{a as T}from"./index-BGjwsboe.js";import"./index-DfEvrl5z.js";import{B as v,I as f}from"./button.constants-BtWRRBoE.js";import{V as y,D as E,F as b}from"./formfieldwrapper.component-63e8oEkZ.js";import{T as I,V as A}from"./text.constants-DJu2q-6E.js";import{D as _}from"./DataAriaLabelMixin-vs_lw9aw.js";import{F as $}from"./FormInternalsMixin-Ch02HUy5.js";import"./index-CgTICbPI.js";import"./index-CUxX-hvH.js";import"./index-BGkqZMsC.js";const N=[g`
  :host{
...
`,...T(!0)],C=x.constructTagName("input"),k={OFF:"off",NONE:"none",ON:"on",SENTENCES:"sentences",WORDS:"words",CHARACTERS:"characters"},R={MAX_LENGTH:10,HELPERTEXT:"Prefix text should not exceed 10 characters",VALIDATION:y.ERROR},s={VALIDATION:y.DEFAULT,ICON_SIZE_VALUE:1,ICON_SIZE_UNIT:"rem",CLEAR_BUTTON_ICON:"cancel-bold",CLEAR_BUTTON_VARIANT:v.TERTIARY,CLEAR_BUTTON_SIZE:f[20],PREFIX_TEXT_TYPE:I.BODY_MIDSIZE_REGULAR,PREFIX_TEXT_TAG:A.SPAN};var S=Object.defineProperty,o=(u,t,i,h)=>{for(var a=void 0,l=u.length-1,m;l>=0;l--)(m=u[l])&&(a=m(t,i,a)||a);return a&&S(t,i,a),a};const p=class p extends $(_(b)){constructor(){super(...arguments),this.placeholder="",this.readonly=!1,this.trailingButton=!1,this.autocapitalize=k.OFF,this.autocomplete="off",this.autofocus=!1,this.clearAriaLabel=""}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this.inputElement&&(this.inputElement.checkValidity(),this.setInputValidity(),this.internals.setFormValue(this.inputElement.value))}).catch(t=>{this.onerror&&this.onerror(t)})}formResetCallback(){this.value="",this.requestUpdate()}formStateRestoreCallback(t){this.value=t}handleValueChange(){this.updateComplete.then(()=>{this.setInputValidity()}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&this.handleValueChange()}setInputValidity(){this.validationMessage&&this.value===""?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()}attributeChangedCallback(t,i,h){super.attributeChangedCallback(t,i,h),["maxlength","minlength","pattern","required"].includes(t)&&this.updateComplete.then(()=>{this.setInputValidity()}).catch(l=>{this.onerror&&this.onerror(l)})}updateValue(){this.value=this.inputElement.value,this.internals.setFormValue(this.inputElement.value)}onInput(){this.updateValue(),this.setInputValidity()}onChange(t){this.updateValue(),this.setInputValidity();const i=t.constructor;this.dispatchEvent(new i(t.type,t))}handleKeyDown(t){var i;t.key==="Enter"&&((i=this.form)==null||i.requestSubmit())}renderLeadingIcon(){return this.leadingIcon?d`
    ...
    `:c}renderPrefixText(){return this.prefixText?d`
      <mdc-text 
        ...
        aria-hidden="true"
      >
        ${this.prefixText.slice(0,R.MAX_LENGTH)}
      </mdc-text>
