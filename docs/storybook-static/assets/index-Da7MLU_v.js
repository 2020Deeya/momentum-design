import{u as y,n as d,U as I,S as z,q as n,h as m,k as h,G as v,$ as O}from"./iframe-xJvWfTzZ.js";import{t as f}from"./if-defined-GCyvQTHu.js";import{I as M}from"./IconNameMixin-6gzykPlm.js";import{a as s}from"./index-3T6Teot2.js";import"./index-BbYB32IG.js";const _=y.constructTagName("avatar"),r={COUNTER:"counter",ICON:"icon",PHOTO:"photo",TEXT:"text"},T=99,C="user-regular",e={24:24,32:32,48:48,64:64,72:72,88:88,124:124},b={TYPE:r.PHOTO,SIZE:e[32],ICON_NAME:C};var P=Object.defineProperty,l=(a,t,i,E)=>{for(var o=void 0,c=a.length-1,p;c>=0;c--)(p=a[c])&&(o=p(t,i,o)||o);return o&&P(t,i,o),o};const x=a=>{class t extends a{constructor(){super(...arguments),this.size=b.SIZE,this.isTyping=!1}}return l([d({type:String})],t.prototype,"src"),l([d({type:String})],t.prototype,"initials"),l([d({type:String})],t.prototype,"presence"),l([d({type:Number,reflect:!0,attribute:"size"})],t.prototype,"size"),l([d({type:Number})],t.prototype,"counter"),l([d({type:Boolean,attribute:"is-typing"})],t.prototype,"isTyping"),t},N=[I,z`
    :host {
  ...
  `],S=a=>({[e[124]]:s[124],[e[88]]:s[88],[e[72]]:s[72],[e[64]]:s[64],[e[48]]:s[48],[e[32]]:s[32],[e[24]]:s[24]})[a]||s[32],A=a=>({[e[124]]:4.75,[e[88]]:3,[e[72]]:2.5,[e[64]]:2.25,[e[48]]:1.75,[e[32]]:1.25,[e[24]]:1})[a]||1.25,k=a=>({[e[124]]:n.HEADING_XLARGE_MEDIUM,[e[88]]:n.HEADING_LARGE_MEDIUM,[e[72]]:n.HEADING_MIDSIZE_MEDIUM,[e[64]]:n.HEADING_SMALL_MEDIUM,[e[48]]:n.HEADING_SMALL_MEDIUM,[e[32]]:n.BODY_MIDSIZE_MEDIUM,[e[24]]:n.BODY_SMALL_MEDIUM})[a]||n.BODY_MIDSIZE_MEDIUM;var D=Object.defineProperty,w=(a,t,i,E)=>{for(var o=void 0,c=a.length-1,p;c>=0;c--)(p=a[c])&&(o=p(t,i,o)||o);return o&&D(t,i,o),o};const g=class g extends x(M(v)){constructor(){super(...arguments),this.isPhotoLoaded=!1}getPresenceTemplateBasedOnType(t){return t===r.COUNTER&&(this.counter||this.counter===0)||this.isTyping?m:this.presence?h`
      ...
      />
    `}iconTemplate(){const t=this.iconName||b.ICON_NAME;return h`
    ...
    `}};g.styles=[...v.styles,...N];let u=g;w([O()],u.prototype,"isPhotoLoaded");u.register(_);export{e as A,b as D,x as a};
