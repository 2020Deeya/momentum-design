import{i as f,k as m}from"./lit-element-D5KKan5q.js";import{n as c}from"./index-C9z9WAEj.js";import{r as g}from"./state-CSSggq2n.js";import{a as p}from"./buttonsimple.component-PSrQpcnn.js";import{D as e,B as l,b as d,I as y,P as x,a as I,T as z}from"./button.constants-DagSuLvr.js";import{g as v}from"./button.utils-rNW36Ji7.js";import"./index-Cn5GmLqL.js";const k=f`
  :host {
...
`,T=[k];var N=Object.defineProperty,a=(u,o,n,i)=>{for(var r=void 0,s=u.length-1,h;s>=0;s--)(h=u[s])&&(r=h(o,n,r)||r);return r&&N(o,n,r),r};const b=class b extends p{constructor(){super(...arguments),this.variant=e.VARIANT,this.size=e.SIZE,this.color=e.COLOR,this.role="button",this.typeInternal=e.TYPE_INTERNAL}update(o){super.update(o),o.has("active")&&this.modifyIconName(this.active),o.has("size")&&this.setSize(this.size),o.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),o.has("color")&&this.setColor(this.color),o.has("typeInternal")&&this.setSize(this.size),(o.has("prefixIcon")||o.has("postfixIcon"))&&this.inferButtonType()}modifyIconName(o){o?(this.prefixIcon&&(this.prevPrefixIcon=this.prefixIcon,this.prefixIcon=`${v(this.prefixIcon)}-filled`),this.postfixIcon&&(this.prevPostfixIcon=this.postfixIcon,this.postfixIcon=`${v(this.postfixIcon)}-filled`)):(this.prevPrefixIcon&&(this.prefixIcon=this.prevPrefixIcon),this.prevPostfixIcon&&(this.postfixIcon=this.prevPostfixIcon))}setVariant(o){this.setAttribute("variant",Object.values(l).includes(o)?o:e.VARIANT)}setSize(o){const i=this.typeInternal===d.ICON?Object.values(y).includes(o)&&!(o===y[20]&&this.variant!==l.TERTIARY):Object.values(x).includes(o);this.setAttribute("size",i?`${o}`:`${e.SIZE}`)}setColor(o){!Object.values(I).includes(o)||this.variant===l.TERTIARY?this.setAttribute("color",`${e.COLOR}`):this.setAttribute("color",o)}inferButtonType(){var n,i;const o=(i=(n=this.shadowRoot)==null?void 0:n.querySelector("slot"))==null?void 0:i.assignedNodes().filter(r=>{var s;return r.nodeType!==Node.TEXT_NODE||((s=r.textContent)==null?void 0:s.trim())}).length;o&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=d.PILL_WITH_ICON,this.setAttribute("data-btn-type","pill-with-icon")):!o&&(this.prefixIcon||this.postfixIcon)?(this.typeInternal=d.ICON,this.setAttribute("data-btn-type","icon")):(this.typeInternal=d.PILL,this.setAttribute("data-btn-type","pill"))}render(){return m`
    ...
    `}};b.styles=[...p.styles,...T];let t=b;a([c({type:String,attribute:"prefix-icon",reflect:!0})],t.prototype,"prefixIcon");a([c({type:String,attribute:"postfix-icon",reflect:!0})],t.prototype,"postfixIcon");a([c({type:String})],t.prototype,"variant");a([c({type:Number})],t.prototype,"size");a([c({type:String})],t.prototype,"color");a([c({type:String,reflect:!0})],t.prototype,"role");a([g()],t.prototype,"typeInternal");t.register(z);export{t as B};
