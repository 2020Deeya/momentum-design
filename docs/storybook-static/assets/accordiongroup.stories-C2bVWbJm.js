import{i as Y,C as I,k as A,n as f}from"./iframe-Bj0osOL6.js";import{t as L}from"./if-defined-CbM6SSoV.js";import{o as U}from"./query-assigned-elements-uEuc3rg8.js";import{T as H}from"./index-Bg9mTWNy.js";import{D as d,T as K,a as J,S as i,b as n}from"./accordionbutton.component-w3L-F3Lo.js";import{a as P}from"./index-Dlj8Qg7i.js";import"./index-C6g-P5KV.js";import"./index-BdGCALLB.js";import"./index-MwKbaYdO.js";import{c as Q,s as X}from"./commonArgTypes-BluK8w5L.js";import{t as tt}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./index-DUmiLLSY.js";import"./button.component-CijhK_wp.js";import"./button.constants-CTne--Mk.js";import"./buttonsimple.constants-ElE0wGVf.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-BmcHpvsb.js";import"./keys-hFXe221I.js";import"./DisabledMixin-BTbPzOYb.js";import"./TabIndexMixin-CrwsWmHR.js";import"./button.utils-rNW36Ji7.js";import"./index-CMrnPay3.js";import"./index-vCr8mJ6x.js";import"./index-DTrDRi1E.js";import"./index-BjY5WNcT.js";import"./v4-CmTdKEVZ.js";import"./index-Chz6xt1p.js";import"./IconNameMixin-DCn8z7t-.js";import"./index-B2GNtVnu.js";import"./chip.component-Wbo9KYWa.js";import"./staticchip.component-B2w0kcdU.js";const ot=Y`
  :host {
...
`,at=[ot,...P()];var rt=Object.defineProperty,s=(o,t,a,l)=>{for(var c=void 0,S=o.length-1,E;S>=0;S--)(E=o[S])&&(c=E(t,a,c)||c);return c&&rt(t,a,c),c};const x=class x extends I{constructor(){super(),this.size=d.SIZE,this.variant=d.VARIANT,this.allowMultiple=!1,this.addEventListener("shown",this.handleAccordionExpanded)}handleAccordionExpanded(t){this.allowMultiple||[...this.accordionItems,...this.accordionButtonItems].forEach(a=>{a!==t.target&&a.hasAttribute("expanded")&&a.toggleAttribute("expanded")})}setChildrenAccordionAttributes(t,a){[...this.accordionItems].forEach(l=>{l.setAttribute(t,a)}),[...this.accordionButtonItems].forEach(l=>{l.setAttribute(t,a)})}updated(t){super.updated(t),t.has("size")&&(this.size||(this.size=d.SIZE),this.setChildrenAccordionAttributes("size",this.size)),t.has("variant")&&(this.variant||(this.variant=d.VARIANT),this.setChildrenAccordionAttributes("variant",this.variant))}render(){return A` <slot></slot> `}};x.styles=[...I.styles,...at];let e=x;s([f({type:String,reflect:!0})],e.prototype,"size");s([f({type:String,reflect:!0})],e.prototype,"variant");s([f({type:Boolean,reflect:!0,attribute:"allow-multiple"})],e.prototype,"allowMultiple");s([U({selector:H})],e.prototype,"accordionItems");s([U({selector:K})],e.prototype,"accordionButtonItems");e.register(J);const r=A`Loreum impusm sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
  ...
  </mdc-accordiongroup>`,kt={title:"Components/accordion/accordiongroup",tags:["autodocs"],component:"mdc-accordiongroup",render:et,argTypes:{...Q,...X,"allow-multiple":{control:"boolean"},size:{control:"select",options:Object.values(i)},variant:{control:"select",options:Object.values(n)},...tt(["default","--mdc-accordiongroup-border-color"])}},m={args:{size:d.SIZE,variant:d.VARIANT,"allow-multiple":!1}},p={args:{variant:n.STACKED,size:i.SMALL}},u={args:{variant:n.CONTAINED,size:i.SMALL}},h={args:{variant:n.BORDERLESS,size:i.SMALL}},b={args:{size:i.SMALL,variant:n.CONTAINED}},v={args:{size:i.LARGE,variant:n.CONTAINED}},g={args:{size:i.SMALL,variant:n.CONTAINED,"allow-multiple":!1},render:o=>A`
  ...
  \`
}`,...(F=(W=g.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};const Bt=["Example","StackedVariant","ContainedVariant","BorderlessVariant","SmallSize","LargeSize","MultiInteractiveAccordion"];export{h as BorderlessVariant,u as ContainedVariant,m as Example,v as LargeSize,g as MultiInteractiveAccordion,b as SmallSize,p as StackedVariant,Bt as __namedExportsOrder,kt as default};
