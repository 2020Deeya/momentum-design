import{i as q,D as Z,k as l}from"./lit-element-D5KKan5q.js";import{n as z}from"./index-C9z9WAEj.js";import{a as P}from"./index-CcXofQbA.js";import{D as Q}from"./DisabledMixin-BZruwOeC.js";import{T as X}from"./TabIndexMixin-CsrHswKP.js";import{C as x}from"./card.component-BbEuZO0l.js";import{R as J}from"./roles-DMFGbP5t.js";import{T as K}from"./index-NhH2pmNU.js";import"./index-BxpyMMVk.js";import"./index-D3DhXfcW.js";import"./index-BQHpR8ua.js";import{Q as Y}from"./repeat-CNQ7t7Vw.js";import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as ee,s as te}from"./commonArgTypes-BluK8w5L.js";import{h as ae,d as re}from"./utils-CO8B6ZcN.js";import{V as oe,O as T,D as t}from"./CardAndDialogFooterMixin-COm20Ox1.js";import{V as y}from"./text.constants-ZF0jM5wn.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-D0QAbDxL.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./index-YKllVwdU.js";import"./if-defined-D5BV9-c0.js";import"./DataAriaLabelMixin-D53Z5CZ7.js";import"./formfieldwrapper.component-5n2-mkV5.js";import"./radio.constants-DXoIHWZL.js";import"./iframe-CnyU4f7B.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-CqyNsepP.js";const ie=q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,le=[ie,...P()];var de=Object.defineProperty,j=(e,a,i,d)=>{for(var r=void 0,o=e.length-1,I;o>=0;o--)(I=e[o])&&(r=I(a,i,r)||r);return r&&de(a,i,r),r};const f=class f extends Q(X(x)){constructor(){super(),this.checked=!1,this.name="",this.addEventListener("click",this.toggleChecked),this.addEventListener("keydown",this.toggleOnEnter),this.addEventListener("keyup",this.toggleOnSpace)}connectedCallback(){super.connectedCallback(),this.role=J.RADIO}getAllCardsWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-cardradio[name="${this.name}"]`))}toggleChecked(){if(this.disabled)return;this.getAllCardsWithinSameGroup().forEach(i=>{i.checked=!1}),this.checked=!0}setDisabled(a){this.setAttribute("aria-disabled",`${a}`),this.tabIndex=a?-1:0}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&this.setDisabled(this.disabled)}updateCardRadio(a,i){a[i].focus(),a[i].toggleChecked()}toggleOnEnter(a){if(this.disabled)return;const d=this.getAllCardsWithinSameGroup().filter(o=>!o.disabled),r=d.indexOf(this);if(["ArrowDown","ArrowRight"].includes(a.key)){const o=(r+1)%d.length;this.updateCardRadio(d,o)}else if(["ArrowUp","ArrowLeft"].includes(a.key)){const o=(r-1+d.length)%d.length;this.updateCardRadio(d,o)}a.key==="Enter"&&this.toggleChecked()}toggleOnSpace(a){a.key===" "&&this.toggleChecked()}renderHeader(){return this.cardTitle?l`<div part="header">
  ...
  `}};f.styles=[...x.styles,...le];let c=f;j([z({type:Boolean,reflect:!0})],c.prototype,"checked");j([z({type:String})],c.prototype,"name");c.register(K);const se=e=>l`
  <mdc-cardradio
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    ...
    tabindex="${e.tabIndex}"
    class="${e.class}"
    style="${e.style}">${e.children}</mdc-cardradio>`,je={title:"Work In Progress/card/cardradio",tags:["autodocs"],component:"mdc-cardradio",render:se,parameters:{badges:["wip"]},argTypes:{variant:{control:"select",options:Object.values(oe)},orientation:{control:"select",options:Object.values(T)},name:{control:"text"},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"title-tag-name":{control:"select",options:Object.values(y)},"subtitle-tag-name":{control:"select",options:Object.values(y)},...ae(["children"]),...ee,...te}},s=l`<mdc-text slot='body' 
...
Ut in massa luctus lacus sodales accumsan. Praesent at aliquam leo. Ut a scelerisque turpis.</mdc-text>`,m={args:{"card-title":"Title",name:"radio-card",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,variant:t.VARIANT,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,children:s}},p={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x280","image-alt":"Image Alt","icon-name":"placeholder-bold","aria-label":"Aria Label","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:T.HORIZONTAL,children:s}},h={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"aria-label":"Aria Label",checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION,children:s}},u={args:{"image-src":"https://placehold.co/320x200","image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION}},b={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,children:l`
    ...
    ${s}`}},g={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x540","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:T.HORIZONTAL,checked:!1,disabled:!1,tabIndex:0,children:l`
...
}`,...(R=($=h.parameters)==null?void 0:$.docs)==null?void 0:R.source}}};var L,D,G;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    'image-src': 'https://placehold.co/320x200',
    'image-alt': 'Image Alt',
    'card-title': 'Title',
...
}`,...(G=(D=u.parameters)==null?void 0:D.docs)==null?void 0:G.source}}};var M,U,F;b.parameters={...b.parameters,docs:{...(M=b.parameters)==null?void 0:M.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'image-src': 'https://placehold.co/320x200',
...
}`,...(F=(U=b.parameters)==null?void 0:U.docs)==null?void 0:F.source}}};var V,B,w;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
...
}`,...(w=(B=g.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};var H,W,_;A.parameters={...A.parameters,docs:{...(H=A.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-formfieldgroup
    label="Radio Cards"
    name="radio-cards"
...
}`,...(_=(W=A.parameters)==null?void 0:W.docs)==null?void 0:_.source}}};const qe=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInRadioGroup"];export{u as CardWithoutBody,h as CardWithoutImage,A as CardsInRadioGroup,g as ContentAfterBody,b as ContentBeforeBody,m as Example,p as HorizontalCard,qe as __namedExportsOrder,je as default};
