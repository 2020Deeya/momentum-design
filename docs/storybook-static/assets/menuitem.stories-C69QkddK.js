import{a as o}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{k as t}from"./lit-element-D5KKan5q.js";import"./index-DsMtFNtc.js";import{c as X,s as Y}from"./commonArgTypes-BluK8w5L.js";import{h as Z,d as ee,a as r}from"./utils-CO8B6ZcN.js";import"./index-DoWd4k5M.js";import"./index-CWciZxqh.js";import"./index-EdEUAxWC.js";import{P as U}from"./popover.component-B9J0JIz9.js";import{A as te,a as re}from"./menuitem.component-WkshLR4b.js";import"./v4-CQkTLCs1.js";import"./index-D1yLszQ-.js";import"./index-C9z9WAEj.js";import"./index-B8iBaVCW.js";import"./roles-Ch6n0tol.js";import"./v4-CmTdKEVZ.js";import"./class-map-BcCVsMyu.js";import"./directive-Ctav8iJK.js";import"./if-defined-D5BV9-c0.js";import"./IconNameMixin-CujGSn0t.js";import"./index-MA1r3zrt.js";import"./divider.constants-DyEGqhgz.js";import"./button.constants-D0QAbDxL.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./iframe-BWoec5za.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./base-DIkkzJ-c.js";import"./FocusTrapMixin-CjzCjsSm.js";import"./listitem.component-CzD32tB4.js";import"./query-assigned-elements-uEuc3rg8.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";const i="Menu Item",n=e=>t`<div role="menu" style="width: 20rem;">${e}</div>`,ne=e=>n(t`
  <mdc-menuitem
    @click="${o("onclick")}"
    @keydown="${o("onkeydown")}"
    @keyup="${o("onkeyup")}"
  ...
  `),...r()},p={render:()=>n(t`
    <mdc-menuitem label="${i}" side-header-text="##"></mdc-menuitem>
  `),...r()},b={render:()=>n(t`
    <mdc-menuitem label="${i}" arrow-position='trailing'></mdc-menuitem>
  `),...r()},h={render:()=>n(t`
    <mdc-menuitem label="${i}" arrow-position='leading'></mdc-menuitem>
  `),...r()},g={render:()=>t`
...
}`,...(x=(v=m.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var w,I,W;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...
  \`),
  ...hideAllControls()
}`,...(W=(I=l.parameters)==null?void 0:I.docs)==null?void 0:W.source}}};var $,f,S;a.parameters={...a.parameters,docs:{...($=a.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
  ...
  \`),
  ...hideAllControls()
}`,...(S=(f=a.parameters)==null?void 0:f.docs)==null?void 0:S.source}}};var A,C,M;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
    <mdc-menuitem label="\${label}">
      <mdc-icon length-unit="rem" slot="trailing-controls" name="placeholder-bold"></mdc-icon>
    </mdc-menuitem>
  \`),
  ...hideAllControls()
}`,...(M=(C=d.parameters)==null?void 0:C.docs)==null?void 0:M.source}}};var O,T,k;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
    <mdc-menuitem label="\${label}">
      <mdc-badge slot="trailing-controls" type="dot"></mdc-badge>
    </mdc-menuitem>
  \`),
  ...hideAllControls()
}`,...(k=(T=c.parameters)==null?void 0:T.docs)==null?void 0:k.source}}};var D,P,E;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
    <mdc-menuitem label="\${label}">
      <mdc-badge slot="trailing-controls" variant="primary" type="icon" icon-name="placeholder-bold"></mdc-badge>
    </mdc-menuitem>
  \`),
  ...hideAllControls()
}`,...(E=(P=s.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};var L,R,B;u.parameters={...u.parameters,docs:{...(L=u.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
    <mdc-menuitem label="\${label}">
      <mdc-badge slot="trailing-controls" type="counter" counter="10"></mdc-badge>
    </mdc-menuitem>
