import{i as k,u as m,k as n,D as v,C as s,n as b}from"./iframe-Cg5TAAQy.js";import{D as u}from"./DisabledMixin-BKNV4Fwu.js";import"./index-Bu_SSHse.js";const p=[k`
    :host {
      margin: 0.125rem 0;
  ...
  `],T=m.constructTagName("checkbox"),l={CHECKED:"check-bold",INDETERMINATE:"minus-bold"},x=m.constructTagName("staticcheckbox");var g=Object.defineProperty,h=(i,e,a,f)=>{for(var c=void 0,r=i.length-1,d;r>=0;r--)(d=i[r])&&(c=d(e,a,c)||c);return c&&g(e,a,c),c};const t=class t extends u(s){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1}render(){const e=this.checked||this.indeterminate?n`
      ...
      <div part="icon-container">${e}</div>`}};t.styles=[...s.styles,...p];let o=t;h([b({type:Boolean,reflect:!0})],o.prototype,"checked");h([b({type:Boolean,reflect:!0})],o.prototype,"indeterminate");o.register(x);export{T};
