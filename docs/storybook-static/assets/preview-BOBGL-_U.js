import{s as m}from"./chunk-L4EGOTBX-DZdh6BXL.js";import"./entry-preview-WYIabKHs.js";import{k as c}from"./lit-element-CHllvULs.js";import"./index-DJCRZ6zR.js";import"./index-BUkT1jCB.js";import"./directive-helpers-D8kir-nK.js";import"./index-DrFu-skq.js";import"./index-HW6KrQZO.js";import"./state-CWckTc1X.js";import"./create-context-89xeped_.js";import"./iconprovider.component-BsPZ_dvP.js";const p="1.0.0",u="",h=[{kind:"javascript-module",path:"components/avatar/avatar.component.js",declarations:[{kind:"class",description:`The \`mdc-avatar\` component is used to represent a person or a space.
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Icon",module:"components/icon/icon.component.js"}}]},{kind:"javascript-module",path:"components/input/input.component.js",declarations:[{kind:"class",description:`mdc-input is a component that allows users to input text.
 It contains:
...
This appears on the trailing side of the list item.`,attribute:"subline-text",reflects:!0},{kind:"method",name:"getText",privacy:"private",return:{type:{text:""}},parameters:[{name:"slotName",type:{text:"string"},description:"The name of the slot to be used."},{name:"type",type:{text:"TextType"},description:"The type of the text element."},{name:"content",optional:!0,type:{text:"string"},description:"The text content to be displayed within the slot."}],description:"Generates a template for a text slot with the specified content."},{kind:"method",name:"disableSlottedChildren",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"disabled",type:{text:"boolean"},description:"Whether to disable or enable the controls."}],description:`Disable or enable all slotted elements in the leading and trailing slots.
This is useful when the list item is disabled, to prevent the user from interacting with the controls.`},{kind:"field",name:"role",type:{text:"string"},default:"'listitem'"},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean"},default:"false",description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,attribute:"disabled",reflects:!0,inheritedFrom:{name:"DisabledMixin",module:"utils/mixins/DisabledMixin.js"}},{kind:"field",name:"tabIndex",type:{text:"number"},default:"0",description:"This property specifies the tab order of the element.",attribute:"tabIndex",reflects:!0,inheritedFrom:{name:"TabIndexMixin",module:"utils/mixins/TabIndexMixin.js"}}],attributes:[{name:"variant",type:{text:"ListItemVariants"},description:"The variant of the list item. It can be a pill, rectangle or a full-width.",default:"'full-width'",fieldName:"variant"},{name:"label",type:{text:"string | undefined"},description:`The primary label of the list item.
...
- **2**
- **3**
- **4**`,default:"0",attribute:"elevation",reflects:!0},{kind:"field",name:"dataRole",type:{text:"HTMLElement['role']"},description:"Role of the modalcontainer",default:"dialog",attribute:"data-role",reflects:!0},{kind:"field",name:"dataAriaModal",type:{text:"boolean"},description:"Aria modal of the modalcontainer",default:"false",attribute:"data-aria-modal",reflects:!0},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"dataAriaLabelledby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that label the current element.\nThe `aria-labelledby` attribute to be set for accessibility.",attribute:"data-aria-labelledby",reflects:!0,inheritedFrom:{name:"DataAriaLabelledbyMixin",module:"utils/mixins/DataAriaLabelledbyMixin.js"}},{kind:"field",name:"dataAriaDescribedby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that provide additional\ndescriptive information for the current element.\nThe `aria-describedby` attribute to be set for accessibility.",attribute:"data-aria-describedby",reflects:!0,inheritedFrom:{name:"DataAriaDescribedbyMixin",module:"utils/mixins/DataAriaDescribedbyMixin.js"}}],attributes:[{name:"color",type:{text:"ModalContainerColor"},description:`Color of the modalcontainer
- **tonal**
...
- **2**
- **3**
- **4**`,default:"0",fieldName:"elevation"},{name:"data-role",type:{text:"HTMLElement['role']"},description:"Role of the modalcontainer",default:"dialog",fieldName:"dataRole"},{name:"data-aria-modal",type:{text:"boolean"},description:"Aria modal of the modalcontainer",default:"false",fieldName:"dataAriaModal"},{name:"data-aria-label",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,fieldName:"dataAriaLabel",inheritedFrom:{name:"DataAriaLabelMixin",module:"src/utils/mixins/DataAriaLabelMixin.ts"}},{name:"data-aria-labelledby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that label the current element.\nThe `aria-labelledby` attribute to be set for accessibility.",fieldName:"dataAriaLabelledby",inheritedFrom:{name:"DataAriaLabelledbyMixin",module:"src/utils/mixins/DataAriaLabelledbyMixin.ts"}},{name:"data-aria-describedby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that provide additional\ndescriptive information for the current element.\nThe `aria-describedby` attribute to be set for accessibility.",fieldName:"dataAriaDescribedby",inheritedFrom:{name:"DataAriaDescribedbyMixin",module:"src/utils/mixins/DataAriaDescribedbyMixin.ts"}}],mixins:[{name:"DataAriaLabelMixin",module:"/src/utils/mixins/DataAriaLabelMixin"},{name:"DataAriaLabelledbyMixin",module:"/src/utils/mixins/DataAriaLabelledbyMixin"},{name:"DataAriaDescribedbyMixin",module:"/src/utils/mixins/DataAriaDescribedbyMixin"}],superclass:{name:"Component",module:"/src/models"},tagName:"mdc-modalcontainer",jsDoc:`/**
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Modalcontainer",module:"components/modalcontainer/modalcontainer.component.js"}}]},{kind:"javascript-module",path:"components/popover/popover.component.js",declarations:[{kind:"class",description:`Popover component is a lightweight floating UI element that displays additional content when triggered.
...
supports dynamic height adjustments with scrollable content when needed。`,name:"Popover",cssProperties:[{description:"radius of the arrow border",name:"--mdc-popover-arrow-border-radius"},{description:"border of the arrow",name:"--mdc-popover-arrow-border"},{description:"primary background color of the popover",name:"--mdc-popover-primary-background-color"},{description:"inverted background color of the popover",name:"--mdc-popover-inverted-background-color"},{description:"inverted border color of the popover",name:"--mdc-popover-inverted-border-color"},{description:"inverted text color of the popover",name:"--mdc-popover-inverted-text-color"}],slots:[{description:"Default slot for modal container",name:""}],members:[{kind:"field",name:"id",type:{text:"string"},default:"''",description:"The unique ID of the popover.",attribute:"id"},{kind:"field",name:"triggerID",type:{text:"string"},default:"''",description:`The ID of the element that triggers the popover.
This attribute is required for the popover to work.`,attribute:"triggerID"},{kind:"field",name:"trigger",type:{text:"PopoverTrigger"},description:`Determines the events that cause the Popover to show.
...
- **right**
- **right-start**
- **right-end**`,default:"bottom",attribute:"placement",reflects:!0},{kind:"field",name:"color",type:{text:"ModalContainerColor"},description:`Color of the popover
- **tonal**
...
It uses the floating-ui/dom library to calculate the position.`},{kind:"field",name:"utils",default:"new PopoverUtils(this)"},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"dataAriaLabelledby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that label the current element.\nThe `aria-labelledby` attribute to be set for accessibility.",attribute:"data-aria-labelledby",reflects:!0,inheritedFrom:{name:"DataAriaLabelledbyMixin",module:"utils/mixins/DataAriaLabelledbyMixin.js"}},{kind:"field",name:"dataAriaDescribedby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that provide additional\ndescriptive information for the current element.\nThe `aria-describedby` attribute to be set for accessibility.",attribute:"data-aria-describedby",reflects:!0,inheritedFrom:{name:"DataAriaDescribedbyMixin",module:"utils/mixins/DataAriaDescribedbyMixin.js"}},{kind:"field",name:"enabledFocusTrap",type:{text:"boolean"},description:`Determines whether the focus trap is enabled.
...
- **right**
- **right-start**
- **right-end**`,default:"bottom",fieldName:"placement"},{name:"color",type:{text:"ModalContainerColor"},description:`Color of the popover
- **tonal**
 ...
 *
 */`,customElement:!0,slots:[{description:"slot to add the label info icon",name:"label-info",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"Toggle",module:"components/toggle/toggle.component.js"}}]},{kind:"javascript-module",path:"components/virtualizedlist/virtualizedlist.component.js",declarations:[{kind:"class",description:`\`mdc-virtualizedlist\` component for creating custom virtualized lists.
...
- 72
- 88
- 124`,default:"32",fieldName:"size"},{name:"counter",type:{text:"number | undefined"},description:"The counter is the number which can be displayed on the avatar.\nThe maximum number is 99 and if the given number is greater than 99,\nthen the avatar will be displayed as `99+`.\nIf the given number is a negative number,\nthen the avatar will be displayed as `0`.",fieldName:"counter"},{name:"is-typing",type:{text:"boolean"},default:"false",description:"Represents the typing indicator when the user is typing.",fieldName:"isTyping"}],parameters:[{name:"superClass",type:{text:"T"}}]}],exports:[{kind:"js",name:"AvatarComponentMixin",declaration:{name:"AvatarComponentMixin",module:"utils/mixins/AvatarComponentMixin.js"}}]},{kind:"javascript-module",path:"utils/mixins/DataAriaDescribedbyMixin.js",declarations:[{kind:"mixin",description:"",name:"DataAriaDescribedbyMixin",members:[{kind:"field",name:"dataAriaDescribedby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that provide additional\ndescriptive information for the current element.\nThe `aria-describedby` attribute to be set for accessibility.",attribute:"data-aria-describedby",reflects:!0}],attributes:[{name:"data-aria-describedby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that provide additional\ndescriptive information for the current element.\nThe `aria-describedby` attribute to be set for accessibility.",fieldName:"dataAriaDescribedby"}],parameters:[{name:"superClass",type:{text:"T"}}]}],exports:[{kind:"js",name:"DataAriaDescribedbyMixin",declaration:{name:"DataAriaDescribedbyMixin",module:"utils/mixins/DataAriaDescribedbyMixin.js"}}]},{kind:"javascript-module",path:"utils/mixins/DataAriaLabelMixin.js",declarations:[{kind:"mixin",description:"",name:"DataAriaLabelMixin",members:[{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
...
The Aria-Label attribute to be set for accessibility.`,fieldName:"dataAriaLabel"}],parameters:[{name:"superClass",type:{text:"T"}}]}],exports:[{kind:"js",name:"DataAriaLabelMixin",declaration:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}}]},{kind:"javascript-module",path:"utils/mixins/DataAriaLabelledbyMixin.js",declarations:[{kind:"mixin",description:"",name:"DataAriaLabelledbyMixin",members:[{kind:"field",name:"dataAriaLabelledby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that label the current element.\nThe `aria-labelledby` attribute to be set for accessibility.",attribute:"data-aria-labelledby",reflects:!0}],attributes:[{name:"data-aria-labelledby",type:{text:"string | null"},default:"null",description:"Defines an ID reference to one or more elements that label the current element.\nThe `aria-labelledby` attribute to be set for accessibility.",fieldName:"dataAriaLabelledby"}],parameters:[{name:"superClass",type:{text:"T"}}]}],exports:[{kind:"js",name:"DataAriaLabelledbyMixin",declaration:{name:"DataAriaLabelledbyMixin",module:"utils/mixins/DataAriaLabelledbyMixin.js"}}]},{kind:"javascript-module",path:"utils/mixins/DisabledMixin.js",declarations:[{kind:"mixin",description:"",name:"DisabledMixin",members:[{kind:"field",name:"disabled",type:{text:"boolean"},default:"false",description:`Indicates whether the component is disabled.
