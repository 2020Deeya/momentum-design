import{S,U as y,X as O,u as x,q as _,V as $,c as w,k as t,h as L,E as U,n as I}from"./iframe-BF2FNzUT.js";import{B as C}from"./buttonsimple.component-CG56nNl1.js";import{I as M}from"./IconNameMixin-C8BnGXez.js";import"./index-HlHE88ny.js";import{c as V,s as D}from"./commonArgTypes-BluK8w5L.js";import{a as F}from"./utils-Dd_sfl9-.js";import"./preload-helper-C1FmrZbK.js";import"./TabIndexMixin-wPLFduzZ.js";import"./DisabledMixin-BAPxi5zf.js";import"./index-Csx79wEk.js";import"./index-DTrDRi1E.js";const G=S`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,B=[y,G,...O()],P=x.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},a={VARIANT:o.NEUTRAL,TEXT_TYPE:_.BODY_MIDSIZE_REGULAR,TAG_NAME:$.SPAN,SIZE:w[24],ROLE:"button"},j=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var Y=Object.defineProperty,R=(r,m,p,X)=>{for(var e=void 0,d=r.length-1,u;d>=0;d--)(u=r[d])&&(e=u(m,p,e)||e);return e&&Y(m,p,e),e};const h=class h extends M(C){constructor(){super(...arguments),this.variant=a.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=a.SIZE,this.role=a.ROLE}render(){return t`
      ...
      ${this.label?t`<mdc-text part="label" type="${a.TEXT_TYPE}" tagname="${a.TAG_NAME}"
            >${this.label}</mdc-text
          >`:L}
    `}};h.styles=[...U.styles,...B];let c=h;R([I({type:String,reflect:!0})],c.prototype,"variant");R([I({type:String})],c.prototype,"label");c.register(P);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,W=r=>t` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
