import"./index-C8WP2WR3.js";import"./index-CXBSCbv0.js";import"./index-MQYM6xaV.js";import{T as y,V as O}from"./index-BrLJ_9IK.js";import"./index-fjT__CNK.js";import{i as P,k as n,D as b}from"./lit-element-D5KKan5q.js";import{u as $,n as p}from"./index-C9z9WAEj.js";import{r as c}from"./state-CSSggq2n.js";import{e as T}from"./query-DXShiZ7f.js";import{o as V}from"./query-assigned-elements-uEuc3rg8.js";import{t as v}from"./if-defined-D5BV9-c0.js";import{K as r}from"./listitem.component-CHPaF0Zk.js";import{D as R}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as D}from"./FormInternalsMixin-CqDKsEWP.js";import{R as f}from"./roles-BH_hBfTz.js";import{D as I,V as E,F as g}from"./formfieldwrapper.component-D6q8AeiS.js";import{T as k}from"./optgroup.constants-CwoRKCZY.js";import{T as x}from"./index-DdtCqw8I.js";import{P as w}from"./popover.component-gG75l09H.js";import{a as N}from"./index-B-GnYs90.js";const C=$.constructTagName("select"),h={ARROW_UP:"arrow-up-bold",ARROW_DOWN:"arrow-down-bold"},A="select-base-triggerid",_=P`
  :host {
...
`,F=[_,...N(!0)];var S=Object.defineProperty,l=(m,e,t,a)=>{for(var s=void 0,o=m.length-1,d;o>=0;o--)(d=m[o])&&(s=d(e,t,s)||s);return s&&S(e,t,s),s};const u=class u extends D(R(g)){constructor(){super(...arguments),this.readonly=!1,this.height="auto",this.baseIconName=h.ARROW_DOWN,this.selectedValue="",this.displayPopover=!1,this.activeDescendant=""}getAllValidOptions(){var e;return((e=this.optionsList)==null?void 0:e.map(t=>t.tagName.toLowerCase()===x?t:t.tagName.toLowerCase()===k?Array.from(t.children).filter(a=>a.tagName.toLowerCase()===x):[]).flat())||[]}handlePopoverOpen(){this.displayPopover=!0,this.baseIconName=h.ARROW_UP,this.updateActivedescendant()}handlePopoverClose(){this.displayPopover=!1,this.baseIconName=h.ARROW_DOWN}updateTabIndexForAllOptions(e){var a;let t=!1;this.getAllValidOptions().forEach(s=>{s===e?(this.setSelectedValue(s),t=!0,s.setAttribute("selected",""),s.setAttribute("tabindex","0")):(s==null||s.setAttribute("tabindex","-1"),s==null||s.removeAttribute("selected"))}),t||(a=this.getAllValidOptions()[0])==null||a.setAttribute("tabindex","0")}handleOptionsClick(e){this.updateTabIndexForAllOptions(e.target)}setSelectedValue(e){this.selectedValueText=(e==null?void 0:e.getAttribute("label"))??(e==null?void 0:e.textContent)??"",this.selectedIcon=e==null?void 0:e.getAttribute("prefix-icon"),this.selectedValue=(e==null?void 0:e.getAttribute("value"))??(e==null?void 0:e.textContent)??"",this.value=this.selectedValue,this.internals.setFormValue(this.selectedValue),this.manageRequired(),this.dispatchInput(this.selectedValue),this.dispatchChange(this.selectedValue)}manageRequired(){!this.selectedValue&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.selectedValue="",this.selectedValueText=void 0,this.selectedIcon=null,this.internals.setFormValue(this.selectedValue),this.updateTabIndexForAllOptions()}formStateRestoreCallback(e){this.selectedValue=e,this.selectedValueText=e}dispatchChange(e){e&&this.dispatchEvent(new CustomEvent("change",{detail:{value:e},composed:!0,bubbles:!0}))}dispatchInput(e){e&&this.dispatchEvent(new CustomEvent("input",{detail:{value:e},composed:!0,bubbles:!0}))}handlePopoverOnOpen(e){var t;switch(e.key){case r.TAB:{const a=this.getAllValidOptions().findIndex(s=>s===e.target);this.setFocusAndTabIndex(a),e.preventDefault();break}case r.SPACE:this.closePopover(),e.preventDefault();break;case r.ENTER:this.closePopover(),e.preventDefault(),(t=this.form)==null||t.requestSubmit();break;case r.HOME:this.setFocusAndTabIndex(0),e.preventDefault();break;case r.END:this.setFocusAndTabIndex(this.getAllValidOptions().length-1),e.preventDefault();break;case r.ARROW_DOWN:case r.ARROW_UP:case r.PAGE_DOWN:case r.PAGE_UP:this.handleOptionsNavigation(e),e.preventDefault();break}}handlePopoverOnClose(e){switch(e.key){case r.ARROW_DOWN:case r.ARROW_UP:case r.ENTER:case r.SPACE:this.openPopover(),e.preventDefault();break;case r.HOME:this.openPopover(),this.setFocusAndTabIndex(0),e.preventDefault();break;case r.END:this.openPopover(),this.setFocusAndTabIndex(this.getAllValidOptions().length-1),e.preventDefault();break}}handleOptionsNavigation(e){const t=this.getAllValidOptions(),a=t.findIndex(o=>o===e.target),s=this.getNewIndexBasedOnKey(e.key,a,t.length);s!==-1&&(this.setFocusAndTabIndex(s),e.preventDefault())}getNewIndexBasedOnKey(e,t,a){return e===r.ARROW_DOWN&&t!==a-1?t+1:e===r.ARROW_UP&&t>0?t-1:e===r.PAGE_DOWN?t+10>a?a-1:t+10:e===r.PAGE_UP?t-10<0?0:t-10:-1}updateActivedescendant(e){var a,s;const t=this.getAllValidOptions();if(e){const o=t.findIndex(d=>d===e);this.activeDescendant=((a=t[o])==null?void 0:a.id)??""}else{const o=t.find(d=>d.getAttribute("tabindex")==="0");this.activeDescendant=(o==null?void 0:o.id)??((s=t[0])==null?void 0:s.id)??""}}resetActivedescendant(){this.activeDescendant=""}setFocusAndTabIndex(e){const t=this.getAllValidOptions(),a=t[e];a&&(a.focus(),t.forEach((s,o)=>{const d=e===o?"0":"-1";s==null||s.setAttribute("tabindex",d)}),this.activeDescendant=a.id??"")}openPopover(){var s;this.displayPopover=!0;const e=this.getAllValidOptions(),t=e.find(o=>o.hasAttribute("selected")),a=e.find(o=>o.getAttribute("tabindex")==="0");this.activeDescendant=((s=t||a||e[0])==null?void 0:s.id)??""}closePopover(){this.displayPopover=!1,this.resetActivedescendant()}firstUpdated(){const e=this.getAllValidOptions(),t=e.findIndex(a=>a==null?void 0:a.hasAttribute("selected"));t!==-1?(this.setSelectedValue(e[t]),this.updateTabIndexForAllOptions(e[t])):this.placeholder?this.placeholder&&this.manageRequired():(this.setSelectedValue(e[0]),this.updateTabIndexForAllOptions())}getNativeSelect(){return n`
    ...
    `}updated(e){super.updated(e),(e.has("disabled")||e.has("readonly"))&&(this.closePopover(),this.handlePopoverClose()),e.has("displayPopover")&&(this.displayPopover?this.openPopover():this.closePopover())}render(){return n`
      ...
      <div part="container">
        <div
          ...
          aria-invalid="${this.helpTextType===E.ERROR?"true":"false"}"
        >
    ...
    `}};u.styles=[...g.styles,...F];let i=u;l([p({type:String})],i.prototype,"placeholder");l([p({type:Boolean})],i.prototype,"readonly");l([p({type:String})],i.prototype,"height");l([V()],i.prototype,"optionsList");l([c()],i.prototype,"baseIconName");l([c()],i.prototype,"selectedValueText");l([c()],i.prototype,"selectedIcon");l([c()],i.prototype,"selectedValue");l([c()],i.prototype,"displayPopover");l([c()],i.prototype,"activeDescendant");l([T("select")],i.prototype,"inputElement");i.register(C);
