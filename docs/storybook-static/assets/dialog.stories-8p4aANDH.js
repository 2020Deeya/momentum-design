import"./index-By-ccbFQ.js";import{V as F,T as H}from"./index-BrLJ_9IK.js";import{i as Pe,k as r,D as R}from"./lit-element-D5KKan5q.js";import{t as w}from"./if-defined-D5BV9-c0.js";import{u as Oe,C as G,n}from"./index-C9z9WAEj.js";import{c as Ne,F as Ze}from"./popover.component-b3MZdLOz.js";import{B as Fe,I as He}from"./button.constants-ld6CW6g-.js";import{F as Re}from"./FooterMixin-B4UrmLg9.js";import{a as _}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as Ge,s as Ue}from"./commonArgTypes-BluK8w5L.js";import{t as Me}from"./utils-CF1irry3.js";import"./index-CqBxmkhL.js";import"./index-DWeOc_ym.js";import"./index-DWRtudfj.js";import"./button.component-CzH-VU4W.js";import"./state-CSSggq2n.js";import"./buttonsimple.component-CHHctxKG.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./keys-Hz01Ianf.js";import"./buttonsimple.constants-wHSLNcjv.js";import"./index-B-GnYs90.js";import"./button.utils-rNW36Ji7.js";import"./index-CG5ZFYCw.js";import"./iframe-BwtIvwmR.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./base-DIkkzJ-c.js";import"./roles-BH_hBfTz.js";import"./query-assigned-elements-uEuc3rg8.js";import"./link.constants-CqyNsepP.js";import"./v4-CQkTLCs1.js";import"./link.component-CnXE6lpN.js";import"./IconNameMixin-CujGSn0t.js";import"./linksimple.component-Co560Rby.js";import"./v4-CmTdKEVZ.js";const We=Oe.constructTagName("dialog"),we={DEFAULT:"default",PROMOTIONAL:"promotional"},s={VISIBLE:!1,Z_INDEX:1e3,ROLE:"dialog",SIZE:"small",HEADER_TAG_NAME:"h2",DESCRIPTION_TAG_NAME:"p",CANCEL_ICON:"cancel-bold",VARIANT:we.DEFAULT,DISABLE_ARIA_HAS_POPUP:!1,FOCUS_TRAP:!0},m=["small","medium","large","xlarge","fullscreen"],Ve=["dialog","alertdialog"];class y{static dispatchDialogEvent(e,o,i=!0){o.dispatchEvent(new CustomEvent(e,{detail:{show:o.visible},composed:!0,bubbles:i}))}static onShowDialog(e){this.dispatchDialogEvent("shown",e)}static onHideDialog(e){this.dispatchDialogEvent("hidden",e)}static onCloseDialog(e,o=!0){this.dispatchDialogEvent("close",e,o)}static onCreatedDialog(e){this.dispatchDialogEvent("created",e)}static onDestroyedDialog(e){this.dispatchDialogEvent("destroyed",e)}}const je=Pe`
  :host {
...
`,Je=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
  ...
  `},rt=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
    ${h(t.triggerId,"Click me!",e)}
    ${u(t,qe(),o)}
  `},Ut={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:Je,parameters:{badges:["stable"]},argTypes:{...Ge,...Ue,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(we)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},"focus-trap":{control:"boolean"},role:{control:"select",options:Object.values(Ve)},size:{control:"select",options:Object.values(m)},visible:{control:"boolean"},...Me(["--mdc-dialog-primary-background-color","--mdc-dialog-border-color","--mdc-dialog-header-text-color","--mdc-dialog-description-text-color","--mdc-dialog-elevation-3","--mdc-dialog-width"])}},l={id:"dialog","z-index":s.Z_INDEX,role:s.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:s.VARIANT},g={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":s.HEADER_TAG_NAME,"description-tag-name":s.DESCRIPTION_TAG_NAME},v={args:{size:s.SIZE,...l,...g}},f={name:"Size: Small",args:{size:m[0],...l,...g}},E={name:"Size: Medium",args:{size:m[1],...l,...g}},I={name:"Size: Large",args:{size:m[2],...l,...g}},x={name:"Size: XLarge",args:{size:m[3],...l,...g}},A={name:"Size: Fullscreen",args:{size:m[4],...l,...g}},D={args:{...l,size:m[0]}},S={render:tt,args:{...l,size:m[0]}},T={render:et,args:{...l,...g,size:s.SIZE}},$={render:Qe,args:{...l,...g,size:s.SIZE}},z={render:t=>r`
  ...
  `},C={render:t=>{const e=()=>{document.getElementById(t.id).removeAttribute("visible")};return r`
...
}`,...(ve=(ye=$.parameters)==null?void 0:ye.docs)==null?void 0:ve.source}}};var fe,Ee,Ie;z.parameters={...z.parameters,docs:{...(fe=z.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  ...
  \`
}`,...(Ie=(Ee=z.parameters)==null?void 0:Ee.docs)==null?void 0:Ie.source}}};var xe,Ae,De;C.parameters={...C.parameters,docs:{...(xe=C.parameters)==null?void 0:xe.docs,source:{originalSource:`{
  render: (args: Args) => {
    const onClose = () => {
...
}`,...(De=(Ae=C.parameters)==null?void 0:Ae.docs)==null?void 0:De.source}}};var Se,Te,$e;L.parameters={...L.parameters,docs:{...(Se=L.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  render: renderWithPopover,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...($e=(Te=L.parameters)==null?void 0:Te.docs)==null?void 0:$e.source}}};var ze,Ce,Le;k.parameters={...k.parameters,docs:{...(ze=k.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  render: renderDialogWithinDialog,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(Le=(Ce=k.parameters)==null?void 0:Ce.docs)==null?void 0:Le.source}}};var ke,Be,_e;B.parameters={...B.parameters,docs:{...(ke=B.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  render: renderDialogWithIframe,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(_e=(Be=B.parameters)==null?void 0:Be.docs)==null?void 0:_e.source}}};const Mt=["Example","small","medium","large","xlarge","fullscreen","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithIframe"];export{B as DialogWithIframe,k as DialogWithinDialog,v as Example,C as MountUnmount,L as WithPopover,z as WithoutTriggerElement,Mt as __namedExportsOrder,Ut as default,A as fullscreen,I as large,E as medium,f as small,$ as withCustomHeader,T as withSaveCancelButtons,D as withoutHeader,S as withoutHeaderOrFooter,x as xlarge};
