import{i as q,D as x,k as o}from"./lit-element-D5KKan5q.js";import{n as j}from"./property-Bj3TGwkg.js";import{D as W}from"./DisabledMixin-B-Cnza7-.js";import{T as Q}from"./TabIndexMixin-DEwGeIeI.js";import{C as f}from"./card.component-CuN9bBbP.js";import{R as J}from"./roles-CJI3JVG-.js";import{K as k}from"./keys-hFXe221I.js";import{u as ee}from"./provider.component-DrWB4byV.js";import{a as te}from"./index-B-GnYs90.js";import"./index-BEvv3dN7.js";import{V as y}from"./index-D2VIkDCb.js";import"./index-ODP4z9SH.js";import{Q as ae}from"./repeat-CNQ7t7Vw.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as oe,s as ie}from"./commonArgTypes-BluK8w5L.js";import{a as re,t as le,d as ce}from"./utils-CFOyPOhY.js";import{V as se,O as T,D as t}from"./FooterMixin-oJpTePmN.js";import"./index-PaDnv4jT.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-BBlkZKjZ.js";import"./buttonsimple.constants-CVV9o_W6.js";import"./iframe-BcvPl-hx.js";import"../sb-preview/runtime.js";import"./state-CmYk530Z.js";import"./index-CwZu4Wnd.js";import"./iconprovider.component-BtAZSWEH.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-DNTydABS.js";import"./index-BVnuQHQM.js";import"./button.component-DXfxhmBS.js";import"./buttonsimple.component-jROCF6tv.js";import"./button.utils-rNW36Ji7.js";import"./index-tP-ttYY9.js";import"./popover.component-CWSuSUni.js";import"./if-defined-D5BV9-c0.js";import"./index-CnFwjDgi.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-DVpSBUFD.js";import"./formfieldwrapper.component-BO2gGcYF.js";const ne=ee.constructTagName("cardcheckbox"),N={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},i={CHECK:"check",CHECKBOX:"checkbox"},A={SELECTION_TYPE:i.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},de=q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,me=[de,...te()];var pe=Object.defineProperty,Z=(e,a,C,be)=>{for(var r=void 0,g=e.length-1,I;g>=0;g--)(I=e[g])&&(r=I(a,C,r)||r);return r&&pe(a,C,r),r};const E=class E extends W(Q(f)){constructor(){super(),this.checked=!1,this.selectionType=A.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=J.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}toggleOnEnter(a){a.key===k.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===k.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?N.CHECKED:N.DEFAULT;switch(this.selectionType){case i.CHECK:return o`<mdc-icon
