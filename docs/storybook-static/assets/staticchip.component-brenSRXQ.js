import{u as p,q as u,V as g,S as v,U as k,h as s,k as l,G as i,n as h}from"./iframe-xJvWfTzZ.js";import{I as T}from"./IconNameMixin-6gzykPlm.js";const I=p.constructTagName("staticchip"),E={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",ORANGE:"orange",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},c={COLOR:E.DEFAULT,TEXT_TYPE:u.BODY_MIDSIZE_REGULAR,TAG_NAME:g.SPAN},A=v`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,L=[k,A];var O=Object.defineProperty,b=(t,m,d,_)=>{for(var o=void 0,e=t.length-1,n;e>=0;e--)(n=t[e])&&(o=n(m,d,o)||o);return o&&O(m,d,o),o};const a=class a extends T(i){constructor(){super(...arguments),this.color=c.COLOR,this.label=""}renderIcon(){return this.iconName?l` <mdc-icon name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:s}render(){return l`
      ${this.renderIcon()}
      ${this.label?l`<mdc-text part="label" type="${c.TEXT_TYPE}" tagname="${c.TAG_NAME}"
            >${this.label}</mdc-text
          >`:s}
    `}};a.styles=[...i.styles,...L];let r=a;b([h({type:String,reflect:!0})],r.prototype,"color");b([h({type:String})],r.prototype,"label");export{E as C,r as S,I as T};
