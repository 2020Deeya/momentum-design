import{L as O,T as _}from"./linksimple.component-BkU_jXN1.js";import{k as L}from"./iframe-Cg5TAAQy.js";import{a as d,t as w,r as s}from"./utils-CFOyPOhY.js";import"./if-defined-Op7ekpVq.js";import"./DataAriaLabelMixin-DprWfCyu.js";import"./DisabledMixin-BKNV4Fwu.js";import"./index-hvNnVypU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,C=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
