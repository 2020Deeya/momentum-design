import{L as O,T as _}from"./linksimple.component-CytjtpHp.js";import{k as L}from"./iframe-CxpxgoKw.js";import{h as s,r as d}from"./utils-D6nie9pS.js";import"./if-defined-C4FxUqXH.js";import"./DataAriaLabelMixin-C2nZv75Y.js";import"./DisabledMixin-yyW__Gvm.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
