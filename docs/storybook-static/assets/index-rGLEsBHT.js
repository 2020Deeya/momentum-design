import{i as k,k as n,D as v}from"./lit-element-D5KKan5q.js";import{u as m,C as s,n as b}from"./index-C9z9WAEj.js";import{D as u}from"./DisabledMixin-BZruwOeC.js";import"./index-D9plsxGQ.js";const C=m.constructTagName("checkbox"),l={CHECKED:"check-bold",INDETERMINATE:"minus-bold"},p=[k`
  :host{
    margin: 0.125rem 0;
...
`],x=m.constructTagName("staticcheckbox");var g=Object.defineProperty,h=(i,e,a,f)=>{for(var o=void 0,r=i.length-1,d;r>=0;r--)(d=i[r])&&(o=d(e,a,o)||o);return o&&g(e,a,o),o};const t=class t extends u(s){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1}render(){const e=this.checked||this.indeterminate?n`
      <mdc-icon
        class="icon"
