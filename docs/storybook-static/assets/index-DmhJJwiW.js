import"./index-CH1cZHfR.js";import"./index-vaVizDGy.js";import{D as n,T as g,a as p}from"./toggle.constants-BhhTjM0t.js";import"./index-D1yLszQ-.js";import"./index-BZV85M7K.js";import{i as u,k as v}from"./lit-element-D5KKan5q.js";import{n as r}from"./index-C9z9WAEj.js";import{t as s}from"./if-defined-D5BV9-c0.js";import{D as b}from"./DataAriaLabelMixin-D53Z5CZ7.js";import{F as f}from"./FormInternalsMixin-CqDKsEWP.js";import{R as k}from"./roles-BH_hBfTz.js";import"./index-CeyAPSga.js";import{D as y,F as m}from"./formfieldwrapper.component-B1RGcmSz.js";import{a as x,h as $}from"./index-MA1r3zrt.js";const E=[x,u`
  :host {
...
`,...$(!0)];var w=Object.defineProperty,l=(d,e,t,z)=>{for(var o=void 0,a=d.length-1,h;a>=0;a--)(h=d[a])&&(o=h(e,t,o)||o);return o&&w(e,t,o),o};const c=class c extends f(b(m)){constructor(){super(...arguments),this.checked=!1,this.size=n.SIZE,this.autofocus=!1}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}formResetCallback(){this.checked=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}manageRequired(){!this.checked&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}setFormValue(){let e=null;this.checked?e=this.value?this.value:"isActive":e=null,this.manageRequired(),this.internals.setFormValue(e)}toggleState(){this.disabled||(this.checked=!this.checked)}handleKeyDown(e){var t;e.key==="Enter"&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}setToggleSize(e){this.setAttribute("size",Object.values(g).includes(e)?e:n.SIZE)}update(e){super.update(e),e.has("checked")&&this.setFormValue(),e.has("size")&&this.setToggleSize(this.size)}render(){return v`
    ...
    `}};c.styles=[...m.styles,...E];let i=c;l([r({type:Boolean,reflect:!0})],i.prototype,"checked");l([r({type:String,reflect:!0})],i.prototype,"size");l([r({type:Boolean,reflect:!0})],i.prototype,"autofocus");i.register(p);
