import"./index-DogmHr-7.js";import{u,am as f,a2 as g,ab as b,R as x,k as c,h,T as p,n as r}from"./iframe-27lSNS5L.js";import{F as v}from"./FormInternalsMixin-5y8g9t76.js";import{L as m}from"./listitem.component-Dq1fn1Qo.js";import{L as I}from"./listitem.constants-X_X8IF7b.js";const T="check-bold",y=u.constructTagName("option"),E=[f,g`
    :host {
  ...
  `];var L=Object.defineProperty,n=(o,t,s,A)=>{for(var e=void 0,a=o.length-1,d;a>=0;a--)(d=o[a])&&(e=d(t,s,e)||e);return e&&L(t,s,e),e};const l=class l extends v(m){constructor(){super(...arguments),this.selected=!1,this.ariaLabel=null}connectedCallback(){super.connectedCallback(),this.role=x.OPTION,this.variant=I.INSET_RECTANGLE,this.setAttribute("aria-selected",`${this.selected}`),this.setAttribute("aria-disabled",`${!!this.disabled}`),this.name=void 0,this.sideHeaderText=void 0,this.sublineText=void 0}update(t){super.update(t),t.has("selected")&&(this.setAttribute("aria-selected",`${this.selected}`),this.dispatchModifiedEvent(this.selected?"selected":"unselected"))}renderIcon(t,s){return c` <mdc-icon length-unit="rem" slot="${t}" name="${s}"></mdc-icon> `}render(){const t=this.selected?this.renderIcon("trailing-controls",T):h;return c`
    ...
    `}};l.styles=[...m.styles,...E];let i=l;n([r({type:Boolean,reflect:!0})],i.prototype,"selected");n([r({type:String,reflect:!0,attribute:"prefix-icon"})],i.prototype,"prefixIcon");n([r({type:String,reflect:!0,attribute:"aria-label"})],i.prototype,"ariaLabel");i.register(y);export{y as T};
