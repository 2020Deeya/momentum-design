import{i as h,D as b,k as n}from"./lit-element-D5KKan5q.js";import{u,C as p,n as a}from"./index-C9z9WAEj.js";import{a as v}from"./index-MA1r3zrt.js";import{D as g}from"./DisabledMixin-BZruwOeC.js";import{I as y}from"./IconNameMixin-CujGSn0t.js";import{T,V as E}from"./text.constants-ZF0jM5wn.js";import"./index-D3DhXfcW.js";import"./index-D9plsxGQ.js";import"./index-CT0t0VxZ.js";const f=h`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
...
`,A=[v,f],_=u.constructTagName("inputchip"),t={TEXT_TYPE:T.BODY_MIDSIZE_REGULAR,TAG_NAME:E.SPAN,CLOSE_ICON:"cancel-bold"};var k=Object.defineProperty,c=(l,s,m,x)=>{for(var r=void 0,e=l.length-1,d;e>=0;e--)(d=l[e])&&(r=d(s,m,r)||r);return r&&k(s,m,r),r};const i=class i extends y(g(p)){constructor(){super(...arguments),this.label="",this.error=!1,this.clearAriaLabel=""}renderIcon(){return this.iconName?n`
    <mdc-icon 
      name="${this.iconName}" 
      length-unit="rem" 
      size="1"></mdc-icon>
