import{u as W,a2 as Q,a8 as J,R as ee,h as te,k as r,n as Z,V as N}from"./iframe-27lSNS5L.js";import{D as ae}from"./DisabledMixin-C8yRpiPh.js";import{K as ie,a as re,T as oe,A as C}from"./KeyDownHandledMixin-C0pPiymU.js";import{C as x}from"./card.component-DzNGwT3p.js";import"./index-DogmHr-7.js";import"./index-C_tIGTbA.js";import{t as i}from"./if-defined-Cfu5CGM9.js";import{Q as ne}from"./repeat-RZC6-5zl.js";import{i as le}from"./manifest-B9CvakwT.js";import{i as n}from"./imageFixtures-CD4avj2q.js";import{c as ce,s as se}from"./commonArgTypes-BG7EqI50.js";import{h as de,a as me}from"./utils-B5QUENNQ.js";import{V as be,O as f,D as t}from"./FooterMixin-mgA8KF73.js";import"./index-DrZOZqbs.js";import"./preload-helper-C1FmrZbK.js";import"./index-VdFiEtqE.js";import"./query-assigned-elements-CnblnU_U.js";import"./index-DTrDRi1E.js";import"./formfieldwrapper.constants-Dhs6NMSb.js";import"./popover.constants-0eGuKeFU.js";import"./directive-Ctav8iJK.js";import"./link.constants-CprSOOL-.js";import"./index-BbkwTyFa.js";import"./button.component-BOsKAk_X.js";import"./buttonsimple.component-DZEwCnlZ.js";import"./button.utils-rNW36Ji7.js";import"./index-Ec0JWbYd.js";import"./popover.component-BsQBAUky.js";import"./BackdropMixin-tLZVBOEW.js";import"./index-CphmwtSI.js";import"./v4-CmTdKEVZ.js";import"./formfieldwrapper.component-BrqqbHKu.js";const ue=W.constructTagName("cardcheckbox"),v={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},o={CHECK:"check",CHECKBOX:"checkbox"},I={SELECTION_TYPE:o.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},pe=Q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,he=[pe,...J()];var Ae=Object.defineProperty,q=(e,a,s,Te)=>{for(var l=void 0,E=e.length-1,k;E>=0;E--)(k=e[E])&&(l=k(a,s,l)||l);return l&&Ae(a,s,l),l};const y=class y extends ie(re(ae(oe(x)))){constructor(){super(),this.checked=!1,this.selectionType=I.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}handleKeyDown(a){const s=this.getActionForKeyEvent(a);s===C.ENTER&&(this.toggleChecked(),this.keyDownEventHandled(),a.preventDefault()),s===C.SPACE&&a.preventDefault()}toggleOnSpace(a){this.getActionForKeyEvent(a)===C.SPACE&&(a.preventDefault(),this.toggleChecked())}renderSelection(){const a=this.checked?v.CHECKED:v.DEFAULT;switch(this.selectionType){case o.CHECK:return r`<mdc-icon
    ...
    `}};y.styles=[...x.styles,...he];let m=y;q([Z({type:Boolean,reflect:!0})],m.prototype,"checked");q([Z({type:String,attribute:"selection-type",reflect:!0})],m.prototype,"selectionType");m.register(ue);const{action:d}=__STORYBOOK_MODULE_ACTIONS__,ge=e=>r`<div role="main">
    <mdc-cardcheckbox
      @click="${d("onclick")}"
      @keydown="${d("onkeydown")}"
      @keyup="${d("onkeyup")}"
...
>`,b={args:{"card-title":"Title",subtitle:"Subtitle","image-src":n.card,"image-alt":"Image Alt","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,variant:t.VARIANT,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,"selection-type":o.CHECK,children:c}},u={args:{"card-title":"Title",subtitle:"Subtitle","image-src":n.card,"image-alt":"Image Alt","icon-name":"placeholder-bold","aria-label":"Aria Label","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"selection-type":o.CHECKBOX,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:f.HORIZONTAL,children:c}},p={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"aria-label":"Aria Label","selection-type":o.CHECK,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION,children:c}},h={args:{"image-src":n.card,"image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","selection-type":o.CHECK,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION}},A={args:{"card-title":"Title",subtitle:"Subtitle","image-src":n.card,"image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,"selection-type":o.CHECKBOX,checked:!1,disabled:!1,tabIndex:0,children:r`<div slot="before-body">
...
}`,...(F=(D=u.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};var H,R,M;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'icon-name': 'placeholder-bold',
...
}`,...(M=(R=p.parameters)==null?void 0:R.docs)==null?void 0:M.source}}};var U,_,G;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    'image-src': imageFixtures.card,
    'image-alt': 'Image Alt',
    'card-title': 'Title',
  ...
  \`,
  ...hideAllControls()
}`,...(z=(j=T.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};const Qe=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInCheckboxGroup"];export{h as CardWithoutBody,p as CardWithoutImage,T as CardsInCheckboxGroup,g as ContentAfterBody,A as ContentBeforeBody,b as Example,u as HorizontalCard,Qe as __namedExportsOrder,We as default};
