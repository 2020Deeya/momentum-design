import{F as d,a4 as n,k as m}from"./iframe-CxpxgoKw.js";import{R as r}from"./class-map-CY9N3GcI.js";import{p as i}from"./index-Ducpmia8.js";import{c as v,s as p}from"./commonArgTypes-BG7EqI50.js";import{d as x}from"./utils-D6nie9pS.js";import"./preload-helper-C1FmrZbK.js";import"./directive-Ctav8iJK.js";class h extends d{constructor(){super(...arguments),this.themeProviderContext=i.consume({host:this,context:n.Context})}render(){var t;return m`
...
`,f={title:"Components/themeprovider",tags:["autodocs"],component:"mdc-themeprovider",render:u,argTypes:{themeclass:{options:c,control:{type:"radio"}},...x(["Context"]),...v,...p}},o={args:{themeclass:c[0],class:"custom-classname",style:"margin-top: 20px;"}};var s,a,l;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    themeclass: THEMES[0],
    class: 'custom-classname',
    style: 'margin-top: 20px;'
  }
}`,...(l=(a=o.parameters)==null?void 0:a.docs)==null?void 0:l.source}}};const E=["Example"];export{o as Example,E as __namedExportsOrder,f as default};
