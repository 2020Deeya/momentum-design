import"./index-4h9rMrU5.js";import"./index-BJUzqu_n.js";import"./index-BOLr6w2j.js";import{k as i}from"./lit-element-D5KKan5q.js";import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{t as $}from"./if-defined-D5BV9-c0.js";import{c as ee,s as ne}from"./commonArgTypes-BluK8w5L.js";import{B as t,P as r,a,I as O}from"./button.constants-BBlkZKjZ.js";import{B as o}from"./buttonsimple.constants-CVV9o_W6.js";import"./button.component-AY6DUPps.js";import"./property-Bj3TGwkg.js";import"./state-CmYk530Z.js";import"./roles-CJI3JVG-.js";import"./buttonsimple.component-UJ4pbvCi.js";import"./provider.component-DrWB4byV.js";import"./keys-hFXe221I.js";import"./DisabledMixin-B-Cnza7-.js";import"./TabIndexMixin-DEwGeIeI.js";import"./index-B-GnYs90.js";import"./button.utils-rNW36Ji7.js";import"./index-BKP09M4C.js";import"./iframe-BdWKYyxM.js";import"../sb-preview/runtime.js";import"./index-CwZu4Wnd.js";import"./iconprovider.component-BtAZSWEH.js";import"./create-context-89xeped_.js";import"./ref-DHPoG6bl.js";import"./directive-helpers-Bb6vhctq.js";import"./directive-Ctav8iJK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./v4-CQkTLCs1.js";const s=e=>i` <mdc-button
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
  ...
  >`,ge={title:"Components/button",tags:["autodocs"],component:"mdc-button",render:s,parameters:{badges:["stable"]},argTypes:{children:{description:"Text label for the button.",control:"text"},"prefix-icon":{control:"text"},"postfix-icon":{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},variant:{control:"select",options:Object.values(t)},size:{control:"select",options:Object.values(r)},color:{control:"select",options:Object.values(a)},type:{control:"select",options:Object.values(o)},ariaStateKey:{control:"text"},inverted:{control:"boolean"},autofocus:{control:"boolean"},...ee,...ne}},l={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:t.PRIMARY,size:r[32],color:a.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0,inverted:!1}},d={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:t.PRIMARY,size:r[32],color:a.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},c={render:e=>i` <div style="padding: 10px; background: var(--mds-color-theme-inverted-background-normal);">
    ...
    >
      ...
      ${e.children}
    </mdc-button>`,args:{children:"Loading...",active:!1,disabled:!1,"soft-disabled":!1,variant:t.PRIMARY,size:r[32],color:a.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},v={render:e=>i` <mdc-button
      @click="${n("onclick")}"
      @keydown="${n("onkeydown")}"
      @keyup="${n("onkeyup")}"
      @focus="${n("onfocus")}"
