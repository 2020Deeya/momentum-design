import{n as r,i as f,k as p,C as m}from"./iframe-Cg5TAAQy.js";import{K as n}from"./keys-hFXe221I.js";import{D as v}from"./DisabledMixin-BKNV4Fwu.js";import{T as y}from"./TabIndexMixin-0hHS2f4l.js";import{D as l,B as b}from"./buttonsimple.constants-D0Md3OfM.js";import{h as g,a as z}from"./index-hvNnVypU.js";var E=Object.defineProperty,S=(a,t,i,u)=>{for(var e=void 0,h=a.length-1,d;h>=0;h--)(d=a[h])&&(e=d(t,i,e)||e);return e&&E(t,i,e),e};const A=a=>{class t extends a{constructor(){super(...arguments),this.elementToAutoFocus=this,this.autoFocusOnMount=!1}async firstUpdated(u){super.firstUpdated(u),this.autoFocusOnMount&&(await this.updateComplete,this.elementToAutoFocus.focus())}}return S([r({type:Boolean,reflect:!0,attribute:"auto-focus-on-mount"})],t.prototype,"autoFocusOnMount"),t},x=[g,f`
    :host {
