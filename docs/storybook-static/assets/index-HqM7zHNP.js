import{u as g,U as p,S as k,X as y,W as f,k as d,h as v,q as m,V as x,n as e}from"./iframe-RauP6Djh.js";import{g as I}from"./button.utils-rNW36Ji7.js";import{B as h}from"./buttonsimple.component-D5e1XWB4.js";import{I as A}from"./IconNameMixin-Cv1BjF_z.js";import"./index-BX5-tHVv.js";const N=g.constructTagName("tab"),u={GLASS:"glass",LINE:"line",PILL:"pill"},l={VARIANT:u.PILL,ACTIVE:!1},S=[p,k`
    :host {
  ...
  `,...y()];var T=Object.defineProperty,i=(s,a,t,E)=>{for(var r=void 0,c=s.length-1,b;c>=0;c--)(b=s[c])&&(r=b(a,t,r)||r);return r&&T(a,t,r),r};const n=class n extends A(h){constructor(){super(...arguments),this.active=l.ACTIVE,this.variant=l.VARIANT,this.handleTabActiveChange=a=>{const t=new CustomEvent("activechange",{detail:{tabId:this.tabId,active:a},bubbles:!0});this.dispatchEvent(t)}}connectedCallback(){super.connectedCallback(),this.role=f.TAB,this.softDisabled=void 0,this.size=void 0,this.type=void 0,this.ariaStateKey="aria-selected",!this.tabId&&this.onerror&&this.onerror("tab id is required")}modifyIconName(a){this.iconName&&(a?(this.prevIconName=this.iconName,this.iconName=`${I(this.iconName)}-filled`):this.prevIconName&&(this.iconName=this.prevIconName))}setVariant(a){this.setAttribute("variant",Object.values(u).includes(a)?a:l.VARIANT)}setActive(a,t){super.setActive(a,t),this.modifyIconName(t)}executeAction(){this.handleTabActiveChange(this.active)}update(a){super.update(a),a.has("variant")&&this.setVariant(this.variant)}render(){return d`
      <div part="container">
    ...
    `}};n.styles=[...h.styles,...S];let o=n;i([e({type:Boolean,reflect:!0})],o.prototype,"active");i([e({type:String,reflect:!0})],o.prototype,"text");i([e({type:String,reflect:!0})],o.prototype,"variant");i([e({type:String,reflect:!0,attribute:"tab-id"})],o.prototype,"tabId");o.register(N);export{u as T,o as a};
