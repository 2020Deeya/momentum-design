import{i as f,k as s,D as d}from"./lit-element-D5KKan5q.js";import{n as o}from"./property-Bj3TGwkg.js";import{t as u}from"./if-defined-D5BV9-c0.js";import{p as y}from"./index-CwZu4Wnd.js";import{T as v,V as w}from"./index-D2VIkDCb.js";import{D as k,b as x,I as T,A as N,c as A}from"./menupopover.constants-DOiR7Cni.js";import{I}from"./IconNameMixin-Bk-Z_FTS.js";import{M as b}from"./menuitem.component-B6PRyjrF.js";import{g as E}from"./button.utils-rNW36Ji7.js";import{S as C}from"./sidenavigation.component-Bu2qGlnw.js";import{a as p}from"./index-Dp2YoXFx.js";import{h as L,a as $}from"./index-CqVtAZCJ.js";import{v as g}from"./v4-CmTdKEVZ.js";import"./index-DePA0NqY.js";import"./index-g4PC2eax.js";const S=[L,f`
    :host {
  ...
  `,...$()];var _=Object.defineProperty,i=(l,e,t,a)=>{for(var n=void 0,c=l.length-1,h;c>=0;c--)(h=l[c])&&(n=h(e,t,n)||n);return n&&_(e,t,n),n};const m=class m extends I(b){constructor(){super(),this.maxCounter=k.MAX_COUNTER,this.ariaLabel=null,this.sideNavigationContext=y.consume({host:this,context:C.Context}),this.emitNavMenuItemActiveChange=e=>{const t=new CustomEvent("activechange",{detail:{navId:this.navId,active:e},bubbles:!0});this.dispatchEvent(t)},this.addEventListener("click",this.handleClickEvent.bind(this)),this.addEventListener("focusin",this.renderDynamicTooltip.bind(this)),this.addEventListener("mouseenter",this.renderDynamicTooltip.bind(this)),this.addEventListener("focusout",this.removeTooltip.bind(this)),this.addEventListener("mouseout",this.removeTooltip.bind(this))}connectedCallback(){super.connectedCallback(),this.variant=void 0,!this.navId&&this.onerror&&this.onerror("[mdc-navmenuitem] navId is required and was not provided."),this.toggleAttribute("in-menupopover",this.isNested())}disconnectedCallback(){super.disconnectedCallback(),this.removeTooltip()}updated(){var t;const e=(t=this.sideNavigationContext)==null?void 0:t.value;if(e)if(this.showLabel=this.isNested()?!0:e.expanded,this.showLabel)this.removeAttribute("aria-label");else{const a=this.label??"";this.ariaLabel=this.ariaLabel||a,this.setAttribute("aria-label",a)}}removeTooltip(){const e=document.querySelector(`${p}[triggerid="${this.id}"]`);e&&e.remove()}renderDynamicTooltip(){if(!this.tooltipText)return;this.id||(this.id=`mdc-navmenuitem-${g()}`),this.removeTooltip();const e=document.createElement(p);e.id=`mdc-navmenuitem-tooltip-${g()}`,e.textContent=this.tooltipText,e.setAttribute("triggerid",this.id),e.setAttribute("visible",""),e.setAttribute("show-arrow",""),this.hasAttribute("slot")&&e.setAttribute("slot",this.getAttribute("slot")||""),this.after(e)}isNested(){let e=this.parentElement;for(;e;){if(e.tagName.toLowerCase()===x)return!0;e=e.parentElement}return!1}modifyIconName(e){if(!this.iconName)return;const t=this.iconName.endsWith("-filled"),a=E(this.iconName);e?t||(this.prevIconName=this.iconName,this.iconName=`${a}-filled`):this.prevIconName&&(this.iconName=this.prevIconName)}handleClickEvent(){this.disabled||this.emitNavMenuItemActiveChange(this.active)}update(e){super.update(e),e.has("active")&&this.modifyIconName(this.active)}renderTextLabel(e){return s`
      <mdc-text
    ...
    `}renderArrowIcon(e){const t=e?"":"arrow";return s`
      <mdc-icon name=${T.RIGHT_ARROW} length-unit="rem" part="trailing-arrow" class="${t}"> </mdc-icon>
