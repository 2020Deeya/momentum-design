import"./index-BM6crIDy.js";import"./index--6BtgxvU.js";import"./index-D8KF8cRC.js";import{k as i}from"./lit-element-D5KKan5q.js";import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{t as $}from"./if-defined-D5BV9-c0.js";import{c as ee,s as ne}from"./commonArgTypes-BluK8w5L.js";import{B as a,P as r,a as t,I as O}from"./button.constants-BpS-4nLb.js";import{B as o}from"./buttonsimple.constants-CNAgWCp2.js";import"./button.component-CMTraJwt.js";import"./provider.component-BaQC7CJH.js";import"./state-C0WmBOuD.js";import"./roles-DU0xbrD4.js";import"./buttonsimple.component-I-gcvU8_.js";import"./keys-hFXe221I.js";import"./DisabledMixin-DcYwkKYf.js";import"./TabIndexMixin-TvgH_pmh.js";import"./index-B-GnYs90.js";import"./button.utils-rNW36Ji7.js";import"./index-DfmSPb8h.js";import"./iframe-BkLDYSSw.js";import"../sb-preview/runtime.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-ChWiF_5p.js";import"./create-context-89xeped_.js";import"./ref-DHPoG6bl.js";import"./directive-helpers-Bb6vhctq.js";import"./directive-Ctav8iJK.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./v4-CQkTLCs1.js";const s=e=>i` <mdc-button
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
  ...
  >`,Le={title:"Components/button",tags:["autodocs"],component:"mdc-button",render:s,parameters:{badges:["stable"]},argTypes:{children:{description:"Text label for the button.",control:"text"},"prefix-icon":{control:"text"},"postfix-icon":{control:"text"},active:{control:"boolean"},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},variant:{control:"select",options:Object.values(a)},size:{control:"select",options:Object.values(r)},color:{control:"select",options:Object.values(t)},type:{control:"select",options:Object.values(o)},ariaStateKey:{control:"text"},inverted:{control:"boolean"},autofocus:{control:"boolean"},...ee,...ne}},l={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0,inverted:!1}},d={args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},c={render:e=>i` <div style="padding: 10px; background: var(--mds-color-theme-inverted-background-normal);">
      ${s(e)}
    </div>`,args:{children:"Click Me",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0,inverted:!0}},b={args:{children:"Left Icon","prefix-icon":"placeholder-bold",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},T={args:{children:"Right Icon","postfix-icon":"placeholder-bold",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},p={argTypes:{size:{options:Object.values(O)},"aria-label":{description:"Aria label for the icon button. Required for accessibility."}},args:{"prefix-icon":"placeholder-bold",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:O[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0,"aria-label":"icon button"}},f={render:e=>i` <div style="padding: 10px; background: var(--mds-color-theme-inverted-background-normal);">
      ${s(e)}
    </div>`,argTypes:{size:{options:Object.values(O)},"aria-label":{description:"Aria label for the icon button. Required for accessibility."}},args:{"prefix-icon":"placeholder-bold",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:O[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0,"aria-label":"icon button",inverted:!0}},u={render:e=>s({...e,style:"width: 150px;"}),args:{children:"Long text with icons",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},m={render:e=>s({...e,style:"width: 150px;"}),args:{children:"Long text with icons","prefix-icon":"placeholder-bold",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},I={render:e=>i` <mdc-button
      @click="${n("onclick")}"
      @keydown="${n("onkeydown")}"
      @keyup="${n("onkeyup")}"
      @focus="${n("onfocus")}"
    ...
    >
      ...
      ${e.children}
    </mdc-button>`,args:{children:"Loading...",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}},v={render:e=>i` <mdc-button
      @click="${n("onclick")}"
      @keydown="${n("onkeydown")}"
      @keyup="${n("onkeyup")}"
      @focus="${n("onfocus")}"
    ...
    >
      ...
      ></mdc-animation>
      ${e.children}
    </mdc-button>`,args:{children:"Wow",active:!1,disabled:!1,"soft-disabled":!1,variant:a.PRIMARY,size:r[32],color:t.DEFAULT,type:o.BUTTON,role:"button",tabIndex:0}};var y,U,N;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    children: 'Click Me',
    active: false,
    disabled: false,
