import{a2 as v,u as g,C as i,n as k,k as h}from"./iframe-DKOSXYge.js";import{t as y}from"./if-defined-9DVKm8cQ.js";import{c as b,s as f}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const A=v`
  :host {
...
`,L={title:"Components/decorator/marker",tags:["autodocs"],component:"mdc-marker",render:I,argTypes:{variant:{control:"radio",options:Object.values(s)},...b,...f},parameters:{actions:{disable:!0}}},a={args:{variant:s.SOLID}};var l,p,u;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    variant: MARKER_VARIANTS.SOLID
  }
}`,...(u=(p=a.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};const N=["Example"];export{a as Example,N as __namedExportsOrder,L as default};
