import{a2 as v,a8 as y,R as f,k as l,V as x,h as E,T as o,C as g,n as r}from"./iframe-27lSNS5L.js";import{o as u}from"./query-assigned-elements-CnblnU_U.js";import{D as k}from"./DisabledMixin-C8yRpiPh.js";import{K as L,a as I,T as D,A as d}from"./KeyDownHandledMixin-C0pPiymU.js";import{a as S}from"./LifeCycleMixin-CkFTW4AQ.js";import{D as T}from"./listitem.constants-X_X8IF7b.js";class b{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const C=v`
  :host {
...
`,A=[C,...y()];var w=Object.defineProperty,a=(n,t,e,c)=>{for(var s=void 0,h=n.length-1,m;h>=0;h--)(m=n[h])&&(s=m(t,e,s)||s);return s&&w(t,e,s),s};const p=class p extends L(I(k(D(S(g))))){constructor(){super(),this.variant=T.VARIANT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("keyup",this.handleKeyUp.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||f.LISTITEM}handleClick(t){this.disabled&&(t.stopImmediatePropagation(),t.preventDefault())}handleKeyDown(t){const e=this.getActionForKeyEvent(t);!t.defaultPrevented&&e===d.ENTER&&(this.isEventFromInsideListItem(t)||(this.keyDownEventHandled(),t.preventDefault(),this.triggerClickEvent(t)))}handleKeyUp(t){const e=this.getActionForKeyEvent(t);!t.defaultPrevented&&e===d.SPACE&&(this.isEventFromInsideListItem(t)||(t.preventDefault(),this.triggerClickEvent(t)))}isEventFromInsideListItem(t){const e=t.target;return e!==this&&document.activeElement===e&&this.contains(e)}triggerClickEvent(t){if(this.isEventFromInsideListItem(t))return;const e=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});this.dispatchEvent(e)}getText(t,e,c){return l`
      <slot name="${t}">
        ${c?l`<mdc-text part="${t}" type="${e}" tagname="${x.SPAN}">${c}</mdc-text>`:E}
      </slot>
    `}disableSlottedChildren(t=!1){[...this.leadingControlsSlot,...this.trailingControlsSlot].forEach(e=>{t?(e.setAttribute("disabled",""),b.onDisableListItem(this)):(e.removeAttribute("disabled"),b.onEnableListItem(this))}),this.setAttribute("aria-disabled",`${t}`)}update(t){super.update(t),t.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.disableSlottedChildren(this.disabled),this.dispatchModifiedEvent(this.disabled?"disabled":"enabled")),t.has("softDisabled")&&this.disableSlottedChildren(this.softDisabled),t.has("dataIndex")&&(this.ariaPosInSet=`${this.dataIndex!==void 0?this.dataIndex+1:""}`)}renderTrailingControls(){return l`<slot
