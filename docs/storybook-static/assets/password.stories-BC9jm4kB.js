import"./index-ByxV3AY1.js";import"./index-Ci0uq2G1.js";import{u as M,h as Y,k as w,B as j,$ as U,n as g}from"./iframe-B-ccdKrm.js";import"./index-Csi_0zAz.js";import{I as y}from"./input.component-DJuTnP-v.js";import{I as v}from"./input.constants-C2fLZG9l.js";import{D as $,V as G}from"./formfieldwrapper.constants-46YXZN3a.js";import{t as o}from"./if-defined-7Kv2ZD8z.js";import{c as K,s as X}from"./commonArgTypes-BluK8w5L.js";import{a as Z}from"./utils-Dd_sfl9-.js";import{P as J,S as Q}from"./popover.component-CNDfncp6.js";import"./button.component-tFE8Qy4X.js";import"./buttonsimple.component-DbIBs-Sd.js";import"./TabIndexMixin-D4qInLKk.js";import"./DisabledMixin-DspPi3Nk.js";import"./button.utils-rNW36Ji7.js";import"./preload-helper-C1FmrZbK.js";import"./index-DTm0XU5m.js";import"./index-DTrDRi1E.js";import"./base-DIkkzJ-c.js";import"./index-BqpChkl1.js";import"./v4-CmTdKEVZ.js";import"./directive-Ctav8iJK.js";import"./index-CsBe4sUK.js";import"./formfieldwrapper.component-Czm0YztF.js";import"./DataAriaLabelMixin-B9dl85lc.js";import"./FormInternalsMixin-DDHAcgmo.js";import"./query-BPxBhMfF.js";import"./BackdropMixin-Cl3TrAyP.js";const S={HIDE_BOLD:"hide-bold",SHOW_BOLD:"show-bold"},ee=M.constructTagName("password");var te=Object.defineProperty,f=(e,s,r,d)=>{for(var t=void 0,a=e.length-1,l;a>=0;a--)(l=e[a])&&(t=l(s,r,t)||t);return t&&te(s,r,t),t};const x=class x extends y{constructor(){super(...arguments),this.showButtonAriaLabel="",this.hideButtonAriaLabel="",this.helpTextType=$.VALIDATION,this.showPassword=!1}connectedCallback(){super.connectedCallback(),this.trailingButton=!0}toggleShowPassword(){this.showPassword=!this.showPassword}renderTrailingButton(s=!1){const r=s||this.value;return r?w`
      <mdc-button
      ...
      ></mdc-button>
    `:Y}renderInputElement(s,r){const d=this.showPassword?v.TEXT:v.PASSWORD;return super.renderInputElement(d,r)}};x.styles=[...y.styles];let n=x;f([g({type:String,attribute:"show-button-aria-label",reflect:!0})],n.prototype,"showButtonAriaLabel");f([g({type:String,attribute:"hide-button-aria-label",reflect:!0})],n.prototype,"hideButtonAriaLabel");f([g({type:String,attribute:"help-text-type"})],n.prototype,"helpTextType");f([U()],n.prototype,"showPassword");n.register(ee);const{action:i}=__STORYBOOK_MODULE_ACTIONS__,C=e=>{const s=e.maxlength&&e.value?e.value.substring(0,e.maxlength):e.value;return w` <mdc-password
    @input="${i("oninput")}"
    @change="${i("onchange")}"
    @focus="${i("onfocus")}"
    @blur="${i("onblur")}"
  ...
  ></mdc-password>`},qe={title:"Components/password",tags:["autodocs"],component:"mdc-password",render:C,args:{name:"password"},argTypes:{id:{control:"text",description:"The unique id of the password field. It is used to link the password field with the label."},placeholder:{control:"text",description:"The placeholder text that is displayed when the password field is empty."},name:{control:"text",description:"The name of the password field. It is used to identify the password field in a form."},"show-button-aria-label":{control:"text"},"hide-button-aria-label":{control:"text"},label:{control:"text",description:"The label of the password field. It is linked to the password field using the for attribute."},"help-text":{control:"text",description:"Helper text for the password"},"help-text-type":{control:"select",options:Object.values(G)},"validation-message":{control:"text",description:"Custom validation message that will override the default message and displayed when the password is invalid."},readonly:{control:"boolean",description:"readonly attribute of the password field. If true, the password field is read-only."},disabled:{control:"boolean"},minlength:{control:"number",description:"The minimum number of characters that the password field can accept."},maxlength:{control:"number",description:"The maximum number of characters that the password field can accept."},"auto-focus-on-mount":{control:"boolean"},dirname:{control:"text"},pattern:{control:"text",description:"The pattern attribute of the password field. Specifies a regular expression that the password value must match for validation purposes."},required:{control:"boolean",description:"The required attribute to indicate that the password field is required. It is used to append a required indicator (*) to the label."},size:{control:"number",description:"The size attribute of the password field. Specifies the width of the password field."},"data-aria-label":{control:"text"},"toggletip-text":{control:"text"},"toggletip-placement":{control:"select",options:Object.values(J)},"toggletip-strategy":{control:"select",options:Object.values(Q)},"info-icon-aria-label":{control:"text"},...Z(["autocapitalize","clear-aria-label","showPassword","trailing-button","prefix-text","leading-icon"]),...K,...X}},p={args:{class:"custom-classname",label:"Password",name:"password",placeholder:"Placeholder",readonly:!1,disabled:!1,required:!0,"show-button-aria-label":"Show password","hide-button-aria-label":"Hide password","validation-message":""}},u={render:e=>w`
      <form @submit=${r=>{r.preventDefault();const d=r.target,a=new FormData(d).get("password");i("Form Submitted")({value:a})}}>
        <fieldset>
...
}`,...(N=(k=b.parameters)==null?void 0:k.docs)==null?void 0:N.source}}};const Fe=["Example","FormFieldPassword","FormFieldPasswordWithHelpTextValidation","DefaultValidation","ErrorValidation","SuccessValidation"];export{c as DefaultValidation,h as ErrorValidation,p as Example,u as FormFieldPassword,m as FormFieldPasswordWithHelpTextValidation,b as SuccessValidation,Fe as __namedExportsOrder,qe as default};
