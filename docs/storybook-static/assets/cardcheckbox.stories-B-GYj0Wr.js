import{i as q,D as x,k as o}from"./lit-element-D5KKan5q.js";import{u as W,n as j}from"./provider.component-BaQC7CJH.js";import{D as Q}from"./DisabledMixin-DcYwkKYf.js";import{T as J}from"./TabIndexMixin-TvgH_pmh.js";import{C as f}from"./card.component-CSHyC_aH.js";import{R as ee}from"./roles-DU0xbrD4.js";import{K as k}from"./keys-hFXe221I.js";import{a as te}from"./index-B-GnYs90.js";import"./index-DOWla3nt.js";import{V as y}from"./index-riA1qVWu.js";import"./index-BGQl1LKU.js";import{Q as ae}from"./repeat-CNQ7t7Vw.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as oe,s as ie}from"./commonArgTypes-BluK8w5L.js";import{a as re,t as le,d as ce}from"./utils-CFOyPOhY.js";import{V as se,O as T,D as t}from"./FooterMixin-9o7JZZe3.js";import"./index-CLsubYs4.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-BpS-4nLb.js";import"./buttonsimple.constants-CNAgWCp2.js";import"./iframe-Clzlgkuk.js";import"../sb-preview/runtime.js";import"./state-C0WmBOuD.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-ChWiF_5p.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-Df3Yk0mX.js";import"./index-gCTMK9KP.js";import"./button.component-DvOKP7op.js";import"./buttonsimple.component-I-gcvU8_.js";import"./button.utils-rNW36Ji7.js";import"./index-jqlgGWqR.js";import"./popover.component-LefqH8IC.js";import"./if-defined-D5BV9-c0.js";import"./index-Dm_kZN_u.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-Cpdy3gUS.js";import"./formfieldwrapper.component-C-SgLT80.js";const ne=W.constructTagName("cardcheckbox"),N={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},i={CHECK:"check",CHECKBOX:"checkbox"},A={SELECTION_TYPE:i.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},de=q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,me=[de,...te()];var pe=Object.defineProperty,Z=(e,a,C,be)=>{for(var r=void 0,g=e.length-1,I;g>=0;g--)(I=e[g])&&(r=I(a,C,r)||r);return r&&pe(a,C,r),r};const E=class E extends Q(J(f)){constructor(){super(),this.checked=!1,this.selectionType=A.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked)}toggleOnEnter(a){a.key===k.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===k.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?N.CHECKED:N.DEFAULT;switch(this.selectionType){case i.CHECK:return o`<mdc-icon
    ...
    `}};E.styles=[...f.styles,...me];let s=E;Z([j({type:Boolean,reflect:!0})],s.prototype,"checked");Z([j({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(ne);const he=e=>o` <mdc-cardcheckbox
    @click="${c("onclick")}"
    @keydown="${c("onkeydown")}"
    @keyup="${c("onkeyup")}"
    @focus="${c("onfocus")}"
...
}`,...(z=(Y=u.parameters)==null?void 0:Y.docs)==null?void 0:z.source}}};const it=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInCheckboxGroup"];export{p as CardWithoutBody,m as CardWithoutImage,u as CardsInCheckboxGroup,b as ContentAfterBody,h as ContentBeforeBody,n as Example,d as HorizontalCard,it as __namedExportsOrder,ot as default};
