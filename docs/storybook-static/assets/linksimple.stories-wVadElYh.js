import{L as O,T as _}from"./linksimple.component-D9P2z-o2.js";import{k as L}from"./iframe-RauP6Djh.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-CvYHhL43.js";import"./DataAriaLabelMixin-LwvKS9ZP.js";import"./DisabledMixin-Dnl3OyzP.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
