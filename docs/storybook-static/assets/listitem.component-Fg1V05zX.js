import{u as E,S as y,X as x,W as f,k as d,V as T,h as L,q as n,E as g,n as s}from"./iframe-DiPDdTpK.js";import{o as v}from"./query-assigned-elements-uEuc3rg8.js";import{T as I,K as c}from"./TabIndexMixin-C3DoHV5Y.js";import{D as k}from"./DisabledMixin-B9P009FD.js";const h={CREATED:"created",FIRST_UPDATE_COMPLETED:"first-update-completed",DESTROYED:"destroyed",MODIFIED:"modified"},D=o=>{class t extends o{connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event(h.CREATED,{bubbles:!0,composed:!0})),this.updateComplete.then(()=>{this.dispatchEvent(new Event(h.FIRST_UPDATE_COMPLETED,{bubbles:!0,composed:!0}))})}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event(h.DESTROYED,{bubbles:!0,composed:!0}))}dispatchModifiedEvent(r){this.dispatchEvent(new CustomEvent(h.MODIFIED,{detail:{change:r},bubbles:!0,composed:!0}))}}return t},O=E.constructTagName("listitem"),C={FULL_WIDTH:"full-width",INSET_PILL:"inset-pill",INSET_RECTANGLE:"inset-rectangle"},S={VARIANT:C.FULL_WIDTH};class u{static dispatchListItemEvent(t,e){e.dispatchEvent(new Event(t,{composed:!0,bubbles:!0}))}static onDisableListItem(t){this.dispatchListItemEvent("disabled",t)}static onEnableListItem(t){this.dispatchListItemEvent("enabled",t)}static onCreatedListItem(t){setTimeout(()=>{this.dispatchListItemEvent("created",t)},0)}static onDestroyedListItem(t){this.dispatchListItemEvent("destroyed",t)}}const A=y`
  :host {
...
`,_=[A,...x()];var w=Object.defineProperty,a=(o,t,e,r)=>{for(var l=void 0,p=o.length-1,m;p>=0;p--)(m=o[p])&&(l=m(t,e,l)||l);return l&&w(t,e,l),l};const b=class b extends k(I(D(g))){constructor(){super(),this.variant=S.VARIANT,this.addEventListener("keydown",this.handleKeyDown.bind(this)),this.addEventListener("click",this.handleClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=this.role||f.LISTITEM}handleClick(t){this.disabled&&(t.stopImmediatePropagation(),t.preventDefault())}handleKeyDown(t){(t.key===c.ENTER||t.key===c.SPACE)&&this.triggerClickEvent(t)&&t.preventDefault()}triggerClickEvent(t){if(t.target!==this&&document.activeElement===t.target)return!1;const r=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});return this.dispatchEvent(r),!0}getText(t,e,r){return d`
      <slot name="${t}">
        ${r?d`<mdc-text part="${t}" type="${e}" tagname="${T.SPAN}">${r}</mdc-text>`:L}
      </slot>
    `}disableSlottedChildren(t=!1){[...this.leadingControlsSlot,...this.trailingControlsSlot].forEach(e=>{t?(e.setAttribute("disabled",""),u.onDisableListItem(this)):(e.removeAttribute("disabled"),u.onEnableListItem(this))}),this.setAttribute("aria-disabled",`${t}`)}update(t){super.update(t),t.has("disabled")&&(this.tabIndex=this.disabled?-1:0,this.disableSlottedChildren(this.disabled),this.dispatchModifiedEvent(this.disabled?"disabled":"enabled")),t.has("softDisabled")&&this.disableSlottedChildren(this.softDisabled),t.has("dataIndex")&&(this.ariaPosInSet=`${this.dataIndex!==void 0?this.dataIndex+1:""}`)}renderTrailingControls(){return d`<slot
    ...
    `}};b.styles=[...g.styles,..._];let i=b;a([v({slot:"leading-controls"})],i.prototype,"leadingControlsSlot");a([v({slot:"trailing-controls"})],i.prototype,"trailingControlsSlot");a([s({type:String,reflect:!0})],i.prototype,"variant");a([s({type:String,reflect:!0})],i.prototype,"label");a([s({type:String,reflect:!0,attribute:"secondary-label"})],i.prototype,"secondaryLabel");a([s({type:String,reflect:!0,attribute:"tertiary-label"})],i.prototype,"tertiaryLabel");a([s({type:String,reflect:!0,attribute:"side-header-text"})],i.prototype,"sideHeaderText");a([s({type:String,reflect:!0,attribute:"subline-text"})],i.prototype,"sublineText");a([s({type:Boolean,reflect:!0,attribute:"soft-disabled"})],i.prototype,"softDisabled");a([s({type:Number,reflect:!0,attribute:"data-index"})],i.prototype,"dataIndex");export{i as L,O as T,C as a,h as b};
