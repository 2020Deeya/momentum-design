import{i as V,D as k,k as a}from"./lit-element-D5KKan5q.js";import{a as B}from"./index-CcXofQbA.js";import{B as H}from"./buttonsimple.component-C1CVlJGY.js";import{a as z,C as W}from"./card.component-BbEuZO0l.js";import{u as j}from"./index-C9z9WAEj.js";import"./index-BxpyMMVk.js";import"./index-D3DhXfcW.js";import{a as r}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as _,s as q}from"./commonArgTypes-BluK8w5L.js";import{h as Z}from"./utils-CO8B6ZcN.js";import{V as w,O as u,D as t}from"./CardAndDialogFooterMixin-COm20Ox1.js";import{V as T}from"./text.constants-ZF0jM5wn.js";import{B as P}from"./button.constants-D0QAbDxL.js";import"./DisabledMixin-BZruwOeC.js";import"./TabIndexMixin-CsrHswKP.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./iframe-CnyU4f7B.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./v4-CQkTLCs1.js";import"./link.constants-CqyNsepP.js";const Q=V`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,X=[Q,...B()],A=class A extends z(H){connectedCallback(){super.connectedCallback(),this.active=void 0,this.size=void 0}renderHeader(){return this.cardTitle?a`<div part="header">
     ${this.renderIcon()}
     ${this.renderTitle()}
  ...
  `}};A.styles=[...W.styles,...X];let p=A;const J=j.constructTagName("cardbutton");p.register(J);const K=e=>a`
  <mdc-cardbutton 
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @keyup="${r("onkeyup")}"
    ...
    tabIndex="${e.tabIndex}"
    class="${e.class}"
    style="${e.style}">${e.children}</mdc-cardbutton>`,vt={title:"Work In Progress/card/cardbutton",tags:["autodocs"],component:"mdc-cardbutton",render:K,parameters:{badges:["wip"]},argTypes:{variant:{control:"select",options:Object.values(w)},orientation:{control:"select",options:Object.values(u)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},"title-tag-name":{control:"select",options:Object.values(T)},"subtitle-tag-name":{control:"select",options:Object.values(T)},disabled:{control:"boolean"},"soft-disabled":{control:"boolean"},tabIndex:{control:"number"},type:{control:"select",options:Object.values(P)},...Z(["children","active","size"]),..._,...q}},o=a`<mdc-text slot='body' 
...
Ut in massa luctus lacus sodales accumsan. Praesent at aliquam leo. Ut a scelerisque turpis.</mdc-text>`,i={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,children:o,disabled:!1,"soft-disabled":!1}},l={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x300","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:u.HORIZONTAL,children:o}},n={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,children:o}},s={args:{"image-src":"https://placehold.co/320x200","image-alt":"Image Alt",variant:t.VARIANT,orientation:t.ORIENTATION,children:o}},c={args:{"image-src":"https://placehold.co/320x200","image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"icon-name":"placeholder-bold",variant:t.VARIANT,orientation:t.ORIENTATION}},d={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,children:a`
    ...
    ${o}`}};var b,g,h;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
...
}`,...(x=(O=s.parameters)==null?void 0:O.docs)==null?void 0:x.source}}};var R,L,C;c.parameters={...c.parameters,docs:{...(R=c.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    'image-src': 'https://placehold.co/320x200',
    'image-alt': 'Image Alt',
    'card-title': 'Title',
...
}`,...(M=(G=m.parameters)==null?void 0:G.docs)==null?void 0:M.source}}};const Ot=["Example","HorizontalCard","CardWithoutImage","CardWithoutHeader","CardWithoutBody","ContentBeforeBody","ContentAfterBody"];export{c as CardWithoutBody,s as CardWithoutHeader,n as CardWithoutImage,m as ContentAfterBody,d as ContentBeforeBody,i as Example,l as HorizontalCard,Ot as __namedExportsOrder,vt as default};
