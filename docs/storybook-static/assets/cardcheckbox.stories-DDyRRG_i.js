import{i as q,D as f,k as o}from"./lit-element-D5KKan5q.js";import{u as W,n as j}from"./index-C9z9WAEj.js";import{D as Q}from"./DisabledMixin-BZruwOeC.js";import{T as J}from"./TabIndexMixin-CsrHswKP.js";import{C as x}from"./card.component-CbJ1_Qok.js";import{R as ee}from"./roles-BH_hBfTz.js";import{K as y}from"./keys-Hz01Ianf.js";import{a as te}from"./index-B-GnYs90.js";import"./index-CG5ZFYCw.js";import{V as k}from"./index-BrLJ_9IK.js";import"./index-Cxyb0S3g.js";import{Q as ae}from"./repeat-CNQ7t7Vw.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as oe,s as re}from"./commonArgTypes-BluK8w5L.js";import{h as ie,d as le}from"./utils-CF1irry3.js";import{V as ce,O as T,D as t}from"./FooterMixin-B4UrmLg9.js";import"./index-Dn_ubkDk.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-ld6CW6g-.js";import"./buttonsimple.constants-wHSLNcjv.js";import"./iframe-BwtIvwmR.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-CqyNsepP.js";import"./index-By-ccbFQ.js";import"./button.component-CzH-VU4W.js";import"./buttonsimple.component-CHHctxKG.js";import"./button.utils-rNW36Ji7.js";import"./index-CjMuRb2X.js";import"./popover.component-b3MZdLOz.js";import"./if-defined-D5BV9-c0.js";import"./index-96ToHBu8.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-D53Z5CZ7.js";import"./formfieldwrapper.component-nmLPHhLb.js";const se=W.constructTagName("cardcheckbox"),N={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},A={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},ne=q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,de=[ne,...te()];var me=Object.defineProperty,Z=(e,a,C,he)=>{for(var i=void 0,g=e.length-1,I;g>=0;g--)(I=e[g])&&(i=I(a,C,i)||i);return i&&me(a,C,i),i};const E=class E extends Q(J(x)){constructor(){super(),this.checked=!1,this.selectionType=A.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked),this.addEventListener("keydown",this.toggleOnEnter),this.addEventListener("keyup",this.toggleOnSpace)}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked)}toggleOnEnter(a){a.key===y.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===y.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?N.CHECKED:N.DEFAULT;switch(this.selectionType){case r.CHECK:return o`<mdc-icon
    ...
    `}};E.styles=[...x.styles,...de];let s=E;Z([j({type:Boolean,reflect:!0})],s.prototype,"checked");Z([j({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(se);const pe=e=>o` <mdc-cardcheckbox
    @click="${c("onclick")}"
    @keydown="${c("onkeydown")}"
    @keyup="${c("onkeyup")}"
    @focus="${c("onfocus")}"
  ...
  >`,at={title:"Components/card/cardcheckbox",tags:["autodocs"],component:"mdc-cardcheckbox",render:pe,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(ce)},orientation:{control:"select",options:Object.values(T)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"selection-type":{control:"select",options:Object.values(r)},"title-tag-name":{control:"select",options:Object.values(k)},"subtitle-tag-name":{control:"select",options:Object.values(k)},...ie(["children"]),...oe,...re}},l=o`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
...
>`,n={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,variant:t.VARIANT,orientation:t.ORIENTATION,checked:!1,disabled:!1,tabIndex:0,"selection-type":r.CHECK,children:l}},d={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/160x280","image-alt":"Image Alt","icon-name":"placeholder-bold","aria-label":"Aria Label","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"selection-type":r.CHECKBOX,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:T.HORIZONTAL,children:l}},m={args:{"card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,"aria-label":"Aria Label","selection-type":r.CHECK,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION,children:l}},p={args:{"image-src":"https://placehold.co/320x200","image-alt":"Image Alt","card-title":"Title",subtitle:"Subtitle","icon-name":"placeholder-bold","selection-type":r.CHECK,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,checked:!1,disabled:!1,tabIndex:0,variant:t.VARIANT,orientation:t.ORIENTATION}},h={args:{"card-title":"Title",subtitle:"Subtitle","image-src":"https://placehold.co/320x200","image-alt":"Image Alt","icon-name":"placeholder-bold",variant:t.VARIANT,"title-tag-name":t.TAGNAME,"subtitle-tag-name":t.TAGNAME,orientation:t.ORIENTATION,"selection-type":r.CHECKBOX,checked:!1,disabled:!1,tabIndex:0,children:o` <mdc-text slot="before-body" type="body-midsize-medium" tagname="span"
  ...
  `,argTypes:{...le(["variant","orientation","card-title","subtitle","image-src","image-alt","icon-name","checked","disabled","tabIndex","data-aria-label"])}};var v,S,O;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
    'image-src': 'https://placehold.co/320x200',
...
}`,...(K=(B=h.parameters)==null?void 0:B.docs)==null?void 0:K.source}}};var V,P,X;b.parameters={...b.parameters,docs:{...(V=b.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    'card-title': 'Title',
    subtitle: 'Subtitle',
...
}`,...(X=(P=b.parameters)==null?void 0:P.docs)==null?void 0:X.source}}};var Y,w,z;u.parameters={...u.parameters,docs:{...(Y=u.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => html\`
    <mdc-formfieldgroup label="Checkbox Cards" help-text="Help Text" data-aria-label="Checkbox Cards">
      <div style="display: flex; gap: 0.5rem; flex-wrap: wrap">
...
}`,...(z=(w=u.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const ot=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInCheckboxGroup"];export{p as CardWithoutBody,m as CardWithoutImage,u as CardsInCheckboxGroup,b as ContentAfterBody,h as ContentBeforeBody,n as Example,d as HorizontalCard,ot as __namedExportsOrder,at as default};
