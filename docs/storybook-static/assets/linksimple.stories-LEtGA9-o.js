import{L as O,T as _}from"./linksimple.component-Wd0P8vE8.js";import{k as L}from"./iframe-DtiRZQ2l.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-r97CdV4N.js";import"./DataAriaLabelMixin-CLQqFjU0.js";import"./DisabledMixin-D_v0Rzs7.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
