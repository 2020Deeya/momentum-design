import"./index-C18IF3Nt.js";import"./index-DXkeu3PJ.js";import{T as u}from"./index-B3-ZXIf4.js";import"./index-CeMd0DMi.js";import"./index-CJCK-I0Z.js";import{i as p,D as b,k as h,n as a}from"./iframe-BZIqfezz.js";import{t as c}from"./if-defined-CZ3GbhfA.js";import{K as k}from"./keys-hFXe221I.js";import{A as f}from"./buttonsimple.component-CkAGc9fc.js";import{D as v}from"./DataAriaLabelMixin-CFQK4gtm.js";import{F as x}from"./FormInternalsMixin-CopWLCDr.js";import{D as g,F as m}from"./formfieldwrapper.component-oW93GVYf.js";import{a as y}from"./index-B-4qjIUw.js";const $=[p`
    :host {
  ...
  `,...y(!0)];var E=Object.defineProperty,s=(n,e,t,T)=>{for(var i=void 0,r=n.length-1,l;r>=0;r--)(l=n[r])&&(i=l(e,t,i)||i);return i&&E(e,t,i),i};const d=class d extends f(x(v(m))){constructor(){super(...arguments),this.checked=!1,this.indeterminate=!1,this.autofocus=!1,this.renderLabelAndHelperText=()=>this.label?h`<div class="text-container">${this.renderLabel()} ${this.renderHelperText()}</div>`:b}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}firstUpdated(e){this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(e)}setFormValue(){let e=null;this.checked?e=this.value?this.value:"on":e=null,this.manageRequired(),this.internals.setFormValue(e)}manageRequired(){!this.checked&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}formResetCallback(){this.checked=!1,this.indeterminate=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}toggleState(){this.disabled||(this.checked=!this.checked,this.indeterminate=!1)}handleKeyDown(e){var t;e.key===k.ENTER&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}update(e){super.update(e),e.has("checked")&&this.setFormValue()}render(){return h`
      <mdc-staticcheckbox
    ...
    `}};d.styles=[...m.styles,...$];let o=d;s([a({type:Boolean,reflect:!0})],o.prototype,"checked");s([a({type:Boolean,reflect:!0})],o.prototype,"indeterminate");s([a({type:Boolean,reflect:!0})],o.prototype,"autofocus");o.register(u);
