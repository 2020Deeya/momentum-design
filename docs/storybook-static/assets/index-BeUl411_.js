import{i as p,k as s,D as d}from"./lit-element-D5KKan5q.js";import{n as o}from"./index-C9z9WAEj.js";import{t as u}from"./if-defined-D5BV9-c0.js";import{p as g}from"./index-2PiEGcHV.js";import{T as v,V as f}from"./index-BrLJ_9IK.js";import{T as y}from"./menupopover.constants-BkwERfSm.js";import{I as w}from"./IconNameMixin-CujGSn0t.js";import{M as b}from"./menuitem.component-Rtoon-jg.js";import{g as k}from"./button.utils-rNW36Ji7.js";import{D as N,S as I,I as x,A,b as C}from"./sidenavigation.component-swtrqB-j.js";import{a as L,h as E}from"./index-Cx7wvr8C.js";import"./index-CXlMGGhE.js";import"./index-BZWajUZW.js";import"./index-D2NeUKIj.js";const T=[L,p`
    :host {
  ...
  `,...E()];var $=Object.defineProperty,i=(l,e,t,a)=>{for(var n=void 0,c=l.length-1,h;c>=0;c--)(h=l[c])&&(n=h(e,t,n)||n);return n&&$(e,t,n),n};const m=class m extends w(b){constructor(){super(),this.maxCounter=N.MAX_COUNTER,this.ariaLabel=null,this.sideNavigationContext=g.consume({host:this,context:I.Context}),this.emitNavMenuItemActiveChange=e=>{const t=new CustomEvent("activechange",{detail:{navId:this.navId,active:e},bubbles:!0});this.dispatchEvent(t)},this.addEventListener("click",this.handleClickEvent)}connectedCallback(){super.connectedCallback(),this.variant=void 0,this.tooltipPlacement=void 0,!this.navId&&this.onerror&&this.onerror("[mdc-navmenuitem] navId is required and was not provided."),this.toggleAttribute("in-menupopover",this.isNested())}updated(){var t;const e=(t=this.sideNavigationContext)==null?void 0:t.value;if(e)if(this.showLabel=this.isNested()?!0:e.expanded,this.showLabel)this.removeAttribute("aria-label");else{const a=this.label??"";this.ariaLabel=this.ariaLabel||a,this.setAttribute("aria-label",a)}}isNested(){let e=this.parentElement;for(;e;){if(e.tagName.toLowerCase()===y)return!0;e=e.parentElement}return!1}modifyIconName(e){if(!this.iconName)return;const t=this.iconName.endsWith("-filled"),a=k(this.iconName);e?t||(this.prevIconName=this.iconName,this.iconName=`${a}-filled`):this.prevIconName&&(this.iconName=this.prevIconName)}handleClickEvent(){this.disabled||this.emitNavMenuItemActiveChange(this.active)}update(e){super.update(e),e.has("active")&&this.modifyIconName(this.active)}renderTextLabel(e){return s`
      <mdc-text
    ...
    `}renderArrowIcon(e){const t=e?"":"arrow";return s`
      <mdc-icon name=${x.RIGHT_ARROW} length-unit="rem" part="trailing-arrow" class="${t}"> </mdc-icon>
    `}renderBadge(e){const t=e?"":"badge";return Object.values(A).includes(this.badgeType)?s`
      <mdc-badge
        class="${t}"
