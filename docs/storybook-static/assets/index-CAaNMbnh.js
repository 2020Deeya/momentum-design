import{S as E,U as y,X as f,W as T,k as r,V as p,q as d,h as u,G as k,n as c}from"./iframe-xJvWfTzZ.js";import{T as R}from"./TabIndexMixin-CiYdC3A9.js";import{K as n}from"./keys-hFXe221I.js";import{p as S}from"./index-DzxFCTYp.js";import{D as x,b as C,a as o,c as h,d as A}from"./stepper.component-DM7y7bB2.js";import"./index-BbYB32IG.js";const N=E`
  :host {
    gap: 0.5rem;
    ...
    >`;return this.status===o.ERROR_INCOMPLETE||this.status===o.ERROR_CURRENT?r`<div part="help-text-container">
      ...
      <div part="label-container">
        ${this.label?r`<mdc-text part="label" tagname=${p.SPAN} type=${d.BODY_MIDSIZE_REGULAR}
            ...
            >`:u}
        ${this.renderHelpText()}
      </div>`}};v.styles=[...k.styles,..._];let e=v;i([c({type:String,reflect:!0})],e.prototype,"variant");i([c({type:String,reflect:!0})],e.prototype,"status");i([c({type:String,reflect:!0})],e.prototype,"label");i([c({type:String,reflect:!0,attribute:"help-text"})],e.prototype,"helpText");i([c({type:Number,reflect:!0,attribute:"step-number"})],e.prototype,"stepNumber");e.register(A);
