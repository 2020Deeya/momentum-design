import{L as O,T as _}from"./linksimple.component-C7KLsJJd.js";import{k as L}from"./iframe-CHzZc0ya.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-DXPOpxmJ.js";import"./DataAriaLabelMixin-K4ZBFGcU.js";import"./DisabledMixin-B0bcvnrU.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
