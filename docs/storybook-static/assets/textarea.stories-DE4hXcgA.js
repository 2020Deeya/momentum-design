import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{t as o}from"./if-defined-D5BV9-c0.js";import{i as Z,D as E,k as h}from"./lit-element-D5KKan5q.js";import{u as G,n as i}from"./index-C9z9WAEj.js";import{F as X,e as J}from"./FormInternalsMixin-Dg5j8Yib.js";import{a as K}from"./index-BX3Tn-Br.js";import"./index-DTPvceyl.js";import{V as p,D as Q,F as A}from"./formfieldwrapper.component-CzpAXlhk.js";import{A as T}from"./input.constants-BmYxuDFu.js";import{T as ee}from"./text.constants-ZF0jM5wn.js";import{D as te}from"./DataAriaLabelMixin-D53Z5CZ7.js";import"./index-Bl2xiqtE.js";import"./index-CebKo0V0.js";import"./index-D3DhXfcW.js";import{c as ae,s as re}from"./commonArgTypes-BluK8w5L.js";import{h as oe,d as j}from"./utils-D1SE5bce.js";import"./v4-CQkTLCs1.js";import"./base-DIkkzJ-c.js";import"./v4-CmTdKEVZ.js";import"./DisabledMixin-BZruwOeC.js";import"./button.constants-CBmzmO0q.js";import"./buttonsimple.component-CNln8tgM.js";import"./TabIndexMixin-CsrHswKP.js";import"./state-CSSggq2n.js";import"./button.utils-DKnTcKwe.js";import"./iframe-DSarDEbX.js";import"../sb-preview/runtime.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";const le=[Z`
  :host {
...
`,...K(!0)],ie=G.constructTagName("textarea"),w={HARD:"hard",SOFT:"soft"},C={OFF:"off",ON:"on"},d={CHARACTER_COUNTER_TYPE:ee.BODY_MIDSIZE_REGULAR,ROWS:5,COLS:40,WRAP:w.SOFT};var se=Object.defineProperty,l=(e,t,s,u)=>{for(var r=void 0,c=e.length-1,m;c>=0;c--)(m=e[c])&&(r=m(t,s,r)||r);return r&&se(t,s,r),r};const $=class $ extends X(te(A)){constructor(){super(...arguments),this.readonly=!1,this.rows=d.ROWS,this.cols=d.COLS,this.wrap=w.SOFT,this.autocapitalize=T.OFF,this.autocomplete=C.OFF,this.autofocus=!1,this.characterLimitExceedingFired=!1}get textarea(){return this.inputElement}connectedCallback(){var t;super.connectedCallback(),this.value=((t=this.textContent)==null?void 0:t.trim())||this.value,this.updateComplete.then(()=>{this.textarea&&(this.textarea.checkValidity(),this.setTextareaValidity(),this.internals.setFormValue(this.textarea.value))}).catch(s=>{this.onerror&&this.onerror(s)})}setTextareaValidity(){this.requiredLabel&&this.validationMessage&&this.value===""?this.textarea.setCustomValidity(this.validationMessage):this.maxCharacterLimit&&this.value.length>this.maxCharacterLimit&&this.helpTextType===p.ERROR&&this.helpText?this.textarea.setCustomValidity(this.helpText):this.textarea.setCustomValidity(""),this.setValidity()}formResetCallback(){this.value="",this.requestUpdate()}formStateRestoreCallback(t){this.value=t}handleValueChange(){this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&(this.handleValueChange(),this.handleCharacterOverflowStateChange())}attributeChangedCallback(t,s,u){super.attributeChangedCallback(t,s,u),["maxlength","minlength","required"].includes(t)&&this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(c=>{this.onerror&&this.onerror(c)})}dispatchCharacterOverflowStateChangeEvent(){this.dispatchEvent(new CustomEvent("limitexceeded",{detail:{currentCharacterCount:this.value.length,maxCharacterLimit:this.maxCharacterLimit,value:this.value},bubbles:!0,composed:!0}))}handleCharacterOverflowStateChange(){this.maxCharacterLimit&&(this.value.length>this.maxCharacterLimit&&!this.characterLimitExceedingFired?(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!0):this.value.length<=this.maxCharacterLimit&&this.characterLimitExceedingFired&&(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!1))}updateValue(){this.value=this.textarea.value,this.internals.setFormValue(this.textarea.value)}onChange(t){this.updateValue();const s=t.constructor;this.dispatchEvent(new s(t.type,t))}renderCharacterCounter(){return this.maxCharacterLimit?h`
      <mdc-text
        part="character-counter"
        tagname="span"
        type=${d.CHARACTER_COUNTER_TYPE}
      >
      ${this.value.length<10?`0${this.value.length}`:this.value.length}/${this.maxCharacterLimit}
      </mdc-text>
    `:E}renderTextareaFooter(){return!this.helpText&&!this.maxCharacterLimit?E:h`
      ...
      <div class="textarea-container mdc-focus-ring" part="textarea-container">
        <textarea
          ...
          aria-describedby="${o(this.helpText?Q.HELPER_TEXT_ID:"")}"
          aria-invalid="${this.helpTextType==="error"?"true":"false"}"
        ></textarea>
        </div>
        ${this.renderTextareaFooter()}
        `}};$.styles=[...A.styles,...le];let a=$;l([i({type:String})],a.prototype,"placeholder");l([i({type:Boolean})],a.prototype,"readonly");l([i({type:Number})],a.prototype,"rows");l([i({type:Number})],a.prototype,"cols");l([i({type:String})],a.prototype,"wrap");l([i({type:String})],a.prototype,"autocapitalize");l([i({type:String})],a.prototype,"autocomplete");l([i({type:Boolean})],a.prototype,"autofocus");l([i({type:String})],a.prototype,"dirname");l([i({type:Number})],a.prototype,"maxlength");l([i({type:Number})],a.prototype,"minlength");l([i({type:Number,attribute:"max-character-limit"})],a.prototype,"maxCharacterLimit");l([J("textarea")],a.prototype,"inputElement");a.register(ie);const ce=e=>h`<mdc-textarea
    @input="${n("oninput")}"
    @change="${n("onchange")}"
    @focus="${n("onfocus")}"
    @blur="${n("onblur")}"
    @limitexceeded="${n("limitexceeded")}"
    label="${e.label}"
  ...
  ></mdc-textarea>`,Pe={title:"Components/textarea",tags:["autodocs"],component:"mdc-textarea",render:ce,parameters:{badges:["stable"]},argTypes:{...ae,...re,name:{control:"text"},value:{control:"text"},placeholder:{control:"text"},label:{control:"text"},"required-label":{control:"text"},"help-text":{control:"text"},readonly:{control:"boolean"},disabled:{control:"boolean"},rows:{control:"number"},cols:{control:"number"},wrap:{control:"select",options:Object.values(w)},minlength:{control:"number"},maxlength:{control:"number"},"max-character-limit":{control:"number"},autocapitalize:{control:"select",options:Object.values(T)},autofocus:{control:"boolean"},autocomplete:{control:"select",options:Object.values(C)},dirname:{control:"text"},"data-aria-label":{control:"text"},"help-text-type":{control:"select",options:Object.values(p)},...oe(["characterLimitExceedingFired","textarea","validity","willValidate"]),...j(["--mdc-textarea-disabled-border-color","--mdc-textarea-disabled-text-color","--mdc-textarea-disabled-background-color","--mdc-textarea-border-color","--mdc-textarea-text-color","--mdc-textarea-background-color","--mdc-textarea-hover-background-color","--mdc-textarea-focused-background-color","--mdc-textarea-focused-border-color","--mdc-textarea-error-border-color","--mdc-textarea-warning-border-color","--mdc-textarea-success-border-color","--mdc-textarea-primary-border-color","--mdc-textarea-text-secondary-normal"])}},x={args:{name:"textarea",label:"Label",rows:d.ROWS,cols:d.COLS,wrap:d.WRAP,"required-label":"required",placeholder:"Placeholder",value:"","help-text":"Help text","help-text-type":p.DEFAULT,readonly:!1,disabled:!1,autocapitalize:T.OFF,autocomplete:C.OFF,autofocus:!1,"data-aria-label":""}},Y={name:"textarea",label:"Label",rows:d.ROWS,cols:d.COLS,wrap:d.WRAP},b={args:{...Y,value:"Disabled & typed textarea",disabled:!0},parameters:{docs:{description:{story:"This story displays a disabled textarea component. The textarea will be displayed as disabledwhen the `disabled` attribute is set to true. The user will not be able to interact with the textarea."}}}},y={args:{...Y,readonly:!0,value:"Readonly textarea"},parameters:{docs:{description:{story:"This story displays a readonly textarea component. The textarea will be displayed as readonlywhen the `readonly` attribute is set to true. The user will not be able to edit the content of the textarea."}}}},v={argTypes:{...j(["label","help-text","required-label","placeholder","value","help-text-type"])},render:()=>h`
  <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
    ${Object.values(p).map(e=>h`<mdc-textarea
      help-text-type="${e}"
      label="Label"
      ...
      <fieldset>
        ...
        <mdc-textarea
          ...
          name="tweet"
          label="Tweet"
          @limitexceeded=${r=>{var m,L;n("limitexceeded")(r);const{detail:c}=r;c.currentCharacterCount>c.maxCharacterLimit?(e=`Input must not exceed ${c.maxCharacterLimit} characters.`,t=p.ERROR):(e="",t=p.DEFAULT),(m=document.getElementById("textarea"))==null||m.setAttribute("help-text",e),(L=document.getElementById("textarea"))==null||L.setAttribute("help-text-type",t)}}
          help-text="${e}"
          help-text-type="${t}"
          required-label="required"
          max-character-limit="75"
    ...
    <form @submit=${t=>{t.preventDefault();const u=new FormData(t.target).get("tweet");n("Form Submitted")({value:u})}}>
      <fieldset>
      <legend>Form Example</legend>
      <mdc-textarea
        id="textarea"
    ...
    `};var F,S,O;x.parameters={...x.parameters,docs:{...(F=x.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    name: 'textarea',
    label: 'Label',
    rows: DEFAULTS.ROWS,
...
}`,...(O=(S=x.parameters)==null?void 0:S.docs)==null?void 0:O.source}}};var D,R,k;b.parameters={...b.parameters,docs:{...(D=b.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    ...commonArgs,
...
}`,...(k=(R=b.parameters)==null?void 0:R.docs)==null?void 0:k.source}}};var q,V,I;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    ...commonArgs,
    readonly: true,
...
}`,...(I=(V=y.parameters)==null?void 0:V.docs)==null?void 0:I.source}}};var z,U,P;v.parameters={...v.parameters,docs:{...(z=v.parameters)==null?void 0:z.docs,source:{originalSource:`{
  argTypes: {
...
}`,...(P=(U=v.parameters)==null?void 0:U.docs)==null?void 0:P.source}}};var _,W,N;f.parameters={...f.parameters,docs:{...(_=f.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
    let helpText = '';
...
}`,...(N=(W=f.parameters)==null?void 0:W.docs)==null?void 0:N.source}}};var M,H,B;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => {
    const handleSubmit = (event: Event) => {
      event.preventDefault();
      const formData = new FormData(event.target as HTMLFormElement);
...
}`,...(B=(H=g.parameters)==null?void 0:H.docs)==null?void 0:B.source}}};const _e=["Example","DisabledTextarea","ReadonlyTextarea","AllVariants","TextareaWithCharacterCounter","TextareaInsideForm"];export{v as AllVariants,b as DisabledTextarea,x as Example,y as ReadonlyTextarea,g as TextareaInsideForm,f as TextareaWithCharacterCounter,_e as __namedExportsOrder,Pe as default};
