import{L as O,T as _}from"./linksimple.component-9BlOE2sy.js";import{k as L}from"./iframe-27lSNS5L.js";import{h as s,r as d}from"./utils-B5QUENNQ.js";import"./if-defined-Cfu5CGM9.js";import"./DataAriaLabelMixin-zPfGvZtM.js";import"./DisabledMixin-C8yRpiPh.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
