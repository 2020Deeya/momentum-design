import{u as P,U as q,F as C,k as c,n as J}from"./iframe-CxpxgoKw.js";import{c as Q,s as X}from"./commonArgTypes-BG7EqI50.js";import"./preload-helper-C1FmrZbK.js";const Y=P.constructTagName("skeleton"),a={BUTTON:"button",CIRCULAR:"circular",RECTANGULAR:"rectangular",ROUNDED:"rounded"},F={VARIANT:a.RECTANGULAR},Z=q`
  :host {
...
`;var ee=Object.defineProperty,te=(e,t,o,n)=>{for(var r=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(r=i(t,o,r)||r);return r&&ee(t,o,r),r};const k=class k extends C{constructor(){super(...arguments),this.variant=F.VARIANT}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}firstUpdated(t){super.firstUpdated(t),this.checkSlotContent()}checkSlotContent(){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("slot");t&&(t.assignedNodes().length>0?this.setAttribute("has-content",""):this.removeAttribute("has-content"))}render(){return c`<slot @slotchange=${this.checkSlotContent}></slot>`}};k.styles=[...C.styles,Z];let v=k;te([J({type:String,reflect:!0})],v.prototype,"variant");v.register(Y);let d=0;const l=e=>{d+=1;const t=document.getElementById("normal-content-dynamic"),o=document.getElementById("skeleton-content-dynamic");if(!t||!o)return;t.children.length===1&&t.children[0].tagName==="P"&&(t.innerHTML="",o.innerHTML="");let n;switch(e){case"button":n=document.createElement("button"),n.textContent=`Button ${d}`,n.style.cssText=`
...
`,ce={title:"Components/skeleton",tags:["autodocs"],component:"mdc-skeleton",render:re,argTypes:{variant:{control:"select",options:Object.values(a)},...Q,...X}},p={args:{variant:F.VARIANT}},u={args:{variant:a.RECTANGULAR}},m={args:{variant:a.ROUNDED}},x={args:{variant:a.CIRCULAR}},g={args:{variant:a.BUTTON}},b={render:oe,args:{variant:a.RECTANGULAR}},h={render:e=>c`
