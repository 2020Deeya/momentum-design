import{S as $,u as A,k as n,h as I,V as x,q as _,n as E,l as D}from"./iframe-Cx7Wu_b6.js";import{t as l}from"./if-defined-5q8SXfR8.js";import{d as p,D as T,a as O,c as d}from"./dialog.component-C2TR2xQE.js";import{i as k}from"./manifest-Dzdn0cqL.js";import"./index-BdBlgII1.js";import{c as S,s as z}from"./commonArgTypes-BluK8w5L.js";import{a as L}from"./utils-Dd_sfl9-.js";import"./preload-helper-C1FmrZbK.js";import"./BackdropMixin-BFaSnNs6.js";import"./FooterMixin-BzzAQa9p.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./link.constants-3-mqk789.js";import"./index-BVwG7zk0.js";import"./index-DTrDRi1E.js";import"./button.component-D-NtKVUd.js";import"./buttonsimple.component-BieaVO3g.js";import"./TabIndexMixin-7DEYTwho.js";import"./DisabledMixin-CxWBtTFO.js";import"./button.utils-rNW36Ji7.js";import"./index-CF2bI6-v.js";const w=$`
  :host {
...
`,N=[w],C=A.constructTagName("announcementdialog"),G=["medium","large","xlarge","fullscreen"],f={SIZE:"medium"};var U=Object.defineProperty,v=(t,e,o,m)=>{for(var r=void 0,s=t.length-1,u;s>=0;s--)(u=t[s])&&(r=u(e,o,r)||r);return r&&U(e,o,r),r};const c=class c extends p{constructor(){super(...arguments),this.size=f.SIZE}connectedCallback(){super.connectedCallback(),this.variant=T.DEFAULT}renderHeader(){return n`${I}`}renderBody(){return n`
    ...
    `}};c.styles=[...p.styles,...N];let a=c;v([E({type:String,reflect:!0})],a.prototype,"illustration");v([E({type:String,reflect:!0})],a.prototype,"size");a.register(C);const{action:g}=__STORYBOOK_MODULE_ACTIONS__,M=(t,e,o)=>n`<mdc-announcementdialog
    class="${t.class}"
    style="${t.style}"
    id="${t.id}"
    z-index="${t["z-index"]}"
...
`,R=t=>{const e=()=>{document.getElementById(t.id).toggleAttribute("visible")},o=()=>{document.getElementById(t.id).removeAttribute("visible")};return n`
    ...
    ${M(t,Z(e),o)}
  `},dt={title:"Widgets/announcementdialog",tags:["autodocs"],component:"mdc-announcementdialog",render:R,argTypes:{...S,...z,id:{control:"text"},triggerId:{control:"text"},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"header-tag-name":{control:"select",options:Object.values(x)},"should-focus-trap-wrap":{control:"boolean"},"focus-trap":{control:"boolean"},role:{control:"select",options:Object.values(O)},size:{control:"select",options:Object.values(G)},visible:{control:"boolean"},illustration:{control:"select",options:Object.values(D.invert(k)),table:{defaultValue:{summary:"undefined"}}},...L(["variant","description-text","description-tag-name"])}},i={args:{size:f.SIZE,"header-text":"Dialog Header","header-tag-name":d.HEADER_TAG_NAME,illustration:"onezerox-better-threetwozero-onboarding-tertiary",visible:!1,"close-button-aria-label":"Close dialog",role:d.ROLE,id:"dialog",triggerId:"dialog-trigger-btn","z-index":d.Z_INDEX,"--mdc-dialog-height":"30rem"}};var b,h,y;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
...
}`,...(y=(h=i.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};const ct=["Example"];export{i as Example,ct as __namedExportsOrder,dt as default};
