import"./index-Cj9AhLBJ.js";import"./index-CtdxlO-8.js";import{D as n,T as g,a as f}from"./toggle.constants-BTICiz3P.js";import{W as b,U as y,X as v,h as k,k as h,R as x,n as m}from"./iframe-CxpxgoKw.js";import"./index-CQkuaoMa.js";import{t as o}from"./if-defined-C4FxUqXH.js";import{K as c}from"./TabIndexMixin-CZzYVn8l.js";import{A as $}from"./buttonsimple.component-DFh3t6qR.js";import{a as E}from"./ControlTypeMixin-Bu1ig6Sa.js";import{D as T}from"./DataAriaLabelMixin-C2nZv75Y.js";import{F as S}from"./FormInternalsMixin-D_XFLKkT.js";import"./index-BSaW_T_D.js";import{D as z}from"./formfieldwrapper.constants-Dc9HIqjp.js";import{F as p}from"./formfieldwrapper.component-CStRZizq.js";const C=[b,y`
    :host {
  ...
  `,...v(!0)];var D=Object.defineProperty,u=(l,e,t,F)=>{for(var s=void 0,a=l.length-1,d;a>=0;a--)(d=l[a])&&(s=d(e,t,s)||s);return s&&D(e,t,s),s};const r=class r extends E($(S(T(p)))){constructor(){super(...arguments),this.checked=!1,this.size=n.SIZE,this.renderLabelAndHelperText=()=>this.label?h`<div part="text-container">${this.renderLabel()} ${this.renderHelperText()}</div>`:k}connectedCallback(){super.connectedCallback(),this.helpTextType=void 0}firstUpdated(e){this.inputElement&&this.autoFocusOnMount&&(this.elementToAutoFocus=this.inputElement),super.firstUpdated(e)}formResetCallback(){this.checked=!1}formStateRestoreCallback(e){e&&(this.checked=!0)}manageRequired(){!this.checked&&this.required?(this.validationMessage?this.inputElement.setCustomValidity(this.validationMessage):this.inputElement.setCustomValidity(""),this.setValidity()):this.internals.setValidity({})}setFormValue(){let e=null;this.checked?e=this.value?this.value:"isActive":e=null,this.manageRequired(),this.internals.setFormValue(e)}toggleState(){!this.disabled&&!this.softDisabled&&!this.readonly&&this.controlType!=="controlled"&&(this.checked=!this.checked)}handleKeyDown(e){var t;(this.readonly||this.softDisabled)&&e.key===c.SPACE&&e.preventDefault(),e.key===c.ENTER&&((t=this.form)==null||t.requestSubmit())}handleChange(e){this.toggleState();const t=e.constructor;this.dispatchEvent(new t(e.type,e))}setToggleSize(e){this.setAttribute("size",Object.values(g).includes(e)?e:n.SIZE)}update(e){super.update(e),e.has("checked")&&this.setFormValue(),e.has("size")&&this.setToggleSize(this.size)}render(){return h`
    ...
    `}};r.styles=[...p.styles,...C];let i=r;u([m({type:Boolean,reflect:!0})],i.prototype,"checked");u([m({type:String,reflect:!0})],i.prototype,"size");i.register(f);
