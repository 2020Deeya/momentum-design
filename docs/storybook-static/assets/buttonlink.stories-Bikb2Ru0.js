import{a2 as P,a8 as j,a5 as D,k as h,n as A,u as M,P as E,b as U,B as C,I as u,R as Z}from"./iframe-DtiRZQ2l.js";import{a as V,B as F}from"./button.component-CbP3poVC.js";import{L as W}from"./linksimple.component-Wd0P8vE8.js";import"./index-BK86NvBQ.js";import{i as x}from"./manifest-D-vaL5Hi.js";import{t as o}from"./if-defined-r97CdV4N.js";import{c as Y,s as G}from"./commonArgTypes-BG7EqI50.js";import{h as K}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./buttonsimple.component-Q3CPaVOs.js";import"./DisabledMixin-D_v0Rzs7.js";import"./KeyDownHandledMixin-DXj2iMY0.js";import"./index-DOdZz0Sq.js";import"./button.utils-rNW36Ji7.js";import"./DataAriaLabelMixin-CLQqFjU0.js";import"./index-DTrDRi1E.js";const q=P`
  :host {
    border: unset;
  }
...
`,H=[q,...j(!0)];var J=Object.defineProperty,R=(t,e,s,tt)=>{for(var i=void 0,f=t.length-1,m;f>=0;f--)(m=t[f])&&(i=m(e,s,i)||i);return i&&J(e,s,i),i};const b=class b extends V(W){constructor(){super(...arguments),this.size=D.SIZE}setSoftDisabled(e,s){s?e.setAttribute("aria-disabled","true"):e.removeAttribute("aria-disabled")}update(e){super.update(e),e.has("softDisabled")&&this.setSoftDisabled(this,this.softDisabled),e.has("size")&&this.setSize(this.size),e.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),e.has("color")&&this.setColor(this.color),e.has("typeInternal")&&this.setSize(this.size),(e.has("prefixIcon")||e.has("postfixIcon"))&&this.inferButtonType()}renderAnchorContent(){return h`
