import{a as d}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{t as o}from"./if-defined-D5BV9-c0.js";import{i as Y,D as L,k as m}from"./lit-element-D5KKan5q.js";import{n as i}from"./property-Bj3TGwkg.js";import{e as Z}from"./query-DXShiZ7f.js";import"./index-BLrhNmIW.js";import{V as p,D as G,F as A}from"./formfieldwrapper.component-BeqiOSNt.js";import{A as T}from"./input.constants-Ds8TJq2q.js";import{D as X}from"./DataAriaLabelMixin-DVpSBUFD.js";import{F as J}from"./FormInternalsMixin-DR-5bOLb.js";import{u as K}from"./provider.component-DrWB4byV.js";import{T as Q}from"./index-DeEenWCE.js";import{a as ee}from"./index-B-GnYs90.js";import"./index-dmTNvFdU.js";import"./index-D0tujtMk.js";import"./index-D1vBhXTb.js";import{c as te,s as ae}from"./commonArgTypes-BluK8w5L.js";import{a as re,t as oe,d as le}from"./utils-CFOyPOhY.js";import{a as ie}from"./popover.component-CWSuSUni.js";import"./v4-CQkTLCs1.js";import"./base-DIkkzJ-c.js";import"./DisabledMixin-B-Cnza7-.js";import"./button.constants-BBlkZKjZ.js";import"./buttonsimple.constants-CVV9o_W6.js";import"./roles-CJI3JVG-.js";import"./v4-CmTdKEVZ.js";import"./button.component-AY6DUPps.js";import"./state-CmYk530Z.js";import"./buttonsimple.component-UJ4pbvCi.js";import"./keys-hFXe221I.js";import"./TabIndexMixin-DEwGeIeI.js";import"./button.utils-rNW36Ji7.js";import"./iframe-BRXRuPOj.js";import"../sb-preview/runtime.js";import"./index-CwZu4Wnd.js";import"./iconprovider.component-BtAZSWEH.js";import"./create-context-89xeped_.js";import"./index-CnFwjDgi.js";const se=K.constructTagName("textarea"),w={HARD:"hard",SOFT:"soft"},C={OFF:"off",ON:"on"},c={CHARACTER_COUNTER_TYPE:Q.BODY_MIDSIZE_REGULAR,ROWS:5,COLS:40,WRAP:w.SOFT},ne=[Y`
    :host {
  ...
  `,...ee(!0)];var ce=Object.defineProperty,l=(e,t,s,u)=>{for(var r=void 0,n=e.length-1,h;n>=0;n--)(h=e[n])&&(r=h(t,s,r)||r);return r&&ce(t,s,r),r};const $=class $ extends J(X(A)){constructor(){super(...arguments),this.readonly=!1,this.rows=c.ROWS,this.cols=c.COLS,this.wrap=w.SOFT,this.autocapitalize=T.OFF,this.autocomplete=C.OFF,this.autofocus=!1,this.characterLimitExceedingFired=!1}get textarea(){return this.inputElement}connectedCallback(){var t;super.connectedCallback(),this.value=((t=this.textContent)==null?void 0:t.trim())||this.value,this.updateComplete.then(()=>{this.textarea&&(this.textarea.checkValidity(),this.setTextareaValidity(),this.internals.setFormValue(this.textarea.value))}).catch(s=>{this.onerror&&this.onerror(s)})}setTextareaValidity(){this.required&&this.validationMessage&&this.value===""?this.textarea.setCustomValidity(this.validationMessage):this.maxCharacterLimit&&this.value.length>this.maxCharacterLimit&&this.helpTextType===p.ERROR&&this.helpText?this.textarea.setCustomValidity(this.helpText):this.textarea.setCustomValidity(""),this.setValidity()}formResetCallback(){this.value="",this.requestUpdate()}formStateRestoreCallback(t){this.value=t}handleValueChange(){this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(t=>{this.onerror&&this.onerror(t)})}updated(t){super.updated(t),t.has("value")&&(this.handleValueChange(),this.handleCharacterOverflowStateChange())}attributeChangedCallback(t,s,u){super.attributeChangedCallback(t,s,u),["maxlength","minlength","required"].includes(t)&&this.updateComplete.then(()=>{this.setTextareaValidity()}).catch(n=>{this.onerror&&this.onerror(n)})}dispatchCharacterOverflowStateChangeEvent(){this.dispatchEvent(new CustomEvent("limitexceeded",{detail:{currentCharacterCount:this.value.length,maxCharacterLimit:this.maxCharacterLimit,value:this.value},bubbles:!0,composed:!0}))}handleCharacterOverflowStateChange(){this.maxCharacterLimit&&(this.value.length>this.maxCharacterLimit&&!this.characterLimitExceedingFired?(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!0):this.value.length<=this.maxCharacterLimit&&this.characterLimitExceedingFired&&(this.dispatchCharacterOverflowStateChangeEvent(),this.characterLimitExceedingFired=!1))}updateValue(){this.value=this.textarea.value,this.internals.setFormValue(this.textarea.value)}onChange(t){this.updateValue();const s=t.constructor;this.dispatchEvent(new s(t.type,t))}renderCharacterCounter(){return this.maxCharacterLimit?m`
    ...
    `}};$.styles=[...A.styles,...ne];let a=$;l([i({type:String})],a.prototype,"placeholder");l([i({type:Boolean})],a.prototype,"readonly");l([i({type:Number})],a.prototype,"rows");l([i({type:Number})],a.prototype,"cols");l([i({type:String})],a.prototype,"wrap");l([i({type:String})],a.prototype,"autocapitalize");l([i({type:String})],a.prototype,"autocomplete");l([i({type:Boolean})],a.prototype,"autofocus");l([i({type:String})],a.prototype,"dirname");l([i({type:Number})],a.prototype,"maxlength");l([i({type:Number})],a.prototype,"minlength");l([i({type:Number,attribute:"max-character-limit"})],a.prototype,"maxCharacterLimit");l([Z("textarea")],a.prototype,"inputElement");a.register(se);const de=e=>m`<mdc-textarea
    @input="${d("oninput")}"
    @change="${d("onchange")}"
    @focus="${d("onfocus")}"
    @blur="${d("onblur")}"
...
}`,...(j=(H=f.parameters)==null?void 0:H.docs)==null?void 0:j.source}}};const Xe=["Example","DisabledTextarea","ReadonlyTextarea","AllVariants","TextareaWithCharacterCounter","TextareaInsideForm"];export{v as AllVariants,b as DisabledTextarea,x as Example,y as ReadonlyTextarea,f as TextareaInsideForm,g as TextareaWithCharacterCounter,Xe as __namedExportsOrder,Ge as default};
