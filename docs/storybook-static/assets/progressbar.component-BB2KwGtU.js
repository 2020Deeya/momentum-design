import{u as b,i as v,k as t,n}from"./iframe-Cg5TAAQy.js";import"./index-u3SoyIHI.js";import{D as u}from"./DataAriaLabelMixin-DprWfCyu.js";import{V as o,F as g}from"./formfieldwrapper.component-DCOecobz.js";import{R as f}from"./roles-CJI3JVG-.js";import{h as y}from"./index-hvNnVypU.js";import{v as T}from"./v4-CmTdKEVZ.js";const x=b.constructTagName("progressbar"),l={DEFAULT:"default",INLINE:"inline"},A={VARIANT:l.DEFAULT,VALIDATION:o.DEFAULT},V=[y,v`
    :host {
  ...
  `];var $=Object.defineProperty,d=(c,r,a,h)=>{for(var e=void 0,i=c.length-1,m;i>=0;i--)(m=c[i])&&(e=m(r,a,e)||e);return e&&$(r,a,e),e};const p=class p extends u(g){constructor(){super(...arguments),this.variant=A.VARIANT,this.value="0",this.error=!1,this.renderProgressbar=()=>{const r=this.getValidationVariant(),a=this.clampedValue>0&&this.clampedValue<100,h=this.error?"100":`${this.clampedValue}`;return t`
      <div
    ...
    `}}connectedCallback(){super.connectedCallback(),this.id=`${x}-${T()}`,this.disabled=void 0,this.toggletipText=void 0,this.toggletipPlacement=void 0}get clampedValue(){const r=Number(this.value);return Number.isNaN(r)?0:Math.max(0,Math.min(100,r))}getValidationVariant(){return this.error?this.helpTextType=o.ERROR:this.clampedValue===100?this.helpTextType=o.SUCCESS:this.helpTextType=o.DEFAULT,this.helpTextType}render(){const r=this.variant===l.INLINE;return t`
      ${r?t`<div part="inline-label-container">${this.renderLabelElement()} ${this.renderProgressbar()}</div>`:t`
          ...
          `}
    `}};p.styles=[...g.styles,...V];let s=p;d([n({type:String,reflect:!0})],s.prototype,"variant");d([n({type:String,reflect:!0})],s.prototype,"value");d([n({type:Boolean})],s.prototype,"error");export{A as D,s as P,x as T,l as V};
