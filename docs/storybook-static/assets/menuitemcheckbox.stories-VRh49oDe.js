import{k as i}from"./iframe-DPFjqenE.js";import{t as f}from"./if-defined-CWibhRqJ.js";import{V as D}from"./index-Bdl3nW1C.js";import"./index-B3AyXvhh.js";import{c as v,s as U}from"./commonArgTypes-BluK8w5L.js";import{a as W,h as L}from"./utils-Dd_sfl9-.js";import{I as c}from"./menuitemcheckbox.constants-CKWfg1qu.js";import"./preload-helper-C1FmrZbK.js";import"./index-BNJUzuSR.js";import"./DisabledMixin-Cykcjfj2.js";import"./formfieldwrapper.constants-BaZKN8L-.js";import"./toggle.constants-CE2hN_2g.js";import"./index-C6sOYqch.js";import"./popover.component-DM3hg66q.js";import"./base-DIkkzJ-c.js";import"./BackdropMixin-BxKxUE6U.js";import"./v4-CmTdKEVZ.js";import"./class-map-Bybcn__I.js";import"./directive-Ctav8iJK.js";import"./menuitem.component-TRJWmVXh.js";import"./listitem.component-pBPzqyF5.js";import"./query-assigned-elements-uEuc3rg8.js";import"./keys-hFXe221I.js";import"./TabIndexMixin-DSFaTMZl.js";import"./index-BqLKzGKe.js";import"./index-DTrDRi1E.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,M=e=>i`<div role="menu" style="width: 25rem;">${e}</div>`,O=e=>M(i` <mdc-menuitemcheckbox
      @change="${l("onchange")}"
      @click="${l("onclick")}"
      @focus="${l("onfocus")}"
      ?disabled="${e.disabled}"
    ...
    >
      ${e.children}
    </mdc-menuitemcheckbox>`),me={title:"Components/menupopover/menuitemcheckbox",tags:["autodocs"],component:"mdc-menuitemcheckbox",render:O,argTypes:{checked:{control:"boolean"},indicator:{control:"select",options:Object.values(c)},disabled:{control:"boolean"},label:{control:"text"},"secondary-label":{control:"text"},"control-type":{control:"select",options:[void 0,...D]},"soft-disabled":{control:"boolean"},...W(["data-aria-label","variant","tertiary-label","side-header-text","subline-text","leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","arrow-position","arrow-direction"]),...v,...U}},o={args:{indicator:c.CHECKBOX,checked:!1,label:"Menu Item",disabled:!1,"secondary-label":"",children:i`<mdc-icon length-unit="rem" name="alert-muted-bold" slot="leading-controls"></mdc-icon>`}},t={args:{checked:!0,indicator:c.TOGGLE,label:"Menu Item With Toggle",disabled:!1,"secondary-label":""}},m={args:{checked:!0,indicator:c.CHECKBOX,label:"Menu Item With Checkbox",disabled:!1,"secondary-label":""}},n={args:{checked:!0,indicator:c.CHECKMARK,label:"Menu Item With Checkmark",disabled:!1,"secondary-label":""}},d={render:()=>M(i`
