import{L as O,T as _}from"./linksimple.component-DMZ4ipf1.js";import{k as L}from"./iframe-DmhiQuZU.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-M-aGcL8O.js";import"./DataAriaLabelMixin-53VQiHcg.js";import"./DisabledMixin-Bniru7f_.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
