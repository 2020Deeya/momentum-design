import{i as Z,D as f,k as o}from"./lit-element-D5KKan5q.js";import{u as W,n as z}from"./index-C9z9WAEj.js";import{a as q}from"./index-CcXofQbA.js";import{D as Q}from"./DisabledMixin-BZruwOeC.js";import{T as J}from"./TabIndexMixin-CsrHswKP.js";import{C as x}from"./card.component-BbEuZO0l.js";import{R as ee}from"./roles-DMFGbP5t.js";import"./index-BxpyMMVk.js";import"./index-D3DhXfcW.js";import"./index-BAyRj1ge.js";import{Q as te}from"./repeat-CNQ7t7Vw.js";import{a as c}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as ae,s as oe}from"./commonArgTypes-BluK8w5L.js";import{h as re,d as ie}from"./utils-CO8B6ZcN.js";import{V as le,O as T,D as t}from"./CardAndDialogFooterMixin-COm20Ox1.js";import{V as k}from"./text.constants-ZF0jM5wn.js";import"./index-YKllVwdU.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./button.constants-D0QAbDxL.js";import"./buttonsimple.constants-CGc1uJX6.js";import"./iframe-CnyU4f7B.js";import"../sb-preview/runtime.js";import"./state-CSSggq2n.js";import"./index-2PiEGcHV.js";import"./iconprovider.component-Bvm-70EG.js";import"./create-context-89xeped_.js";import"./directive-Ctav8iJK.js";import"./directive-helpers-Bb6vhctq.js";import"./v4-CQkTLCs1.js";import"./link.constants-CqyNsepP.js";import"./if-defined-D5BV9-c0.js";import"./DataAriaLabelMixin-D53Z5CZ7.js";import"./formfieldwrapper.component-5n2-mkV5.js";const ce=Z`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,se=[ce,...q()],ne=W.constructTagName("cardcheckbox"),y={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},A={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"};var de=Object.defineProperty,j=(e,a,I,pe)=>{for(var i=void 0,g=e.length-1,C;g>=0;g--)(C=e[g])&&(i=C(a,I,i)||i);return i&&de(a,I,i),i};const E=class E extends Q(J(x)){constructor(){super(),this.checked=!1,this.selectionType=A.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked),this.addEventListener("keydown",this.toggleOnEnter),this.addEventListener("keyup",this.toggleOnSpace)}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked)}toggleOnEnter(a){a.key==="Enter"&&this.toggleChecked()}toggleOnSpace(a){a.key===" "&&this.toggleChecked()}renderSelection(){const a=this.checked?y.CHECKED:y.DEFAULT;switch(this.selectionType){case r.CHECK:return o`<mdc-icon part="check check-icon" 
                   size="${A.ICON_SIZE}"
  ...
  <mdc-cardcheckbox
    ...
    tabindex="${e.tabIndex}"
    class="${e.class}"
    style="${e.style}">${e.children}</mdc-cardcheckbox>`,ze={title:"Work In Progress/card/cardcheckbox",tags:["autodocs"],component:"mdc-cardcheckbox",render:me,parameters:{badges:["wip"]},argTypes:{variant:{control:"select",options:Object.values(le)},orientation:{control:"select",options:Object.values(T)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"selection-type":{control:"select",options:Object.values(r)},"title-tag-name":{control:"select",options:Object.values(k)},"subtitle-tag-name":{control:"select",options:Object.values(k)},...re(["children"]),...ae,...oe}},l=o`<mdc-text slot='body' 
