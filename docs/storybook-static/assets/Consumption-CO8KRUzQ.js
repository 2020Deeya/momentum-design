import{j as e}from"./iframe-BZIqfezz.js";import{useMDXComponents as t}from"./index-BIMrh-N5.js";import"./preload-helper-C1FmrZbK.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"consumption",children:"Consumption"}),`
...
`})}),`
`,e.jsx(n.h2,{id:"supporting-packages-for-momentum-design-system",children:"Supporting packages for Momentum Design System"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.strong,{children:"ThemeProvider"}),` component will switch themes based on the Momentum Tokens
defined in:
`,e.jsx(n.a,{href:"https://momentum-design.github.io/momentum-design/en/tokens/theme-stable/",rel:"nofollow",children:"Theme Tokens Stable"})]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.strong,{children:"IconsProvider"}),` component will use the Icons defined in:
`,e.jsx(n.a,{href:"https://momentum-design.github.io/momentum-design/en/tokens/icons/",rel:"nofollow",children:"Icons Asset Browser"})]}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"mds-typography"}),` class needs to be set on the root element for proper font
usage.`]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(n.p,{children:`Providers allow configuration for all the Momentum Design Components contained
within the provider.`}),`
`,e.jsx("br",{}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:[`IconProvider sets the icon source and icons configuration. (refer to
`,e.jsx(n.a,{href:"https://momentum-design.github.io/momentum-design/storybook-static/index.html?path=/docs/components-iconprovider--docs",rel:"nofollow",children:e.jsx(n.strong,{children:`Icon
Provider`})}),")."]}),`
`]}),`
`,e.jsx("br",{}),`
`,e.jsxs(n.ol,{start:"2",children:[`
`,e.jsxs(n.li,{children:["ThemeProvider sets the theme class. (refer to ",e.jsx(n.a,{href:"https://momentum-design.github.io/momentum-design/storybook-static/index.html?path=/docs/components-themeprovider--docs",rel:"nofollow",children:e.jsx(n.strong,{children:`Theme
Provider`})}),")."]}),`
`]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="@momentum-design/tokens/dist/css/components/complete.css"
    />
  </head>
