import{i as E,k as t,D as y}from"./lit-element-D5KKan5q.js";import{u as R,C as N,n as A}from"./provider.component-BaQC7CJH.js";import{B as S}from"./buttonsimple.component-CKyEWPbX.js";import{h as I,a as $}from"./index-CqVtAZCJ.js";import{a as x}from"./buttonsimple.constants-An7St6B1.js";import{T as w,V as O}from"./index-DHsMOcdX.js";import"./index-Dbn_3kMA.js";import{a as n}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{c as _,s as L}from"./commonArgTypes-BluK8w5L.js";import{a as C,t as U}from"./utils-CFOyPOhY.js";import"./keys-hFXe221I.js";import"./DisabledMixin-DcYwkKYf.js";import"./TabIndexMixin-TvgH_pmh.js";import"./roles-CJI3JVG-.js";import"./iframe-BoEDzChW.js";import"../sb-preview/runtime.js";import"./state-C0WmBOuD.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-DWn5NkGG.js";import"./create-context-89xeped_.js";import"./index-DTrDRi1E.js";import"./v4-CQkTLCs1.js";const V=E`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,G=[I,V,...$()],D=R.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:w.BODY_MIDSIZE_REGULAR,TAG_NAME:O.SPAN,SIZE:x[24],ROLE:"button"},M=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.WARNING]:"warning-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled"})[r];var P=Object.defineProperty,T=(r,s,h,F)=>{for(var a=void 0,m=r.length-1,p;m>=0;m--)(p=r[m])&&(a=p(s,h,a)||a);return a&&P(s,h,a),a};const d=class d extends S{constructor(){super(...arguments),this.variant=e.VARIANT,this.label=""}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return t`
      ...
      ${this.label?t`<mdc-text part="label" type="${e.TEXT_TYPE}" tagname="${e.TAG_NAME}"
            >${this.label}</mdc-text
          >`:y}
    `}};d.styles=[...N.styles,...G];let c=d;T([A({type:String})],c.prototype,"variant");T([A({type:String})],c.prototype,"label");c.register(D);const j=r=>t` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
...
}`,...(b=(u=l.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var g,k,f;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:'{\n  render: () => html` <div style="display: flex; gap: 0.5rem;">\n      ${Object.values(VARIANTS).map(variant => html` <mdc-alertchip variant="${variant}" label="${variant}"></mdc-alertchip> `)}\n    </div>`\n}',...(f=(k=i.parameters)==null?void 0:k.docs)==null?void 0:f.source}}};const hr=["Example","AllVariants"];export{i as AllVariants,l as Example,hr as __namedExportsOrder,dr as default};
