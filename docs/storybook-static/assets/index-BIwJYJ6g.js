import"./index-vaVizDGy.js";import"./index-Dc38goqw.js";import{T as C}from"./toggle.constants-BhhTjM0t.js";import{T as i}from"./index-D1yLszQ-.js";import"./index-BKZkjmoV.js";import{i as T,D as o,k as c}from"./lit-element-D5KKan5q.js";import{n as E}from"./index-C9z9WAEj.js";import{R as b}from"./roles-BH_hBfTz.js";import{M as k}from"./menuitem.component-aDaBf8X_.js";import{D as g,I as l,T as A}from"./menuitemcheckbox.constants-Cja4JgF_.js";import{A as e}from"./menusection.constants-CectB7Mc.js";const f=T`
  :host {
...
`,R=[f];var u=Object.defineProperty,p=(d,a,h,L)=>{for(var t=void 0,s=d.length-1,m;s>=0;s--)(m=d[s])&&(t=m(a,h,t)||t);return t&&u(a,h,t),t};const n=class n extends k{constructor(){super(),this.ariaChecked=g.ARIA_CHECKED,this.indicator=g.INDICATOR,this.menuitemcheckboxHandleClick=()=>{if(this.disabled)return;const a=this.ariaChecked===e.TRUE;this.ariaChecked=a?e.FALSE:e.TRUE},this.addEventListener("click",this.menuitemcheckboxHandleClick)}connectedCallback(){super.connectedCallback(),this.role=b.MENUITEMCHECKBOX}staticCheckbox(){return this.indicator!==l.CHECKBOX?o:c`
  ...
  `}staticToggle(){return this.indicator!==l.TOGGLE?o:c`
      <mdc-statictoggle
        ...
        size="${C.COMPACT}"
      ></mdc-statictoggle>
    `}getCheckmarkIcon(){return this.indicator!==l.CHECKMARK||this.ariaChecked===e.FALSE?o:c`
      <mdc-icon
        slot="trailing-controls"
        name="check-bold"
        part="checkmark-icon"
