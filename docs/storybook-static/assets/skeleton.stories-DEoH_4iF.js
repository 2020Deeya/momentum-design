import{u as F,i as q,C,k as c,n as J}from"./iframe-BZIqfezz.js";import{c as Q,s as X}from"./commonArgTypes-BluK8w5L.js";import{t as Y}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";const Z=F.constructTagName("skeleton"),a={BUTTON:"button",CIRCULAR:"circular",RECTANGULAR:"rectangular",ROUNDED:"rounded"},P={VARIANT:a.RECTANGULAR},ee=q`
  :host {
...
`;var te=Object.defineProperty,ne=(e,t,o,n)=>{for(var r=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(r=i(t,o,r)||r);return r&&te(t,o,r),r};const k=class k extends C{constructor(){super(...arguments),this.variant=P.VARIANT}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}firstUpdated(t){super.firstUpdated(t),this.checkSlotContent()}checkSlotContent(){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector("slot");t&&(t.assignedNodes().length>0?this.setAttribute("has-content",""):this.removeAttribute("has-content"))}render(){return c`<slot @slotchange=${this.checkSlotContent}></slot>`}};k.styles=[...C.styles,ee];let v=k;ne([J({type:String,reflect:!0})],v.prototype,"variant");v.register(Z);let d=0;const l=e=>{d+=1;const t=document.getElementById("normal-content-dynamic"),o=document.getElementById("skeleton-content-dynamic");if(!t||!o)return;t.children.length===1&&t.children[0].tagName==="P"&&(t.innerHTML="",o.innerHTML="");let n;switch(e){case"button":n=document.createElement("button"),n.textContent=`Button ${d}`,n.style.cssText=`
      ...
      `;break;default:return}const r=n.cloneNode(!0),s=n.cloneNode(!0),i=()=>{r.remove(),s.remove()};r.onclick=i,s.onclick=i,t.appendChild(r),o.appendChild(s)},re=()=>{const e=document.getElementById("normal-content-dynamic"),t=document.getElementById("skeleton-content-dynamic");e&&t&&(e.innerHTML=`
...
`,pe={title:"Components/skeleton",tags:["autodocs"],component:"mdc-skeleton",render:oe,argTypes:{variant:{control:"select",options:Object.values(a)},...Y(["--mdc-skeleton-background-color","--mdc-skeleton-height","--mdc-skeleton-width"]),...Q,...X}},p={args:{variant:P.VARIANT}},m={args:{variant:a.RECTANGULAR}},u={args:{variant:a.ROUNDED}},x={args:{variant:a.CIRCULAR}},g={args:{variant:a.BUTTON}},b={render:ae,args:{variant:a.RECTANGULAR}},h={render:e=>c`
  ...
  `,args:{variant:a.RECTANGULAR}},y={render:se,args:{variant:a.RECTANGULAR}};var f,A,T;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    variant: DEFAULTS.VARIANT
  }
}`,...(T=(A=p.parameters)==null?void 0:A.docs)==null?void 0:T.source}}};var R,E,N;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    variant: SKELETON_VARIANTS.RECTANGULAR
  }
}`,...(N=(E=m.parameters)==null?void 0:E.docs)==null?void 0:N.source}}};var w,S,$;u.parameters={...u.parameters,docs:{...(w=u.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    variant: SKELETON_VARIANTS.ROUNDED
  }
}`,...($=(S=u.parameters)==null?void 0:S.docs)==null?void 0:$.source}}};var L,U,I;x.parameters={...x.parameters,docs:{...(L=x.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(H=y.parameters)==null?void 0:H.docs)==null?void 0:j.source}}};const me=["Example","Rectangular","Rounded","Circular","Button","WithContent","DynamicContent","ResponsiveContainer"];export{g as Button,x as Circular,h as DynamicContent,p as Example,m as Rectangular,y as ResponsiveContainer,u as Rounded,b as WithContent,me as __namedExportsOrder,pe as default};
