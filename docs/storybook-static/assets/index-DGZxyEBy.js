import{i as c,k as o}from"./lit-element-D5KKan5q.js";import{C as u,n as a}from"./provider.component-BaQC7CJH.js";import{t as f}from"./if-defined-D5BV9-c0.js";import{p as x}from"./index-CbmtUAjA.js";import{R as m}from"./roles-CJI3JVG-.js";import{S as v}from"./sidenavigation.component-CIQen2Pm.js";import{b,T as y}from"./menuitemradio.constants-HxwjPhBY.js";import"./index-B-FpByUM.js";const g=c`
  :host {
    display: flex;
...
`,T=[g];var C=Object.defineProperty,d=(l,e,i,h)=>{for(var t=void 0,s=l.length-1,p;s>=0;s--)(p=l[s])&&(t=p(e,i,t)||t);return t&&C(e,i,t),t};const n=class n extends u{constructor(){super(...arguments),this.ariaLabel=null,this.headerText=null,this.showDivider=!1,this.dividerVariant=b.DIVIDER_VARIANT,this.hideHeaderText=!1,this.sideNavigationContext=x.consume({host:this,context:v.Context})}connectedCallback(){super.connectedCallback(),this.setAttribute("role",m.GROUP)}update(e){var t;super.update(e),(e.has("ariaLabel")||e.has("headerText"))&&(!this.ariaLabel||this.ariaLabel===e.get("headerText"))&&(this.ariaLabel=this.headerText||"");const i=(t=this.sideNavigationContext)==null?void 0:t.value;if(!i)return;const{expanded:h}=i;this.hideHeaderText=!h}renderHeader(){var e,i;return this.headerText?o` <mdc-listheader
