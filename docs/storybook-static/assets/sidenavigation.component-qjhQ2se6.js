...
`,L=[$];var k=Object.defineProperty,c=(m,t,e,i)=>{for(var r=void 0,a=m.length-1,s;a>=0;a--)(s=m[a])&&(r=s(t,e,r)||r);return r&&k(t,e,r),r};const b=class b extends E{constructor(){super({context:d.context,initialValue:new d(u.VARIANT,!0)}),this.variant=u.VARIANT,this.footerText="",this.handleNestedNavMenuItemActiveChange=t=>{var e;if((e=this.context)!=null&&e.value){const i=this.findNav(this.navMenuItems,t.detail.navId);this.context.value.setCurrentActiveNavMenuItem(i)}},this.findNav=(t,e)=>t.find(i=>i.navId===e),this.addEventListener("activechange",this.handleNestedNavMenuItemActiveChange.bind(this))}connectedCallback(){super.connectedCallback(),this.role=I.NAVIGATION}static get Context(){return d.context}updated(t){if(super.updated(t),t.has("variant"))switch(this.setVariant(this.variant),this.variant){case n.FIXED_EXPANDED:this.expanded=!0;break;case n.FIXED_COLLAPSED:this.expanded=!1;break}(t.has("variant")||t.has("expanded"))&&this.updateContext()}firstUpdated(t){super.firstUpdated(t),this.variant===n.FLEXIBLE&&this.expanded===void 0&&(this.expanded=!0,this.updateContext())}updateContext(){(this.context.value.variant!==this.variant||this.context.value.expanded!==this.expanded||this.context.value.parentNavTooltipText!==this.parentNavTooltipText)&&(this.context.value.variant=this.variant,this.context.value.expanded=this.expanded,this.context.value.parentNavTooltipText=this.parentNavTooltipText,this.context.updateObservers())}get navMenuItems(){return Array.from(this.querySelectorAll(`${A}:not([disabled])`))}setVariant(t){this.setAttribute("variant",Object.values(n).includes(t)?t:u.VARIANT)}toggleSideNavigation(){this.expanded=!this.expanded,this.dispatchEvent(new CustomEvent("toggle",{detail:{expanded:this.expanded}}))}preventScrollOnSpace(t){t.key===O.SPACE&&t.preventDefault()}render(){return this.variant===n.HIDDEN?p``:p`
      ...
      ${this.variant===n.FLEXIBLE?p`<mdc-divider
            ...
            variant=${D.GRADIENT}
            arrow-direction=${this.expanded?v.NEGATIVE:v.POSITIVE}
            button-position=${v.POSITIVE}
          >
            <mdc-button
    ...
    `}};b.styles=[...C.styles,...L];let o=b;c([l({type:String,reflect:!0})],o.prototype,"variant");c([l({type:String,reflect:!0,attribute:"footer-text"})],o.prototype,"footerText");c([l({type:Boolean,reflect:!0})],o.prototype,"expanded");c([l({type:String,reflect:!0,attribute:"grabber-btn-aria-label"})],o.prototype,"grabberBtnAriaLabel");c([l({type:String,reflect:!0,attribute:"parent-nav-tooltip-text"})],o.prototype,"parentNavTooltipText");export{o as S};
