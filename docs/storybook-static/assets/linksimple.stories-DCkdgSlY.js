import{L as O,T as _}from"./linksimple.component-DOqnlUy8.js";import{k as L}from"./iframe-1S-3kruQ.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-NbJk3MzI.js";import"./DataAriaLabelMixin-DahwTZAX.js";import"./DisabledMixin-CoPZzXIJ.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
