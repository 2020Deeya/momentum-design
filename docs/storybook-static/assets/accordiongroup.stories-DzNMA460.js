import{S as Y,X as H,E as I,k as g,n as f}from"./iframe-B-ccdKrm.js";import{t as L}from"./if-defined-7Kv2ZD8z.js";import{o as U}from"./query-assigned-elements-uEuc3rg8.js";import{T as K}from"./index-DySCcjpu.js";import{D as d,T as X,a as J,S as i,b as n}from"./accordionbutton.component-BDdz-N2m.js";import"./index-Cqavi-iG.js";import"./index-BxdDkrEE.js";import"./index-DsUeUIv0.js";import{c as P,s as Q}from"./commonArgTypes-BluK8w5L.js";import"./preload-helper-C1FmrZbK.js";import"./base-DIkkzJ-c.js";import"./index-ByxV3AY1.js";import"./button.component-tFE8Qy4X.js";import"./buttonsimple.component-DbIBs-Sd.js";import"./TabIndexMixin-D4qInLKk.js";import"./DisabledMixin-DspPi3Nk.js";import"./button.utils-rNW36Ji7.js";import"./index-Ci0uq2G1.js";import"./index-DTm0XU5m.js";import"./index-DTrDRi1E.js";import"./v4-CmTdKEVZ.js";import"./index-BkffPeCV.js";import"./IconNameMixin-DPW1VKY9.js";import"./index-DQNoijmT.js";import"./chip.component-C6kVH1lc.js";import"./staticchip.component-DnYpHxLJ.js";const tt=Y`
  :host {
...
`,ot=[tt,...H()];var at=Object.defineProperty,s=(o,t,a,l)=>{for(var c=void 0,S=o.length-1,E;S>=0;S--)(E=o[S])&&(c=E(t,a,c)||c);return c&&at(t,a,c),c};const x=class x extends I{constructor(){super(),this.size=d.SIZE,this.variant=d.VARIANT,this.allowMultiple=!1,this.addEventListener("shown",this.handleAccordionExpanded)}handleAccordionExpanded(t){this.allowMultiple||[...this.accordionItems,...this.accordionButtonItems].forEach(a=>{a!==t.target&&a.hasAttribute("expanded")&&a.toggleAttribute("expanded")})}setChildrenAccordionAttributes(t,a){[...this.accordionItems].forEach(l=>{l.setAttribute(t,a)}),[...this.accordionButtonItems].forEach(l=>{l.setAttribute(t,a)})}updated(t){super.updated(t),t.has("size")&&(this.size||(this.size=d.SIZE),this.setChildrenAccordionAttributes("size",this.size)),t.has("variant")&&(this.variant||(this.variant=d.VARIANT),this.setChildrenAccordionAttributes("variant",this.variant))}render(){return g` <slot></slot> `}};x.styles=[...I.styles,...ot];let e=x;s([f({type:String,reflect:!0})],e.prototype,"size");s([f({type:String,reflect:!0})],e.prototype,"variant");s([f({type:Boolean,reflect:!0,attribute:"allow-multiple"})],e.prototype,"allowMultiple");s([U({selector:K})],e.prototype,"accordionItems");s([U({selector:X})],e.prototype,"accordionButtonItems");e.register(J);const r=g`Loreum impusm sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
  ...
  \`
}`,...(F=(W=A.parameters)==null?void 0:W.docs)==null?void 0:F.source}}};const wt=["Example","StackedVariant","ContainedVariant","BorderlessVariant","SmallSize","LargeSize","MultiInteractiveAccordion"];export{h as BorderlessVariant,u as ContainedVariant,m as Example,v as LargeSize,A as MultiInteractiveAccordion,b as SmallSize,p as StackedVariant,wt as __namedExportsOrder,Ct as default};
