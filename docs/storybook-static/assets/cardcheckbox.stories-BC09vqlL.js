import{u as q,S as Q,X as J,W as ee,h as x,k as i,n as Z,V as y}from"./iframe-DmhiQuZU.js";import{D as te}from"./DisabledMixin-Bniru7f_.js";import{T as ae,K as f}from"./TabIndexMixin-JV96JSI7.js";import{C as N}from"./card.component-C61hWn07.js";import"./index-BGJsKC7x.js";import"./index-Cdcr4Qlu.js";import{Q as ie}from"./repeat-6JXCgJ2S.js";import{i as o}from"./imageFixtures-CD4avj2q.js";import{c as re,s as oe}from"./commonArgTypes-BluK8w5L.js";import{a as le,d as ce}from"./utils-Dd_sfl9-.js";import{V as ne,O as E,D as t}from"./FooterMixin-BYp_tHr7.js";import"./index-BsNZb4YV.js";import"./preload-helper-C1FmrZbK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./index-Dpp6LnB6.js";import"./index-DTrDRi1E.js";import"./formfieldwrapper.constants-CCfRA6HA.js";import"./directive-Ctav8iJK.js";import"./link.constants-CgAZktiY.js";import"./index-DuKB7Srz.js";import"./button.component-BEZI7dR8.js";import"./buttonsimple.component-DB9V7EY2.js";import"./button.utils-rNW36Ji7.js";import"./index-CR0Xyaa8.js";import"./if-defined-M-aGcL8O.js";import"./popover.component-CtXrIwgS.js";import"./BackdropMixin-Fv7Uo6bb.js";import"./index-WDcV9CKq.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-53VQiHcg.js";import"./formfieldwrapper.component-Ba6XCZno.js";const se=q.constructTagName("cardcheckbox"),v={DEFAULT:"check-circle-bold",CHECKED:"check-circle-filled"},r={CHECK:"check",CHECKBOX:"checkbox"},T={SELECTION_TYPE:r.CHECK,ICON_SIZE:1.5,ICON_LENGTH_UNIT:"rem"},de=Q`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,me=[de,...J()];var be=Object.defineProperty,W=(e,a,I,pe)=>{for(var l=void 0,A=e.length-1,k;A>=0;A--)(k=e[A])&&(l=k(a,I,l)||l);return l&&be(a,I,l),l};const C=class C extends te(ae(N)){constructor(){super(),this.checked=!1,this.selectionType=T.SELECTION_TYPE,this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=ee.CHECKBOX}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&(this.setAttribute("aria-disabled",`${this.disabled}`),this.tabIndex=this.disabled?-1:0)}toggleChecked(){this.disabled||(this.checked=!this.checked),this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}toggleOnEnter(a){a.key===f.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===f.SPACE&&this.toggleChecked()}renderSelection(){const a=this.checked?v.CHECKED:v.DEFAULT;switch(this.selectionType){case r.CHECK:return i`<mdc-icon
        ...
        ></mdc-staticcheckbox>`;default:return x}}renderHeader(){return this.cardTitle?i`<div part="header">${this.renderIcon()} ${this.renderTitle()} ${this.renderSelection()}</div>`:x}render(){return i`
      ${this.renderImage()}
      <div part="body">
        ${this.renderHeader()}
    ...
    `}};C.styles=[...N.styles,...me];let s=C;W([Z({type:Boolean,reflect:!0})],s.prototype,"checked");W([Z({type:String,attribute:"selection-type",reflect:!0})],s.prototype,"selectionType");s.register(se);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,ue=e=>i` <mdc-cardcheckbox
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
  ...
  >`,ze={title:"Components/card/cardcheckbox",tags:["autodocs"],component:"mdc-cardcheckbox",render:ue,argTypes:{variant:{control:"select",options:Object.values(ne)},orientation:{control:"select",options:Object.values(E)},"card-title":{control:"text"},subtitle:{control:"text"},"image-src":{control:"text"},"image-alt":{control:"text"},"icon-name":{control:"text"},checked:{control:"boolean"},disabled:{control:"boolean"},tabIndex:{control:"number"},"aria-label":{control:"text"},"selection-type":{control:"select",options:Object.values(r)},"title-tag-name":{control:"select",options:Object.values(y)},"subtitle-tag-name":{control:"select",options:Object.values(y)},...le(["children"]),...re,...oe}},c=i`<mdc-text slot="body" type="body-midsize-medium" tagname="span"
...
}`,...(j=(z=g.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};const je=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInCheckboxGroup"];export{u as CardWithoutBody,b as CardWithoutImage,g as CardsInCheckboxGroup,h as ContentAfterBody,p as ContentBeforeBody,d as Example,m as HorizontalCard,je as __namedExportsOrder,ze as default};
