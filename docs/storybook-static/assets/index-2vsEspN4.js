import{i as h,k as g}from"./lit-element-D5KKan5q.js";import{n as u}from"./property-Bj3TGwkg.js";import{r as b}from"./state-CmYk530Z.js";import{u as v,C as m}from"./provider.component-DrWB4byV.js";import{h as E}from"./index-CqVtAZCJ.js";import"./index-g4PC2eax.js";const _=v.constructTagName("presence"),e={ACTIVE:"active",AWAY:"away",AWAY_CALLING:"away-calling",BUSY:"busy",DND:"dnd",MEETING:"meeting",ON_CALL:"on-call",ON_DEVICE:"on-device",ON_MOBILE:"on-mobile",PAUSE:"pause",PTO:"pto",PRESENTING:"presenting",QUIET:"quiet",SCHEDULED:"scheduled"},c={24:24,32:32,48:48,64:64,72:72,88:88,124:124},s={TYPE:e.ACTIVE,SIZE:c[32]},k=[E,h`
    :host {
  ...
  `],y=o=>{switch(o){case e.AWAY:return"recents-presence-badge-filled";case e.AWAY_CALLING:return"away-calling-presence-filled";case e.BUSY:return"busy-presence-bold";case e.DND:return"dnd-presence-badge-filled";case e.MEETING:return"camera-filled";case e.ON_CALL:return"handset-filled";case e.ON_DEVICE:return"generic-device-video-badge-filled";case e.ON_MOBILE:return"phone-badge-filled";case e.PAUSE:return"pause-badge-filled";case e.PTO:return"pto-presence-filled";case e.PRESENTING:return"share-screen-badge-filled";case e.QUIET:return"quiet-hours-presence-filled";case e.SCHEDULED:return"meetings-presence-badge-filled";case e.ACTIVE:default:return"active-presence-small-filled"}},f=o=>({[c[124]]:2.25,[c[88]]:1.625,[c[72]]:1.3125,[c[64]]:1.1875,[c[48]]:.875,[c[32]]:.875,[c[24]]:.875})[o]||.875;var I=Object.defineProperty,d=(o,r,l,T)=>{for(var n=void 0,a=o.length-1,p;a>=0;a--)(p=o[a])&&(n=p(r,l,n)||n);return n&&I(r,l,n),n};const i=class i extends m{constructor(){super(...arguments),this.type=s.TYPE,this.size=s.SIZE,this.currentIconType=s.TYPE}update(r){super.update(r),r.has("size")&&this.setSize(this.size)}setSize(r){this.setAttribute("size",Object.values(c).includes(r)?`${r}`:s.SIZE.toString())}get icon(){const r=y(this.type);return r==="active-presence-small-filled"&&(this.type=s.TYPE),r}handleOnLoad(){this.currentIconType=this.type}handleOnError(){this.onerror&&this.onerror("There was a problem while fetching the icon. Please check the icon name and try again.")}render(){return g`
    ...
    `}};i.styles=[...m.styles,...k];let t=i;d([u({type:String,reflect:!0})],t.prototype,"type");d([u({type:Number,reflect:!0})],t.prototype,"size");d([b()],t.prototype,"currentIconType");t.register(_);export{s as D,e as P,c as a};
