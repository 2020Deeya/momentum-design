import{s as c}from"./chunk-L4EGOTBX-9DS_KiQO.js";import"./entry-preview-BI3Ia3go.js";import{k as p}from"./lit-element-D5KKan5q.js";import"./index-p76AQOEb.js";import"./index-CymK7bIw.js";import"./directive-helpers-Bb6vhctq.js";import"./index-DrFu-skq.js";import"./index-C9z9WAEj.js";import"./state-CSSggq2n.js";import"./create-context-89xeped_.js";import"./iconprovider.component-Bvm-70EG.js";const m="1.0.0",h="",u=[{kind:"javascript-module",path:"components/alertchip/alertchip.component.js",declarations:[{kind:"class",description:`mdc-alertchip component is an interactive chip that consumers can use to represent an alert.
...
For example: \`aria-pressed,aria-expanded\``,default:"'aria-pressed'",attribute:"ariaStateKey",reflects:!0,inheritedFrom:{name:"Buttonsimple",module:"components/buttonsimple/buttonsimple.component.js"}},{kind:"field",name:"type",type:{text:"ButtonType"},description:`This property defines the type attribute for the button element.
...
In case multiple aria attributes should be toggled, they can be passed in as
a comma separated string.
For example: \`aria-pressed,aria-expanded\``,default:"'aria-pressed'",fieldName:"ariaStateKey",inheritedFrom:{name:"Buttonsimple",module:"src/components/buttonsimple/buttonsimple.component.ts"}},{name:"type",type:{text:"ButtonType"},description:`This property defines the type attribute for the button element.
The type attribute specifies the behavior of the button when it is clicked.
- **submit**: The button submits the form data to the server.
- **reset**: The button resets the form data to its initial state.
...
The error detail is set to the error object.`}],events:[{description:"(React: onLoad) This event is dispatched when the brandvisual has been successfully loaded.",name:"load",reactName:"onLoad"},{description:"(React: onError) This event is dispatched when the brandvisual fetching has failed.",name:"error",reactName:"onError"}],attributes:[{name:"name",type:{text:"BrandVisualNames | undefined"},description:"Name of the brandVisual (= filename)",fieldName:"name"}],superclass:{name:"Component",module:"/src/models"},tagName:"mdc-brandvisual",jsDoc:`/**
...
The type of button is inferred based on the presence of slot and/or prefix and postfix icons.`,name:"Button",slots:[{description:"Text label of the button.",name:""}],members:[{kind:"field",name:"prefixIcon",type:{text:"IconNames | undefined"},description:`The name of the icon to display as a prefix.
...
If the key is 'Space', the button's default is prevent to avoid scrolling etc in the host application.`,inheritedFrom:{name:"Buttonsimple",module:"components/buttonsimple/buttonsimple.component.js"}},{kind:"method",name:"handleKeyUp",privacy:"private",parameters:[{name:"event",type:{text:"KeyboardEvent"},description:"The keyboard event."}],description:`Handles the keyup event on the button.
If the key is 'Enter' or 'Space', the button is clicked.
If the key is 'Space', the button is pressed. The native HTML button works in the same way.`,inheritedFrom:{name:"Buttonsimple",module:"components/buttonsimple/buttonsimple.component.js"}}],attributes:[{name:"prefix-icon",type:{text:"IconNames | undefined"},description:`The name of the icon to display as a prefix.
...
**Important:** When using soft disabled, consumers must ensure that
the button behaves like a disabled button, allowing only focus and
preventing any interactions (clicks or keyboard actions) from triggering unintended actions.`,default:"undefined",attribute:"soft-disabled"},{kind:"field",name:"size",type:{text:"ButtonSize"},description:"Simplebutton size is a super set of all the sizes supported by children components.",default:"32",attribute:"size",reflects:!0},{kind:"field",name:"role",description:`This property defines the ARIA role for the element. By default, it is set to 'button'.
Consumers should override this role when:
- The element is being used in a context where a different role is more appropriate.
- Custom behaviors are implemented that require a specific ARIA role for accessibility purposes.`,default:"button",attribute:"role",reflects:!0},{kind:"field",name:"ariaStateKey",description:`This property defines the ARIA state key, which will be toggled when the
Button is set to \`active\`.
The default value is 'aria-pressed', which is commonly used for toggle buttons.
...
In case multiple aria attributes should be toggled, they can be passed in as
a comma separated string.
For example: \`aria-pressed,aria-expanded\``,default:"'aria-pressed'",attribute:"ariaStateKey",reflects:!0},{kind:"field",name:"type",type:{text:"ButtonType"},description:`This property defines the type attribute for the button element.
The type attribute specifies the behavior of the button when it is clicked.
- **submit**: The button submits the form data to the server.
- **reset**: The button resets the form data to its initial state.
...
Consumers should override this role when:
- The element is being used in a context where a different role is more appropriate.
- Custom behaviors are implemented that require a specific ARIA role for accessibility purposes.`,default:"button",fieldName:"role"},{name:"ariaStateKey",description:`This property defines the ARIA state key, which will be toggled when the
Button is set to \`active\`.
The default value is 'aria-pressed', which is commonly used for toggle buttons.
...
In case multiple aria attributes should be toggled, they can be passed in as
a comma separated string.
For example: \`aria-pressed,aria-expanded\``,default:"'aria-pressed'",fieldName:"ariaStateKey"},{name:"type",type:{text:"ButtonType"},description:`This property defines the type attribute for the button element.
The type attribute specifies the behavior of the button when it is clicked.
- **submit**: The button submits the form data to the server.
- **reset**: The button resets the form data to its initial state.
...
and dispatch the new change event.`},{kind:"field",name:"renderLabelAndHelperText",privacy:"private"},{kind:"field",name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
 ...
 *
 */`,customElement:!0,cssProperties:[{description:"The color of the chip.",name:"--mdc-chip-color",inheritedFrom:{name:"Chip",module:"src/components/chip/chip.component.ts"}},{description:"The border color of the chip.",name:"--mdc-chip-border-color",inheritedFrom:{name:"Chip",module:"src/components/chip/chip.component.ts"}},{description:"The background color of the chip.",name:"--mdc-chip-background-color",inheritedFrom:{name:"Chip",module:"src/components/chip/chip.component.ts"}}],events:[{description:"(React: onClick) This event is dispatched when the button is clicked.",name:"click",reactName:"onClick",inheritedFrom:{name:"Buttonsimple",module:"src/components/buttonsimple/buttonsimple.component.ts"}},{description:"(React: onKeyDown) This event is dispatched when a key is pressed down on the button.",name:"keydown",reactName:"onKeyDown",inheritedFrom:{name:"Buttonsimple",module:"src/components/buttonsimple/buttonsimple.component.ts"}},{description:"(React: onKeyUp) This event is dispatched when a key is released on the button.",name:"keyup",reactName:"onKeyUp",inheritedFrom:{name:"Buttonsimple",module:"src/components/buttonsimple/buttonsimple.component.ts"}},{description:"(React: onFocus) This event is dispatched when the button receives focus.",name:"focus",reactName:"onFocus",inheritedFrom:{name:"Buttonsimple",module:"src/components/buttonsimple/buttonsimple.component.ts"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"FilterChip",module:"components/filterchip/filterchip.component.js"}}]},{kind:"javascript-module",path:"components/formfieldgroup/formfieldgroup.component.js",declarations:[{kind:"class",description:`\`mdc-formfieldgroup\` component, groups the form field components together.
...
If no icon name is provided, no icon will be rendered.`},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",attribute:"disabled",reflects:!0,inheritedFrom:{name:"DisabledMixin",module:"utils/mixins/DisabledMixin.js"}},{kind:"field",name:"iconName",type:{text:"IconNames | undefined"},description:"Name of the icon (= filename).\n\nIf no `icon-name` is provided, no icon will be rendered.",attribute:"icon-name",inheritedFrom:{name:"IconNameMixin",module:"utils/mixins/IconNameMixin.js"}}],attributes:[{name:"inline",type:{text:"boolean"},description:"The link can be inline or standalone.",default:"false",fieldName:"inline"},{name:"inverted",type:{text:"boolean"},description:"The link color can be inverted by setting the inverted attribute to true.",default:"false",fieldName:"inverted"},{name:"size",type:{text:"LinkSize"},description:`Size of the link.
Acceptable values include:

- 'small'
- 'midsize'
- 'large'`,default:"large",fieldName:"size"},{name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",fieldName:"disabled",inheritedFrom:{name:"DisabledMixin",module:"src/utils/mixins/DisabledMixin.ts"}},{name:"icon-name",type:{text:"IconNames | undefined"},description:"Name of the icon (= filename).\n\nIf no `icon-name` is provided, no icon will be rendered.",fieldName:"iconName",inheritedFrom:{name:"IconNameMixin",module:"src/utils/mixins/IconNameMixin.ts"}}],mixins:[{name:"DisabledMixin",module:"/src/utils/mixins/DisabledMixin"},{name:"IconNameMixin",module:"/src/utils/mixins/IconNameMixin"}],superclass:{name:"Component",module:"/src/models"},tagName:"mdc-link",jsDoc:`/**
...
This is useful when the list item is disabled, to prevent the user from interacting with the controls.`},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",attribute:"disabled",reflects:!0,inheritedFrom:{name:"DisabledMixin",module:"utils/mixins/DisabledMixin.js"}},{kind:"field",name:"tabIndex",type:{text:"number"},default:"0",description:"This property specifies the tab order of the element.",attribute:"tabIndex",reflects:!0,inheritedFrom:{name:"TabIndexMixin",module:"utils/mixins/TabIndexMixin.js"}}],events:[{description:"(React: onClick) This event is dispatched when the listitem is clicked.",name:"click",reactName:"onClick"},{description:"(React: onKeyDown) This event is dispatched when a key is pressed down on the listitem.",name:"keydown",reactName:"onKeyDown"},{description:"(React: onKeyUp) This event is dispatched when a key is released on the listitem.",name:"keyup",reactName:"onKeyUp"},{description:"(React: onFocus) This event is dispatched when the listitem receives focus.",name:"focus",reactName:"onFocus"}],attributes:[{name:"variant",type:{text:"ListItemVariants"},description:"The variant of the list item. It can be a pill, rectangle or a full-width.",default:"'full-width'",fieldName:"variant"},{name:"label",type:{text:"string | undefined"},description:`The primary label of the list item.
...
They are used to group elements in a form together.`,attribute:"name",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",attribute:"value",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validationMessage",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",attribute:"validation-message",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validity",type:{text:"ValidityState"},readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"willValidate",readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"setValidity",description:"Sets the validity of the input field based on the input field's validity.",return:{type:{text:""}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"checkValidity",return:{type:{text:"boolean"}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"reportValidity",inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"ListItem",module:"components/listitem/listitem.component.js"}},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
...
This appears on the trailing side of the list item.`,attribute:"subline-text",reflects:!0,inheritedFrom:{name:"ListItem",module:"components/listitem/listitem.component.js"}},{kind:"method",name:"getText",privacy:"protected",return:{type:{text:""}},parameters:[{name:"slotName",type:{text:"string"},description:"The name of the slot to be used."},{name:"type",type:{text:"TextType"},description:"The type of the text element."},{name:"content",optional:!0,type:{text:"string"},description:"The text content to be displayed within the slot."}],description:"Generates a template for a text slot with the specified content.",inheritedFrom:{name:"ListItem",module:"components/listitem/listitem.component.js"}},{kind:"method",name:"disableSlottedChildren",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"disabled",type:{text:"boolean"},description:"Whether to disable or enable the controls."}],description:`Disable or enable all slotted elements in the leading and trailing slots.
This is useful when the list item is disabled, to prevent the user from interacting with the controls.`,inheritedFrom:{name:"ListItem",module:"components/listitem/listitem.component.js"}}],events:[{description:"(React: onClick) This event is dispatched when the option is clicked.",name:"click",reactName:"onClick",inheritedFrom:{name:"ListItem",module:"src/components/listitem/listitem.component.ts"}},{description:"(React: onKeyDown) This event is dispatched when a key is pressed down on the option.",name:"keydown",reactName:"onKeyDown",inheritedFrom:{name:"ListItem",module:"src/components/listitem/listitem.component.ts"}},{description:"(React: onKeyUp) This event is dispatched when a key is released on the option.",name:"keyup",reactName:"onKeyUp",inheritedFrom:{name:"ListItem",module:"src/components/listitem/listitem.component.ts"}},{description:"(React: onFocus) This event is dispatched when the option receives focus.",name:"focus",reactName:"onFocus",inheritedFrom:{name:"ListItem",module:"src/components/listitem/listitem.component.ts"}}],attributes:[{name:"selected",type:{text:"boolean"},default:"false",description:"The selected attribute is used to indicate that the option is selected.",fieldName:"selected"},{name:"prefix-icon",type:{text:"IconNames | undefined"},description:"The prefix icon attribute is used to display the icon name on the left of the option label.",fieldName:"prefixIcon"},{name:"aria-label",type:{text:"string | null"},default:"null",description:"Any additional description can be provided here for screen readers.",fieldName:"ariaLabel"},{name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,fieldName:"name",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",fieldName:"value",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"validation-message",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",fieldName:"validationMessage",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"data-aria-label",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,fieldName:"dataAriaLabel",inheritedFrom:{name:"ListItem",module:"src/components/listitem/listitem.component.ts"}},{name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
...
If true, focus will be restricted to the content within this component.`,default:"false",attribute:"enabledFocusTrap",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"field",name:"enabledPreventScroll",type:{text:"boolean"},description:"Prevent outside scrolling when popover show.",default:"false",attribute:"enabledPreventScroll",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"field",name:"shouldWrapFocus",type:{text:"() => boolean"},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"deactivateFocusTrap",description:"Deactivate the focus trap.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"hasNoClientRects",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element has no client rectangles (not visible in the viewport).",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"hasZeroDimensions",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element has zero dimensions (width and height are both 0).",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"isNotVisible",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Determines if the element is not visible in the DOM.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"hasHiddenStyle",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element has inline styles that make it hidden.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"hasComputedHidden",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element is hidden by a computed style.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"isHidden",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element is hidden from the user.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"isNotTabbable",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element is not tabbable.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"isInteractiveElement",privacy:"private",return:{type:{text:""}},parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element is interactive.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"isFocusable",privacy:"private",parameters:[{name:"element",type:{text:"HTMLElement"},description:"The element to check."}],description:"Checks if the element is focusable.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"findFocusable",privacy:"private",return:{type:{text:""}},parameters:[{name:"root",type:{text:"ShadowRoot | HTMLElement"},description:"The root element to search for focusable elements."},{name:"matches",default:"new Set()",type:{text:"Set<HTMLElement>"},description:"The set of focusable elements."}],description:"Recursively finds all focusable elements within the given root and its descendants.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"setFocusableElements",privacy:"public",description:"Updates the list of focusable elements within the component's shadow root.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"setInitialFocus",privacy:"public",parameters:[{name:"prefferableElement",default:"0",type:{text:"number"},description:"The index of the prefferable element to focus."}],description:"Sets the initial focus within the container.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"calculateNextIndex",privacy:"private",parameters:[{name:"currentIndex",type:{text:"number"},description:"The current index."},{name:"step",type:{text:"number"},description:"The step to calculate the next index."}],description:"Calculates the next index for the focus trap.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"getDeepActiveElement",privacy:"private",description:"Returns the deepest active element in the shadow DOM.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"findElement",privacy:"private",parameters:[{name:"activeElement",type:{text:"HTMLElement"},description:"The active element."}],description:"Finds the index of the active element within the focusable elements.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"isEqualFocusNode",privacy:"private",parameters:[{name:"activeElement",type:{text:"HTMLElement"},description:"The active element."},{name:"element",type:{text:"HTMLElement"},description:"The element to compare."}],description:"Checks if the active element is equal to the given element.",return:{type:{text:""}},inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"trapFocus",privacy:"private",parameters:[{name:"direction",type:{text:"boolean"},description:`The direction of the focus trap.
If true, the focus will be trapped in the previous element.`}],description:"Traps focus within the container.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}},{kind:"method",name:"handleKeydown",privacy:"private",parameters:[{name:"event",type:{text:"KeyboardEvent"},description:"The keyboard event."}],description:"Traps focus within the container.",inheritedFrom:{name:"FocusTrapMixin",module:"utils/mixins/FocusTrapMixin.js"}}],events:[{description:"(React: onShown) This event is dispatched when the popover is shown",name:"shown",reactName:"onShown"},{description:"(React: onHidden) This event is dispatched when the popover is hidden",name:"hidden",reactName:"onHidden"},{description:"(React: onCreated) This event is dispatched when the popover is created (added to the DOM)",name:"created",reactName:"onCreated"},{description:"(React: onDestroyed) This event is dispatched when the popover is destroyed (removed from the DOM)",name:"destroyed",reactName:"onDestroyed"}],attributes:[{name:"id",type:{text:"string"},default:"''",description:"The unique ID of the popover.",fieldName:"id"},{name:"triggerID",type:{text:"string"},default:"''",description:`The ID of the element that triggers the popover.
...
This component is created by extending FormfieldWrapper.`,name:"Progressbar",cssProperties:[{description:"Background color of the progressbar when inactive.",name:"--mdc-progressbar-default-background-color"},{description:"Background color of the progressbar when active.",name:"--mdc-progressbar-default-active-background-color"},{description:"Background color of the progressbar when in success state.",name:"--mdc-progressbar-success-background-color"},{description:"Background color of the progressbar when in error state.",name:"--mdc-progressbar-error-background-color"},{description:"The height of the progressbar.",name:"--mdc-progressbar-height"},{description:"The border radius of the progressbar.",name:"--mdc-progressbar-border-radius"},{description:"Color of the progressbar label text.",name:"--mdc-progressbar-label-color"},{description:"Line height of the label text.",name:"--mdc-progressbar-label-lineheight"},{description:"Font size of the label text.",name:"--mdc-progressbar-label-fontsize"},{description:"Font weight of the label text.",name:"--mdc-progressbar-label-fontweight"},{description:"Color of the help text.",name:"--mdc-progressbar-help-text-color"}],members:[{kind:"field",name:"variant",type:{text:"Variant"},description:`Types of the progressbar
- **Default**
...
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",fieldName:"disabled",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",fieldName:"label",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"required-label",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
the input field is marked as required and the label is appended with this text.`,fieldName:"requiredLabel",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"id",type:{text:"string"},default:"''",description:"The unique id of the input field. It is used to link the input field with the label.",fieldName:"id",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"help-text-type",type:{text:"ValidationType"},description:"The type of help text. It can be 'default', 'error', 'warning', 'success', 'priority'.",fieldName:"helpTextType",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"help-text",type:{text:"string | undefined"},description:"The help text that is displayed below the input field.",fieldName:"helpText",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}}],slots:[{description:"slot to add the label info icon",name:"label-info",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}}]}],exports:[{kind:"js",name:"default",declaration:{name:"Progressspinner",module:"components/progressspinner/progressspinner.component.js"}}]},{kind:"javascript-module",path:"components/radio/radio.component.js",declarations:[{kind:"class",description:`Radio allow users to select single options from a list or turn an item/feature on or off.
...
If no radio group is checked, the first enabled radio will have a tab index of 0`},{kind:"field",name:"renderLabelAndHelperText",privacy:"private"},{kind:"field",name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,attribute:"name",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",attribute:"value",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validationMessage",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",attribute:"validation-message",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validity",type:{text:"ValidityState"},readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"willValidate",readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"setValidity",description:"Sets the validity of the input field based on the input field's validity.",return:{type:{text:""}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"checkValidity",return:{type:{text:"boolean"}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"reportValidity",inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",attribute:"disabled",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",attribute:"label",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"requiredLabel",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
...
id is used to link the label with the input field.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderRequiredLabel",privacy:"protected",inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpTextIcon",privacy:"protected",description:`creates the helpertext icon based on the helpTextType for validation.
If the helpTextType is not set, it defaults to 'default' and it doesn't display any icon.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpText",privacy:"protected",description:`creates the helper text component when the helpertext value is set.
It is also used to display the validation message based on the helpTextType.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderLabel",privacy:"protected",description:"renders the mdc-label-text container that contains the label and labelInfoToggleTip.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelperText",privacy:"protected",description:"renders the mdc-help-text container that contains the helpertext icon and helpertext.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}}],events:[{type:{text:"EventConstructor"}},{description:"(React: onChange) Event that gets dispatched when the radio state changes.",name:"change",reactName:"onChange"},{description:"(React: onFocus) Event that gets dispatched when the radio receives focus.",name:"focus",reactName:"onFocus"}],attributes:[{name:"checked",type:{text:"boolean"},default:"false",description:"Determines whether the radio is selected or unselected.",fieldName:"checked"},{name:"readonly",type:{text:"boolean"},default:"false",description:"Determines whether the radio is read-only.",fieldName:"readonly"},{name:"autofocus",type:{text:"boolean"},default:"false",description:`Automatically focus on the element when the page loads.
[MDN Reference](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/autofocus)`,fieldName:"autofocus"},{name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,fieldName:"name",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",fieldName:"value",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"validation-message",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",fieldName:"validationMessage",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"data-aria-label",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,fieldName:"dataAriaLabel",inheritedFrom:{name:"DataAriaLabelMixin",module:"src/utils/mixins/DataAriaLabelMixin.ts"}},{name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",fieldName:"disabled",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",fieldName:"label",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"required-label",type:{text:"string | undefined"},description:`The required label of the input field.
...
Specifies the width of the input field.`,default:"undefined",attribute:"size",inheritedFrom:{name:"Input",module:"components/input/input.component.js"}},{kind:"field",name:"clearAriaLabel",type:{text:"string"},default:"''",description:"Aria label for the trailing button. If trailing button is set to true, this label is used for the clear button.",attribute:"clear-aria-label",inheritedFrom:{name:"Input",module:"components/input/input.component.js"}},{kind:"method",name:"handleValueChange",description:`Handles the value change of the input field.
Sets the form value and updates the validity of the input field.`,return:{type:{text:""}},inheritedFrom:{name:"Input",module:"components/input/input.component.js"}},{kind:"method",name:"setInputValidity",privacy:"private",inheritedFrom:{name:"Input",module:"components/input/input.component.js"}},{kind:"method",name:"updateValue",privacy:"private",description:`Updates the value of the input field.
...
id is used to link the label with the input field.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderRequiredLabel",privacy:"protected",inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpTextIcon",privacy:"protected",description:`creates the helpertext icon based on the helpTextType for validation.
If the helpTextType is not set, it defaults to 'default' and it doesn't display any icon.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpText",privacy:"protected",description:`creates the helper text component when the helpertext value is set.
It is also used to display the validation message based on the helpTextType.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderLabel",privacy:"protected",description:"renders the mdc-label-text container that contains the label and labelInfoToggleTip.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelperText",privacy:"protected",description:"renders the mdc-help-text container that contains the helpertext icon and helpertext.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}}],superclass:{name:"Input",module:"/src/components/input/input.component"},tagName:"mdc-searchfield",jsDoc:`/**
 ...
 *
 */`,customElement:!0,attributes:[{name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,fieldName:"name",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",fieldName:"value",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"validation-message",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",fieldName:"validationMessage",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"data-aria-label",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
...
- ARROW_DOWN, ARROW_UP, PAGE_DOWN, PAGE_UP: Handles navigation between options.`},{kind:"method",name:"handlePopoverOnClose",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"event",type:{text:"KeyboardEvent"},description:"The keyboard event."}],description:`Handles the keydown event on the select element when the popover is closed.
The options are as follows:
...
- END: Opens the popover and sets focus and tabindex on the last option.`},{kind:"method",name:"handleOptionsNavigation",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"event",type:{text:"KeyboardEvent"},description:"The keyboard event that triggered the navigation."}],description:`Handles the navigation of options when the user presses
ArrowUp, ArrowDown, PageUp, or PageDown keys.`},{kind:"method",name:"getNewIndexBasedOnKey",privacy:"private",return:{type:{text:""}},parameters:[{name:"key",type:{text:"string"},description:"The navigation key that was pressed."},{name:"currentIndex",type:{text:"number"},description:"The current index of the focused option."},{name:"optionsLength",type:{text:"number"},description:"The total number of options."}],description:`Calculates the new index based on the pressed navigation key.
...
- PageUp: Moves focus 10 options up or to the first option.`},{kind:"method",name:"updateActivedescendant",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"target",type:{text:"EventTarget | null"}}]},{kind:"method",name:"resetActivedescendant",privacy:"private",return:{type:{text:"void"}}},{kind:"method",name:"setFocusAndTabIndex",privacy:"private",return:{type:{text:"void"}},parameters:[{name:"newIndex",type:{text:"number"}}]},{kind:"method",name:"openPopover",privacy:"private",return:{type:{text:"void"}}},{kind:"method",name:"closePopover",privacy:"private",return:{type:{text:"void"}}},{kind:"method",name:"getNativeSelect",privacy:"private",return:{type:{text:""}},description:`Generates the native select element.
...
Instead, the overlay uses the native select element to generate the list of options.`},{kind:"method",name:"getOptionsContentFromSlot",privacy:"private",return:{type:{text:""}},description:"This method maps over all valid options and constructs their corresponding\nHTML `<option>` elements. The attributes such as `value`, `label`, `disabled`,\nand `selected` are extracted from the respective option elements.\nIf the attribute is not present, a default value or fallback is used.\nThe content of each `<option>` is set to the text content of the option element."},{kind:"method",name:"getPopoverContent",privacy:"private",return:{type:{text:"TemplateResult | typeof nothing"}},description:"Generates the content for the popover associated with the select component.\nIf the component is disabled or readonly, returns `nothing`.\nOtherwise, returns a `TemplateResult` that renders a popover with various configurations\nsuch as visibility, interaction, and event handlers.\nThe popover acts as a dropdown list with options, allowing user interaction."},{kind:"field",name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,attribute:"name",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",attribute:"value",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validationMessage",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",attribute:"validation-message",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validity",type:{text:"ValidityState"},readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"willValidate",readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"setValidity",description:"Sets the validity of the input field based on the input field's validity.",return:{type:{text:""}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"checkValidity",return:{type:{text:"boolean"}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"reportValidity",inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",attribute:"disabled",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",attribute:"label",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"requiredLabel",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
...
id is used to link the label with the input field.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderRequiredLabel",privacy:"protected",inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpTextIcon",privacy:"protected",description:`creates the helpertext icon based on the helpTextType for validation.
If the helpTextType is not set, it defaults to 'default' and it doesn't display any icon.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelpText",privacy:"protected",description:`creates the helper text component when the helpertext value is set.
It is also used to display the validation message based on the helpTextType.`,return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderLabel",privacy:"protected",description:"renders the mdc-label-text container that contains the label and labelInfoToggleTip.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"method",name:"renderHelperText",privacy:"protected",description:"renders the mdc-help-text container that contains the helpertext icon and helpertext.",return:{type:{text:""}},inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}}],events:[{name:"change",type:{text:"CustomEvent"},description:"(React: onChange) This event is dispatched when the select is changed.",reactName:"onChange"},{description:"(React: onClick) This event is dispatched when the select is clicked.",name:"click",reactName:"onClick"},{description:"(React: onKeyDown) This event is dispatched when a key is pressed down on the select.",name:"keydown",reactName:"onKeyDown"},{description:"(React: onFocus) This event is dispatched when the select receives focus.",name:"focus",reactName:"onFocus"}],attributes:[{name:"placeholder",type:{text:"string | undefined"},description:"The placeholder text which will be shown on the text if provided.",fieldName:"placeholder"},{name:"readonly",type:{text:"boolean"},default:"false",description:"readonly attribute of the select field. If true, the select is read-only.",fieldName:"readonly"},{name:"height",type:{text:"string"},default:"'auto'",description:`height attribute of the select field. If set,
then a scroll bar will be visible when there more options than the adjusted height.`,fieldName:"height"},{name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,fieldName:"name",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",fieldName:"value",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"validation-message",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",fieldName:"validationMessage",inheritedFrom:{name:"FormInternalsMixin",module:"src/utils/mixins/FormInternalsMixin.ts"}},{name:"data-aria-label",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,fieldName:"dataAriaLabel",inheritedFrom:{name:"DataAriaLabelMixin",module:"src/utils/mixins/DataAriaLabelMixin.ts"}},{name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",fieldName:"disabled",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",fieldName:"label",inheritedFrom:{name:"FormfieldWrapper",module:"src/components/formfieldwrapper/formfieldwrapper.component.ts"}},{name:"required-label",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
 ...
 */`,customElement:!0}],exports:[{kind:"js",name:"default",declaration:{name:"Select",module:"components/select/select.component.js"}}]},{kind:"javascript-module",path:"components/spinner/spinner.component.js",declarations:[{kind:"class",description:`\`mdc-spinner\` is loading spinner which is an indeterminate progress indicator, meaning
...
The 'change' event does not bubble up through the shadow DOM as it was not composed.
Therefore, we need to re-dispatch the same event to ensure it is propagated correctly.
Read more: https://developer.mozilla.org/en-US/docs/Web/API/Event/composed`},{kind:"method",name:"renderCharacterCounter",privacy:"protected"},{kind:"method",name:"renderTextareaFooter",privacy:"protected"},{kind:"field",name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,attribute:"name",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",attribute:"value",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validationMessage",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",attribute:"validation-message",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validity",type:{text:"ValidityState"},readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"willValidate",readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"setValidity",description:"Sets the validity of the input field based on the input field's validity.",return:{type:{text:""}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"checkValidity",return:{type:{text:"boolean"}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"reportValidity",inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",attribute:"disabled",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",attribute:"label",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"requiredLabel",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
...
it defaults to the value specified in DEFAULTS.SIZE.`},{kind:"field",name:"name",type:{text:"string"},default:"''",description:`Indicates the name of the component group.
They are used to group elements in a form together.`,attribute:"name",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"value",type:{text:"string"},default:"''",description:"Indicates the value of the component group (ex: input, checkbox, radio, select etc...)",attribute:"value",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validationMessage",type:{text:"string | undefined"},description:"Custom validation message that will override the default message and displayed when the input is invalid.",attribute:"validation-message",reflects:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"validity",type:{text:"ValidityState"},readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"willValidate",readonly:!0,inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"setValidity",description:"Sets the validity of the input field based on the input field's validity.",return:{type:{text:""}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"checkValidity",return:{type:{text:"boolean"}},inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"method",name:"reportValidity",inheritedFrom:{name:"FormInternalsMixin",module:"utils/mixins/FormInternalsMixin.js"}},{kind:"field",name:"dataAriaLabel",type:{text:"string | null"},default:"null",description:`Defines a string value that labels the current element.
The Aria-Label attribute to be set for accessibility.`,attribute:"data-aria-label",reflects:!0,inheritedFrom:{name:"DataAriaLabelMixin",module:"utils/mixins/DataAriaLabelMixin.js"}},{kind:"field",name:"disabled",type:{text:"boolean | undefined"},description:`Indicates whether the component is disabled.
When the component is disabled for user interaction; it is not focusable or clickable.`,default:"undefined",attribute:"disabled",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"label",type:{text:"string | undefined"},description:"The label of the input field. It is linked to the input field using the `for` attribute.",attribute:"label",reflects:!0,inheritedFrom:{name:"FormfieldWrapper",module:"components/formfieldwrapper/formfieldwrapper.component.js"}},{kind:"field",name:"requiredLabel",type:{text:"string | undefined"},description:`The required label of the input field.
When an appropriate string value is set,
