import"./index-YmzihkB2.js";import{k as n}from"./iframe-xJvWfTzZ.js";import{c as R,s as O}from"./commonArgTypes-BluK8w5L.js";import{a as E}from"./utils-Dd_sfl9-.js";import"./index-Bk5fWp_B.js";import{P as W,S as D}from"./popover.component-JAlOViKa.js";import"./index-BbYB32IG.js";import"./preload-helper-C1FmrZbK.js";import"./index-DzxFCTYp.js";import"./index-DTrDRi1E.js";import"./index-TelUOFoz.js";import"./DisabledMixin-Dw5Pn0Dw.js";import"./index-DK8-LS-B.js";import"./v4-CmTdKEVZ.js";import"./if-defined-GCyvQTHu.js";import"./formfieldwrapper.component-BIugPeVU.js";import"./DataAriaLabelMixin-BOwflVwV.js";import"./FormInternalsMixin-DS4X73T0.js";import"./query-DXShiZ7f.js";import"./base-DIkkzJ-c.js";import"./keys-hFXe221I.js";import"./buttonsimple.component-BiDxEwPG.js";import"./TabIndexMixin-CiYdC3A9.js";import"./radio.constants-DVgCsr5_.js";import"./button.component-DS_uJzH5.js";import"./button.utils-rNW36Ji7.js";import"./BackdropMixin-DWE1QluE.js";const{action:a}=__STORYBOOK_MODULE_ACTIONS__,_=e=>n`
  <mdc-radio
    @change="${a("onchange")}"
    @keydown="${a("onkeydown")}"
    @focus="${a("onfocus")}"
  ...
  ></mdc-radio>
`,re={title:"Components/radio",tags:["autodocs"],component:"mdc-radio",render:_,argTypes:{readonly:{control:{type:"boolean"}},disabled:{control:{type:"boolean"}},checked:{control:{type:"boolean"}},label:{control:{type:"text"}},name:{control:{type:"text"}},value:{control:{type:"text"}},"help-text":{control:{type:"text"}},"data-aria-label":{control:{type:"text"}},required:{control:{type:"boolean"}},"toggletip-text":{control:{type:"text"}},"toggletip-placement":{control:{type:"select"},options:Object.values(W)},"toggletip-strategy":{control:{type:"select"},options:Object.values(D)},"info-icon-aria-label":{control:{type:"text"}},"auto-focus-on-mount":{control:"boolean"},...E(["help-text-type"]),...R,...O}},o={args:{label:"Standard Plan",checked:!1,readonly:!1,disabled:!1}},t={render:()=>n`
  ...
  `,parameters:{docs:{description:{story:"Radio buttons with the same `name` attribute are grouped together. When radio buttons share the same `name`, selecting one will automatically deselect the others in the group. The example includes various states of radio buttons such as disabled, readonly, and different labels. We can use flex layout to display radio buttons in a column."}}}},l={args:{"data-aria-label":"Radio button without label"},parameters:{docs:{description:{story:"If we don't want to display a label, we can omit the 'label' attribute, but it is recommended to pass an aria label through data-aria-label for accessibility. "}}}},d={render:()=>n` <div style="display: flex; flex-direction: column;">
    ...
    </div>`,parameters:{docs:{description:{story:"To disable the radio button, use the `disabled` attribute. "}}}},r={render:()=>n` <div style="display: flex; flex-direction: column;">
...
}`,...(f=(h=l.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var g,v,x;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
...
}`,...(k=(S=r.parameters)==null?void 0:S.docs)==null?void 0:k.source}}};var T,w,$;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    label: 'Standard Plan',
...
}`,...($=(w=i.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};const ie=["Example","withNameGroup","WithoutLabel","Disabled","ReadOnly","WithHelpText"];export{d as Disabled,o as Example,r as ReadOnly,i as WithHelpText,l as WithoutLabel,ie as __namedExportsOrder,re as default,t as withNameGroup};
