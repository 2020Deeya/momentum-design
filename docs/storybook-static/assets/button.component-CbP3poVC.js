import{n as m,a4 as y,a5 as s,B as u,b as E,a6 as v,I as O,P as _,a2 as A,a7 as R,R as C,k as b,t as F}from"./iframe-DtiRZQ2l.js";import{B as S}from"./buttonsimple.component-Q3CPaVOs.js";import{g as w}from"./button.utils-rNW36Ji7.js";var B=Object.defineProperty,p=(d,t,l,r)=>{for(var o=void 0,e=d.length-1,a;e>=0;e--)(a=d[e])&&(o=a(t,l,o)||o);return o&&B(t,l,o),o};const L=d=>{class t extends d{constructor(){super(...arguments),this.variant=s.VARIANT,this.color=s.COLOR,this.typeInternal=s.TYPE_INTERNAL}setVariant(r){this.setAttribute("variant",Object.values(u).includes(r)?r:s.VARIANT)}setColor(r){!Object.values(E).includes(r)||this.variant===u.TERTIARY?this.setAttribute("color",`${s.COLOR}`):this.setAttribute("color",r)}setSize(r){const e=this.typeInternal===v.ICON?Object.values(O).includes(r)&&!(r===O[20]&&this.variant!==u.TERTIARY):Object.values(_).includes(r);this.setAttribute("size",e?`${r}`:`${s.SIZE}`)}inferButtonType(){var x,I,k,z,N,T;const r=(I=(x=this.shadowRoot)==null?void 0:x.querySelector("slot:not([name])"))==null?void 0:I.assignedNodes().filter(n=>{var i;return n.nodeType!==Node.TEXT_NODE||((i=n.textContent)==null?void 0:i.trim())}).length,o=(z=(k=this.shadowRoot)==null?void 0:k.querySelector('slot[name="prefix"]'))==null?void 0:z.assignedNodes().filter(n=>{var i;return n.nodeType!==Node.TEXT_NODE||((i=n.textContent)==null?void 0:i.trim())}).length,e=this.prefixIcon||o&&o>0,a=(T=(N=this.shadowRoot)==null?void 0:N.querySelector('slot[name="postfix"]'))==null?void 0:T.assignedNodes().filter(n=>{var i;return n.nodeType!==Node.TEXT_NODE||((i=n.textContent)==null?void 0:i.trim())}).length,g=this.postfixIcon||a&&a>0;r&&(e||g)?(this.typeInternal=v.PILL_WITH_ICON,this.setAttribute("data-btn-type","pill-with-icon")):!r&&(e||g)?(this.typeInternal=v.ICON,this.setAttribute("data-btn-type","icon")):(this.typeInternal=v.PILL,this.setAttribute("data-btn-type","pill"))}}return p([m({type:String,attribute:"prefix-icon",reflect:!0})],t.prototype,"prefixIcon"),p([m({type:String,attribute:"postfix-icon",reflect:!0})],t.prototype,"postfixIcon"),p([m({type:String})],t.prototype,"variant"),p([m({type:String})],t.prototype,"color"),p([y()],t.prototype,"typeInternal"),t},$=A`
  :host {
...
`,j=[$];var U=Object.defineProperty,h=(d,t,l,r)=>{for(var o=void 0,e=d.length-1,a;e>=0;e--)(a=d[e])&&(o=a(t,l,o)||o);return o&&U(t,l,o),o};const f=class f extends R(L(S)){constructor(){super(...arguments),this.size=s.SIZE,this.inverted=s.INVERTED,this.role=C.BUTTON}get overflowElement(){return this.buttonTextPart}update(t){super.update(t),t.has("active")&&this.inferFilledIconName(this.active),t.has("size")&&this.setSize(this.size),t.has("variant")&&(this.setVariant(this.variant),this.setSize(this.size)),t.has("color")&&this.setColor(this.color),t.has("typeInternal")&&this.setSize(this.size),(t.has("prefixIcon")||t.has("postfixIcon"))&&(this.inferFilledIconName(this.active),this.inferButtonType())}inferFilledIconName(t){t?(this.prefixIcon&&(this.prefixFilledIconName=`${w(this.prefixIcon)}-filled`),this.postfixIcon&&(this.postfixFilledIconName=`${w(this.postfixIcon)}-filled`)):(this.prefixFilledIconName=this.prefixIcon,this.postfixFilledIconName=this.postfixIcon)}render(){return b`
    ...
    `}};f.styles=[...S.styles,...j];let c=f;h([F('slot[part="button-text"]')],c.prototype,"buttonTextPart");h([m({type:Number})],c.prototype,"size");h([m({type:Boolean,reflect:!0})],c.prototype,"inverted");h([m({type:String,reflect:!0})],c.prototype,"role");h([y()],c.prototype,"prefixFilledIconName");h([y()],c.prototype,"postfixFilledIconName");export{c as B,L as a};
