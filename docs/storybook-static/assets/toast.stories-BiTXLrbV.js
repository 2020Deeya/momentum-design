import{u as P,I as Y,i as k,B as f,a2 as W,h as y,k as e,T as z,C as S,n as l,a4 as A,V as G}from"./iframe-DtiRZQ2l.js";import{t as V}from"./if-defined-r97CdV4N.js";import{o as j}from"./query-assigned-elements-DwDnvVcz.js";import{F as Z}from"./FooterMixin-Mq4Nldj1.js";import"./index-BK86NvBQ.js";import"./index-DfWVvsBp.js";import"./index-BG1CXw62.js";import"./index-DgEWhX7i.js";import{c as H,s as J}from"./commonArgTypes-BG7EqI50.js";import{b as X,h as K,a as v}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./link.constants-CbPjMniZ.js";import"./index-DOdZz0Sq.js";import"./index-DTrDRi1E.js";import"./button.component-CbP3poVC.js";import"./buttonsimple.component-Q3CPaVOs.js";import"./DisabledMixin-D_v0Rzs7.js";import"./KeyDownHandledMixin-DXj2iMY0.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-CImnIDM_.js";import"./index-LlA7PxVE.js";const q=P.constructTagName("toast"),m={CUSTOM:"custom",SUCCESS:"success",WARNING:"warning",ERROR:"error"},T={SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},a={HEADER_TAG_NAME:"h2",CANCEL_ICON:"cancel-bold",ARROW_UP_BOLD:"arrow-up-bold",ARROW_DOWN_BOLD:"arrow-down-bold",PREFIX_ICON_SIZE:1.5,CLOSE_ICON_SIZE:Y[20],BUTTON:k,PRIMARY_BUTTON:f.PRIMARY,SECONDARY_BUTTON:f.SECONDARY,TERTIARY_BUTTON:f.TERTIARY,VARIANT:m.CUSTOM},Q=t=>{switch(t){case m.SUCCESS:return T.SUCCESS_ICON_NAME;case m.WARNING:return T.WARNING_ICON_NAME;case m.ERROR:return T.ERROR_ICON_NAME;default:return null}},tt=W`
  :host {
...
`,et=[tt];var ot=Object.defineProperty,s=(t,o,n,b)=>{for(var d=void 0,g=t.length-1,_;g>=0;g--)(_=t[g])&&(d=_(o,n,d)||d);return d&&ot(o,n,d),d};const N=class N extends Z(S){constructor(){super(...arguments),this.variant=a.VARIANT,this.headerTagName=a.HEADER_TAG_NAME,this.ariaLabel=null,this.isDetailVisible=!1,this.hasDetailedSlot=!1,this.hasFooterButtons=""}closeToast(){const o=new CustomEvent("close",{bubbles:!0,composed:!0,detail:{id:this.id}});this.dispatchEvent(o)}toggleDetailVisibility(){this.isDetailVisible=!this.isDetailVisible}updateDetailedSlotPresence(){var o;this.hasDetailedSlot=((o=this.detailedElements)==null?void 0:o.some(n=>{var b;return(b=n.textContent)==null?void 0:b.trim()}))??!1}updateFooterButtonsPresence(){var o,n;this.hasFooterButtons=(((o=this.footerButtonPrimary)==null?void 0:o.length)??0)>0||(((n=this.footerButtonSecondary)==null?void 0:n.length)??0)>0||this.shouldRenderToggleButton()?"has-footer-buttons":""}firstUpdated(o){super.firstUpdated(o),this.updateDetailedSlotPresence()}renderIcon(o){return o?e`
    ...
    `:y}renderHeader(){return this.headerText?e`
      ...
      ${this.renderFooter()}
    `}};N.styles=[...S.styles,...et];let r=N;s([l({type:String,reflect:!0})],r.prototype,"variant");s([l({type:String,attribute:"close-button-aria-label"})],r.prototype,"closeButtonAriaLabel");s([l({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText");s([l({type:String,reflect:!0,attribute:"header-tag-name"})],r.prototype,"headerTagName");s([l({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel");s([l({type:String,reflect:!0,attribute:"show-more-text"})],r.prototype,"showMoreText");s([l({type:String,reflect:!0,attribute:"show-less-text"})],r.prototype,"showLessText");s([A()],r.prototype,"isDetailVisible");s([A()],r.prototype,"hasDetailedSlot");s([j({slot:"toast-body-detailed",flatten:!0})],r.prototype,"detailedElements");s([A()],r.prototype,"hasFooterButtons");r.register(q);const{action:rt}=__STORYBOOK_MODULE_ACTIONS__,L=t=>e`
  <mdc-toast
    variant="${V(t.variant)}"
...
`,h={args:{...i,"header-text":"Toast Title","show-more-text":"Show more","show-less-text":"Show less","prefix-icon":"placeholder-bold","normal-body":"This is a toast message.","detailed-body":"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",children:e`${c}`}},p={name:"All Variants",render:()=>e`
  ...
  ...hideAllControls()
}`,...(M=(F=x.parameters)==null?void 0:F.docs)==null?void 0:M.source}}};const Ot=["Example","AllVariants","UserJoined","Connecting"];export{p as AllVariants,x as Connecting,h as Example,u as UserJoined,Ot as __namedExportsOrder,St as default};
