import{S as K,X as P,W as Q,h as X,k as l,n as q,V as E}from"./iframe-DPFjqenE.js";import{D as Y}from"./DisabledMixin-Cykcjfj2.js";import{T as J}from"./TabIndexMixin-DSFaTMZl.js";import{C as x}from"./card.component-BA3fChcx.js";import{K as y}from"./keys-hFXe221I.js";import{T as ee}from"./index-DS0oUM4h.js";import"./index-B3AyXvhh.js";import"./index-C4vhaNGP.js";import{Q as te}from"./repeat-gAP0cejz.js";import{i as d}from"./imageFixtures-CD4avj2q.js";import{c as ae,s as re}from"./commonArgTypes-BluK8w5L.js";import{a as ie,d as oe}from"./utils-Dd_sfl9-.js";import{V as le,O as f,D as t}from"./FooterMixin-CaryS3nL.js";import"./preload-helper-C1FmrZbK.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./index-DS2WEg4g.js";import"./index-DSSW6gez.js";import"./button.component-Bl-tx1B_.js";import"./buttonsimple.component-9O-RouYg.js";import"./button.utils-rNW36Ji7.js";import"./index-dw7rpoDr.js";import"./popover.component-DM3hg66q.js";import"./if-defined-CWibhRqJ.js";import"./BackdropMixin-BxKxUE6U.js";import"./index-Dur846gR.js";import"./v4-CmTdKEVZ.js";import"./DataAriaLabelMixin-CpOSfRJX.js";import"./formfieldwrapper.component-sKN8ResQ.js";import"./formfieldwrapper.constants-BaZKN8L-.js";import"./radio.constants-Dt6uWYmL.js";import"./index-BqLKzGKe.js";import"./index-DTrDRi1E.js";import"./directive-Ctav8iJK.js";import"./link.constants-ypds10gQ.js";const de=K`
  :host {
    cursor: pointer;
    user-select: none;
  }
...
`,ne=[de,...P()];var se=Object.defineProperty,Z=(e,a,o,n)=>{for(var r=void 0,i=e.length-1,v;i>=0;i--)(v=e[i])&&(r=v(a,o,r)||r);return r&&se(a,o,r),r};const I=class I extends Y(J(x)){constructor(){super(),this.checked=!1,this.name="",this.addEventListener("click",this.toggleChecked.bind(this)),this.addEventListener("keydown",this.toggleOnEnter.bind(this)),this.addEventListener("keyup",this.toggleOnSpace.bind(this))}connectedCallback(){super.connectedCallback(),this.role=Q.RADIO}getAllCardsWithinSameGroup(){return Array.from(document.querySelectorAll(`mdc-cardradio[name="${this.name}"]`))}toggleChecked(){if(this.disabled||this.checked)return;this.getAllCardsWithinSameGroup().forEach(o=>{o.checked=!1}),this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}setDisabled(a){this.setAttribute("aria-disabled",`${a}`),this.tabIndex=a?-1:0}update(a){super.update(a),a.has("checked")&&this.setAttribute("aria-checked",`${this.checked}`),a.has("disabled")&&this.setDisabled(this.disabled)}updateCardRadio(a,o){a[o].focus(),a[o].toggleChecked()}toggleOnEnter(a){if(this.disabled)return;const n=this.getAllCardsWithinSameGroup().filter(i=>!i.disabled),r=n.indexOf(this);if(["ArrowDown","ArrowRight"].includes(a.key)){const i=(r+1)%n.length;this.updateCardRadio(n,i)}else if(["ArrowUp","ArrowLeft"].includes(a.key)){const i=(r-1+n.length)%n.length;this.updateCardRadio(n,i)}a.key===y.ENTER&&this.toggleChecked()}toggleOnSpace(a){a.key===y.SPACE&&this.toggleChecked()}renderHeader(){return this.cardTitle?l`<div part="header">
    ...
    `}};I.styles=[...x.styles,...ne];let m=I;Z([q({type:Boolean,reflect:!0})],m.prototype,"checked");Z([q({type:String})],m.prototype,"name");m.register(ee);const{action:c}=__STORYBOOK_MODULE_ACTIONS__,ce=e=>l` <mdc-cardradio
    @click="${c("onclick")}"
    @keydown="${c("onkeydown")}"
    @keyup="${c("onkeyup")}"
    @focus="${c("onfocus")}"
...
}`,...(j=(z=T.parameters)==null?void 0:z.docs)==null?void 0:j.source}}};const Ze=["Example","HorizontalCard","CardWithoutImage","CardWithoutBody","ContentBeforeBody","ContentAfterBody","CardsInRadioGroup"];export{h as CardWithoutBody,p as CardWithoutImage,T as CardsInRadioGroup,A as ContentAfterBody,g as ContentBeforeBody,u as Example,b as HorizontalCard,Ze as __namedExportsOrder,qe as default};
