import{u as v,S as x,k as p,V as u,q as b,h as y,B as A,I as E,E as f,n as a}from"./iframe-bG46usBV.js";import{t as T}from"./if-defined-Di4ztU1F.js";import{B as D,P as I,F as S}from"./BackdropMixin-Brk0KMHX.js";import{F as _}from"./FooterMixin-jTe9xd_H.js";const $=v.constructTagName("dialog"),L={DEFAULT:"default",PROMOTIONAL:"promotional"},o={VISIBLE:!1,Z_INDEX:1e3,ROLE:"dialog",SIZE:"small",HEADER_TAG_NAME:"h2",DESCRIPTION_TAG_NAME:"p",CANCEL_ICON:"cancel-bold",VARIANT:L.DEFAULT,DISABLE_ARIA_HAS_POPUP:!1,FOCUS_TRAP:!0},z=["small","medium","large","xlarge","fullscreen"],F=["dialog","alertdialog"];class c{static dispatchDialogEvent(t,i,d=!0){i.dispatchEvent(new CustomEvent(t,{detail:{show:i.visible},composed:!0,bubbles:d}))}static onShowDialog(t){this.dispatchDialogEvent("shown",t)}static onHideDialog(t){this.dispatchDialogEvent("hidden",t)}static onCloseDialog(t,i=!0){this.dispatchDialogEvent("close",t,i)}static onCreatedDialog(t){this.dispatchDialogEvent("created",t)}static onDestroyedDialog(t){this.dispatchDialogEvent("destroyed",t)}}const B=x`
  :host {
