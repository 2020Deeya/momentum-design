import{i as P,D as f,k as e}from"./lit-element-D5KKan5q.js";import{t as M}from"./if-defined-D5BV9-c0.js";import{a as k}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{u as Y,C as _,n as l}from"./provider.component-BaQC7CJH.js";import{r as A}from"./state-C0WmBOuD.js";import{o as W}from"./query-assigned-elements-uEuc3rg8.js";import{F as z}from"./FooterMixin-Dp15GCvz.js";import{T as G,V as j}from"./index-DHsMOcdX.js";import{I as Z,T as H,B as y}from"./button.constants-B6suqA4v.js";import"./index-Dbn_3kMA.js";import"./index-CYZCdwYI.js";import"./index-CQu1XVAy.js";import"./index-C7TFT72S.js";import{c as J,s as X}from"./commonArgTypes-BluK8w5L.js";import{d as q,a as K,t as Q,h as v}from"./utils-CFOyPOhY.js";import"./v4-CQkTLCs1.js";import"./base-DIkkzJ-c.js";import"./link.constants-Df3Yk0mX.js";import"./buttonsimple.constants-An7St6B1.js";import"./roles-CJI3JVG-.js";import"./iframe-BoEDzChW.js";import"../sb-preview/runtime.js";import"./index-CbmtUAjA.js";import"./iconprovider.component-DWn5NkGG.js";import"./create-context-89xeped_.js";import"./index-CqVtAZCJ.js";import"./index-DTrDRi1E.js";import"./button.component-D5eG231X.js";import"./buttonsimple.component-CKyEWPbX.js";import"./keys-hFXe221I.js";import"./DisabledMixin-DcYwkKYf.js";import"./TabIndexMixin-TvgH_pmh.js";import"./button.utils-rNW36Ji7.js";import"./IconNameMixin-CRlZlTtq.js";import"./index-x3UcAGjz.js";const tt=Y.constructTagName("toast"),m={CUSTOM:"custom",SUCCESS:"success",WARNING:"warning",ERROR:"error"},T={SUCCESS_ICON_NAME:"check-circle-bold",WARNING_ICON_NAME:"warning-bold",ERROR_ICON_NAME:"error-legacy-bold"},a={HEADER_TAG_NAME:"h2",CANCEL_ICON:"cancel-bold",ARROW_UP_BOLD:"arrow-up-bold",ARROW_DOWN_BOLD:"arrow-down-bold",PREFIX_ICON_SIZE:1.5,CLOSE_ICON_SIZE:Z[20],BUTTON:H,PRIMARY_BUTTON:y.PRIMARY,SECONDARY_BUTTON:y.SECONDARY,TERTIARY_BUTTON:y.TERTIARY,VARIANT:m.CUSTOM},et=t=>{switch(t){case m.SUCCESS:return T.SUCCESS_ICON_NAME;case m.WARNING:return T.WARNING_ICON_NAME;case m.ERROR:return T.ERROR_ICON_NAME;default:return null}},ot=P`
  :host {
...
`,rt=[ot];var at=Object.defineProperty,s=(t,o,n,b)=>{for(var d=void 0,g=t.length-1,S;g>=0;g--)(S=t[g])&&(d=S(o,n,d)||d);return d&&at(o,n,d),d};const N=class N extends z(_){constructor(){super(...arguments),this.variant=a.VARIANT,this.headerTagName=a.HEADER_TAG_NAME,this.ariaLabel=null,this.isDetailVisible=!1,this.hasDetailedSlot=!1,this.hasFooterButtons=""}closeToast(){const o=new CustomEvent("close",{bubbles:!0,composed:!0,detail:{id:this.id}});this.dispatchEvent(o)}toggleDetailVisibility(){this.isDetailVisible=!this.isDetailVisible}updateDetailedSlotPresence(){var o;this.hasDetailedSlot=((o=this.detailedElements)==null?void 0:o.some(n=>{var b;return(b=n.textContent)==null?void 0:b.trim()}))??!1}updateFooterButtonsPresence(){var o,n;this.hasFooterButtons=(((o=this.footerButtonPrimary)==null?void 0:o.length)??0)>0||(((n=this.footerButtonSecondary)==null?void 0:n.length)??0)>0||this.shouldRenderToggleButton()?"has-footer-buttons":""}firstUpdated(o){super.firstUpdated(o),this.updateDetailedSlotPresence()}renderIcon(o){return o?e`
    ...
    `:f}renderHeader(){return this.headerText?e`
        ...
        `:f}handleFooterSlot(o,n){super.handleFooterSlot(o,n),this.updateFooterButtonsPresence()}renderFooter(){return this.updateFooterButtonsPresence(),e` <slot name="footer">
      ...
      ${this.renderFooter()}
    `}};N.styles=[..._.styles,...rt];let r=N;s([l({type:String,reflect:!0})],r.prototype,"variant");s([l({type:String,attribute:"close-button-aria-label"})],r.prototype,"closeButtonAriaLabel");s([l({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText");s([l({type:String,reflect:!0,attribute:"header-tag-name"})],r.prototype,"headerTagName");s([l({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel");s([l({type:String,reflect:!0,attribute:"show-more-text"})],r.prototype,"showMoreText");s([l({type:String,reflect:!0,attribute:"show-less-text"})],r.prototype,"showLessText");s([A()],r.prototype,"isDetailVisible");s([A()],r.prototype,"hasDetailedSlot");s([W({slot:"toast-body-detailed",flatten:!0})],r.prototype,"detailedElements");s([A()],r.prototype,"hasFooterButtons");r.register(tt);const L=t=>e`
  <mdc-toast
    variant="${M(t.variant)}"
...
`,Pt={title:"Components/toast",tags:["autodocs"],component:"mdc-toast",render:L,parameters:{badges:["stable"]},argTypes:{variant:{control:"select",options:Object.values(m)},"header-text":{control:"text"},"header-tag-name":{control:"select",options:Object.values(j)},"close-button-aria-label":{control:"text"},"show-more-text":{control:"text"},"show-less-text":{control:"text"},"prefix-icon":{control:"text",description:"Icon name for the content prefix (slot: content-prefix). Only for custom variant."},"normal-body":{control:"text",description:"Content for the main body of the toast (slot: toast-body-normal)"},"detailed-body":{control:"text",description:"Content for the detailed body of the toast, shown when expanded (slot: toast-body-detailed)"},...J,...X,...q(["content-prefix","toast-body-normal","toast-body-detailed","footer-button-primary","footer-button-secondary","footer"]),...K(["children","isDetailVisible","hasDetailedSlot","detailedElements","hasFooterButtons"]),...Q(["--mdc-toast-background-color","--mdc-toast-border-color","--mdc-toast-header-text-color","--mdc-toast-icon-color","--mdc-toast-elevation-3","--mdc-toast-width","--mdc-toast-padding"])}},i={variant:"custom","header-tag-name":"span","close-button-aria-label":"Close toast"},c=e`
  <mdc-button slot="footer-button-secondary">Secondary</mdc-button>
  <mdc-button slot="footer-button-primary">Primary</mdc-button>
`,p={args:{...i,"header-text":"Toast Title","show-more-text":"Show more","show-less-text":"Show less","prefix-icon":"placeholder-bold","normal-body":"This is a toast message.","detailed-body":"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",children:e`${c}`}},h={name:"All Variants",render:()=>e`
  ...
  `,...v()},u={name:"User Joined",args:{...i,"header-text":"",children:e`
    ...
    `},...v()},x={name:"Connecting",args:{...i,"header-text":"Connecting",children:e`
      <mdc-spinner slot="content-prefix" size="small"></mdc-spinner>
    `},...v()};var C,E,w;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    ...DefaultArgs,
...
}`,...(w=(E=p.parameters)==null?void 0:E.docs)==null?void 0:w.source}}};var O,R,$;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: 'All Variants',
  render: () => html\`
    <div style="display: grid; grid-template-columns: repeat(2, 0fr); gap: 2rem;">
      \${[{
  ...
  \`,
  ...hideAllControls()
}`,...($=(R=h.parameters)==null?void 0:R.docs)==null?void 0:$.source}}};var D,I,B;u.parameters={...u.parameters,docs:{...(D=u.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'User Joined',
  args: {
    ...DefaultArgs,
    'header-text': '',
  ...
  ...hideAllControls()
}`,...(B=(I=u.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};var U,F,V;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'Connecting',
  args: {
    ...DefaultArgs,
  ...
  ...hideAllControls()
}`,...(V=(F=x.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};const kt=["Example","AllVariants","UserJoined","Connecting"];export{h as AllVariants,x as Connecting,p as Example,u as UserJoined,kt as __namedExportsOrder,Pt as default};
