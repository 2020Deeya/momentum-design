import"./index-DXkeu3PJ.js";import"./index-0VQUSirF.js";import{T as r}from"./index-CeMd0DMi.js";import"./index-CcLekXMS.js";import{i as u,k as c,D as l,n as k}from"./iframe-BZIqfezz.js";import{R as f}from"./class-map-DAoid3ot.js";import{R as A}from"./roles-CJI3JVG-.js";import{M as h}from"./menuitem.component-DUEyyS6C.js";import{D as R,T as g,I as m,a as b}from"./menuitemradio.constants-Bx8Mp4h5.js";import{b as E}from"./menupopover.constants-DXeyONqs.js";const v=u`
...
`,$=[v];var T=Object.defineProperty,p=(o,t,i,y)=>{for(var e=void 0,a=o.length-1,n;a>=0;a--)(n=o[a])&&(e=n(t,i,e)||e);return e&&T(t,i,e),e};const d=class d extends h{constructor(){super(),this.checked=!1,this.indicator=R.INDICATOR,this.addEventListener("click",this.handleMouseClick.bind(this))}connectedCallback(){super.connectedCallback(),this.role=A.MENUITEMRADIO}getAllRadiosWithinSameGroup(){const t=this.closest(`${g}, ${E}`);return!t||!this.name?[]:Array.from(t.querySelectorAll(`${this.tagName}[name="${this.name}"]`))}updateOtherRadiosCheckedState(){this.getAllRadiosWithinSameGroup().forEach(i=>{i!==this&&i.removeAttribute("checked")})}handleMouseClick(){this.disabled||this.checked||(this.updateOtherRadiosCheckedState(),this.checked=!0,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})))}update(t){super.update(t),t.has("checked")&&(this.ariaChecked=`${this.checked}`,t.get("checked")===!1&&this.checked&&this.updateOtherRadiosCheckedState())}renderStaticRadio(){return this.indicator===m.RADIO?c`
    ...
    `}};d.styles=[...h.styles,...$];let s=d;p([k({type:Boolean,reflect:!0})],s.prototype,"checked");p([k({type:String,reflect:!0})],s.prototype,"indicator");s.register(b);
