import{i as p,k as d,D as f}from"./lit-element-D5KKan5q.js";import{n as h}from"./index-C9z9WAEj.js";import{I as u}from"./IconNameMixin-CujGSn0t.js";import{D as z,a as s,L as m,T as v}from"./link.constants-CqyNsepP.js";import{L as g}from"./linksimple.component-CTvKnIXa.js";import"./index-T_iFLgWD.js";const c=p`
  :host {
    gap: 0.25rem;
  }
...
`,y=[c];var b=Object.defineProperty,x=(i,o,n,I)=>{for(var e=void 0,r=i.length-1,l;r>=0;r--)(l=i[r])&&(e=l(o,n,e)||e);return e&&b(o,n,e),e};const a=class a extends u(g){constructor(){super(...arguments),this.size=z.LINK_SIZE}getIconSize(){switch(this.size){case m.SMALL:return s.SMALL;case m.MIDSIZE:return s.MIDSIZE;default:return s.LARGE}}render(){return d`
      <slot></slot>
      ${this.iconName?d`
        <mdc-icon
          name=${this.iconName}
        ...
        ></mdc-icon>
      `:f}
    `}};a.styles=[...g.styles,...y];let t=a;x([h({type:String,reflect:!0})],t.prototype,"size");t.register(v);
