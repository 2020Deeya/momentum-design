import{i as D,k as c,D as v}from"./lit-element-D5KKan5q.js";import{u as L,P as $,C as O,n as s}from"./index-C9z9WAEj.js";import{t as I}from"./if-defined-D5BV9-c0.js";import{a as _,h as R}from"./index-MA1r3zrt.js";import{a as P}from"./buttonsimple.constants-CGc1uJX6.js";import{T as f,V as E}from"./index-D1yLszQ-.js";import{T as w}from"./index-CHcrYI_8.js";import{p as V}from"./index-2PiEGcHV.js";import{T as x}from"./menupopover.constants-D31hJpJi.js";import{I as B}from"./IconNameMixin-CujGSn0t.js";import{M as k}from"./menuitem.component-BRf3IJAH.js";import{g as M}from"./button.utils-rNW36Ji7.js";import{r as C}from"./state-CSSggq2n.js";import{n as X}from"./create-context-89xeped_.js";import{P as F}from"./popover.component-DqsEEw9E.js";import{b as p,D as G,a as U}from"./divider.constants-DyEGqhgz.js";import{R as W}from"./roles-Ch6n0tol.js";import"./index-fH_qu31O.js";import"./index-BQIA-yjU.js";const Y=[_,D`
  :host {
...
`,...R()],Z=L.constructTagName("sidenavigation"),l={FIXED_EXPANDED:"fixed-expanded",FIXED_COLLAPSED:"fixed-collapsed",FLEXIBLE:"flexible",HIDDEN:"hidden"},g={VARIANT:l.FLEXIBLE},S=L.constructTagName("navitem"),j={DOT:w.DOT,COUNTER:w.COUNTER},H={RIGHT_ARROW:"arrow-right-bold"},z={MAX_COUNTER:99,TEXT_TYPE:f.BODY_MIDSIZE_REGULAR,TAG_NAME:E.SPAN,SIZE:P[24],VARIANT:l.FLEXIBLE},q=D`
:host {
...
`,J=[q],A=class A{constructor(t,e,i){this.variant=t,this.expanded=e,this.parentNavTooltipText=i}hasSiblingWithTriggerId(t){var r;const e=t==null?void 0:t.getAttribute("id");return e?Array.from(((r=t==null?void 0:t.parentElement)==null?void 0:r.children)??[]).some(a=>a!==t&&a.tagName.toLowerCase()===x&&a.getAttribute("triggerid")===e):!1}getParentNavItems(t){if(!t)return[];const e=[];let i=t;for(;i;){const r=i==null?void 0:i.closest(x);if(!r)break;const a=r.getAttribute("triggerid");if(!a)break;const o=document.getElementById(a);if(o&&o.tagName.toLowerCase()===S)e.push(o),i=o;else break}return e}setCurrentActiveNavItem(t){var a;const e=((a=this.currentActiveNavItem)==null?void 0:a.navId)===(t==null?void 0:t.navId),i=(t==null?void 0:t.disableAriaCurrent)||this.hasSiblingWithTriggerId(t);if(e||i||(this.currentActiveNavItem&&(this.currentActiveNavItem.removeAttribute("aria-current"),this.currentActiveNavItem.removeAttribute("active"),this.getParentNavItems(this.currentActiveNavItem).forEach(y=>{y.removeAttribute("tooltip-text"),y.removeAttribute("active")})),!t))return;this.currentActiveNavItem=t,t.setAttribute("aria-current","page"),t.setAttribute("active",""),this.getParentNavItems(t).forEach(o=>{o.setAttribute("tooltip-text",this.parentNavTooltipText||""),o.setAttribute("tooltip-placement",F.BOTTOM),o.setAttribute("active","")})}};A.context=X(Z);let u=A;var K=Object.defineProperty,m=(b,t,e,i)=>{for(var r=void 0,a=b.length-1,o;a>=0;a--)(o=b[a])&&(r=o(t,e,r)||r);return r&&K(t,e,r),r};const N=class N extends ${constructor(){super({context:u.context,initialValue:new u(g.VARIANT,!0)}),this.variant=g.VARIANT,this.customerName="",this.flexibleExpanded=this.variant===g.VARIANT,this.arrowDirection=this.flexibleExpanded?p.NEGATIVE:p.POSITIVE,this.updateExpansionState=()=>{switch(this.variant){case l.FLEXIBLE:this.expanded=this.flexibleExpanded;break;case l.FIXED_EXPANDED:this.expanded=!0;break;case l.FIXED_COLLAPSED:this.expanded=!1;break}}}connectedCallback(){super.connectedCallback(),this.role=W.NAVIGATION}static get Context(){return u.context}updated(t){super.updated(t),t.has("variant")&&(this.setVariant(this.variant),this.updateExpansionState()),(t.has("variant")||t.has("expanded"))&&this.updateContext()}updateContext(){(this.context.value.variant!==this.variant||this.context.value.expanded!==this.expanded||this.context.value.parentNavTooltipText!==this.parentNavTooltipText)&&(this.context.value.variant=this.variant,this.context.value.expanded=this.expanded,this.context.value.parentNavTooltipText=this.parentNavTooltipText,this.context.updateObservers())}setVariant(t){this.setAttribute("variant",Object.values(l).includes(t)?t:g.VARIANT)}toggleSideNavigation(){this.flexibleExpanded=!this.flexibleExpanded,this.arrowDirection=this.arrowDirection===p.NEGATIVE?p.POSITIVE:p.NEGATIVE,this.updateExpansionState()}render(){return this.variant===l.HIDDEN?c``:c`
        <div part="side-navigation-container" id='side-nav-container'>
          ...
          <div part="fixed-section">
              ...
              <div part="brand-logo-container">
                ...
                ${this.expanded?c`<mdc-text type=${f.BODY_MIDSIZE_MEDIUM} tagname=${E.SPAN} 
                part="label">${this.customerName}</mdc-text>`:v}
              </div>
          </div>
        </div>
  ...
  `}};N.styles=[...O.styles,...J];let d=N;m([s({type:String,reflect:!0})],d.prototype,"variant");m([s({type:String,reflect:!0,attribute:"customer-name"})],d.prototype,"customerName");m([s({type:Boolean,reflect:!0})],d.prototype,"expanded");m([s({type:String,reflect:!0,attribute:"grabber-btn-aria-label"})],d.prototype,"grabberBtnAriaLabel");m([s({type:String,reflect:!0,attribute:"parent-nav-tooltip-text"})],d.prototype,"parentNavTooltipText");m([C()],d.prototype,"flexibleExpanded");m([C()],d.prototype,"arrowDirection");var Q=Object.defineProperty,h=(b,t,e,i)=>{for(var r=void 0,a=b.length-1,o;a>=0;a--)(o=b[a])&&(r=o(t,e,r)||r);return r&&Q(t,e,r),r};const T=class T extends B(k){constructor(){super(...arguments),this.maxCounter=z.MAX_COUNTER,this.ariaLabel=null,this.sideNavigationContext=V.consume({host:this,context:d.Context}),this.emitNavItemActiveChange=t=>{const e=new CustomEvent("activechange",{detail:{navId:this.navId,active:t},bubbles:!0});this.dispatchEvent(e)}}connectedCallback(){super.connectedCallback(),this.variant=void 0,this.tooltipPlacement=void 0,this.addEventListener("click",this.handleClickEvent),!this.navId&&this.onerror&&this.onerror("[mdc-navitem] navId is required and was not provided.")}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleClickEvent)}updated(){var e;const t=(e=this.sideNavigationContext)==null?void 0:e.value;if(t)if(this.showLabel=this.isNested()?!0:t.expanded,this.showLabel)this.removeAttribute("aria-label");else{const i=this.label??"";this.ariaLabel=this.ariaLabel||i,this.setAttribute("aria-label",i)}}isNested(){let t=this.parentElement;for(;t;){if(t.tagName.toLowerCase()===x)return!0;t=t.parentElement}return!1}modifyIconName(t){if(!this.iconName)return;const e=this.iconName.endsWith("-filled"),i=M(this.iconName);t?e||(this.prevIconName=this.iconName,this.iconName=`${i}-filled`):this.prevIconName&&(this.iconName=this.prevIconName)}handleClickEvent(){this.disabled||this.emitNavItemActiveChange(this.active)}update(t){super.update(t),t.has("active")&&this.modifyIconName(this.active)}renderTextLabel(t){return c`
      <mdc-text
    ...
    `}renderBadge(t){const e=t?"":"badge";return Object.values(j).includes(this.badgeType)?c`
      <mdc-badge 
        class="${e}"
