import{i as g,k as d,D as m}from"./lit-element-D5KKan5q.js";import{u as p,n as e}from"./index-C9z9WAEj.js";import{a as k,h as y}from"./index-MA1r3zrt.js";import{g as f}from"./button.utils-rNW36Ji7.js";import{B as v}from"./buttonsimple.component-UuTVCePh.js";import{T as h,V as x}from"./index-D1yLszQ-.js";import{I}from"./IconNameMixin-CujGSn0t.js";import{R as A}from"./roles-BH_hBfTz.js";import"./index-vaVizDGy.js";const N=[k,g`
...
`,...y()],T=p.constructTagName("tab"),u={GLASS:"glass",LINE:"line",PILL:"pill"},l={VARIANT:u.PILL,ACTIVE:!1};var S=Object.defineProperty,i=(s,a,t,E)=>{for(var r=void 0,c=s.length-1,b;c>=0;c--)(b=s[c])&&(r=b(a,t,r)||r);return r&&S(a,t,r),r};const n=class n extends I(v){constructor(){super(...arguments),this.active=l.ACTIVE,this.variant=l.VARIANT,this.handleTabActiveChange=a=>{const t=new CustomEvent("activechange",{detail:{tabId:this.tabId,active:a},bubbles:!0});this.dispatchEvent(t)}}connectedCallback(){super.connectedCallback(),this.role=A.TAB,this.softDisabled=void 0,this.size=void 0,this.type=void 0,this.ariaStateKey="aria-selected",!this.tabId&&this.onerror&&this.onerror("tab id is required")}modifyIconName(a){this.iconName&&(a?(this.prevIconName=this.iconName,this.iconName=`${f(this.iconName)}-filled`):this.prevIconName&&(this.iconName=this.prevIconName))}setVariant(a){this.setAttribute("variant",Object.values(u).includes(a)?a:l.VARIANT)}setActive(a,t){super.setActive(a,t),this.modifyIconName(t)}executeAction(){this.handleTabActiveChange(this.active)}update(a){super.update(a),a.has("variant")&&this.setVariant(this.variant)}render(){return d`
      <div part="container">
    ...
    `}};n.styles=[...v.styles,...N];let o=n;i([e({type:Boolean,reflect:!0})],o.prototype,"active");i([e({type:String,reflect:!0})],o.prototype,"text");i([e({type:String,reflect:!0})],o.prototype,"variant");i([e({type:String,reflect:!0,attribute:"tab-id"})],o.prototype,"tabId");o.register(T);export{u as T,o as a};
