import"./index-Bu_SSHse.js";import{u as m,i as h,k as v,C as s,n}from"./iframe-Cg5TAAQy.js";import{D as b}from"./DisabledMixin-BKNV4Fwu.js";const p=m.constructTagName("statictoggle"),u={DEFAULT:"default",COMPACT:"compact"},l={CHECKED:"check-bold",UNCHECKED:"cancel-bold"},E={compact:.75,default:1.25},f={SIZE:u.DEFAULT},k=[h`
    :host {
  ...
  `];var C=Object.defineProperty,g=(r,a,i,y)=>{for(var t=void 0,c=r.length-1,d;c>=0;c--)(d=r[c])&&(t=d(a,i,t)||t);return t&&C(a,i,t),t};const e=class e extends b(s){constructor(){super(...arguments),this.checked=!1,this.size=f.SIZE}render(){return v`
      <slot></slot>
      <div part="slider">
        <mdc-icon
    ...
    `}};e.styles=[...s.styles,...k];let o=e;g([n({type:Boolean,reflect:!0})],o.prototype,"checked");g([n({type:String,reflect:!0})],o.prototype,"size");o.register(p);const _=m.constructTagName("toggle"),A={DEFAULT:"default",COMPACT:"compact"},I={SIZE:A.DEFAULT,VALIDATION_MESSAGE:"Please toggle this switch if you want to proceed."};export{I as D,A as T,_ as a};
