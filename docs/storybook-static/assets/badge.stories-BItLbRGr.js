import"./index-DA5DVIry.js";import{k as D}from"./iframe-BZIqfezz.js";import{c as M,s as V}from"./commonArgTypes-BluK8w5L.js";import{t as F}from"./utils-CFOyPOhY.js";import{T as r,I as h,D as p}from"./badge.constants-CwPhnXQ1.js";import"./if-defined-CZ3GbhfA.js";import"./IconNameMixin-COUfbKOL.js";import"./roles-CJI3JVG-.js";import"./index-CeMd0DMi.js";import"./index-B-4qjIUw.js";import"./index-DXkeu3PJ.js";import"./preload-helper-C1FmrZbK.js";import"./index-CQdIFnMT.js";import"./index-DTrDRi1E.js";const o=[9,99,999],X=e=>D`
  <mdc-badge
    type="${e.type}"
...
`,ae={title:"Components/badge",tags:["autodocs"],component:"mdc-badge",render:X,argTypes:{type:{control:"select",options:Object.values(r)},overlay:{control:"boolean"},counter:{if:{arg:"type",eq:r.COUNTER},control:"number"},"max-counter":{if:{arg:"type",eq:r.COUNTER},control:"select",options:o},"icon-name":{if:{arg:"type",eq:r.ICON},control:"text"},variant:{if:{arg:"type",eq:r.ICON},control:"select",options:Object.values(h)},"aria-label":{control:"text"},...F(["--mdc-badge-primary-foreground-color","--mdc-badge-primary-background-color","--mdc-badge-secondary-foreground-color","--mdc-badge-secondary-background-color","--mdc-badge-success-foreground-color","--mdc-badge-success-background-color","--mdc-badge-warning-foreground-color","--mdc-badge-warning-background-color","--mdc-badge-error-foreground-color","--mdc-badge-error-background-color","--mdc-badge-overlay-background-color"]),...M,...V}},a={args:{type:p.TYPE,"icon-name":"placeholder-bold",variant:p.VARIANT,counter:1,"max-counter":o[1],overlay:!1}},n={args:{type:p.TYPE,"icon-name":"placeholder-bold",variant:p.VARIANT,counter:1,"max-counter":o[1],overlay:!1}},c={args:{type:r.ICON,"icon-name":"placeholder-bold",variant:h.PRIMARY,overlay:!1}},t={args:{type:r.COUNTER,counter:10,"max-counter":o[1],overlay:!1}},s={args:{type:r.SUCCESS,overlay:!1}},l={args:{type:r.WARNING,overlay:!1}},m={args:{type:r.ERROR,overlay:!1}},d={render:q,args:{type:r.COUNTER,counter:1e3,"max-counter":o[2],overlay:!0}};var u,i,y;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
...
}`,...(y=(i=a.parameters)==null?void 0:i.docs)==null?void 0:y.source}}};var g,v,T;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    type: DEFAULTS.TYPE,
    'icon-name': 'placeholder-bold',
    variant: DEFAULTS.VARIANT,
...
}`,...(L=(k=d.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};const ne=["Example","Dot","Icon","Counter","Success","Warning","Error","Overlay"];export{t as Counter,n as Dot,m as Error,a as Example,c as Icon,d as Overlay,s as Success,l as Warning,ne as __namedExportsOrder,ae as default};
