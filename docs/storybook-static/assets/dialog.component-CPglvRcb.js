...
`,V=[k];var H=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,o=(p,t,e,s)=>{for(var a=s>1?void 0:s?Z(t,e):t,n=p.length-1,d;n>=0;n--)(d=p[n])&&(a=(s?d(t,e,a):d(a))||a);return s&&a&&H(t,e,a),a};const v=class v extends C(F(R(B(D)))){constructor(){super(...arguments),this.responsiveSettingsContext=w.consume({host:this,context:u.Context,subscribe:!0,syncProperties:["size"]}),this.id="",this.visible=l.VISIBLE,this.zIndex=l.Z_INDEX,this.internalSize=l.SIZE,this.variant=l.VARIANT,this.closeButtonAriaLabel=null,this.ariaLabel=null,this.ariaLabelledby=null,this.ariaDescribedby=null,this.ariaDescription=null,this.headerTagName=l.HEADER_TAG_NAME,this.descriptionTagName=l.DESCRIPTION_TAG_NAME,this.role=l.ROLE,this.disableAriaHasPopup=l.DISABLE_ARIA_HAS_POPUP,this.focusTrap=l.FOCUS_TRAP,this.preventScroll=!0,this.triggerElement=null,this.lastActiveElement=null,this.onEscapeKeydown=t=>{!this.visible||t.code!=="Escape"||(t.preventDefault(),t.stopPropagation(),this.closeDialog())}}get size(){var t,e;return(e=(t=this.responsiveSettingsContext)==null?void 0:t.value)!=null&&e.forceFullscreenDialog?"fullscreen":this.internalSize}set size(t){this.internalSize=t}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onEscapeKeydown.bind(this))}disconnectedCallback(){var t,e;super.disconnectedCallback(),this.removeEventListener("keydown",this.onEscapeKeydown),this.removeBackdrop(),(t=this.triggerElement)==null||t.setAttribute("aria-expanded","false"),this.deactivatePreventScroll(),(e=this.deactivateFocusTrap)==null||e.call(this),this.focusBackToTrigger(),h.onDestroyedDialog(this)}applyZIndex(){var t;this.style.setProperty("z-index",`${this.zIndex}`),(t=this.backdropElement)==null||t.style.setProperty("z-index",`${this.zIndex-1}`)}async firstUpdated(t){super.firstUpdated(t),this.setAttribute("aria-modal","true"),this.setupAriaLabelledDescribedBy(),this.applyZIndex(),h.onCreatedDialog(this)}async updated(t){if(super.updated(t),t.has("triggerId")&&(this.triggerElement=this.getRootNode().querySelector(`[id="${this.triggerId}"]`),this.setupAriaHasPopup()),t.has("visible")){const e=t.get("visible");await this.isOpenUpdated(e,this.visible)}t.has("zIndex")&&(this.zIndex===null&&(this.zIndex=l.Z_INDEX),this.applyZIndex()),t.has("variant")&&this.updateFooterButtonColors(this.variant),(t.has("ariaLabel")||t.has("ariaLabelledby")||t.has("ariaDescribedby")||t.has("ariaDescription")||t.has("headerText")||t.has("descriptionText"))&&this.setupAriaLabelledDescribedBy(),t.has("focusTrap")&&!this.focusTrap&&this.visible&&this.deactivateFocusTrap()}setupAriaHasPopup(){var t,e;this.disableAriaHasPopup||(e=this.triggerElement)==null||e.setAttribute("aria-haspopup",((t=this.triggerElement)==null?void 0:t.getAttribute("aria-haspopup"))||"dialog")}setupAriaLabelledDescribedBy(){!this.ariaLabelledby&&!this.ariaLabel&&(this.headerText?this.setAttribute("aria-label",this.headerText):this.triggerId&&this.setAttribute("aria-labelledby",this.triggerId)),!this.ariaDescribedby&&!this.ariaDescription&&(this.descriptionText?this.setAttribute("aria-description",this.descriptionText):this.triggerId&&this.setAttribute("aria-describedby",this.triggerId))}closeDialog(){h.onCloseDialog(this,!1)}async isOpenUpdated(t,e){var s,a,n,d,y;t!==e&&(e&&!t?(this.lastActiveElement=document.activeElement,this.removeBackdrop(),this.createBackdrop("dialog"),this.activatePreventScroll(),await this.updateComplete,this.focusTrap&&((s=this.activateFocusTrap)==null||s.call(this)),(a=this.setInitialFocus)==null||a.call(this),(n=this.triggerElement)==null||n.setAttribute("aria-expanded","true"),h.onShowDialog(this)):!e&&t&&(this.removeBackdrop(),(d=this.triggerElement)==null||d.setAttribute("aria-expanded","false"),this.deactivatePreventScroll(),(y=this.deactivateFocusTrap)==null||y.call(this),this.focusBackToTrigger(),h.onHideDialog(this)))}focusBackToTrigger(){this.triggerElement?this.triggerElement.focus():this.lastActiveElement&&this.lastActiveElement.focus&&this.lastActiveElement.focus()}renderHeader(){return this.headerText?m` <div part="header-section">
    ...
    `}};v.styles=[...D.styles,...V];let r=v;o([i({type:String,reflect:!0})],r.prototype,"id",2);o([i({type:String,reflect:!0})],r.prototype,"triggerId",2);o([i({type:Boolean,reflect:!0})],r.prototype,"visible",2);o([i({type:Number,reflect:!0,attribute:"z-index"})],r.prototype,"zIndex",2);o([i({type:String,reflect:!0})],r.prototype,"size",1);o([i({type:String,reflect:!0})],r.prototype,"variant",2);o([i({type:String,attribute:"close-button-aria-label"})],r.prototype,"closeButtonAriaLabel",2);o([i({type:String,reflect:!0,attribute:"aria-label"})],r.prototype,"ariaLabel",2);o([i({type:String,reflect:!0,attribute:"aria-labelledby"})],r.prototype,"ariaLabelledby",2);o([i({type:String,reflect:!0,attribute:"aria-describedby"})],r.prototype,"ariaDescribedby",2);o([i({type:String,reflect:!0,attribute:"aria-description"})],r.prototype,"ariaDescription",2);o([i({type:String,reflect:!0,attribute:"header-text"})],r.prototype,"headerText",2);o([i({type:String,reflect:!0,attribute:"description-text"})],r.prototype,"descriptionText",2);o([i({type:String,reflect:!0,attribute:"header-tag-name"})],r.prototype,"headerTagName",2);o([i({type:String,reflect:!0,attribute:"description-tag-name"})],r.prototype,"descriptionTagName",2);o([i({type:String,reflect:!0})],r.prototype,"role",2);o([i({type:Boolean,reflect:!0,attribute:"disable-aria-haspopup"})],r.prototype,"disableAriaHasPopup",2);o([i({type:Boolean,reflect:!0,attribute:"focus-trap"})],r.prototype,"focusTrap",2);export{W as D,J as T,z as V,l as a,G as b,Q as c,r as d,$ as e};
