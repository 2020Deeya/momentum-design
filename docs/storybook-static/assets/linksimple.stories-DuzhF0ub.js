import{L as O,T as _}from"./linksimple.component-BIYtlEx0.js";import{k as L}from"./iframe-B-ccdKrm.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-7Kv2ZD8z.js";import"./DataAriaLabelMixin-B9dl85lc.js";import"./DisabledMixin-DspPi3Nk.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
