import{u as te,i as ae,C as T,k as d,D as c,z as ee,n as l}from"./iframe-BZIqfezz.js";import"./index-DXkeu3PJ.js";import{e as re}from"./base-DIkkzJ-c.js";import{Q as ie}from"./repeat-DgRDcnn4.js";import{K as le}from"./keys-hFXe221I.js";import{f as E,b as se}from"./index-B-4qjIUw.js";import{c as ne,s as oe}from"./commonArgTypes-BluK8w5L.js";import{t as de}from"./utils-CFOyPOhY.js";import"./preload-helper-C1FmrZbK.js";import"./index-CQdIFnMT.js";import"./index-DTrDRi1E.js";import"./directive-Ctav8iJK.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ue;function me(r){return(e,t)=>re(e,t,{get(){return(this.renderRoot??ue??(ue=document.createDocumentFragment())).querySelectorAll(r)}})}const ce=te.constructTagName("slider"),he={START:"start",END:"end",UNDEFINED:void 0},m={MIN:0,MAX:100,STEP:1,STATE:he.UNDEFINED,ICON_SIZE:1.25,ICON_LENGTH_UNIT:"rem"},be=ae`
  :host {
    width: 100%;
...
`,pe=[se,be];var ve=Object.defineProperty,i=(r,e,t,s)=>{for(var o=void 0,n=r.length-1,u;n>=0;n--)(u=r[n])&&(o=u(e,t,o)||o);return o&&ve(e,t,o),o};const k=class k extends T{constructor(){super(),this.thumbFocused=m.STATE,this.thumbHovered=m.STATE,this.range=!1,this.min=m.MIN,this.max=m.MAX,this.step=m.STEP,this.addEventListener("keydown",this.preventChange.bind(this)),this.addEventListener("mousedown",this.preventChange.bind(this))}updated(e){super.updated(e),(e.has("value")||e.has("step")||e.has("min")||e.has("max")||e.has("disabled")||e.has("softDisabled")||e.has("range")||e.has("valueStart")||e.has("valueEnd"))&&this.updateTrackStyling(),e.has("softDisabled")&&this.setSoftDisabled(),(e.has("range")||e.has("valueStart")||e.has("valueEnd"))&&this.initializeRangeSlider()}preventChange(e){this.softDisabled&&(e instanceof KeyboardEvent&&e.key!==le.TAB||!(e instanceof KeyboardEvent))&&(e.preventDefault(),e.stopPropagation())}setSoftDisabled(){this.inputElements.forEach(e=>{const t=e;this.softDisabled?t.setAttribute("aria-disabled","true"):t.removeAttribute("aria-disabled")})}initializeRangeSlider(){this.valueStart===void 0&&(this.valueStart=this.min),this.valueEnd===void 0&&(this.valueEnd=this.max),this.handleInput(0),this.handleInput(1)}handleInput(e){const t=this.inputElements[e];if(t)if(e===0){if(!this.valueEnd)return;const s=Number(t.value);s>this.valueEnd?(t.value=String(this.valueEnd),this.valueStart=this.valueEnd):s>=this.min&&s<this.valueEnd?this.valueStart=s:s<this.min&&(t.value=String(this.min),this.valueStart=this.min)}else{if(!this.valueStart)return;const s=Number(t.value);s<this.valueStart?(t.value=String(this.valueStart),this.valueEnd=this.valueStart):s<=this.max&&s>this.valueStart?this.valueEnd=s:s>this.max&&(t.value=String(this.max),this.valueEnd=this.max)}}iconTemplate(e,t){return typeof e=="string"&&e.length>0?d`<mdc-icon
      ...
      ${e||u}
        ...
        ${ie(e,t=>t,t=>d`<span part="slider-tick" style=${this.getTickStyles(t)}></span>`)}
...
}`,...(P=(J=S.parameters)==null?void 0:J.docs)==null?void 0:P.source}}};const De=["Example","SliderWithTicks","DisabledSlider","SliderWithIcons","SoftDisabledSlider","RangeSlider","RangeSliderWithTicks","DisabledRangeSlider","SoftDisabledRangeSlider"];export{$ as DisabledRangeSlider,v as DisabledSlider,b as Example,x as RangeSlider,y as RangeSliderWithTicks,g as SliderWithIcons,p as SliderWithTicks,S as SoftDisabledRangeSlider,f as SoftDisabledSlider,De as __namedExportsOrder,Ae as default};
