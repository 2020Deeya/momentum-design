import{a2 as S,a3 as O,a8 as x,u as _,T as $,V as w,a as L,R as C,k as t,h as M,C as U,n as R}from"./iframe-DtiRZQ2l.js";import{B as V}from"./buttonsimple.component-Q3CPaVOs.js";import{I as B}from"./IconNameMixin-CImnIDM_.js";import"./index-BK86NvBQ.js";import{i as D}from"./manifest-D-vaL5Hi.js";import{t as h}from"./if-defined-r97CdV4N.js";import{c as F,s as G}from"./commonArgTypes-BG7EqI50.js";import{h as j,a as P}from"./utils-B5QUENNQ.js";import"./preload-helper-C1FmrZbK.js";import"./DisabledMixin-D_v0Rzs7.js";import"./KeyDownHandledMixin-DXj2iMY0.js";import"./index-DOdZz0Sq.js";import"./index-DTrDRi1E.js";const Y=S`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,W=[O,Y,...x()],Z=_.constructTagName("alertchip"),o={NEUTRAL:"neutral",ERROR:"error",SUCCESS:"success",WARNING:"warning",INFORMATIONAL:"informational"},e={VARIANT:o.NEUTRAL,TEXT_TYPE:$.BODY_MIDSIZE_REGULAR,TAG_NAME:w.SPAN,SIZE:L[24],ROLE:C.BUTTON},z=r=>({[o.ERROR]:"error-legacy-badge-filled",[o.INFORMATIONAL]:"info-badge-filled",[o.NEUTRAL]:"dnd-presence-badge-filled",[o.SUCCESS]:"check-circle-badge-filled",[o.WARNING]:"warning-badge-filled"})[r];var X=Object.defineProperty,y=(r,m,u,H)=>{for(var a=void 0,d=r.length-1,v;d>=0;d--)(v=r[d])&&(a=v(m,u,a)||a);return a&&X(m,u,a),a};const p=class p extends B(V){constructor(){super(...arguments),this.variant=e.VARIANT}connectedCallback(){super.connectedCallback(),this.disabled=void 0,this.softDisabled=void 0,this.active=void 0,this.size=e.SIZE,this.role=e.ROLE}render(){return t`
      ...
      ${this.label?t`<mdc-text part="label" type="${e.TEXT_TYPE}" tagname="${e.TAG_NAME}"
            >${this.label}</mdc-text
          >`:M}
    `}};p.styles=[...U.styles,...W];let c=p;y([R({type:String,reflect:!0})],c.prototype,"variant");y([R({type:String})],c.prototype,"label");c.register(Z);const{action:n}=__STORYBOOK_MODULE_ACTIONS__,K=r=>t` <mdc-alertchip
    @click="${n("onclick")}"
    @keydown="${n("onkeydown")}"
    @keyup="${n("onkeyup")}"
    @focus="${n("onfocus")}"
