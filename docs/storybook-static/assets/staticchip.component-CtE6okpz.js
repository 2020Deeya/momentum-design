import{u as p,T as u,V as g,a2 as v,a3 as k,h as s,k as l,C as i,n as h}from"./iframe-DtiRZQ2l.js";import{I as T}from"./IconNameMixin-CImnIDM_.js";const I=p.constructTagName("staticchip"),E={DEFAULT:"default",COBALT:"cobalt",GOLD:"gold",LIME:"lime",MINT:"mint",ORANGE:"orange",PINK:"pink",PURPLE:"purple",SLATE:"slate",VIOLET:"violet"},c={COLOR:E.DEFAULT,TEXT_TYPE:u.BODY_MIDSIZE_REGULAR,TAG_NAME:g.SPAN},A=v`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
    padding: 0 0.5rem;
...
`,f=[k,A];var L=Object.defineProperty,b=(t,m,d,O)=>{for(var o=void 0,e=t.length-1,n;e>=0;e--)(n=t[e])&&(o=n(m,d,o)||o);return o&&L(m,d,o),o};const a=class a extends T(i){constructor(){super(...arguments),this.color=c.COLOR}renderIcon(){return this.iconName?l` <mdc-icon part="icon" name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:s}render(){return l`
      ${this.renderIcon()}
