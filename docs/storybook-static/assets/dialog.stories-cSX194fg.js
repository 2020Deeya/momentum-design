import"./index-YA1hi5Tx.js";import{k as o}from"./iframe-Bj0osOL6.js";import{t as L}from"./if-defined-CbM6SSoV.js";import{c as xe,s as ze}from"./commonArgTypes-BluK8w5L.js";import{t as ke}from"./utils-CFOyPOhY.js";import{D as Te,a as Ce,b as a,c as s}from"./dialog.component-Kha9mPv4.js";import"./index-BtqqqYhC.js";import"./index-DUmiLLSY.js";import"./index-DF8mFfQO.js";import"./index-DiaU-E_E.js";import"./index-CJA57Hvq.js";import"./index-Bp1KQXl_.js";import"./index-BjY5WNcT.js";import"./preload-helper-C1FmrZbK.js";import"./BackdropMixin-kLxgWVe2.js";import"./button.constants-CTne--Mk.js";import"./buttonsimple.constants-ElE0wGVf.js";import"./roles-CJI3JVG-.js";import"./FooterMixin-CwlrTqHZ.js";import"./query-assigned-elements-uEuc3rg8.js";import"./base-DIkkzJ-c.js";import"./link.constants-_bJ-_aV0.js";import"./IconNameMixin-DCn8z7t-.js";import"./linksimple.component-BMicW1xG.js";import"./DataAriaLabelMixin-CIL0eAON.js";import"./DisabledMixin-BTbPzOYb.js";import"./index-Dlj8Qg7i.js";import"./index-CMrnPay3.js";import"./index-vCr8mJ6x.js";import"./index-DTrDRi1E.js";import"./button.component-CijhK_wp.js";import"./buttonsimple.component-BmcHpvsb.js";import"./keys-hFXe221I.js";import"./TabIndexMixin-CrwsWmHR.js";import"./button.utils-rNW36Ji7.js";import"./popover.component-CbzBHE5I.js";import"./v4-CmTdKEVZ.js";import"./ListNavigationMixin-DgCStHq0.js";import"./listitem.component-WEavzXGq.js";import"./CaptureDestroyEventForChildElement-D--MadB6.js";const{action:c}=__STORYBOOK_MODULE_ACTIONS__,l=(e,t,i)=>o`<mdc-dialog
    class="${e.class}"
    style="${e.style}"
    id="${e.id}"
    z-index="${e["z-index"]}"
...
`,Oe=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
  ...
  `},we=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
    ${m(e.triggerId,"Click me!",t)}
    ${l(e,C(t,!0),i)}
  `},_e=e=>{const t=()=>{document.getElementById(e.id).toggleAttribute("visible")},i=()=>{document.getElementById(e.id).removeAttribute("visible")},n=()=>{window.confirm("Are you sure you want to cancel?")&&t()};return o`
    ${m(e.triggerId,"Click me!",t)}
    ${l(e,o`
        <div slot="dialog-body">
          <p>This is the body content of the dialog.</p>
...
`,Tt={title:"Components/dialog",tags:["autodocs"],component:"mdc-dialog",render:Oe,argTypes:{...xe,...ze,id:{control:"text"},triggerId:{control:"text"},variant:{control:"select",options:Object.values(Te)},"z-index":{control:"number"},"aria-labelledby":{control:"text"},"aria-label":{control:"text"},"close-button-aria-label":{control:"text"},"header-text":{control:"text"},"description-text":{control:"text"},"header-tag-name":{control:"text"},"description-tag-name":{control:"text"},"should-focus-trap-wrap":{control:"boolean"},"focus-trap":{control:"boolean"},role:{control:"select",options:Object.values(Ce)},size:{control:"select",options:Object.values(a)},visible:{control:"boolean"},...ke(["--mdc-dialog-primary-background-color","--mdc-dialog-border-color","--mdc-dialog-header-text-color","--mdc-dialog-description-text-color","--mdc-dialog-elevation-3","--mdc-dialog-width","--mdc-dialog-height"])}},r={id:"dialog","z-index":s.Z_INDEX,role:s.ROLE,triggerId:"dialog-trigger-btn","close-button-aria-label":"Close dialog",visible:!1,variant:s.VARIANT},d={"header-text":"Dialog Header","description-text":"This is a dialog description. It is only present if the header is present.","header-tag-name":s.HEADER_TAG_NAME,"description-tag-name":s.DESCRIPTION_TAG_NAME},g={args:{size:s.SIZE,...r,...d}},p={name:"Size: Small",args:{size:a[0],...r,...d}},u={name:"Size: Medium",args:{size:a[1],...r,...d}},b={name:"Size: Large",args:{size:a[2],...r,...d}},h={name:"Size: XLarge",args:{size:a[3],...r,...d}},v={name:"Size: Fullscreen",args:{size:a[4],...r,...d}},y={args:{...r,size:a[0]}},I={render:We,args:{...r,size:a[0]}},f={render:_e,args:{...r,...d,size:s.SIZE}},$={render:we,args:{...r,...d,size:s.SIZE}},D={render:e=>o`
  ...
  `},S={render:e=>{const t=()=>{document.getElementById(e.id).removeAttribute("visible")};return o`
    ...
    `},args:{...r,...d,size:s.SIZE,mountDialog:!0,visible:!0}},E={render:Ze,args:{...r,size:a[0]}},A={render:Ge,args:{...r,size:a[0]}},x={render:He,args:{...r,size:a[0]}},z={render:Fe,args:{...r,size:a[1]}};var P,B,O;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    size: DEFAULTS.SIZE,
    ...commonProperties,
...
}`,...(Ie=(ye=A.parameters)==null?void 0:ye.docs)==null?void 0:Ie.source}}};var fe,$e,De;x.parameters={...x.parameters,docs:{...(fe=x.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  render: renderDialogWithIframe,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[0]
  }
}`,...(De=($e=x.parameters)==null?void 0:$e.docs)==null?void 0:De.source}}};var Se,Ee,Ae;z.parameters={...z.parameters,docs:{...(Se=z.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  render: renderDialogWithList,
  args: {
    ...commonProperties,
    size: DIALOG_SIZE[1]
  }
}`,...(Ae=(Ee=z.parameters)==null?void 0:Ee.docs)==null?void 0:Ae.source}}};const Ct=["Example","small","medium","large","xlarge","fullscreen","withoutHeader","withoutHeaderOrFooter","withSaveCancelButtons","withCustomHeader","WithoutTriggerElement","MountUnmount","WithPopover","DialogWithinDialog","DialogWithIframe","DialogWithList"];export{x as DialogWithIframe,z as DialogWithList,A as DialogWithinDialog,g as Example,S as MountUnmount,E as WithPopover,D as WithoutTriggerElement,Ct as __namedExportsOrder,Tt as default,v as fullscreen,b as large,u as medium,p as small,$ as withCustomHeader,f as withSaveCancelButtons,y as withoutHeader,I as withoutHeaderOrFooter,h as xlarge};
