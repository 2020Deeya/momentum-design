import{L as O,T as _}from"./linksimple.component-Bl2eVNB7.js";import{k as L}from"./iframe-xJvWfTzZ.js";import{a as s,r as d}from"./utils-Dd_sfl9-.js";import"./if-defined-GCyvQTHu.js";import"./DataAriaLabelMixin-BOwflVwV.js";import"./DisabledMixin-Dw5Pn0Dw.js";import"./preload-helper-C1FmrZbK.js";O.register(_);const{action:r}=__STORYBOOK_MODULE_ACTIONS__,S=e=>L`<mdc-linksimple
    @click="${r("onclick")}"
    @keydown="${r("onkeydown")}"
    @focus="${r("onfocus")}"
    @blur="${r("onblur")}"
