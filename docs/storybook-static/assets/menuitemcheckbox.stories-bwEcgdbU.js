import{a}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{k as i}from"./lit-element-D5KKan5q.js";import"./index-BuwDAA9X.js";import"./index-w9FNf-P9.js";import{c as f,s as v}from"./commonArgTypes-BluK8w5L.js";import{a as D,t as W,h as U}from"./utils-CFOyPOhY.js";import{I as c}from"./menuitemcheckbox.constants-dhHMuWzH.js";import"./v4-CQkTLCs1.js";import"./index-50J1UaLU.js";import"./property-Bj3TGwkg.js";import"./provider.component-DrWB4byV.js";import"./DisabledMixin-B-Cnza7-.js";import"./toggle.constants-CAom3NC2.js";import"./index-D2VIkDCb.js";import"./index-DM9rY9pk.js";import"./popover.component-CWSuSUni.js";import"./base-DIkkzJ-c.js";import"./if-defined-D5BV9-c0.js";import"./roles-CJI3JVG-.js";import"./v4-CmTdKEVZ.js";import"./class-map-BcCVsMyu.js";import"./directive-Ctav8iJK.js";import"./menuitem.component-CnlHXNu3.js";import"./listitem.component-CV5l_1p0.js";import"./query-assigned-elements-uEuc3rg8.js";import"./keys-hFXe221I.js";import"./TabIndexMixin-DEwGeIeI.js";import"./index-B-GnYs90.js";import"./iframe-A7U1n2W_.js";import"../sb-preview/runtime.js";import"./state-CmYk530Z.js";import"./index-CwZu4Wnd.js";import"./iconprovider.component-BtAZSWEH.js";import"./create-context-89xeped_.js";const T=e=>i`<div role="menu" style="width: 25rem;">${e}</div>`,L=e=>T(i` <mdc-menuitemcheckbox
      @change="${a("onchange")}"
      @click="${a("onclick")}"
      @focus="${a("onfocus")}"
      ?disabled="${e.disabled}"
    ...
    >
      ${e.children}
    </mdc-menuitemcheckbox>`),be={title:"Components/menupopover/menuitemcheckbox",tags:["autodocs"],component:"mdc-menuitemcheckbox",render:L,parameters:{badges:["stable"]},argTypes:{checked:{control:"boolean"},indicator:{control:"select",options:Object.values(c)},disabled:{control:"boolean"},label:{control:"text"},"secondary-label":{control:"text"},...D(["data-aria-label","variant","tertiary-label","side-header-text","subline-text","leading-controls","leading-text-primary-label","leading-text-secondary-label","leading-text-tertiary-label","trailing-text-side-header","trailing-text-subline","trailing-controls","arrow-position","arrow-direction"]),...W(["--mdc-listitem-default-background-color","--mdc-listitem-background-color-hover","--mdc-listitem-background-color-active","--mdc-listitem-primary-label-color","--mdc-listitem-secondary-label-color","--mdc-listitem-disabled-color","--mdc-listitem-column-gap","--mdc-listitem-padding-left-and-right"]),...f,...v}},o={args:{indicator:c.CHECKBOX,checked:!1,label:"Menu Item",disabled:!1,"secondary-label":"",children:i`<mdc-icon length-unit="rem" name="alert-muted-bold" slot="leading-controls"></mdc-icon>`}},t={args:{checked:!0,indicator:c.TOGGLE,label:"Menu Item With Toggle",disabled:!1,"secondary-label":""}},m={args:{checked:!0,indicator:c.CHECKBOX,label:"Menu Item With Checkbox",disabled:!1,"secondary-label":""}},n={args:{checked:!0,indicator:c.CHECKMARK,label:"Menu Item With Checkmark",disabled:!1,"secondary-label":""}},d={render:()=>T(i`
    ...
    `),...U()};var l,r,b;o.parameters={...o.parameters,docs:{...(l=o.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
...
}`,...(C=(y=n.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};var I,S,M;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => wrapWithDiv(html\`
    ...
    \`),
  ...hideAllControls()
}`,...(M=(S=d.parameters)==null?void 0:S.docs)==null?void 0:M.source}}};const se=["Example","ToggleWithMenuItem","CheckboxWithMenuItem","CheckmarkWithMenuItem","AllVariants"];export{d as AllVariants,m as CheckboxWithMenuItem,n as CheckmarkWithMenuItem,o as Example,t as ToggleWithMenuItem,se as __namedExportsOrder,be as default};
