import{i as b,D as h,k as t}from"./lit-element-D5KKan5q.js";import{u,C as p,n as c}from"./provider.component-BaQC7CJH.js";import{D as v}from"./DisabledMixin-DcYwkKYf.js";import{I as g}from"./IconNameMixin-CRlZlTtq.js";import{h as y}from"./index-CqVtAZCJ.js";import{T,V as E}from"./index-DHsMOcdX.js";import"./index-Dbn_3kMA.js";import"./index-CYZCdwYI.js";const f=b`
  :host {
    height: 1.5rem;
    gap: 0.25rem;
...
`,A=[y,f],_=u.constructTagName("inputchip"),a={TEXT_TYPE:T.BODY_MIDSIZE_REGULAR,TAG_NAME:E.SPAN,CLOSE_ICON:"cancel-bold"};var k=Object.defineProperty,i=(s,m,d,$)=>{for(var r=void 0,e=s.length-1,n;e>=0;e--)(n=s[e])&&(r=n(m,d,r)||r);return r&&k(m,d,r),r};const l=class l extends g(v(p)){constructor(){super(...arguments),this.label="",this.error=!1,this.clearAriaLabel=""}renderIcon(){return this.iconName?t` <mdc-icon part="icon" name="${this.iconName}" length-unit="rem" size="1"></mdc-icon> `:h}handleClose(){this.dispatchEvent(new CustomEvent("remove",{bubbles:!0,composed:!0}))}render(){return t`
      ...
      ></mdc-button>
    `}};l.styles=[...p.styles,...A];let o=l;i([c({type:String})],o.prototype,"label");i([c({type:Boolean})],o.prototype,"error");i([c({type:String,attribute:"clear-aria-label"})],o.prototype,"clearAriaLabel");o.register(_);export{_ as T};
